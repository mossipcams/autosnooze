...
`,Ve=1e3,Ye=6e4,Ke=36e5,Ze=864e5,Je=60,Xe=1440,Qe=300,et=300,tt=3e3,ot=5e3,at=1e3,it=5e3,st=[{label:"30m",minutes:30},{label:"1h",minutes:60},{label:"1d",minutes:1440},{label:"Custom",minutes:null}],rt={not_automation:"Failed to snooze: One or more selected items are not automations",invalid_duration:"Failed to snooze: Please specify a valid duration (days, hours, or minutes)",resume_time_past:"Failed to snooze: Resume time must be in the future",disable_after_resume:"Failed to snooze: Snooze time must be before resume time"},nt="autosnooze_exclude",lt="autosnooze_include";function ct(e,t,o){const a=[];return e>0&&a.push(`${e} day${1!==e?"s":""}`),t>0&&a.push(`${t} hour${1!==t?"s":""}`),o>0&&a.push(`${o} minute${1!==o?"s":""}`),a.join(", ")}function dt(e,t,o){const a=[];return e>0&&a.push(`${e}d`),t>0&&a.push(`${t}h`),o>0&&a.push(`${o}m`),a.join(" ")||"0m"}function ut(e){const t=e.toLowerCase().replace(/\s+/g,"");if(!t)return null;let o=0,a=!1;const i=t.match(/(\d+(?:\.\d+)?)\s*d/),s=t.match(/(\d+(?:\.\d+)?)\s*h/),r=t.match(/(\d+(?:\.\d+)?)\s*m(?!i)/);if(i?.[1]){const e=parseFloat(i[1]);if(isNaN(e)||e<0)return null;o+=e*Xe,a=!0}if(s?.[1]){const e=parseFloat(s[1]);if(isNaN(e)||e<0)return null;o+=e*Je,a=!0}if(r?.[1]){const e=parseFloat(r[1]);if(isNaN(e)||e<0)return null;o+=e,a=!0}if(!a){const e=parseFloat(t);if(isNaN(e)||!(e>0))return null;o=e}if(o=Math.round(o),o<=0)return null;const n=Math.floor(o/Xe),l=o%Xe;return{days:n,hours:Math.floor(l/Je),minutes:l%Je}}function ht(e){return e.days*Xe+e.hours*Je+e.minutes}function pt(e,t){if(!e||!t)return null;const o=new Date(`${e}T${t}`).getTimezoneOffset(),a=o<=0?"+":"-",i=Math.abs(o);return`${e}T${t}${`${a}${String(Math.floor(i/60)).padStart(2,"0")}:${String(i%60).padStart(2,"0")}`}`}function mt(e="light"){!function(e,t,o){const a=new CustomEvent(`hass-${t}`,{bubbles:!0,composed:!0,detail:o});e.dispatchEvent(a)}(window,"haptic",e)}function gt(e,t){const o=e,a=o?.translation_key??o?.data?.translation_key;if(a&&rt[a])return rt[a];const i=o?.message??"";for(const[e,t]of Object.entries(rt))if(i.includes(e)||i.toLowerCase().includes(e.replace(/_/g," ")))return t;return`${t}. Check Home Assistant logs for details.`}async function _t(e,t){try{await e.callService("autosnooze","pause",t)}catch(e){throw console.error("[AutoSnooze] Failed to pause automations:",e),e}}async function bt(e,t){try{await e.callService("autosnooze","cancel",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to wake automation:",e),e}}async function ft(e,t){try{await e.callService("autosnooze","cancel_scheduled",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to cancel scheduled snooze:",e),e}}const yt="autosnooze_last_duration";function vt(e){return e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function xt(e,t,o){return!(!e.labels||0===e.labels.length)&&e.labels.some(e=>{const a=o[e]?.name;return a?.toLowerCase()===t})}function $t(e,t,o){const a={};return e.forEach(e=>{const i=t(e);i&&0!==i.length?i.forEach(t=>{a[t]||(a[t]=[]),a[t].push(e)}):(a[o]||(a[o]=[]),a[o].push(e))}),Object.entries(a).sort((e,t)=>e[0]===o?1:t[0]===o?-1:e[0].localeCompare(t[0]))}function wt(e,t){const o=new Set;return e.forEach(e=>{const a=t(e);a&&a.forEach(e=>o.add(e))}),o.size}const zt="sensor.autosnooze_snoozed_automations";function At(e){const t=e?.states?.[zt];return t?.attributes?.paused_automations??{}}let kt=class extends ne{constructor(){super(...arguments),this.config={},this._selected=[],this._duration=30*Ye,this._customDuration={days:0,hours:0,minutes:30},this._customDurationInput="30m",this._loading=!1,this._search="",this._filterTab="all",this._expandedGroups={},this._scheduleMode=!1,this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime="",this._labelRegistry={},this._categoryRegistry={},this._entityRegistry={},this._showCustomInput=!1,this._automationsCache=null,this._automationsCacheVersion=0,this._wakeAllPending=!1,this._lastDuration=null,this._interval=null,this._syncTimeout=null,this._labelsFetched=!1,this._categoriesFetched=!1,this._entityRegistryFetched=!1,this._lastHassStates=null,this._lastCacheVersion=0,this._searchTimeout=null,this._wakeAllTimeout=null,this._toastTimeout=null,this._toastFadeTimeout=null}set hass(e){const t=this._hass;this._hass=e;const o=e?.language??e?.locale?.language;o!==this._currentLanguage&&(this._currentLanguage=o,e&&qe(e)),this.requestUpdate("hass",t)}get hass(){return this._hass}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-card",title:"AutoSnooze"}}setConfig(e){this.config=e}getCardSize(){const e=this._getPaused(),t=this._getScheduled();return 4+Object.keys(e).length+Object.keys(t).length}shouldUpdate(e){if(!e.has("hass"))return!0;const t=e.get("hass"),o=this.hass;if(!t||!o)return!0;const a=t.states?.["sensor.autosnooze_snoozed_automations"],i=o.states?.["sensor.autosnooze_snoozed_automations"];if(a!==i)return!0;if(t.entities!==o.entities)return!0;if(t.areas!==o.areas)return!0;const s=o.states??{},r=t.states??{};for(const e of Object.keys(s))if(e.startsWith("automation.")&&r[e]!==s[e])return!0;for(const e of Object.keys(r))if(e.startsWith("automation.")&&!s[e])return!0;return!1}updated(e){super.updated(e),e.has("hass")&&this.hass?.connection&&(this._labelsFetched||this._fetchLabelRegistry(),this._categoriesFetched||this._fetchCategoryRegistry(),this._entityRegistryFetched||this._fetchEntityRegistry())}connectedCallback(){super.connectedCallback(),this._interval&&(window.clearInterval(this._interval),this._interval=null),this._syncTimeout&&(window.clearTimeout(this._syncTimeout),this._syncTimeout=null),this._startSynchronizedCountdown(),this._fetchLabelRegistry(),this._fetchCategoryRegistry(),this._fetchEntityRegistry(),this._lastDuration=function(){try{const e=localStorage.getItem(yt);if(!e)return null;const t=JSON.parse(e);return"number"!=typeof t.minutes||"number"!=typeof t.duration?.days||"number"!=typeof t.duration?.hours||"number"!=typeof t.duration?.minutes?null:t}catch{return null}}()}disconnectedCallback(){super.disconnectedCallback(),null!==this._interval&&(clearInterval(this._interval),this._interval=null),null!==this._syncTimeout&&(clearTimeout(this._syncTimeout),this._syncTimeout=null),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),null!==this._toastTimeout&&(clearTimeout(this._toastTimeout),this._toastTimeout=null),null!==this._toastFadeTimeout&&(clearTimeout(this._toastFadeTimeout),this._toastFadeTimeout=null)}_startSynchronizedCountdown(){const e=1e3-Date.now()%1e3;this._syncTimeout=window.setTimeout(()=>{this._syncTimeout=null,this._updateCountdownIfNeeded(),this._interval=window.setInterval(()=>{this._updateCountdownIfNeeded()},at)},e)}_updateCountdownIfNeeded(){if(!this.hass)return;const e=At(this.hass);Object.keys(e).length>0&&this.requestUpdate()}async _fetchLabelRegistry(){!this._labelsFetched&&this.hass?.connection&&(this._labelRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/label_registry/list"}),o={};return Array.isArray(t)&&t.forEach(e=>{o[e.label_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch label registry:",e),{}}}(this.hass),this._labelsFetched=!0)}async _fetchCategoryRegistry(){!this._categoriesFetched&&this.hass?.connection&&(this._categoryRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/category_registry/list",scope:"automation"}),o={};return Array.isArray(t)&&t.forEach(e=>{o[e.category_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch category registry:",e),{}}}(this.hass),this._categoriesFetched=!0)}async _fetchEntityRegistry(){!this._entityRegistryFetched&&this.hass?.connection&&(this._entityRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/entity_registry/list"}),o={};return Array.isArray(t)&&t.filter(e=>e.entity_id.startsWith("automation.")).forEach(e=>{o[e.entity_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch entity registry:",e),{}}}(this.hass),this._entityRegistryFetched=!0,this._automationsCacheVersion++)}_getAutomations(){if(!this.hass?.states)return[];const e=this.hass.states,t=this._automationsCacheVersion;if(this._lastHassStates===e&&this._lastCacheVersion===t&&this._automationsCache)return this._automationsCache;const o=function(e,t){const o=e?.states,a=e?.entities;if(!o)return[];const i=Object.keys(o).filter(e=>e.startsWith("automation.")).map(e=>{const i=o[e];if(!i)return null;const s=t?.[e],r=a?.[e],n=(s?.categories??{}).automation??null;return{id:e,name:i.attributes?.friendly_name??e.replace("automation.",""),area_id:s?.area_id??r?.area_id??null,category_id:n,labels:s?.labels??r?.labels??[]}}).filter(e=>null!==e).sort((e,t)=>e.name.localeCompare(t.name));return i}(this.hass,this._entityRegistry);return this._automationsCache=o,this._lastCacheVersion=t,this._lastHassStates=e,o}_getFilteredAutomations(){return function(e,t,o){let a=e;const i=e.some(e=>xt(e,lt,o));a=i?a.filter(e=>xt(e,lt,o)):a.filter(e=>!xt(e,nt,o));const s=t.toLowerCase();return s&&(a=a.filter(e=>e.name.toLowerCase().includes(s)||e.id.toLowerCase().includes(s))),a}(this._getAutomations(),this._search,this._labelRegistry)}_getAreaName(e){return this.hass?function(e,t){return e?t.areas?.[e]?.name??vt(e):"Unassigned"}(e,this.hass):be("Unassigned",{id:"group.unassigned"})}_getLabelName(e){return function(e,t){return t[e]?.name??vt(e)}(e,this._labelRegistry)}_getCategoryName(e){return function(e,t){return e?t[e]?.name??vt(e):"Uncategorized"}(e,this._categoryRegistry)}_getGroupedByArea(){return $t(this._getFilteredAutomations(),e=>e.area_id?[this._getAreaName(e.area_id)]:null,be("Unassigned",{id:"group.unassigned"}))}_getGroupedByLabel(){const e=this._getFilteredAutomations(),t=[nt.toLowerCase(),lt.toLowerCase()];return $t(e,e=>{if(!e.labels?.length)return null;const o=e.labels.map(e=>this._getLabelName(e)).filter(e=>!t.includes(e.toLowerCase()));return o.length>0?o:null},be("Unlabeled",{id:"group.unlabeled"}))}_getGroupedByCategory(){return $t(this._getFilteredAutomations(),e=>e.category_id?[this._getCategoryName(e.category_id)]:null,be("Uncategorized",{id:"group.uncategorized"}))}_getAreaCount(){return wt(this._getAutomations(),e=>e.area_id?[e.area_id]:null)}_getLabelCount(){const e=this._getAutomations(),t=[nt.toLowerCase(),lt.toLowerCase()];return wt(e,e=>{if(!e.labels?.length)return null;const o=e.labels.filter(e=>!t.includes(this._getLabelName(e).toLowerCase()));return o.length>0?o:null})}_getCategoryCount(){return wt(this._getAutomations(),e=>e.category_id?[e.category_id]:null)}_getPaused(){return this.hass?At(this.hass):{}}_getPausedGroupedByResumeTime(){return this.hass?function(e){const t=At(e),o={};return Object.entries(t).forEach(([e,t])=>{const a=t.resume_at;o[a]||(o[a]={resumeAt:a,disableAt:t.disable_at,automations:[]}),o[a].automations.push({entity_id:e,friendly_name:t.friendly_name,resume_at:t.resume_at,paused_at:t.paused_at,days:t.days,hours:t.hours,minutes:t.minutes,disable_at:t.disable_at})}),Object.values(o).sort((e,t)=>new Date(e.resumeAt).getTime()-new Date(t.resumeAt).getTime())}(this.hass):[]}_getScheduled(){return this.hass?function(e){const t=e?.states?.[zt];return t?.attributes?.scheduled_snoozes??{}}(this.hass):{}}_formatDateTime(e){return function(e,t){const o=new Date(e),a=new Date,i={weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return o.getFullYear()>a.getFullYear()&&(i.year="numeric"),o.toLocaleString(t,i)}(e,this._getLocale())}_formatCountdown(e){return function(e){const t=new Date(e).getTime()-Date.now();if(t<=0)return"Resuming...";const o=Math.floor(t/Ze),a=Math.floor(t%Ze/Ke),i=Math.floor(t%Ke/Ye),s=Math.floor(t%Ye/Ve);return o>0?`${o}d ${a}h ${i}m`:a>0?`${a}h ${i}m ${s}s`:`${i}m ${s}s`}(e)}_getLocale(){return this.hass?.locale?.language}_toggleSelection(e){mt("selection"),this._selected.includes(e)?this._selected=this._selected.filter(t=>t!==e):this._selected=[...this._selected,e]}_toggleGroupExpansion(e){this._expandedGroups={...this._expandedGroups,[e]:!this._expandedGroups[e]}}_selectGroup(e){const t=e.map(e=>e.id),o=t.every(e=>this._selected.includes(e));this._selected=o?this._selected.filter(e=>!t.includes(e)):[...new Set([...this._selected,...t])]}_selectAllVisible(){const e=this._getFilteredAutomations().map(e=>e.id),t=e.every(e=>this._selected.includes(e));this._selected=t?this._selected.filter(t=>!e.includes(t)):[...new Set([...this._selected,...e])]}_clearSelection(){this._selected=[]}_setDuration(e){this._duration=e*Ye;const t=function(e){const t=Math.floor(e/Xe),o=e%Xe;return{days:t,hours:Math.floor(o/Je),minutes:o%Je}}(e);this._customDuration=t,this._customDurationInput=dt(t.days,t.hours,t.minutes)}_updateCustomDuration(){const e=ht(this._customDuration);this._duration=e*Ye}_handleDurationInput(e){this._customDurationInput=e;const t=ut(e);t&&(this._customDuration=t,this._updateCustomDuration())}_getDurationPreview(){const e=ut(this._customDurationInput);return e?ct(e.days,e.hours,e.minutes):""}_isDurationValid(){return null!==ut(this._customDurationInput)}_enterScheduleMode(){const{date:e,time:t}=function(){const e=new Date;return{date:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,time:`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}}();this._scheduleMode=!0,this._disableAtDate=e,this._disableAtTime=t,this._resumeAtDate=e,this._resumeAtTime=t}_hasResumeAt(){return Boolean(this._resumeAtDate&&this._resumeAtTime)}_hasDisableAt(){return Boolean(this._disableAtDate&&this._disableAtTime)}_parseDurationInput(e){return ut(e)}_formatDuration(e,t,o){return ct(e,t,o)}_combineDateTime(e,t){return pt(e,t)}_getErrorMessage(e,t){return gt(e,t)}_formatRegistryId(e){return vt(e)}_handleKeyDown(e,t){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),t())}_hapticFeedback(e="light"){mt(e)}_handleSearchInput(e){const t=e.target.value;null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},Qe)}_showToast(e,t={}){const{showUndo:o=!1,onUndo:a=null}=t;if(!this.shadowRoot)return;const i=this.shadowRoot.querySelector(".toast");i&&i.remove();const s=document.createElement("div");if(s.className="toast",s.setAttribute("role","alert"),s.setAttribute("aria-live","polite"),s.setAttribute("aria-atomic","true"),o&&a){const t=document.createElement("span");t.textContent=e,s.appendChild(t);const o=document.createElement("button");o.className="toast-undo-btn",o.textContent=be("Undo",{id:"button.undo"}),o.setAttribute("aria-label",be("Undo last action",{id:"a11y.undo_action"})),o.addEventListener("click",e=>{e.stopPropagation(),a(),s.remove()}),s.appendChild(o)}else s.textContent=e;this.shadowRoot.appendChild(s),null!==this._toastTimeout&&clearTimeout(this._toastTimeout),null!==this._toastFadeTimeout&&clearTimeout(this._toastFadeTimeout),this._toastTimeout=window.setTimeout(()=>{this._toastTimeout=null,this.shadowRoot&&s.parentNode&&(s.style.animation=`slideUp ${et}ms ease-out reverse`,this._toastFadeTimeout=window.setTimeout(()=>{this._toastFadeTimeout=null,s.parentNode&&s.remove()},et))},ot)}async _snooze(){if(0!==this._selected.length&&!this._loading){if(this._scheduleMode){if(!this._hasResumeAt())return void this._showToast(be("Please set a complete resume date and time",{id:"toast.error.resume_time_required"}));const e=this._hasDisableAt()?pt(this._disableAtDate,this._disableAtTime):null,t=pt(this._resumeAtDate,this._resumeAtTime);if(!t)return void this._showToast(be("Invalid resume date/time",{id:"toast.error.invalid_datetime"}));const o=Date.now()+it,a=new Date(t).getTime();if(a<=o)return void this._showToast(be("Resume time must be in the future",{id:"toast.error.resume_time_past"}));if(e){if(new Date(e).getTime()>=a)return void this._showToast(be("Snooze time must be before resume time",{id:"toast.error.snooze_before_resume"}))}}else if(0===this._duration)return;this._loading=!0;try{if(!this.hass)return void(this._loading=!1);const e=this._selected.length,t=[...this._selected],o=this._scheduleMode,a=this._hasDisableAt();let i;if(this._scheduleMode){const t=this._hasDisableAt()?pt(this._disableAtDate,this._disableAtTime):null,o=pt(this._resumeAtDate,this._resumeAtTime);if(!o)return void(this._loading=!1);if(await _t(this.hass,{entity_id:this._selected,resume_at:o,...t&&{disable_at:t}}),!this.isConnected||!this.shadowRoot)return void(this._loading=!1);if(t)i=1===e?be("Scheduled 1 automation to snooze",{id:"toast.success.scheduled_one"}):be(me`Scheduled ${e} automations to snooze`,{id:"toast.success.scheduled_many"});else{const t=this._formatDateTime(o);i=1===e?be(me`Snoozed 1 automation until ${t}`,{id:"toast.success.snoozed_until_one"}):be(me`Snoozed ${e} automations until ${t}`,{id:"toast.success.snoozed_until_many"})}}else{const{days:t,hours:o,minutes:a}=this._customDuration;if(await _t(this.hass,{entity_id:this._selected,days:t,hours:o,minutes:a}),!this.isConnected||!this.shadowRoot)return void(this._loading=!1);const s=ct(t,o,a);i=1===e?be(me`Snoozed 1 automation for ${s}`,{id:"toast.success.snoozed_for_one"}):be(me`Snoozed ${e} automations for ${s}`,{id:"toast.success.snoozed_for_many"});const r=ht(this._customDuration);!function(e,t){try{const o={minutes:t,duration:e,timestamp:Date.now()};localStorage.setItem(yt,JSON.stringify(o))}catch{}}(this._customDuration,r),this._lastDuration={minutes:r,duration:this._customDuration,timestamp:Date.now()}}this._hapticFeedback("success"),this._showToast(i,{showUndo:!0,onUndo:async()=>{try{if(!this.hass)return;for(const e of t)o&&a?await ft(this.hass,e):await bt(this.hass,e);if(this.isConnected){this._selected=t;const o=1===e?be("Restored 1 automation",{id:"toast.success.restored_one"}):be(me`Restored ${e} automations`,{id:"toast.success.restored_many"});this._showToast(o)}}catch(e){console.error("Undo failed:",e),this.isConnected&&this.shadowRoot&&this._showToast(be("Failed to undo. The automations may have already been modified.",{id:"toast.error.undo_failed"}))}}}),this._selected=[],this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime=""}catch(e){console.error("Snooze failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(gt(e,"Failed to snooze automations"))}this._loading=!1}}async _wake(e){if(this.hass)try{await bt(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be("Automation resumed successfully",{id:"toast.success.resumed"}))}catch(e){console.error("Wake failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(gt(e,be("Failed to resume automation",{id:"toast.error.resume_failed"})))}}async _handleWakeAll(){if(this._wakeAllPending){if(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,!this.hass)return;try{await async function(e){try{await e.callService("autosnooze","cancel_all",{})}catch(e){throw console.error("[AutoSnooze] Failed to wake all automations:",e),e}}(this.hass),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be("All automations resumed successfully",{id:"toast.success.resumed_all"}))}catch(e){console.error("Wake all failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(be("Failed to resume automations. Check Home Assistant logs for details.",{id:"toast.error.resume_all_failed"}))}}else this._hapticFeedback("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},tt)}async _cancelScheduled(e){if(this.hass)try{await ft(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be("Scheduled snooze cancelled successfully",{id:"toast.success.cancelled"}))}catch(e){console.error("Cancel scheduled failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(gt(e,be("Failed to cancel scheduled snooze",{id:"toast.error.cancel_failed"})))}}_renderDateOptions(){const e=function(e=365,t){const o=[],a=new Date,i=a.getFullYear();for(let s=0;s<e;s++){const e=new Date(a);e.setDate(e.getDate()+s);const r=e.getFullYear(),n=`${r}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=e.toLocaleDateString(t,{weekday:"short"}),c=e.toLocaleDateString(t,{month:"short"}),d=e.getDate(),u=r!==i?`${l}, ${c} ${d}, ${r}`:`${l}, ${c} ${d}`;o.push({value:n,label:u})}return o}(365,this._getLocale());return e.map(e=>B`<option value="${e.value}">${e.label}</option>`)}_getDurationPills(){const e=[...st];if(this._lastDuration){const t=this._lastDuration.minutes,o=!st.some(e=>e.minutes===t);if(o){const{days:o,hours:a,minutes:i}=this._lastDuration.duration,s=dt(o,a,i).replace(/ /g,"");e.unshift({label:`Last ${s}`,minutes:t,isLast:!0})}}return e}_renderSelectionList(){const e=this._getFilteredAutomations();if("all"===this._filterTab)return 0===e.length?B`<div class="list-empty" role="status">${be("No automations found",{id:"list.empty"})}</div>`:e.map(e=>B`
        <button
          type="button"
        ...
        >
          <input
            ...
            aria-label="${be(me`Select ${e.name}`,{id:"a11y.select_automation"})}"
            tabindex="-1"
          />
      ...
      `);const t="areas"===this._filterTab?this._getGroupedByArea():"categories"===this._filterTab?this._getGroupedByCategory():this._getGroupedByLabel();return 0===t.length?B`<div class="list-empty" role="status">${be("No automations found",{id:"list.empty"})}</div>`:t.map(([e,t])=>{const o=!1!==this._expandedGroups[e],a=t.every(e=>this._selected.includes(e.id)),i=t.some(e=>this._selected.includes(e.id))&&!a;return B`
        <button
          ...
          aria-expanded=${o}
          aria-label="${be(me`${e} group, ${t.length} automations`,{id:"a11y.group_header"})}"
        >
          <ha-icon icon="mdi:chevron-right" aria-hidden="true"></ha-icon>
          <span>${e}</span>
          <span class="group-badge" aria-label="${be(me`${t.length} automations`,{id:"a11y.group_count"})}">${t.length}</span>
          <input
            type="checkbox"
            .checked=${a}
            .indeterminate=${i}
            ...
            aria-label="${be(me`Select all automations in ${e}`,{id:"a11y.select_all_in_group"})}"
            tabindex="-1"
          />
        </button>
        ${o?t.map(e=>B`
        ...
        `:B`
          <div class="duration-selector">
            ...
            <div class="duration-pills" role="radiogroup" aria-labelledby="duration-header">
              ${this._getDurationPills().map(e=>{const t=ht(this._customDuration),o=null===e.minutes?this._showCustomInput:!this._showCustomInput&&e.minutes===t;return B`
                    <button
                      type="button"
                      class="pill ${o?"active":""}"
                      ...
                      role="radio"
                      aria-checked=${o}
                      aria-label="${null===e.minutes?be("Custom duration",{id:"a11y.custom_duration"}):e.isLast?be("Snooze for last used duration",{id:"a11y.snooze_last_duration"}):be(me`Snooze for ${e.label}`,{id:"a11y.snooze_for_duration"})}"
                    >
                      ${e.label}
                    </button>
                  `})}
    ...
    `}};kt.styles=We,e([ue({attribute:!1})],kt.prototype,"hass",null),e([ue({attribute:!1})],kt.prototype,"config",void 0),e([he()],kt.prototype,"_selected",void 0),e([he()],kt.prototype,"_duration",void 0),e([he()],kt.prototype,"_customDuration",void 0),e([he()],kt.prototype,"_customDurationInput",void 0),e([he()],kt.prototype,"_loading",void 0),e([he()],kt.prototype,"_search",void 0),e([he()],kt.prototype,"_filterTab",void 0),e([he()],kt.prototype,"_expandedGroups",void 0),e([he()],kt.prototype,"_scheduleMode",void 0),e([he()],kt.prototype,"_disableAtDate",void 0),e([he()],kt.prototype,"_disableAtTime",void 0),e([he()],kt.prototype,"_resumeAtDate",void 0),e([he()],kt.prototype,"_resumeAtTime",void 0),e([he()],kt.prototype,"_labelRegistry",void 0),e([he()],kt.prototype,"_categoryRegistry",void 0),e([he()],kt.prototype,"_entityRegistry",void 0),e([he()],kt.prototype,"_showCustomInput",void 0),e([he()],kt.prototype,"_automationsCache",void 0),e([he()],kt.prototype,"_automationsCacheVersion",void 0),e([he()],kt.prototype,"_wakeAllPending",void 0),e([he()],kt.prototype,"_lastDuration",void 0),kt=e([xe()],kt);const St=r`
  .row {
    margin-bottom: 12px;
  }
  .row label {
...
`;let Ct=class extends ne{constructor(){super(...arguments),this._config={}}set hass(e){const t=this._hass;this._hass=e;const o=e?.language??e?.locale?.language;o!==this._currentLanguage&&(this._currentLanguage=o,e&&qe(e)),this.requestUpdate("hass",t)}get hass(){return this._hass}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config)return;const o={...this._config,[e]:t};""!==t&&null!=t||delete o[e],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0}))}render(){return this._config?B`
      <div class="row">
