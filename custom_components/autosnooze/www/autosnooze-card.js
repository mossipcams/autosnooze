        ...
        `:B`
          <div class="duration-selector">
            ...
            <div class="duration-pills" role="radiogroup" aria-labelledby="duration-header">
              ${this._getDurationPills().map(t=>{const e=Pt(this._customDuration),o=null===t.minutes?this._showCustomInput:!this._showCustomInput&&t.minutes===e;return B`
                    <button
                      type="button"
                      class="pill ${o?"active":""}"
                      ...
                      role="radio"
                      aria-checked=${o}
                      aria-label="${null===t.minutes?"Custom duration":t.isLast?"Snooze for last used duration":`Snooze for ${t.label}`}"
                    >
                      ${t.label}
                    </button>
                  `})}
