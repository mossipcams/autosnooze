...
`;class at extends ne{constructor(){super(...arguments),this._config={}}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config)return;const o={...this._config,[e]:t};""!==t&&null!=t||delete o[e],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0}))}render(){return this._config?B`
      <div class="row">
    ...
    `:B``}}at.styles=ot,e([ce({attribute:!1})],at.prototype,"hass",void 0),e([he()],at.prototype,"_config",void 0);const it=r`
    :host {
      display: block;
    }
    .snooze-list {
