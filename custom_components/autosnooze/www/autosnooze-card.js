...
`,ve=1e3,xe=6e4,we=36e5,ze=864e5,Ae=60,$e=1440,ke=300,Se=300,Ce=3e3,je=5e3,Te=1e3,Re=5e3,Me=1e3,De=3e4,Ee=[{label:"30m",minutes:30},{label:"1h",minutes:60},{label:"12h",minutes:720},{label:"1d",minutes:1440},{label:"Custom",minutes:null}],Pe="autosnooze_exclude",Ie="autosnooze_include";function Fe(e,t){const a=1e3-Date.now()%1e3;e.syncTimeout=globalThis.setTimeout(()=>{e.syncTimeout=null,t(),e.interval=globalThis.setInterval(()=>{t();Date.now()%1e3>50&&(Le(e),Fe(e,t))},Te)},a)}function Ne(e){const t={interval:null,syncTimeout:null};return Fe(t,e),t}function Le(e){null!==e.interval&&(globalThis.clearInterval(e.interval),e.interval=null),null!==e.syncTimeout&&(globalThis.clearTimeout(e.syncTimeout),e.syncTimeout=null)}const Oe="autosnooze_last_duration";const Ue="autosnooze_recent_snoozes";function He(){try{const e=localStorage.getItem(Ue);if(!e)return[];const t=JSON.parse(e);if(!Array.isArray(t))return[];const a=Date.now()-2592e6;return t.filter(e=>"string"==typeof e.id&&"number"==typeof e.timestamp&&e.timestamp>a)}catch{return[]}}function Ge(e){const t=e.toLowerCase().replace(/\s+/g,"");if(!t)return null;let a=0,o=!1;const s=t.match(/(\d+(?:\.\d+)?)\s*d/),i=t.match(/(\d+(?:\.\d+)?)\s*h/),r=t.match(/(\d+(?:\.\d+)?)\s*m(?!i)/);if(s?.[1]){const e=parseFloat(s[1]);if(isNaN(e)||e<0)return null;a+=e*$e,o=!0}if(i?.[1]){const e=parseFloat(i[1]);if(isNaN(e)||e<0)return null;a+=e*Ae,o=!0}if(r?.[1]){const e=parseFloat(r[1]);if(isNaN(e)||e<0)return null;a+=e,o=!0}if(!o){if(!/^\d+(?:\.\d+)?$/.test(t))return null;const e=parseFloat(t);if(isNaN(e)||!(e>0))return null;a=e}if(a=Math.round(a),a<=0)return null;const n=Math.floor(a/$e),l=a%$e;return{days:n,hours:Math.floor(l/Ae),minutes:l%Ae}}function Be(e){return null!==Ge(e)}function We(e){return e.days*$e+e.hours*Ae+e.minutes}const qe={days:0,hours:0,minutes:30};class Ve{constructor(){this._state={selected:[],filterTab:"all",search:"",customDuration:{...qe},customDurationInput:"30m",durationMs:30*xe}}getState(){return{...this._state,selected:[...this._state.selected],customDuration:{...this._state.customDuration}}}setSelection(e){this._state.selected=[...e]}toggleSelection(e){this._state.selected.includes(e)?this._state.selected=this._state.selected.filter(t=>t!==e):this._state.selected=[...this._state.selected,e]}clearSelection(){this._state.selected=[]}setFilterTab(e){this._state.filterTab=e}setSearch(e){this._state.search=e}setDuration(e,t){this._state.customDuration={...e},this._state.customDurationInput=t,this._state.durationMs=We(e)*xe}}const Ye="sensor.autosnooze_snoozed_automations",Ke={},Ze={},Je=[];let Xe=null,Qe=null,et=null,tt=null,at=null;function ot(e){return!e||"object"!=typeof e||Array.isArray(e)?null:e}function st(e){return ot(e)}function it(e){return ot(e)}function rt(e){if(0===Object.keys(e).length)return Je;const t={};return Object.entries(e).forEach(([e,a])=>{const o=a.resume_at;t[o]||(t[o]={resumeAt:o,disableAt:a.disable_at,automations:[]}),t[o].automations.push({entity_id:e,friendly_name:a.friendly_name,resume_at:a.resume_at,paused_at:a.paused_at,days:a.days,hours:a.hours,minutes:a.minutes,disable_at:a.disable_at})}),Object.values(t).sort((e,t)=>new Date(e.resumeAt).getTime()-new Date(t.resumeAt).getTime())}function nt(e){const t=e?.states?.[Ye]?.attributes,a=ot(t),o=a?.schema_version,s=a?.paused??a?.paused_automations,i=a?.scheduled??a?.scheduled_snoozes;if(t===Xe&&o===Qe&&s===et&&i===tt&&at)return at;const r=function(e){const t=ot(e);if(!t)return{paused:Ke,scheduled:Ze};const a=t.schema_version;if(1===a){const e=st(t.paused),a=it(t.scheduled);return e&&a?{paused:e,scheduled:a}:{paused:Ke,scheduled:Ze}}if(void 0===a){const e=st(t.paused)??st(t.paused_automations)??{},a=it(t.scheduled)??it(t.scheduled_snoozes)??{};if(Object.keys(e).length>0||Object.keys(a).length>0)return{paused:e,scheduled:a}}const o=st(t.paused_automations),s=it(t.scheduled_snoozes);return{paused:o??Ke,scheduled:s??Ze}}(t);return Xe=t,Qe=o,et=s,tt=i,at={paused:r.paused,scheduled:r.scheduled,groups:rt(r.paused)},at}const lt=Ye;function dt(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`}function ut(e){return`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}function ct(e){return{adjustModalOpen:!0,adjustModalEntityId:e.entityId??"",adjustModalFriendlyName:e.friendlyName??"",adjustModalResumeAt:e.resumeAt,adjustModalEntityIds:e.entityIds??[],adjustModalFriendlyNames:e.friendlyNames??[]}}function ht(e){return Ne(e)}function mt(e){Le(e)}function pt(){return new Ve}function gt(){return function(){try{const e=localStorage.getItem(Oe);if(!e)return null;const t=JSON.parse(e);return"number"!=typeof t.minutes||"number"!=typeof t.duration?.days||"number"!=typeof t.duration?.hours||"number"!=typeof t.duration?.minutes||"number"!=typeof t.timestamp?null:Date.now()-t.timestamp>6048e5?(localStorage.removeItem(Oe),null):t}catch{return null}}()}function bt(){return He().map(e=>e.id)}async function _t(e){return async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/label_registry/list"}),a={};return Array.isArray(t)&&t.forEach(e=>{a[e.label_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch label registry:",e),null}}(e)}async function ft(e){return async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/category_registry/list",scope:"automation"}),a={};return Array.isArray(t)&&t.forEach(e=>{a[e.category_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch category registry:",e),{}}}(e)}async function yt(e){return async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/entity_registry/list"}),a={};return Array.isArray(t)&&t.filter(e=>e.entity_id.startsWith("automation.")).forEach(e=>{a[e.entity_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch entity registry:",e),{}}}(e)}function vt(e){return nt(e)}function xt(e){return Boolean(e?.states?.[Ye])}function wt(e,t){const a=new Date(e),o=new Date,s={weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return a.getFullYear()>o.getFullYear()&&(s.year="numeric"),a.toLocaleString(t,s)}function zt(e,t="Resuming..."){const a=new Date(e).getTime()-Date.now();if(a<=0)return t;const o=Math.floor(a/ze),s=Math.floor(a%ze/we),i=Math.floor(a%we/xe),r=Math.floor(a%xe/ve);return o>0?`${o}d ${s}h ${i}m`:s>0?`${s}h ${i}m ${r}s`:`${i}m ${r}s`}function At(e,t,a){const o=[];return e>0&&o.push(`${e} day${1!==e?"s":""}`),t>0&&o.push(`${t} hour${1!==t?"s":""}`),a>0&&o.push(`${a} minute${1!==a?"s":""}`),o.join(", ")}function $t(e,t,a){const o=[];return e>0&&o.push(`${e}d`),t>0&&o.push(`${t}h`),a>0&&o.push(`${a}m`),o.join(" ")||"0m"}function kt(e="light"){!function(e,t,a){const o=new CustomEvent(`hass-${t}`,{bubbles:!0,composed:!0,detail:a});e.dispatchEvent(o)}(window,"haptic",e)}const St=Symbol.for("autosnooze.customElements.define.patched"),Ct=Symbol.for("autosnooze.customElements.registeredCtors");function jt(){return navigator.userAgent.toLowerCase().includes("jsdom")}function Tt(){if(!jt())return;const e=customElements;if(e[St])return;const t=e.define.bind(e);e.define=(a,o,s)=>{const i=function(){const e=customElements;return e[Ct]??=new WeakSet,e[Ct]}();if(i.has(o)&&!e.get(a)){const e=class extends o{};return t(a,e,s),void i.add(e)}try{t(a,o,s),i.add(o)}catch(e){if(!function(e){return e instanceof Error&&e.message.includes("constructor has already been registered")}(e))throw e;const r=class extends o{};t(a,r,s),i.add(r)}},e[St]=!0}function Rt(e,t){jt()&&Tt(),customElements.get(e)||customElements.define(e,t)}async function Mt(e,t){try{await e.callService("autosnooze","cancel",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to wake automation:",e),e}}async function Dt(e,t){try{await e.callService("autosnooze","cancel_scheduled",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to cancel scheduled snooze:",e),e}}async function Et(e,t,a){try{await e.callService("autosnooze","adjust",{entity_id:t,...a})}catch(e){throw console.error("[AutoSnooze] Failed to adjust snooze:",e),e}}function Pt(e,t){if(!e||!t)return null;const a=new Date(`${e}T${t}`);if(Number.isNaN(a.getTime()))return null;const o=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,s=`${String(a.getHours()).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}`;if(o!==e||s!==t)return null;const i=a.getTimezoneOffset(),r=i<=0?"+":"-",n=Math.abs(i);return`${e}T${t}${`${r}${String(Math.floor(n/60)).padStart(2,"0")}:${String(n%60).padStart(2,"0")}`}`}const It="autosnooze_confirm",Ft=["alarm","security","siren","lock","smoke","carbon monoxide","co2","leak","flood","fire","gas"];function Nt(e){return Ft.some(t=>{const a=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(?<![a-z0-9])${a}(?![a-z0-9])`,"i").test(e)})}function Lt(e){const t=new Set(e.selected);return e.automations.some(a=>{return!!t.has(a.id)&&(o=a.labels,s=e.labelRegistry,o.some(e=>e===It||s[e]?.name===It)||Nt(a.id)||Nt(a.name));var o,s})}async function Ot(e){const t=e.scheduleMode?function(e){const t=e.disableAtDate&&e.disableAtTime?Pt(e.disableAtDate,e.disableAtTime):null,a=Pt(e.resumeAtDate,e.resumeAtTime);if(!a)return null;const o={entity_id:e.selected,resume_at:a,...t&&{disable_at:t},...e.forceConfirm&&{confirm:!0}},s=e.selected.length;return{request:o,toastMessage:t?1===s?_e(e.hass,"toast.success.scheduled_one"):_e(e.hass,"toast.success.scheduled_many",{count:s}):1===s?_e(e.hass,"toast.success.snoozed_until_one",{time:wt(a,e.hass.locale?.language)}):_e(e.hass,"toast.success.snoozed_until_many",{count:s,time:wt(a,e.hass.locale?.language)})}}(e):function(e){const{days:t,hours:a,minutes:o}=e.customDuration,s={minutes:We(e.customDuration),duration:e.customDuration,timestamp:Date.now()};return{request:{entity_id:e.selected,days:t,hours:a,minutes:o,...e.forceConfirm&&{confirm:!0}},toastMessage:1===e.selected.length?_e(e.hass,"toast.success.snoozed_for_one",{duration:At(t,a,o)}):_e(e.hass,"toast.success.snoozed_for_many",{count:e.selected.length,duration:At(t,a,o)}),lastDuration:s}}(e);if(!t)return{status:"aborted"};try{await async function(e,t){try{await e.callService("autosnooze","pause",t)}catch(e){throw console.error("[AutoSnooze] Failed to pause automations:",e),e}}(e.hass,t.request)}catch(e){if("confirm_required"===function(e){const t=e;return t?.translation_key??t?.data?.translation_key}(e))return{status:"confirm_required"};throw e}return function(e){try{const t=Date.now(),a=He(),o=e.map(e=>({id:e,timestamp:t})),s=new Set(e),i=[...o,...a.filter(e=>!s.has(e.id))].slice(0,10);localStorage.setItem(Ue,JSON.stringify(i))}catch{}}(e.selected),function(e){return"lastDuration"in e}(t)?(function(e,t){try{const a={minutes:t,duration:e,timestamp:Date.now()};localStorage.setItem(Oe,JSON.stringify(a))}catch{}}(t.lastDuration.duration,t.lastDuration.minutes),{status:"submitted",toastMessage:t.toastMessage,lastDuration:t.lastDuration}):{status:"submitted",toastMessage:t.toastMessage}}async function Ut(e,t){await Mt(e,t)}async function Ht(e){await async function(e){try{await e.callService("autosnooze","cancel_all",{})}catch(e){throw console.error("[AutoSnooze] Failed to wake all automations:",e),e}}(e)}function Gt(e){if(!e)return null;const t=new Date(e).getTime();return Number.isFinite(t)?t:null}function Bt(e){return e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function Wt(e,t,a="Unassigned"){return e?t.areas?.[e]?.name??Bt(e):a}function qt(e,t){return t[e]?.name??Bt(e)}function Vt(e,t,a="Uncategorized"){return e?t[e]?.name??Bt(e):a}function Yt(e,t,a){return!(!e.labels||0===e.labels.length)&&e.labels.some(e=>{const o=a[e]?.name;return o?.toLowerCase()===t})}function Kt(e,t,a){const o={};return e.forEach(e=>{const s=t(e);if(!s||0===s.length)return o[a]||(o[a]=[]),void o[a].push(e.automation);s.forEach(t=>{o[t]||(o[t]=[]),o[t].push(e.automation)})}),Object.entries(o).sort((e,t)=>e[0]===a?1:t[0]===a?-1:e[0].localeCompare(t[0]))}function Zt(e){const t=new Set([Pe.toLowerCase(),Ie.toLowerCase()]),a=e.search.toLowerCase(),o=new Set,s=new Set,i=new Set,r=e.automations.map(a=>{a.area_id&&o.add(a.area_id),a.category_id&&i.add(a.category_id);const r=function(e,t,a){return e.labels?.length?e.labels.map(e=>qt(e,t)).filter(e=>!a.has(e.toLowerCase())):[]}(a,e.labelRegistry,t);return a.labels?.length&&a.labels.forEach(a=>{const o=qt(a,e.labelRegistry).toLowerCase();t.has(o)||s.add(a)}),{automation:a,areaName:a.area_id?e.hass?Wt(a.area_id,e.hass,e.emptyAreaLabel):Bt(a.area_id):e.emptyAreaLabel,categoryName:a.category_id?Vt(a.category_id,e.categoryRegistry,e.emptyCategoryLabel):e.emptyCategoryLabel,visibleLabelNames:r,hasIncludeLabel:Yt(a,Ie,e.labelRegistry),hasExcludeLabel:Yt(a,Pe,e.labelRegistry)}}),n=r.some(e=>e.hasIncludeLabel),l=r.filter(e=>!!(n?e.hasIncludeLabel:!e.hasExcludeLabel)&&(!a||(e.automation.name.toLowerCase().includes(a)||e.automation.id.toLowerCase().includes(a)))),d="areas"===e.filterTab?Kt(l,e=>e.automation.area_id?[e.areaName]:null,e.emptyAreaLabel):"categories"===e.filterTab?Kt(l,e=>e.automation.category_id?[e.categoryName]:null,e.emptyCategoryLabel):"labels"===e.filterTab?Kt(l,e=>e.visibleLabelNames.length>0?e.visibleLabelNames:null,e.emptyLabelLabel):[];return{filtered:l.map(e=>e.automation),grouped:d,areaCount:o.size,labelCount:s.size,categoryCount:i.size}}class Jt extends ne{constructor(){super(...arguments),this.config={},this._cardStore=pt(),this._selected=[],this._duration=30*xe,this._customDuration={days:0,hours:0,minutes:30},this._customDurationInput="30m",this._loading=!1,this._scheduleMode=!1,this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime="",this._labelRegistry={},this._labelRegistryUnavailable=!1,this._categoryRegistry={},this._entityRegistry={},this._showCustomInput=!1,this._automationsCache=null,this._automationsCacheVersion=0,this._lastDuration=null,this._recentSnoozeIds=[],this._adjustModalOpen=!1,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt="",this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[],this._guardrailConfirmOpen=!1,this._labelsFetched=!1,this._categoriesFetched=!1,this._entityRegistryFetched=!1,this._labelRegistryFetchPromise=null,this._categoryRegistryFetchPromise=null,this._entityRegistryFetchPromise=null,this._lastAutomationFingerprintStates=null,this._lastAutomationFingerprint="",this._lastHassStates=null,this._lastCacheVersion=0,this._toastTimeout=null,this._toastFadeTimeout=null,this._labelRegistryRetryTimeout=null,this._labelRegistryRetryDelayMs=Me}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-card",title:"AutoSnooze"}}setConfig(e){this.config=e}getCardSize(){const e=this._getPausedSnapshot(),t=e.paused,a=e.scheduled;return 4+Object.keys(t).length+Object.keys(a).length}shouldUpdate(e){if(!e.has("hass"))return!0;const t=e.get("hass"),a=this.hass;if(!t||!a)return!0;const o=t.states?.[lt],s=a.states?.[lt];if(o!==s)return!0;if(t.entities!==a.entities)return!0;if(t.areas!==a.areas)return!0;if((t.language??t.locale?.language)!==(a.language??a.locale?.language))return!0;const i=a.states,r=t.states;return!i||!r||r!==i&&this._haveAutomationStatesChanged(r,i)}willUpdate(e){super.willUpdate(e),e.has("hass")&&this._syncAdjustModalWithPausedState()}updated(e){super.updated(e),e.has("hass")&&this.hass?.connection&&(this._labelsFetched||null!==this._labelRegistryRetryTimeout||this._fetchLabelRegistry(),this._categoriesFetched||this._fetchCategoryRegistry(),this._entityRegistryFetched||this._fetchEntityRegistry())}_syncAdjustModalWithPausedState(){if(!this._adjustModalOpen)return;const e=this._getPaused();if(this._adjustModalEntityIds.length>0){if(!this._adjustModalEntityIds.some(t=>e[t]))return void this._handleCloseModalEvent();const t=this._adjustModalEntityIds.find(t=>e[t]);if(t){const a=e[t];a?.resume_at&&a.resume_at!==this._adjustModalResumeAt&&(this._adjustModalResumeAt=a.resume_at)}return}if(this._adjustModalEntityId){const t=e[this._adjustModalEntityId];t?.resume_at&&t.resume_at!==this._adjustModalResumeAt&&(this._adjustModalResumeAt=t.resume_at),t||this._handleCloseModalEvent()}}connectedCallback(){super.connectedCallback(),this._fetchLabelRegistry(),this._fetchCategoryRegistry(),this._fetchEntityRegistry(),this._lastDuration=gt(),this._refreshRecentSnoozeIds()}disconnectedCallback(){super.disconnectedCallback(),null!==this._toastTimeout&&(clearTimeout(this._toastTimeout),this._toastTimeout=null),null!==this._toastFadeTimeout&&(clearTimeout(this._toastFadeTimeout),this._toastFadeTimeout=null),null!==this._labelRegistryRetryTimeout&&(clearTimeout(this._labelRegistryRetryTimeout),this._labelRegistryRetryTimeout=null)}async _fetchLabelRegistry(){if(!this._labelsFetched&&this.hass?.connection)if(this._labelRegistryFetchPromise)await this._labelRegistryFetchPromise;else{this._labelRegistryFetchPromise=(async()=>{const e=await _t(this.hass);if(null!==e)this._labelRegistry=e,this._labelsFetched=!0,this._labelRegistryUnavailable=!1,this._automationsCacheVersion++,this._labelRegistryRetryDelayMs=Me,null!==this._labelRegistryRetryTimeout&&(clearTimeout(this._labelRegistryRetryTimeout),this._labelRegistryRetryTimeout=null);else if(this._labelsFetched=!1,this._labelRegistryUnavailable=!0,null===this._labelRegistryRetryTimeout){const e=this._labelRegistryRetryDelayMs;this._labelRegistryRetryTimeout=window.setTimeout(()=>{this._labelRegistryRetryTimeout=null,this.isConnected&&this._fetchLabelRegistry()},e),this._labelRegistryRetryDelayMs=Math.min(2*this._labelRegistryRetryDelayMs,De)}})();try{await this._labelRegistryFetchPromise}finally{this._labelRegistryFetchPromise=null}}}async _fetchCategoryRegistry(){if(!this._categoriesFetched&&this.hass?.connection)if(this._categoryRegistryFetchPromise)await this._categoryRegistryFetchPromise;else{this._categoryRegistryFetchPromise=(async()=>{this._categoryRegistry=await ft(this.hass),this._categoriesFetched=!0})();try{await this._categoryRegistryFetchPromise}finally{this._categoryRegistryFetchPromise=null}}}async _fetchEntityRegistry(){if(!this._entityRegistryFetched&&this.hass?.connection)if(this._entityRegistryFetchPromise)await this._entityRegistryFetchPromise;else{this._entityRegistryFetchPromise=(async()=>{this._entityRegistry=await yt(this.hass),this._entityRegistryFetched=!0,this._automationsCacheVersion++})();try{await this._entityRegistryFetchPromise}finally{this._entityRegistryFetchPromise=null}}}_refreshRecentSnoozeIds(){this._recentSnoozeIds=bt()}_getAutomations(){if(!this.hass?.states)return[];const e=this.hass.states,t=this._automationsCacheVersion;if(this._lastHassStates===e&&this._lastCacheVersion===t&&this._automationsCache)return this._automationsCache;const a=function(e,t){const a=e?.states,o=e?.entities;return a?Object.keys(a).filter(e=>e.startsWith("automation.")).map(e=>{const s=a[e];if(!s)return null;const i=t?.[e],r=o?.[e],n=i?.categories??{};return{id:e,name:s.attributes?.friendly_name??e.replace("automation.",""),area_id:i?.area_id??r?.area_id??null,category_id:n.automation??null,labels:i?.labels??r?.labels??[]}}).filter(e=>null!==e).sort((e,t)=>e.name.localeCompare(t.name)):[]}(this.hass,this._entityRegistry);return this._automationsCache=a,this._lastCacheVersion=t,this._lastHassStates=e,a}_getAutomationStateFingerprint(e){if(this._lastAutomationFingerprintStates===e)return this._lastAutomationFingerprint;const t=Object.keys(e).filter(e=>e.startsWith("automation.")).sort().map(t=>{const a=e[t];return`${t}:${a?.state??""}:${a?.last_changed??""}:${a?.last_updated??""}`}).join("|");return this._lastAutomationFingerprintStates=e,this._lastAutomationFingerprint=t,t}_haveAutomationStatesChanged(e,t){let a=0;for(const[o,s]of Object.entries(e))if(o.startsWith("automation.")){if(a+=1,!(o in t))return!0;if(t[o]!==s)return!0}let o=0;for(const e of Object.keys(t))e.startsWith("automation.")&&(o+=1);return a!==o}_getPaused(){return this._getPausedSnapshot().paused}_getPausedGroupedByResumeTime(){return this._getPausedSnapshot().groups}_getScheduled(){return this._getPausedSnapshot().scheduled}_getPausedSnapshot(){return this.hass?vt(this.hass):{paused:{},scheduled:{},groups:[]}}_isSnoozeSensorAvailable(){return xt(this.hass)}_formatDateTime(e){return wt(e,this._getLocale())}_getLocale(){return this.hass?.locale?.language}_hasResumeAt(){return Boolean(this._resumeAtDate&&this._resumeAtTime)}_hasDisableAt(){return Boolean(this._disableAtDate&&this._disableAtTime)}_hapticFeedback(e="light"){kt(e)}_showToast(e,t={}){const{showUndo:a=!1,onUndo:o=null}=t;if(!this.shadowRoot)return;const s=this.shadowRoot.querySelector(".toast");s&&s.remove();const i=document.createElement("div");if(i.className="toast",i.setAttribute("role","alert"),i.setAttribute("aria-live","polite"),i.setAttribute("aria-atomic","true"),a&&o){const t=document.createElement("span");t.textContent=e,i.appendChild(t);const a=document.createElement("button");a.className="toast-undo-btn",a.textContent=_e(this.hass,"button.undo"),a.setAttribute("aria-label",_e(this.hass,"a11y.undo_action")),a.addEventListener("click",e=>{e.stopPropagation(),o(),i.remove()}),i.appendChild(a)}else i.textContent=e;this.shadowRoot.appendChild(i),null!==this._toastTimeout&&clearTimeout(this._toastTimeout),null!==this._toastFadeTimeout&&clearTimeout(this._toastFadeTimeout),this._toastTimeout=window.setTimeout(()=>{this._toastTimeout=null,this.shadowRoot&&i.parentNode&&(i.style.animation=`slideUp ${Se}ms ease-out reverse`,this._toastFadeTimeout=window.setTimeout(()=>{this._toastFadeTimeout=null,i.parentNode&&i.remove()},Se))},je)}async _snooze(e=!1){if(0!==this._selected.length&&!this._loading){if(this._scheduleMode){if(!this._hasResumeAt())return void this._showToast(_e(this.hass,"toast.error.resume_time_required"));const e=function(e){const t=Gt(Pt(e.resumeAtDate,e.resumeAtTime));if(null===t)return{status:"error",message:"Resume time is required"};if(t<=e.nowMs)return{status:"error",message:"Resume time must be in the future"};const a=e.disableAtDate&&e.disableAtTime?Pt(e.disableAtDate,e.disableAtTime):null;if(e.disableAtDate&&e.disableAtTime&&null===a)return{status:"error",message:"Snooze time must be before resume time"};if(a){const e=Gt(a);if(null===e)return{status:"error",message:"Snooze time must be before resume time"};if(e>=t)return{status:"error",message:"Snooze time must be before resume time"}}return{status:"valid"}}({disableAtDate:this._disableAtDate,disableAtTime:this._disableAtTime,resumeAtDate:this._resumeAtDate,resumeAtTime:this._resumeAtTime,nowMs:Date.now()+Re});if("error"===e.status){const t="Resume time is required"===e.message?_e(this.hass,"toast.error.invalid_datetime"):"Resume time must be in the future"===e.message?_e(this.hass,"toast.error.resume_time_past"):_e(this.hass,"toast.error.snooze_before_resume");return void this._showToast(t)}}else if(0===this._duration)return;if(e||!Lt({selected:this._selected,automations:this._getAutomations(),labelRegistry:this._labelRegistry})){this._loading=!0,this._guardrailConfirmOpen=!1;try{if(!this.hass)return void(this._loading=!1);const t=this._selected.length,a=[...this._selected],o=this._scheduleMode,s=this._hasDisableAt(),i=await Ot({hass:this.hass,selected:this._selected,scheduleMode:this._scheduleMode,customDuration:this._customDuration,disableAtDate:this._disableAtDate,disableAtTime:this._disableAtTime,resumeAtDate:this._resumeAtDate,resumeAtTime:this._resumeAtTime,forceConfirm:e});if("confirm_required"===i.status)return this._guardrailConfirmOpen=!0,void(this._loading=!1);if("aborted"===i.status)return void(this._loading=!1);if(i.lastDuration&&(this._lastDuration=i.lastDuration),this._refreshRecentSnoozeIds(),!this.isConnected||!this.shadowRoot)return void(this._loading=!1);this._hapticFeedback("success"),this._showToast(i.toastMessage,{showUndo:!0,onUndo:async()=>{try{if(!this.hass)return;const e=await async function(e,t,a){const o=a.wasScheduleMode&&a.hadDisableAt?t=>Dt(e,t):t=>Mt(e,t),s=await Promise.allSettled(t.map(e=>o(e))),i=[],r=[];return s.forEach((e,a)=>{const o=t[a];o&&("fulfilled"===e.status?i.push(o):r.push(o))}),{succeeded:i,failed:r}}(this.hass,a,{wasScheduleMode:o,hadDisableAt:s});if(this.isConnected)if(0===e.failed.length){this._setSelected(a);const e=1===t?_e(this.hass,"toast.success.restored_one"):_e(this.hass,"toast.success.restored_many",{count:t});this._showToast(e)}else this._setSelected(e.failed),this._showToast(_e(this.hass,"toast.error.undo_failed"))}catch(e){console.error("Undo failed:",e),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.error.undo_failed"))}}}),this._setSelected([]),this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime=""}catch(e){console.error("Snooze failed:",e),this._hapticFeedback("failure")}this._loading=!1}else this._guardrailConfirmOpen=!0}}async _wake(e){if(this.hass)try{await Ut(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.resumed"))}catch(e){console.error("Wake failed:",e),this._hapticFeedback("failure")}}async _handleWakeEvent(e){await this._wake(e.detail.entityId)}async _handleWakeAllEvent(){if(this.hass)try{await Ht(this.hass),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.resumed_all"))}catch(e){console.error("Wake all failed:",e),this._hapticFeedback("failure")}}_handleAdjustAutomationEvent(e){const t=ct({entityId:e.detail.entityId,friendlyName:e.detail.friendlyName,resumeAt:e.detail.resumeAt});this._adjustModalOpen=t.adjustModalOpen,this._adjustModalEntityId=t.adjustModalEntityId,this._adjustModalFriendlyName=t.adjustModalFriendlyName,this._adjustModalResumeAt=t.adjustModalResumeAt,this._adjustModalEntityIds=t.adjustModalEntityIds,this._adjustModalFriendlyNames=t.adjustModalFriendlyNames}_handleAdjustGroupEvent(e){const t=ct({entityIds:e.detail.entityIds,friendlyNames:e.detail.friendlyNames,resumeAt:e.detail.resumeAt});this._adjustModalOpen=t.adjustModalOpen,this._adjustModalEntityIds=t.adjustModalEntityIds,this._adjustModalFriendlyNames=t.adjustModalFriendlyNames,this._adjustModalEntityId=t.adjustModalEntityId,this._adjustModalFriendlyName=t.adjustModalFriendlyName,this._adjustModalResumeAt=t.adjustModalResumeAt}async _handleAdjustTimeEvent(e){if(this.hass)try{const t=await async function(e,t,a){const{entityId:o,entityIds:s,...i}=t,r=s||o||"";await Et(e,r,i);const n=24*(i.days||0)*60*60*1e3+60*(i.hours||0)*60*1e3+60*(i.minutes||0)*1e3;return{nextResumeAt:new Date(new Date(a).getTime()+n).toISOString()}}(this.hass,e.detail,this._adjustModalResumeAt);this._hapticFeedback("success"),this._adjustModalResumeAt=t.nextResumeAt,this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.adjusted"))}catch(e){console.error("Adjust failed:",e),this._hapticFeedback("failure")}}_handleCloseModalEvent(){const e={adjustModalOpen:!1,adjustModalEntityId:"",adjustModalFriendlyName:"",adjustModalResumeAt:"",adjustModalEntityIds:[],adjustModalFriendlyNames:[]};this._adjustModalOpen=e.adjustModalOpen,this._adjustModalEntityId=e.adjustModalEntityId,this._adjustModalFriendlyName=e.adjustModalFriendlyName,this._adjustModalResumeAt=e.adjustModalResumeAt,this._adjustModalEntityIds=e.adjustModalEntityIds,this._adjustModalFriendlyNames=e.adjustModalFriendlyNames}async _cancelScheduled(e){if(this.hass)try{await async function(e,t){await Dt(e,t)}(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.cancelled"))}catch(e){console.error("Cancel scheduled failed:",e),this._hapticFeedback("failure")}}_setSelected(e){this._cardStore.setSelection(e),this._selected=this._cardStore.getState().selected}_setDurationState(e,t){this._cardStore.setDuration(e,t);const a=this._cardStore.getState();this._duration=a.durationMs,this._customDuration=a.customDuration,this._customDurationInput=a.customDurationInput}_handleDurationChange(e){const{duration:t,input:a,showCustomInput:o}=e.detail;this._setDurationState(t,a),void 0!==o&&(this._showCustomInput=o)}_handleScheduleModeChange(e){const t=function(e){if(!e.enabled)return{scheduleMode:!1,disableAtDate:"",disableAtTime:"",resumeAtDate:"",resumeAtTime:""};const t=new Date(e.now.getTime()+60*e.resumeMinutes*1e3);return{scheduleMode:!0,disableAtDate:dt(e.now),disableAtTime:ut(e.now),resumeAtDate:dt(t),resumeAtTime:ut(t)}}({enabled:e.detail.enabled,now:new Date,resumeMinutes:this._lastDuration?.minutes??30});this._scheduleMode=t.scheduleMode,e.detail.enabled&&(this._disableAtDate=t.disableAtDate,this._disableAtTime=t.disableAtTime,this._resumeAtDate=t.resumeAtDate,this._resumeAtTime=t.resumeAtTime)}_handleScheduleFieldChange(e){const{field:t,value:a}=e.detail;switch(t){case"disableAtDate":this._disableAtDate=a;break;case"disableAtTime":this._disableAtTime=a;break;case"resumeAtDate":this._resumeAtDate=a;break;case"resumeAtTime":this._resumeAtTime=a}}_handleCustomInputToggle(e){this._showCustomInput=e.detail.show}_handleSelectionChange(e){this._setSelected(e.detail.selected)}_handleGuardrailCancel(){this._guardrailConfirmOpen=!1}async _handleGuardrailContinue(){this._guardrailConfirmOpen=!1,await this._snooze(!0)}_renderScheduledPauses(e,t){return 0===e?"":G`
    ...
    `}render(){if(!this.hass||!this.config)return G``;const e=this._getPausedSnapshot(),t=e.paused,a=Object.keys(t).length,o=e.scheduled,s=Object.keys(o).length,i=this._getAutomations(),r=this._isSnoozeSensorAvailable();return G`
      <ha-card>
        <div class="header">
          <ha-icon icon="mdi:sleep"></ha-icon>
          ${this.config?.title||_e(this.hass,"card.default_title")}
          ${a>0||s>0?G`<span class="status-summary"
                >${a>0?_e(this.hass,"status.active_count",{count:a}):""}${a>0&&s>0?", ":""}${s>0?_e(this.hass,"status.scheduled_count",{count:s}):""}</span
              >`:""}
        </div>
        ...
        ${this._renderScheduledPauses(s,o)}
    ...
    `}}async function Xt(e,t,a){await async function(e,t,a){await Et(e,t,a)}(e,t,a)}Jt.styles=[ye,fe],e([ce({attribute:!1})],Jt.prototype,"hass",void 0),e([ce({attribute:!1})],Jt.prototype,"config",void 0),e([he()],Jt.prototype,"_selected",void 0),e([he()],Jt.prototype,"_duration",void 0),e([he()],Jt.prototype,"_customDuration",void 0),e([he()],Jt.prototype,"_customDurationInput",void 0),e([he()],Jt.prototype,"_loading",void 0),e([he()],Jt.prototype,"_scheduleMode",void 0),e([he()],Jt.prototype,"_disableAtDate",void 0),e([he()],Jt.prototype,"_disableAtTime",void 0),e([he()],Jt.prototype,"_resumeAtDate",void 0),e([he()],Jt.prototype,"_resumeAtTime",void 0),e([he()],Jt.prototype,"_labelRegistry",void 0),e([he()],Jt.prototype,"_labelRegistryUnavailable",void 0),e([he()],Jt.prototype,"_categoryRegistry",void 0),e([he()],Jt.prototype,"_entityRegistry",void 0),e([he()],Jt.prototype,"_showCustomInput",void 0),e([he()],Jt.prototype,"_automationsCache",void 0),e([he()],Jt.prototype,"_automationsCacheVersion",void 0),e([he()],Jt.prototype,"_lastDuration",void 0),e([he()],Jt.prototype,"_recentSnoozeIds",void 0),e([he()],Jt.prototype,"_adjustModalOpen",void 0),e([he()],Jt.prototype,"_adjustModalEntityId",void 0),e([he()],Jt.prototype,"_adjustModalFriendlyName",void 0),e([he()],Jt.prototype,"_adjustModalResumeAt",void 0),e([he()],Jt.prototype,"_adjustModalEntityIds",void 0),e([he()],Jt.prototype,"_adjustModalFriendlyNames",void 0),e([he()],Jt.prototype,"_guardrailConfirmOpen",void 0),Rt("autosnooze-card",Jt);class Qt extends ne{constructor(){super(...arguments),this.config={},this._adjustModal={adjustModalOpen:!1,adjustModalEntityId:"",adjustModalFriendlyName:"",adjustModalResumeAt:"",adjustModalEntityIds:[],adjustModalFriendlyNames:[]}}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-snoozed-card",title:"Snoozed Automations"}}setConfig(e){this.config=e}getCardSize(){const e=this.hass?vt(this.hass):null;return 1+(e?Object.keys(e.paused).length:0)}shouldUpdate(e){const t=e.get("hass");if(!t||!this.hass)return!0;const a=t.states?.[lt]!==this.hass.states?.[lt],o=(t.language??t.locale?.language)!==(this.hass.language??this.hass.locale?.language);return a||o}updated(e){super.updated(e),e.has("hass")&&this._adjustModal.adjustModalOpen&&this._syncAdjustModalWithPaused()}_hapticFeedback(e="light"){kt(e)}_syncAdjustModalWithPaused(){if(!this.hass)return;const e=vt(this.hass).paused,t=this._adjustModal,a=(t.adjustModalEntityIds.length>0?t.adjustModalEntityIds:[t.adjustModalEntityId].filter(Boolean)).find(t=>e[t]);if(!a)return void this._handleCloseModalEvent();const o=e[a]?.resume_at;o&&o!==t.adjustModalResumeAt&&(this._adjustModal={...t,adjustModalResumeAt:o})}async _handleWakeEvent(e){if(this.hass)try{await async function(e,t){await Ut(e,t)}(this.hass,e.detail.entityId),this._hapticFeedback("success")}catch(e){console.error("Wake failed:",e),this._hapticFeedback("failure")}}async _handleWakeAllEvent(){if(this.hass)try{await async function(e){await Ht(e)}(this.hass),this._hapticFeedback("success")}catch(e){console.error("Wake all failed:",e),this._hapticFeedback("failure")}}_handleAdjustAutomationEvent(e){this._adjustModal=ct({entityId:e.detail.entityId,friendlyName:e.detail.friendlyName,resumeAt:e.detail.resumeAt})}_handleAdjustGroupEvent(e){this._adjustModal=ct({entityIds:e.detail.entityIds,friendlyNames:e.detail.friendlyNames,resumeAt:e.detail.resumeAt})}async _handleAdjustTimeEvent(e){if(!this.hass)return;const{entityId:t,entityIds:a,...o}=e.detail,s=a&&a.length>0?a:t;if(s)try{await Xt(this.hass,s,o),this._hapticFeedback("success")}catch(e){console.error("Adjust failed:",e),this._hapticFeedback("failure")}}_handleCloseModalEvent(){this._adjustModal={adjustModalOpen:!1,adjustModalEntityId:"",adjustModalFriendlyName:"",adjustModalResumeAt:"",adjustModalEntityIds:[],adjustModalFriendlyNames:[]}}render(){if(!this.hass||!this.config)return G``;const e=vt(this.hass),t=Object.keys(e.paused).length,a=this._adjustModal;return G`
      <ha-card>
        <div class="header">
          <ha-icon icon="mdi:bell-sleep"></ha-icon>
          ${this.config?.title||_e(this.hass,"card.snoozed_title")}
          ${t>0?G`<span class="status-summary"
        ...
        ${t>0?G`<autosnooze-active-pauses
              ...
              @adjust-automation=${this._handleAdjustAutomationEvent}
              @adjust-group=${this._handleAdjustGroupEvent}
            ></autosnooze-active-pauses>`:G`<div class="snoozed-empty" role="status">
              ${_e(this.hass,"status.no_snoozed")}
            </div>`}

        <autosnooze-adjust-modal
          .hass=${this.hass}
          .open=${a.adjustModalOpen}
          .entityId=${a.adjustModalEntityId}
          .friendlyName=${a.adjustModalFriendlyName}
          .resumeAt=${a.adjustModalResumeAt}
          .entityIds=${a.adjustModalEntityIds}
          .friendlyNames=${a.adjustModalFriendlyNames}
          @adjust-time=${this._handleAdjustTimeEvent}
          @close-modal=${this._handleCloseModalEvent}
        ></autosnooze-adjust-modal>
      </ha-card>
    `}}Qt.styles=[ye,fe],e([ce({attribute:!1})],Qt.prototype,"hass",void 0),e([ce({attribute:!1})],Qt.prototype,"config",void 0),e([he()],Qt.prototype,"_adjustModal",void 0),Rt("autosnooze-snoozed-card",Qt);const ea=r`
  .row {
    margin-bottom: 12px;
  }
  .row label {
...
`;class ta extends ne{constructor(){super(...arguments),this._config={}}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config)return;const a={...this._config,[e]:t};""!==t&&null!=t||delete a[e],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:a},bubbles:!0,composed:!0}))}render(){return this._config?G`
      <div class="row">
    ...
    `:G``}}ta.styles=ea,e([ce({attribute:!1})],ta.prototype,"hass",void 0),e([he()],ta.prototype,"_config",void 0),Rt("autosnooze-card-editor",ta);const aa=r`
    :host {
      display: block;
    }
    .snooze-list {
...
`;class oa extends ne{constructor(){super(...arguments),this.pauseGroups=[],this.pausedCount=0,this._wakeAllPending=!1,this._wakeAllTimeout=null,this._countdownState={interval:null,syncTimeout:null}}connectedCallback(){super.connectedCallback(),this._syncCountdownLifecycle()}updated(e){e.has("pauseGroups")&&this._syncCountdownLifecycle()}disconnectedCallback(){super.disconnectedCallback(),mt(this._countdownState),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null)}_updateCountdownIfNeeded(){this.pauseGroups.length>0&&this.requestUpdate()}_hasLiveCountdowns(){return this.pauseGroups.some(e=>!e.disableAt)}_scheduleCountdownBootstrap(){this._countdownState={interval:null,syncTimeout:globalThis.setTimeout(()=>{this._countdownState.syncTimeout=null,this._hasLiveCountdowns()&&(this._countdownState=ht(()=>this._updateCountdownIfNeeded()))},0)}}_syncCountdownLifecycle(){mt(this._countdownState),0!==this.pauseGroups.length?this._hasLiveCountdowns()?this._countdownState=ht(()=>this._updateCountdownIfNeeded()):this._countdownState={interval:null,syncTimeout:null}:this._scheduleCountdownBootstrap()}_handleWakeAll(){this._wakeAllPending?(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,this._fireWakeAll()):(kt("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},Ce))}_fireWake(e){this.dispatchEvent(new CustomEvent("wake-automation",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireAdjust(e){this.dispatchEvent(new CustomEvent("adjust-automation",{detail:{entityId:e.entity_id,friendlyName:e.friendly_name,resumeAt:e.resume_at},bubbles:!0,composed:!0}))}_fireAdjustGroup(e){this.dispatchEvent(new CustomEvent("adjust-group",{detail:{entityIds:e.automations.map(e=>e.entity_id),friendlyNames:e.automations.map(e=>e.friendly_name||e.entity_id),resumeAt:e.resumeAt},bubbles:!0,composed:!0}))}_fireWakeAll(){this.dispatchEvent(new CustomEvent("wake-all",{bubbles:!0,composed:!0}))}render(){if(0===this.pausedCount)return G``;const e=this.hass?.locale?.language;return G`
        ...
        ${this.pauseGroups.map(t=>G`
          <div class="pause-group" role="group">
            <div class="pause-group-header"
              ...
              ${t.disableAt?G`${_e(this.hass,"status.resumes")} ${wt(t.resumeAt,e)}`:G`<span class="countdown">${zt(t.resumeAt,_e(this.hass,"status.resuming"))}</span>`}
            </div>
    ...
    `}}oa.styles=[ye,aa],e([ce({attribute:!1})],oa.prototype,"hass",void 0),e([ce({attribute:!1})],oa.prototype,"pauseGroups",void 0),e([ce({type:Number})],oa.prototype,"pausedCount",void 0),e([he()],oa.prototype,"_wakeAllPending",void 0),Rt("autosnooze-active-pauses",oa);const sa=r`
    :host {
      display: block;
    }
...
`;class ia extends ne{constructor(){super(...arguments),this.scheduleMode=!1,this.customDuration={days:0,hours:0,minutes:30},this.customDurationInput="30m",this.showCustomInput=!1,this.lastDuration=null,this.disableAtDate="",this.disableAtTime="",this.resumeAtDate="",this.resumeAtTime=""}_getBasePresets(){const e=function(e){const t=e?.states?.[Ye]?.attributes?.duration_presets;return t?.length?t:null}(this.hass);return e?.length?e.filter(e=>null!==e.minutes):Ee.filter(e=>null!==e.minutes)}_getDurationPills(){return[...this._getBasePresets(),{label:_e(this.hass,"duration.custom"),minutes:null}]}_getDurationPreview(){const e=Ge(this.customDurationInput);return e?At(e.days,e.hours,e.minutes):""}_isDurationValid(){return Be(this.customDurationInput)}_renderDateOptions(){const e=function(e=365,t){const a=[],o=new Date,s=o.getFullYear();for(let i=0;i<e;i++){const e=new Date(o);e.setDate(e.getDate()+i);const r=e.getFullYear(),n=`${r}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=e.toLocaleDateString(t,{weekday:"short"}),d=e.toLocaleDateString(t,{month:"short"}),u=e.getDate(),c=r!==s?`${l}, ${d} ${u}, ${r}`:`${l}, ${d} ${u}`;a.push({value:n,label:c})}return a}(365,this.hass?.locale?.language);return e.map(e=>G`<option value="${e.value}">${e.label}</option>`)}_renderLastDurationBadge(){if(!this.lastDuration)return"";const e=this._getBasePresets(),t=this.lastDuration.minutes,a=!e.some(e=>e.minutes===t);if(!a)return"";const{days:o,hours:s,minutes:i}=this.lastDuration.duration,r=$t(o,s,i).replace(/ /g,""),n=We(this.customDuration),l=!this.showCustomInput&&t===n;return G`
    ...
    `}_fireDurationChange(e,t){const a=function(e){const t=Math.floor(e/$e),a=e%$e;return{days:t,hours:Math.floor(a/Ae),minutes:a%Ae}}(e),o=$t(a.days,a.hours,a.minutes);this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:e,duration:a,input:o,showCustomInput:t?.showCustomInput??!1},bubbles:!0,composed:!0}))}_fireCustomDurationChange(e){const t=Ge(e),a=t?We(t):0;this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:a,duration:t??{days:0,hours:0,minutes:0},input:e},bubbles:!0,composed:!0}))}_fireScheduleModeChange(e){this.dispatchEvent(new CustomEvent("schedule-mode-change",{detail:{enabled:e},bubbles:!0,composed:!0}))}_fireScheduleFieldChange(e,t){this.dispatchEvent(new CustomEvent("schedule-field-change",{detail:{field:e,value:t},bubbles:!0,composed:!0}))}_formatScheduleDateTime(e){const t=this.hass?.locale?.language;return new Date(e).toLocaleString(t,{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}_renderScheduleSummary(){if(!this.resumeAtDate||!this.resumeAtTime)return"";const e=Pt(this.resumeAtDate,this.resumeAtTime);if(!e)return"";if(!Boolean(this.disableAtDate&&this.disableAtTime))return G`
      ...
      `;const t=Pt(this.disableAtDate,this.disableAtTime);return t?new Date(t).getTime()>=new Date(e).getTime()?G`
    ...
    `}}ia.styles=sa,e([ce({attribute:!1})],ia.prototype,"hass",void 0),e([ce({type:Boolean})],ia.prototype,"scheduleMode",void 0),e([ce({attribute:!1})],ia.prototype,"customDuration",void 0),e([ce({type:String})],ia.prototype,"customDurationInput",void 0),e([ce({type:Boolean})],ia.prototype,"showCustomInput",void 0),e([ce({attribute:!1})],ia.prototype,"lastDuration",void 0),e([ce({type:String})],ia.prototype,"disableAtDate",void 0),e([ce({type:String})],ia.prototype,"disableAtTime",void 0),e([ce({type:String})],ia.prototype,"resumeAtDate",void 0),e([ce({type:String})],ia.prototype,"resumeAtTime",void 0),Rt("autosnooze-duration-selector",ia);const ra=r`
    :host {
      display: block;
    }
...
`;class na extends ne{constructor(){super(...arguments),this.automations=[],this.selected=[],this.labelRegistry={},this.labelRegistryUnavailable=!1,this.categoryRegistry={},this.recentSnoozeIds=[],this._filterTab="all",this._search="",this._searchInput="",this._expandedGroups={},this._searchTimeout=null,this._viewModelCache=null}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null)}_fireSelectionChange(e){this.dispatchEvent(new CustomEvent("selection-change",{detail:{selected:e},bubbles:!0,composed:!0}))}_toggleSelection(e){let t;kt("selection"),t=this.selected.includes(e)?this.selected.filter(t=>t!==e):[...this.selected,e],this._fireSelectionChange(t)}_toggleGroupExpansion(e){const t=!1!==this._expandedGroups[e];this._expandedGroups={...this._expandedGroups,[e]:!t}}_selectGroup(e){const t=e.map(e=>e.id);let a;a=t.every(e=>this.selected.includes(e))?this.selected.filter(e=>!t.includes(e)):[...new Set([...this.selected,...t])],this._fireSelectionChange(a)}_selectAllVisible(){const e=this._getViewModel().filtered.map(e=>e.id),t=[...new Set([...this.selected,...e])];this._fireSelectionChange(t)}_clearSelection(){this._fireSelectionChange([])}_getFilteredAutomations(){return this._getViewModel().filtered}_getAreaName(e){return this.hass?Wt(e,this.hass):_e(this.hass,"group.unassigned")}_getLabelName(e){return qt(e,this.labelRegistry)}_getCategoryName(e){return Vt(e,this.categoryRegistry)}_getGroupedByTab(e){return Zt({automations:this.automations,search:this._search,filterTab:e,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,emptyAreaLabel:_e(this.hass,"group.unassigned"),emptyLabelLabel:_e(this.hass,"group.unlabeled"),emptyCategoryLabel:_e(this.hass,"group.uncategorized")}).grouped}_getGroupedByArea(){return this._getGroupedByTab("areas")}_getGroupedByLabel(){return this._getGroupedByTab("labels")}_getGroupedByCategory(){return this._getGroupedByTab("categories")}_getAreaCount(){return this._getViewModel().areaCount}_getLabelCount(){return this._getViewModel().labelCount}_getCategoryCount(){return this._getViewModel().categoryCount}_getViewModel(){const e=this._viewModelCache;if(e&&e.automations===this.automations&&e.search===this._search&&e.filterTab===this._filterTab&&e.hass===this.hass&&e.labelRegistry===this.labelRegistry&&e.categoryRegistry===this.categoryRegistry)return e.result;const t=Zt({automations:this.automations,search:this._search,filterTab:this._filterTab,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,emptyAreaLabel:_e(this.hass,"group.unassigned"),emptyLabelLabel:_e(this.hass,"group.unlabeled"),emptyCategoryLabel:_e(this.hass,"group.uncategorized")});return this._viewModelCache={automations:this.automations,search:this._search,filterTab:this._filterTab,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,result:t},t}_handleSearchInput(e){const t=e.target.value;this._searchInput=t,null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},ke)}_clearSearch(){null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null),this._searchInput="",this._search=""}_handleSearchKeydown(e){"Escape"===e.key&&(this._searchInput||this._search)&&(e.preventDefault(),this._clearSearch())}_renderSelectionList(e,t){const{filtered:a,grouped:o}=e;if("all"===this._filterTab){if(0===a.length)return G`<div class="list-empty" role="status">${_e(this.hass,"list.empty")}</div>`;const e=new Set(this.recentSnoozeIds),o=[],s=[];for(const t of a)(e.has(t.id)?o:s).push(t);const i=o.concat(s);return G`
      ...
      `)}
      `}return 0===o.length?G`<div class="list-empty" role="status">${_e(this.hass,"list.empty")}</div>`:o.map(([e,a])=>{const o=!1!==this._expandedGroups[e],s=a.every(e=>t.has(e.id)),i=a.some(e=>t.has(e.id))&&!s;return G`
        <button
          type="button"
    ...
    `}}na.styles=ra,e([ce({attribute:!1})],na.prototype,"hass",void 0),e([ce({attribute:!1})],na.prototype,"automations",void 0),e([ce({attribute:!1})],na.prototype,"selected",void 0),e([ce({attribute:!1})],na.prototype,"labelRegistry",void 0),e([ce({type:Boolean})],na.prototype,"labelRegistryUnavailable",void 0),e([ce({attribute:!1})],na.prototype,"categoryRegistry",void 0),e([ce({attribute:!1})],na.prototype,"recentSnoozeIds",void 0),e([he()],na.prototype,"_filterTab",void 0),e([he()],na.prototype,"_search",void 0),e([he()],na.prototype,"_searchInput",void 0),e([he()],na.prototype,"_expandedGroups",void 0),Rt("autosnooze-automation-list",na);const la=r`
    :host {
      display: block;
    }
    .modal-overlay {
...
`,da=[{label:"+15m",minutes:15},{label:"+30m",minutes:30},{label:"+1h",hours:1},{label:"+2h",hours:2}],ua=[{label:"-15m",minutes:-15,thresholdMs:15*xe},{label:"-30m",minutes:-30,thresholdMs:30*xe}],ca=xe;class ha extends ne{constructor(){super(...arguments),this.open=!1,this.entityId="",this.friendlyName="",this.resumeAt="",this.entityIds=[],this.friendlyNames=[],this._countdownState={interval:null,syncTimeout:null}}get _isGroupMode(){return this.entityIds.length>1}updated(e){e.has("open")&&(this.open?this._startSynchronizedCountdown():this._stopCountdown())}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown()}_startSynchronizedCountdown(){mt(this._countdownState),this._countdownState=ht(()=>this.requestUpdate())}_stopCountdown(){mt(this._countdownState)}_isDecrementDisabled(e){if(!this.resumeAt)return!0;return new Date(this.resumeAt).getTime()-Date.now()-e<ca}_fireAdjustTime(e){this.entityIds.length>0?this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityIds:this.entityIds,...e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityId:this.entityId,...e},bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}_handleOverlayKeydown(e){"Escape"===e.key&&this._close()}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}render(){return this.open?G`
      <div class="modal-overlay" @click=${this._handleOverlayClick} @keydown=${this._handleOverlayKeydown}>
        <div class="modal-content" role="dialog" aria-modal="true" aria-labelledby="adjust-title" @click=${e=>e.stopPropagation()}>
          ...
          <div class="modal-body">
            ...
            <div class="remaining-time">${zt(this.resumeAt,_e(this.hass,"status.resuming"))}</div>
    ...
    `:G``}}ha.styles=la,e([ce({attribute:!1})],ha.prototype,"hass",void 0),e([ce({type:Boolean})],ha.prototype,"open",void 0),e([ce({type:String})],ha.prototype,"entityId",void 0),e([ce({type:String})],ha.prototype,"friendlyName",void 0),e([ce({type:String})],ha.prototype,"resumeAt",void 0),e([ce({attribute:!1})],ha.prototype,"entityIds",void 0),e([ce({attribute:!1})],ha.prototype,"friendlyNames",void 0),Rt("autosnooze-adjust-modal",ha);const ma=Symbol.for("autosnooze.registration.done.v1"),pa=new Set,ga="https://github.com/mossipcams/autosnooze#readme";function ba(){const e=window.customCards;return Array.isArray(e)?e:(void 0!==e&&(t="customCards-not-array",a=`[AutoSnooze] window.customCards was not an array (got ${typeof e}); resetting.`,pa.has(t)||(pa.add(t),console.warn(a))),[]);var t,a}function _a(e="0.2.20"){const t=function(e){return[{type:"autosnooze-card",name:"AutoSnooze Card",description:`Temporarily pause automations with area and label filtering (v${e})`,preview:!0,documentationURL:ga},{type:"autosnooze-snoozed-card",name:"AutoSnooze Snoozed Card",description:`Show only currently snoozed automations with resume and adjust controls (v${e})`,preview:!0,documentationURL:ga}]}(e),a=ba();t.forEach(e=>{const t=a.findIndex(t=>t?.type===e.type);-1===t?a.push(e):a[t]={...a[t],...e}}),window.customCards=a}!function(){const e=globalThis;!0===e[ma]||(e[ma]=!0),_a()}();export{oa as AutoSnoozeActivePauses,ha as AutoSnoozeAdjustModal,na as AutoSnoozeAutomationList,ia as AutoSnoozeDurationSelector,Qt as AutoSnoozeSnoozedCard,Jt as AutomationPauseCard,ta as AutomationPauseCardEditor};
