        ...
        <div class="duration-pills" role="radiogroup" aria-labelledby="duration-header">
          ${o.map(e=>{const t=kt(this.customDuration),o=!this.untilTomorrow&&!this.showCustomInput&&e.minutes===t;return B`
                <button
                  type="button"
                  class="pill ${o?"active":""}"
                  @click=${()=>{this.hass&&lt(this.hass,{event:"duration_option_selected",properties:{method:"preset"},source:"card"}),this._fireDurationChange(e.minutes,{showCustomInput:!1})}}
                  role="radio"
                  aria-checked=${o}
                >
                  ${e.label}
