...
`,ve=1e3,xe=6e4,we=36e5,ze=864e5,$e=60,Ae=1440,ke=300,Se=300,Ce=3e3,Te=5e3,De=1e3,je=5e3,Re=1e3,Ee=3e4,Pe=[{label:"30m",minutes:30},{label:"1h",minutes:60},{label:"12h",minutes:720},{label:"1d",minutes:1440},{label:"Custom",minutes:null}],Me={not_automation:"Failed to snooze: One or more selected items are not automations",invalid_duration:"Failed to snooze: Please specify a valid duration (days, hours, or minutes)",resume_time_past:"Failed to snooze: Resume time must be in the future",disable_after_resume:"Failed to snooze: Snooze time must be before resume time",save_failed:"Failed to save changes. Please try again or check Home Assistant logs.",invalid_adjustment:"Adjustment must be non-zero. Specify at least one of: days, hours, or minutes.",adjust_time_too_short:"Cannot shorten snooze that much. Resume time must be at least 1 minute away.",confirm_required:"Failed to snooze: Confirmation is required for one or more selected automations"},Fe="autosnooze_exclude",Ie="autosnooze_include";const Ne="autosnooze_last_duration";function Oe(e,t){const a=new Date(e),o=new Date,i={weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return a.getFullYear()>o.getFullYear()&&(i.year="numeric"),a.toLocaleString(t,i)}function Le(e,t="Resuming..."){const a=new Date(e).getTime()-Date.now();if(a<=0)return t;const o=Math.floor(a/ze),i=Math.floor(a%ze/we),s=Math.floor(a%we/xe),r=Math.floor(a%xe/ve);return o>0?`${o}d ${i}h ${s}m`:i>0?`${i}h ${s}m ${r}s`:`${s}m ${r}s`}function Ue(e,t,a){const o=[];return e>0&&o.push(`${e} day${1!==e?"s":""}`),t>0&&o.push(`${t} hour${1!==t?"s":""}`),a>0&&o.push(`${a} minute${1!==a?"s":""}`),o.join(", ")}function He(e,t,a){const o=[];return e>0&&o.push(`${e}d`),t>0&&o.push(`${t}h`),a>0&&o.push(`${a}m`),o.join(" ")||"0m"}function Ge(e){const t=e.toLowerCase().replace(/\s+/g,"");if(!t)return null;let a=0,o=!1;const i=t.match(/(\d+(?:\.\d+)?)\s*d/),s=t.match(/(\d+(?:\.\d+)?)\s*h/),r=t.match(/(\d+(?:\.\d+)?)\s*m(?!i)/);if(i?.[1]){const e=parseFloat(i[1]);if(isNaN(e)||e<0)return null;a+=e*Ae,o=!0}if(s?.[1]){const e=parseFloat(s[1]);if(isNaN(e)||e<0)return null;a+=e*$e,o=!0}if(r?.[1]){const e=parseFloat(r[1]);if(isNaN(e)||e<0)return null;a+=e,o=!0}if(!o){const e=parseFloat(t);if(isNaN(e)||!(e>0))return null;a=e}if(a=Math.round(a),a<=0)return null;const n=Math.floor(a/Ae),l=a%Ae;return{days:n,hours:Math.floor(l/$e),minutes:l%$e}}function Be(e){return null!==Ge(e)}function We(e){return e.days*Ae+e.hours*$e+e.minutes}function qe(e,t){if(!e||!t)return null;const a=new Date(`${e}T${t}`).getTimezoneOffset(),o=a<=0?"+":"-",i=Math.abs(a);return`${e}T${t}${`${o}${String(Math.floor(i/60)).padStart(2,"0")}:${String(i%60).padStart(2,"0")}`}`}function Ve(e="light"){!function(e,t,a){const o=new CustomEvent(`hass-${t}`,{bubbles:!0,composed:!0,detail:a});e.dispatchEvent(o)}(window,"haptic",e)}function Ye(e,t){const a=e,o=a?.translation_key??a?.data?.translation_key;if(o&&Me[o])return Me[o];const i=a?.message??"";for(const[e,t]of Object.entries(Me))if(i.includes(e)||i.toLowerCase().includes(e.replace(/_/g," ")))return t;return`${t}. Check Home Assistant logs for details.`}async function Ke(e,t){try{await e.callService("autosnooze","cancel",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to wake automation:",e),e}}async function Ze(e,t){try{await e.callService("autosnooze","cancel_scheduled",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to cancel scheduled snooze:",e),e}}function Je(e,t){const a=1e3-Date.now()%1e3;e.syncTimeout=window.setTimeout(()=>{e.syncTimeout=null,t(),e.interval=window.setInterval(()=>{t();Date.now()%1e3>50&&(Qe(e),Je(e,t))},De)},a)}function Xe(e){const t={interval:null,syncTimeout:null};return Je(t,e),t}function Qe(e){null!==e.interval&&(clearInterval(e.interval),e.interval=null),null!==e.syncTimeout&&(clearTimeout(e.syncTimeout),e.syncTimeout=null)}async function et(e,t){await async function(e,t){try{await e.callService("autosnooze","pause",t)}catch(e){throw console.error("[AutoSnooze] Failed to pause automations:",e),e}}(e,t)}async function tt(e){await async function(e){try{await e.callService("autosnooze","cancel_all",{})}catch(e){throw console.error("[AutoSnooze] Failed to wake all automations:",e),e}}(e)}async function at(e,t,a){await async function(e,t,a){try{await e.callService("autosnooze","adjust",{entity_id:t,...a})}catch(e){throw console.error("[AutoSnooze] Failed to adjust snooze:",e),e}}(e,t,a)}function ot(e){return e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function it(e,t,a){return!(!e.labels||0===e.labels.length)&&e.labels.some(e=>{const o=a[e]?.name;return o?.toLowerCase()===t})}function st(e,t,a){const o={};return e.forEach(e=>{const i=t(e);i&&0!==i.length?i.forEach(t=>{o[t]||(o[t]=[]),o[t].push(e)}):(o[a]||(o[a]=[]),o[a].push(e))}),Object.entries(o).sort((e,t)=>e[0]===a?1:t[0]===a?-1:e[0].localeCompare(t[0]))}function rt(e,t){const a=new Set;return e.forEach(e=>{const o=t(e);o&&o.forEach(e=>a.add(e))}),a.size}const nt="sensor.autosnooze_snoozed_automations";function lt(e){return!e||"object"!=typeof e||Array.isArray(e)?null:e}function dt(e){return lt(e)}function ut(e){return lt(e)}function ct(e){const t=lt(e);if(!t)return{paused:{},scheduled:{}};const a=t.schema_version;if(1===a){const e=dt(t.paused),a=ut(t.scheduled);return e&&a?{paused:e,scheduled:a}:{paused:{},scheduled:{}}}if(void 0===a){const e=dt(t.paused),a=ut(t.scheduled);if(e&&a)return{paused:e,scheduled:a}}return{paused:dt(t.paused_automations)??{},scheduled:ut(t.scheduled_snoozes)??{}}}function ht(e){const t=e?.states?.[nt];return ct(t?.attributes).paused}const pt={days:0,hours:0,minutes:30};class mt{constructor(){this._state={selected:[],filterTab:"all",search:"",customDuration:{...pt},customDurationInput:"30m",durationMs:30*xe}}getState(){return{...this._state,selected:[...this._state.selected],customDuration:{...this._state.customDuration}}}setSelection(e){this._state.selected=[...e]}toggleSelection(e){this._state.selected.includes(e)?this._state.selected=this._state.selected.filter(t=>t!==e):this._state.selected=[...this._state.selected,e]}clearSelection(){this._state.selected=[]}setFilterTab(e){this._state.filterTab=e}setSearch(e){this._state.search=e}setDuration(e,t){this._state.customDuration={...e},this._state.customDurationInput=t,this._state.durationMs=We(e)*xe}}class gt extends ne{constructor(){super(...arguments),this.config={},this._cardStore=new mt,this._selected=[],this._duration=30*xe,this._customDuration={days:0,hours:0,minutes:30},this._customDurationInput="30m",this._loading=!1,this._scheduleMode=!1,this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime="",this._labelRegistry={},this._labelRegistryUnavailable=!1,this._categoryRegistry={},this._entityRegistry={},this._showCustomInput=!1,this._automationsCache=null,this._automationsCacheVersion=0,this._lastDuration=null,this._adjustModalOpen=!1,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt="",this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[],this._guardrailConfirmOpen=!1,this._labelsFetched=!1,this._categoriesFetched=!1,this._entityRegistryFetched=!1,this._lastAutomationFingerprintStates=null,this._lastAutomationFingerprint="",this._lastHassStates=null,this._lastCacheVersion=0,this._toastTimeout=null,this._toastFadeTimeout=null,this._labelRegistryRetryTimeout=null,this._labelRegistryRetryDelayMs=Re}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-card",title:"AutoSnooze"}}setConfig(e){this.config=e}getCardSize(){const e=this._getPaused(),t=this._getScheduled();return 4+Object.keys(e).length+Object.keys(t).length}shouldUpdate(e){if(!e.has("hass"))return!0;const t=e.get("hass"),a=this.hass;if(!t||!a)return!0;const o=t.states?.[nt],i=a.states?.[nt];if(o!==i)return!0;if(t.entities!==a.entities)return!0;if(t.areas!==a.areas)return!0;if((t.language??t.locale?.language)!==(a.language??a.locale?.language))return!0;const s=a.states,r=t.states;if(!s||!r)return!0;if(r===s)return!1;return this._getAutomationStateFingerprint(r)!==this._getAutomationStateFingerprint(s)}updated(e){if(super.updated(e),e.has("hass")&&this.hass?.connection&&(this._labelsFetched||null!==this._labelRegistryRetryTimeout||this._fetchLabelRegistry(),this._categoriesFetched||this._fetchCategoryRegistry(),this._entityRegistryFetched||this._fetchEntityRegistry()),e.has("hass")&&this._adjustModalOpen){const e=this._getPaused();if(this._adjustModalEntityIds.length>0){this._adjustModalEntityIds.some(t=>e[t])||this._handleCloseModalEvent();const t=this._adjustModalEntityIds.find(t=>e[t]);if(t){const a=e[t];a?.resume_at&&a.resume_at!==this._adjustModalResumeAt&&(this._adjustModalResumeAt=a.resume_at)}}else if(this._adjustModalEntityId){const t=e[this._adjustModalEntityId];t?.resume_at&&t.resume_at!==this._adjustModalResumeAt&&(this._adjustModalResumeAt=t.resume_at),t||this._handleCloseModalEvent()}}}connectedCallback(){super.connectedCallback(),this._fetchLabelRegistry(),this._fetchCategoryRegistry(),this._fetchEntityRegistry(),this._lastDuration=function(){try{const e=localStorage.getItem(Ne);if(!e)return null;const t=JSON.parse(e);return"number"!=typeof t.minutes||"number"!=typeof t.duration?.days||"number"!=typeof t.duration?.hours||"number"!=typeof t.duration?.minutes||"number"!=typeof t.timestamp?null:Date.now()-t.timestamp>6048e5?(localStorage.removeItem(Ne),null):t}catch{return null}}()}disconnectedCallback(){super.disconnectedCallback(),null!==this._toastTimeout&&(clearTimeout(this._toastTimeout),this._toastTimeout=null),null!==this._toastFadeTimeout&&(clearTimeout(this._toastFadeTimeout),this._toastFadeTimeout=null),null!==this._labelRegistryRetryTimeout&&(clearTimeout(this._labelRegistryRetryTimeout),this._labelRegistryRetryTimeout=null)}async _fetchLabelRegistry(){if(this._labelsFetched||!this.hass?.connection)return;const e=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/label_registry/list"}),a={};return Array.isArray(t)&&t.forEach(e=>{a[e.label_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch label registry:",e),null}}(this.hass);if(null!==e)this._labelRegistry=e,this._labelsFetched=!0,this._labelRegistryUnavailable=!1,this._automationsCacheVersion++,this._labelRegistryRetryDelayMs=Re,null!==this._labelRegistryRetryTimeout&&(clearTimeout(this._labelRegistryRetryTimeout),this._labelRegistryRetryTimeout=null);else if(this._labelsFetched=!1,this._labelRegistryUnavailable=!0,null===this._labelRegistryRetryTimeout){const e=this._labelRegistryRetryDelayMs;this._labelRegistryRetryTimeout=window.setTimeout(()=>{this._labelRegistryRetryTimeout=null,this.isConnected&&this._fetchLabelRegistry()},e),this._labelRegistryRetryDelayMs=Math.min(2*this._labelRegistryRetryDelayMs,Ee)}}async _fetchCategoryRegistry(){!this._categoriesFetched&&this.hass?.connection&&(this._categoryRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/category_registry/list",scope:"automation"}),a={};return Array.isArray(t)&&t.forEach(e=>{a[e.category_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch category registry:",e),{}}}(this.hass),this._categoriesFetched=!0)}async _fetchEntityRegistry(){!this._entityRegistryFetched&&this.hass?.connection&&(this._entityRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/entity_registry/list"}),a={};return Array.isArray(t)&&t.filter(e=>e.entity_id.startsWith("automation.")).forEach(e=>{a[e.entity_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch entity registry:",e),{}}}(this.hass),this._entityRegistryFetched=!0,this._automationsCacheVersion++)}_getAutomations(){if(!this.hass?.states)return[];const e=this.hass.states,t=this._automationsCacheVersion;if(this._lastHassStates===e&&this._lastCacheVersion===t&&this._automationsCache)return this._automationsCache;const a=function(e,t){const a=e?.states,o=e?.entities;if(!a)return[];const i=Object.keys(a).filter(e=>e.startsWith("automation.")).map(e=>{const i=a[e];if(!i)return null;const s=t?.[e],r=o?.[e],n=(s?.categories??{}).automation??null;return{id:e,name:i.attributes?.friendly_name??e.replace("automation.",""),area_id:s?.area_id??r?.area_id??null,category_id:n,labels:s?.labels??r?.labels??[]}}).filter(e=>null!==e).sort((e,t)=>e.name.localeCompare(t.name));return i}(this.hass,this._entityRegistry);return this._automationsCache=a,this._lastCacheVersion=t,this._lastHassStates=e,a}_getAutomationStateFingerprint(e){if(this._lastAutomationFingerprintStates===e)return this._lastAutomationFingerprint;const t=Object.keys(e).filter(e=>e.startsWith("automation.")).sort().map(t=>{const a=e[t];return`${t}:${a?.state??""}:${a?.last_changed??""}:${a?.last_updated??""}`}).join("|");return this._lastAutomationFingerprintStates=e,this._lastAutomationFingerprint=t,t}_getPaused(){return this.hass?ht(this.hass):{}}_getPausedGroupedByResumeTime(){return this.hass?function(e){const t=ht(e),a={};return Object.entries(t).forEach(([e,t])=>{const o=t.resume_at;a[o]||(a[o]={resumeAt:o,disableAt:t.disable_at,automations:[]}),a[o].automations.push({entity_id:e,friendly_name:t.friendly_name,resume_at:t.resume_at,paused_at:t.paused_at,days:t.days,hours:t.hours,minutes:t.minutes,disable_at:t.disable_at})}),Object.values(a).sort((e,t)=>new Date(e.resumeAt).getTime()-new Date(t.resumeAt).getTime())}(this.hass):[]}_getScheduled(){return this.hass?function(e){const t=e?.states?.[nt];return ct(t?.attributes).scheduled}(this.hass):{}}_isSnoozeSensorAvailable(){return Boolean(this.hass?.states?.[nt])}_formatDateTime(e){return Oe(e,this._getLocale())}_getLocale(){return this.hass?.locale?.language}_hasResumeAt(){return Boolean(this._resumeAtDate&&this._resumeAtTime)}_hasDisableAt(){return Boolean(this._disableAtDate&&this._disableAtTime)}_hapticFeedback(e="light"){Ve(e)}_showToast(e,t={}){const{showUndo:a=!1,onUndo:o=null}=t;if(!this.shadowRoot)return;const i=this.shadowRoot.querySelector(".toast");i&&i.remove();const s=document.createElement("div");if(s.className="toast",s.setAttribute("role","alert"),s.setAttribute("aria-live","polite"),s.setAttribute("aria-atomic","true"),a&&o){const t=document.createElement("span");t.textContent=e,s.appendChild(t);const a=document.createElement("button");a.className="toast-undo-btn",a.textContent=be(this.hass,"button.undo"),a.setAttribute("aria-label",be(this.hass,"a11y.undo_action")),a.addEventListener("click",e=>{e.stopPropagation(),o(),s.remove()}),s.appendChild(a)}else s.textContent=e;this.shadowRoot.appendChild(s),null!==this._toastTimeout&&clearTimeout(this._toastTimeout),null!==this._toastFadeTimeout&&clearTimeout(this._toastFadeTimeout),this._toastTimeout=window.setTimeout(()=>{this._toastTimeout=null,this.shadowRoot&&s.parentNode&&(s.style.animation=`slideUp ${Se}ms ease-out reverse`,this._toastFadeTimeout=window.setTimeout(()=>{this._toastFadeTimeout=null,s.parentNode&&s.remove()},Se))},Te)}async _callPauseWithGuardrailConfirm(e,t=!1){if(!this.hass)return!1;if(t)return await et(this.hass,{...e,confirm:!0}),!0;try{return await et(this.hass,e),!0}catch(e){const t=e;if("confirm_required"===(t?.translation_key??t?.data?.translation_key))return this._guardrailConfirmOpen=!0,!1;throw e}}async _pauseAndEnsureCardReady(e,t=!1){return!!(await this._callPauseWithGuardrailConfirm(e,t)&&this.isConnected&&this.shadowRoot)||(this._loading=!1,!1)}async _snooze(e=!1){if(0!==this._selected.length&&!this._loading){if(this._scheduleMode){if(!this._hasResumeAt())return void this._showToast(be(this.hass,"toast.error.resume_time_required"));const e=this._hasDisableAt()?qe(this._disableAtDate,this._disableAtTime):null,t=qe(this._resumeAtDate,this._resumeAtTime);if(!t)return void this._showToast(be(this.hass,"toast.error.invalid_datetime"));const a=Date.now()+je,o=new Date(t).getTime();if(o<=a)return void this._showToast(be(this.hass,"toast.error.resume_time_past"));if(e){if(new Date(e).getTime()>=o)return void this._showToast(be(this.hass,"toast.error.snooze_before_resume"))}}else if(0===this._duration)return;this._loading=!0,this._guardrailConfirmOpen=!1;try{if(!this.hass)return void(this._loading=!1);const t=this._selected.length,a=[...this._selected],o=this._scheduleMode,i=this._hasDisableAt();let s;if(this._scheduleMode){const a=this._hasDisableAt()?qe(this._disableAtDate,this._disableAtTime):null,o=qe(this._resumeAtDate,this._resumeAtTime);if(!o)return void(this._loading=!1);if(!await this._pauseAndEnsureCardReady({entity_id:this._selected,resume_at:o,...a&&{disable_at:a}},e))return;if(a)s=1===t?be(this.hass,"toast.success.scheduled_one"):be(this.hass,"toast.success.scheduled_many",{count:t});else{const e=this._formatDateTime(o);s=1===t?be(this.hass,"toast.success.snoozed_until_one",{time:e}):be(this.hass,"toast.success.snoozed_until_many",{count:t,time:e})}}else{const{days:a,hours:o,minutes:i}=this._customDuration;if(!await this._pauseAndEnsureCardReady({entity_id:this._selected,days:a,hours:o,minutes:i},e))return;const r=Ue(a,o,i);s=1===t?be(this.hass,"toast.success.snoozed_for_one",{duration:r}):be(this.hass,"toast.success.snoozed_for_many",{count:t,duration:r});const n=We(this._customDuration);!function(e,t){try{const a={minutes:t,duration:e,timestamp:Date.now()};localStorage.setItem(Ne,JSON.stringify(a))}catch{}}(this._customDuration,n),this._lastDuration={minutes:n,duration:this._customDuration,timestamp:Date.now()}}this._hapticFeedback("success"),this._showToast(s,{showUndo:!0,onUndo:async()=>{try{if(!this.hass)return;const e=await async function(e,t,a){const o=a.wasScheduleMode&&a.hadDisableAt?t=>Ze(e,t):t=>Ke(e,t),i=await Promise.allSettled(t.map(e=>o(e))),s=[],r=[];return i.forEach((e,a)=>{const o=t[a];o&&("fulfilled"===e.status?s.push(o):r.push(o))}),{succeeded:s,failed:r}}(this.hass,a,{wasScheduleMode:o,hadDisableAt:i});if(this.isConnected)if(0===e.failed.length){this._setSelected(a);const e=1===t?be(this.hass,"toast.success.restored_one"):be(this.hass,"toast.success.restored_many",{count:t});this._showToast(e)}else this._setSelected(e.failed),this._showToast(be(this.hass,"toast.error.undo_failed"))}catch(e){console.error("Undo failed:",e),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.error.undo_failed"))}}}),this._setSelected([]),this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime=""}catch(e){console.error("Snooze failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ye(e,"Failed to snooze automations"))}this._loading=!1}}async _wake(e){if(this.hass)try{await async function(e,t){await Ke(e,t)}(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.resumed"))}catch(e){console.error("Wake failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ye(e,be(this.hass,"toast.error.resume_failed")))}}async _handleWakeEvent(e){await this._wake(e.detail.entityId)}async _handleWakeAllEvent(){if(this.hass)try{await tt(this.hass),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.resumed_all"))}catch(e){console.error("Wake all failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ye(e,be(this.hass,"toast.error.resume_all_failed")))}}_handleAdjustAutomationEvent(e){this._adjustModalOpen=!0,this._adjustModalEntityId=e.detail.entityId,this._adjustModalFriendlyName=e.detail.friendlyName,this._adjustModalResumeAt=e.detail.resumeAt,this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[]}_handleAdjustGroupEvent(e){this._adjustModalOpen=!0,this._adjustModalEntityIds=e.detail.entityIds,this._adjustModalFriendlyNames=e.detail.friendlyNames,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt=e.detail.resumeAt}async _handleAdjustTimeEvent(e){if(!this.hass)return;const{entityId:t,entityIds:a,...o}=e.detail,i=a||t||"";try{await at(this.hass,i,o),this._hapticFeedback("success");const e=(o.days||0)*ze+(o.hours||0)*we+(o.minutes||0)*xe,t=new Date(this._adjustModalResumeAt).getTime();this._adjustModalResumeAt=new Date(t+e).toISOString(),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.adjusted"))}catch(e){console.error("Adjust failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ye(e,be(this.hass,"toast.error.adjust_failed")))}}_handleCloseModalEvent(){this._adjustModalOpen=!1,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt="",this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[]}async _cancelScheduled(e){if(this.hass)try{await async function(e,t){await Ze(e,t)}(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.cancelled"))}catch(e){console.error("Cancel scheduled failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ye(e,be(this.hass,"toast.error.cancel_failed")))}}_setSelected(e){this._cardStore.setSelection(e),this._selected=this._cardStore.getState().selected}_setDurationState(e,t){this._cardStore.setDuration(e,t);const a=this._cardStore.getState();this._duration=a.durationMs,this._customDuration=a.customDuration,this._customDurationInput=a.customDurationInput}_handleDurationChange(e){const{duration:t,input:a,showCustomInput:o}=e.detail;this._setDurationState(t,a),void 0!==o&&(this._showCustomInput=o)}_handleScheduleModeChange(e){if(this._scheduleMode=e.detail.enabled,e.detail.enabled){const e=new Date,{date:t,time:a}=function(){const e=new Date;return{date:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,time:`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}}(),o=this._lastDuration?.minutes??30,i=new Date(e.getTime()+o*xe),s=i.getFullYear(),r=String(i.getMonth()+1).padStart(2,"0"),n=String(i.getDate()).padStart(2,"0"),l=String(i.getHours()).padStart(2,"0"),d=String(i.getMinutes()).padStart(2,"0");this._disableAtDate=t,this._disableAtTime=a,this._resumeAtDate=`${s}-${r}-${n}`,this._resumeAtTime=`${l}:${d}`}}_handleScheduleFieldChange(e){const{field:t,value:a}=e.detail;switch(t){case"disableAtDate":this._disableAtDate=a;break;case"disableAtTime":this._disableAtTime=a;break;case"resumeAtDate":this._resumeAtDate=a;break;case"resumeAtTime":this._resumeAtTime=a}}_handleCustomInputToggle(e){this._showCustomInput=e.detail.show}_handleSelectionChange(e){this._setSelected(e.detail.selected)}_handleGuardrailCancel(){this._guardrailConfirmOpen=!1}async _handleGuardrailContinue(){this._guardrailConfirmOpen=!1,await this._snooze(!0)}_renderScheduledPauses(e,t){return 0===e?"":G`
    ...
    `}render(){if(!this.hass||!this.config)return G``;const e=this._getPaused(),t=Object.keys(e).length,a=this._getScheduled(),o=Object.keys(a).length,i=this._getAutomations(),s=this._isSnoozeSensorAvailable();return G`
      <ha-card>
        <div class="header">
          <ha-icon icon="mdi:sleep"></ha-icon>
          ${this.config?.title||be(this.hass,"card.default_title")}
          ${t>0||o>0?G`<span class="status-summary"
                >${t>0?be(this.hass,"status.active_count",{count:t}):""}${t>0&&o>0?", ":""}${o>0?be(this.hass,"status.scheduled_count",{count:o}):""}</span
              >`:""}
        </div>
    ...
    `}}gt.styles=[ye,fe],e([ce({attribute:!1})],gt.prototype,"hass",void 0),e([ce({attribute:!1})],gt.prototype,"config",void 0),e([he()],gt.prototype,"_selected",void 0),e([he()],gt.prototype,"_duration",void 0),e([he()],gt.prototype,"_customDuration",void 0),e([he()],gt.prototype,"_customDurationInput",void 0),e([he()],gt.prototype,"_loading",void 0),e([he()],gt.prototype,"_scheduleMode",void 0),e([he()],gt.prototype,"_disableAtDate",void 0),e([he()],gt.prototype,"_disableAtTime",void 0),e([he()],gt.prototype,"_resumeAtDate",void 0),e([he()],gt.prototype,"_resumeAtTime",void 0),e([he()],gt.prototype,"_labelRegistry",void 0),e([he()],gt.prototype,"_labelRegistryUnavailable",void 0),e([he()],gt.prototype,"_categoryRegistry",void 0),e([he()],gt.prototype,"_entityRegistry",void 0),e([he()],gt.prototype,"_showCustomInput",void 0),e([he()],gt.prototype,"_automationsCache",void 0),e([he()],gt.prototype,"_automationsCacheVersion",void 0),e([he()],gt.prototype,"_lastDuration",void 0),e([he()],gt.prototype,"_adjustModalOpen",void 0),e([he()],gt.prototype,"_adjustModalEntityId",void 0),e([he()],gt.prototype,"_adjustModalFriendlyName",void 0),e([he()],gt.prototype,"_adjustModalResumeAt",void 0),e([he()],gt.prototype,"_adjustModalEntityIds",void 0),e([he()],gt.prototype,"_adjustModalFriendlyNames",void 0),e([he()],gt.prototype,"_guardrailConfirmOpen",void 0);const _t=r`
  .row {
    margin-bottom: 12px;
  }
  .row label {
...
`;class bt extends ne{constructor(){super(...arguments),this._config={}}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config)return;const a={...this._config,[e]:t};""!==t&&null!=t||delete a[e],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:a},bubbles:!0,composed:!0}))}render(){return this._config?G`
      <div class="row">
    ...
    `:G``}}bt.styles=_t,e([ce({attribute:!1})],bt.prototype,"hass",void 0),e([he()],bt.prototype,"_config",void 0);const ft=r`
    :host {
      display: block;
    }
    .snooze-list {
...
`;class yt extends ne{constructor(){super(...arguments),this.pauseGroups=[],this.pausedCount=0,this._wakeAllPending=!1,this._wakeAllTimeout=null,this._countdownState={interval:null,syncTimeout:null}}connectedCallback(){super.connectedCallback(),Qe(this._countdownState),this._countdownState=Xe(()=>this._updateCountdownIfNeeded())}disconnectedCallback(){super.disconnectedCallback(),Qe(this._countdownState),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null)}_updateCountdownIfNeeded(){this.pauseGroups.length>0&&this.requestUpdate()}_handleWakeAll(){this._wakeAllPending?(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,this._fireWakeAll()):(Ve("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},Ce))}_fireWake(e){this.dispatchEvent(new CustomEvent("wake-automation",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireAdjust(e){this.dispatchEvent(new CustomEvent("adjust-automation",{detail:{entityId:e.entity_id,friendlyName:e.friendly_name,resumeAt:e.resume_at},bubbles:!0,composed:!0}))}_fireAdjustGroup(e){this.dispatchEvent(new CustomEvent("adjust-group",{detail:{entityIds:e.automations.map(e=>e.entity_id),friendlyNames:e.automations.map(e=>e.friendly_name||e.entity_id),resumeAt:e.resumeAt},bubbles:!0,composed:!0}))}_fireWakeAll(){this.dispatchEvent(new CustomEvent("wake-all",{bubbles:!0,composed:!0}))}render(){if(0===this.pausedCount)return G``;const e=this.hass?.locale?.language;return G`
        ...
        ${this.pauseGroups.map(t=>G`
          <div class="pause-group" role="group">
            <div class="pause-group-header"
              ...
              ${t.disableAt?G`${be(this.hass,"status.resumes")} ${Oe(t.resumeAt,e)}`:G`<span class="countdown">${Le(t.resumeAt,be(this.hass,"status.resuming"))}</span>`}
            </div>
    ...
    `}}yt.styles=[ye,ft],e([ce({attribute:!1})],yt.prototype,"hass",void 0),e([ce({attribute:!1})],yt.prototype,"pauseGroups",void 0),e([ce({type:Number})],yt.prototype,"pausedCount",void 0);const vt=r`
    :host {
      display: block;
    }
...
`;class xt extends ne{constructor(){super(...arguments),this.scheduleMode=!1,this.customDuration={days:0,hours:0,minutes:30},this.customDurationInput="30m",this.showCustomInput=!1,this.lastDuration=null,this.disableAtDate="",this.disableAtTime="",this.resumeAtDate="",this.resumeAtTime=""}_getBasePresets(){const e=this.hass?.states?.[nt],t=e?.attributes?.duration_presets;return t?.length?t:Pe.filter(e=>null!==e.minutes)}_getDurationPills(){return[...this._getBasePresets(),{label:be(this.hass,"duration.custom"),minutes:null}]}_getDurationPreview(){const e=Ge(this.customDurationInput);return e?Ue(e.days,e.hours,e.minutes):""}_isDurationValid(){return Be(this.customDurationInput)}_renderDateOptions(){const e=function(e=365,t){const a=[],o=new Date,i=o.getFullYear();for(let s=0;s<e;s++){const e=new Date(o);e.setDate(e.getDate()+s);const r=e.getFullYear(),n=`${r}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=e.toLocaleDateString(t,{weekday:"short"}),d=e.toLocaleDateString(t,{month:"short"}),u=e.getDate(),c=r!==i?`${l}, ${d} ${u}, ${r}`:`${l}, ${d} ${u}`;a.push({value:n,label:c})}return a}(365,this.hass?.locale?.language);return e.map(e=>G`<option value="${e.value}">${e.label}</option>`)}_renderLastDurationBadge(){if(!this.lastDuration)return"";const e=this._getBasePresets(),t=this.lastDuration.minutes,a=!e.some(e=>e.minutes===t);if(!a)return"";const{days:o,hours:i,minutes:s}=this.lastDuration.duration,r=He(o,i,s).replace(/ /g,""),n=We(this.customDuration),l=!this.showCustomInput&&t===n;return G`
    ...
    `}_fireDurationChange(e,t){const a=function(e){const t=Math.floor(e/Ae),a=e%Ae;return{days:t,hours:Math.floor(a/$e),minutes:a%$e}}(e),o=He(a.days,a.hours,a.minutes);this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:e,duration:a,input:o,showCustomInput:t?.showCustomInput??!1},bubbles:!0,composed:!0}))}_fireCustomDurationChange(e){const t=Ge(e),a=t?We(t):0;this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:a,duration:t??{days:0,hours:0,minutes:0},input:e},bubbles:!0,composed:!0}))}_fireScheduleModeChange(e){this.dispatchEvent(new CustomEvent("schedule-mode-change",{detail:{enabled:e},bubbles:!0,composed:!0}))}_fireScheduleFieldChange(e,t){this.dispatchEvent(new CustomEvent("schedule-field-change",{detail:{field:e,value:t},bubbles:!0,composed:!0}))}_formatScheduleDateTime(e){const t=this.hass?.locale?.language;return new Date(e).toLocaleString(t,{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}_renderScheduleSummary(){if(!this.resumeAtDate||!this.resumeAtTime)return"";const e=qe(this.resumeAtDate,this.resumeAtTime);if(!e)return"";if(!Boolean(this.disableAtDate&&this.disableAtTime))return G`
      ...
      `;const t=qe(this.disableAtDate,this.disableAtTime);return t?new Date(t).getTime()>=new Date(e).getTime()?G`
    ...
    `}}xt.styles=vt,e([ce({attribute:!1})],xt.prototype,"hass",void 0),e([ce({type:Boolean})],xt.prototype,"scheduleMode",void 0),e([ce({attribute:!1})],xt.prototype,"customDuration",void 0),e([ce({type:String})],xt.prototype,"customDurationInput",void 0),e([ce({type:Boolean})],xt.prototype,"showCustomInput",void 0),e([ce({attribute:!1})],xt.prototype,"lastDuration",void 0),e([ce({type:String})],xt.prototype,"disableAtDate",void 0),e([ce({type:String})],xt.prototype,"disableAtTime",void 0),e([ce({type:String})],xt.prototype,"resumeAtDate",void 0),e([ce({type:String})],xt.prototype,"resumeAtTime",void 0);const wt=r`
    :host {
      display: block;
    }
...
`;class zt extends ne{constructor(){super(...arguments),this.automations=[],this.selected=[],this.labelRegistry={},this.labelRegistryUnavailable=!1,this.categoryRegistry={},this._filterTab="all",this._search="",this._searchInput="",this._expandedGroups={},this._searchTimeout=null}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null)}_fireSelectionChange(e){this.dispatchEvent(new CustomEvent("selection-change",{detail:{selected:e},bubbles:!0,composed:!0}))}_toggleSelection(e){let t;Ve("selection"),t=this.selected.includes(e)?this.selected.filter(t=>t!==e):[...this.selected,e],this._fireSelectionChange(t)}_toggleGroupExpansion(e){this._expandedGroups={...this._expandedGroups,[e]:!this._expandedGroups[e]}}_selectGroup(e){const t=e.map(e=>e.id);let a;a=t.every(e=>this.selected.includes(e))?this.selected.filter(e=>!t.includes(e)):[...new Set([...this.selected,...t])],this._fireSelectionChange(a)}_selectAllVisible(){const e=this._getFilteredAutomations().map(e=>e.id),t=[...new Set([...this.selected,...e])];this._fireSelectionChange(t)}_clearSelection(){this._fireSelectionChange([])}_getFilteredAutomations(){return function(e,t,a){let o=e;const i=e.some(e=>it(e,Ie,a));o=i?o.filter(e=>it(e,Ie,a)):o.filter(e=>!it(e,Fe,a));const s=t.toLowerCase();return s&&(o=o.filter(e=>e.name.toLowerCase().includes(s)||e.id.toLowerCase().includes(s))),o}(this.automations,this._search,this.labelRegistry)}_getAreaName(e){return this.hass?function(e,t,a="Unassigned"){return e?t.areas?.[e]?.name??ot(e):a}(e,this.hass):be(this.hass,"group.unassigned")}_getLabelName(e){return function(e,t){return t[e]?.name??ot(e)}(e,this.labelRegistry)}_getCategoryName(e){return function(e,t,a="Uncategorized"){return e?t[e]?.name??ot(e):a}(e,this.categoryRegistry)}_getGroupedByArea(){return st(this._getFilteredAutomations(),e=>e.area_id?[this._getAreaName(e.area_id)]:null,be(this.hass,"group.unassigned"))}_getGroupedByLabel(){const e=this._getFilteredAutomations(),t=[Fe.toLowerCase(),Ie.toLowerCase()];return st(e,e=>{if(!e.labels?.length)return null;const a=e.labels.map(e=>this._getLabelName(e)).filter(e=>!t.includes(e.toLowerCase()));return a.length>0?a:null},be(this.hass,"group.unlabeled"))}_getGroupedByCategory(){return st(this._getFilteredAutomations(),e=>e.category_id?[this._getCategoryName(e.category_id)]:null,be(this.hass,"group.uncategorized"))}_getAreaCount(){return rt(this.automations,e=>e.area_id?[e.area_id]:null)}_getLabelCount(){const e=[Fe.toLowerCase(),Ie.toLowerCase()];return rt(this.automations,t=>{if(!t.labels?.length)return null;const a=t.labels.filter(t=>!e.includes(this._getLabelName(t).toLowerCase()));return a.length>0?a:null})}_getCategoryCount(){return rt(this.automations,e=>e.category_id?[e.category_id]:null)}_handleSearchInput(e){const t=e.target.value;this._searchInput=t,null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},ke)}_clearSearch(){null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null),this._searchInput="",this._search=""}_handleSearchKeydown(e){"Escape"===e.key&&(this._searchInput||this._search)&&(e.preventDefault(),this._clearSearch())}_renderSelectionList(){const e=this._getFilteredAutomations();if("all"===this._filterTab)return 0===e.length?G`<div class="list-empty" role="status">${be(this.hass,"list.empty")}</div>`:e.map(e=>G`
        <button
          type="button"
      ...
      <div class="search-box">
        ...
        ${a?G`
              <button
                ...
                aria-label="${be(this.hass,"a11y.clear_selection")}"
              >
    ...
    `}}zt.styles=wt,e([ce({attribute:!1})],zt.prototype,"hass",void 0),e([ce({attribute:!1})],zt.prototype,"automations",void 0),e([ce({attribute:!1})],zt.prototype,"selected",void 0),e([ce({attribute:!1})],zt.prototype,"labelRegistry",void 0),e([ce({type:Boolean})],zt.prototype,"labelRegistryUnavailable",void 0),e([ce({attribute:!1})],zt.prototype,"categoryRegistry",void 0),e([he()],zt.prototype,"_filterTab",void 0),e([he()],zt.prototype,"_search",void 0),e([he()],zt.prototype,"_searchInput",void 0),e([he()],zt.prototype,"_expandedGroups",void 0);const $t=r`
    :host {
      display: block;
    }
    .modal-overlay {
...
`,At=[{label:"+15m",minutes:15},{label:"+30m",minutes:30},{label:"+1h",hours:1},{label:"+2h",hours:2}],kt=[{label:"-15m",minutes:-15,thresholdMs:15*xe},{label:"-30m",minutes:-30,thresholdMs:30*xe}],St=xe;class Ct extends ne{constructor(){super(...arguments),this.open=!1,this.entityId="",this.friendlyName="",this.resumeAt="",this.entityIds=[],this.friendlyNames=[],this._countdownState={interval:null,syncTimeout:null}}get _isGroupMode(){return this.entityIds.length>1}updated(e){e.has("open")&&(this.open?this._startSynchronizedCountdown():this._stopCountdown())}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown()}_startSynchronizedCountdown(){Qe(this._countdownState),this._countdownState=Xe(()=>this.requestUpdate())}_stopCountdown(){Qe(this._countdownState)}_isDecrementDisabled(e){if(!this.resumeAt)return!0;return new Date(this.resumeAt).getTime()-Date.now()-e<St}_fireAdjustTime(e){this.entityIds.length>0?this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityIds:this.entityIds,...e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityId:this.entityId,...e},bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}_handleOverlayKeydown(e){"Escape"===e.key&&this._close()}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}render(){return this.open?G`
      <div class="modal-overlay" @click=${this._handleOverlayClick} @keydown=${this._handleOverlayKeydown}>
        <div class="modal-content" role="dialog" aria-modal="true" aria-labelledby="adjust-title" @click=${e=>e.stopPropagation()}>
          ...
          <div class="modal-body">
            ...
            <div class="remaining-time">${Le(this.resumeAt,be(this.hass,"status.resuming"))}</div>
    ...
    `:G``}}Ct.styles=$t,e([ce({attribute:!1})],Ct.prototype,"hass",void 0),e([ce({type:Boolean})],Ct.prototype,"open",void 0),e([ce({type:String})],Ct.prototype,"entityId",void 0),e([ce({type:String})],Ct.prototype,"friendlyName",void 0),e([ce({type:String})],Ct.prototype,"resumeAt",void 0),e([ce({attribute:!1})],Ct.prototype,"entityIds",void 0),e([ce({attribute:!1})],Ct.prototype,"friendlyNames",void 0);const Tt=Symbol.for("autosnooze.registration.done.v1"),Dt=new Set,jt="autosnooze-card",Rt=[{tag:"autosnooze-card-editor",ctor:bt},{tag:"autosnooze-active-pauses",ctor:yt},{tag:"autosnooze-duration-selector",ctor:xt},{tag:"autosnooze-automation-list",ctor:zt},{tag:"autosnooze-adjust-modal",ctor:Ct},{tag:jt,ctor:gt}];function Et(e,t,a){Dt.has(e)||(Dt.add(e),console.warn(t))}function Pt(e="0.2.15"){const t=function(e){return{type:jt,name:"AutoSnooze Card",description:`Temporarily pause automations with area and label filtering (v${e})`,preview:!0,documentationURL:"https://github.com/mossipcams/autosnooze#readme"}}(e),a=function(){const e=window.customCards;return Array.isArray(e)?e:(void 0!==e&&Et("customCards-not-array",`[AutoSnooze] window.customCards was not an array (got ${typeof e}); resetting.`),[])}(),o=a.findIndex(e=>e?.type===jt);-1===o?a.push(t):a[o]={...a[o],...t},window.customCards=a}!function(){const e=globalThis;!0===e[Tt]||(Rt.forEach(({tag:e,ctor:t})=>function(e,t,a=customElements){const o=a.get(e);if(o)o!==t&&Et(`element-conflict:${e}`,`[AutoSnooze] Element tag "${e}" is already registered with a different constructor.`);else try{a.define(e,t)}catch(o){const i=a.get(e);if(i===t)return;if(i)return void Et(`element-conflict:${e}`,`[AutoSnooze] Element tag "${e}" was claimed by a different constructor during registration.`);throw o}}(e,t)),e[Tt]=!0),Pt()}();export{yt as AutoSnoozeActivePauses,Ct as AutoSnoozeAdjustModal,zt as AutoSnoozeAutomationList,xt as AutoSnoozeDurationSelector,gt as AutomationPauseCard,bt as AutomationPauseCardEditor};
