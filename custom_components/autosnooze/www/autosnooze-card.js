...
`;class ft extends ne{constructor(){super(...arguments),this._config={}}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config)return;const a={...this._config,[e]:t};""!==t&&null!=t||delete a[e],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:a},bubbles:!0,composed:!0}))}render(){return this._config?B`
    ...
    `:B``}}ft.styles=_t,e([ce({attribute:!1})],ft.prototype,"hass",void 0),e([he()],ft.prototype,"_config",void 0);function yt(e,t){const a=1e3-Date.now()%1e3;e.syncTimeout=window.setTimeout(()=>{e.syncTimeout=null,t(),e.interval=window.setInterval(()=>{t();Date.now()%1e3>50&&(xt(e),yt(e,t))},je)},a)}function vt(e){const t={interval:null,syncTimeout:null};return yt(t,e),t}function xt(e){null!==e.interval&&(clearInterval(e.interval),e.interval=null),null!==e.syncTimeout&&(clearTimeout(e.syncTimeout),e.syncTimeout=null)}const wt=r`
    :host {
      display: block;
    }
    .snooze-list {
...
`;class At extends ne{constructor(){super(...arguments),this.pauseGroups=[],this.pausedCount=0,this._wakeAllPending=!1,this._wakeAllTimeout=null,this._countdownState={interval:null,syncTimeout:null}}connectedCallback(){super.connectedCallback(),xt(this._countdownState),this._countdownState=vt(()=>this._updateCountdownIfNeeded())}disconnectedCallback(){super.disconnectedCallback(),xt(this._countdownState),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null)}_updateCountdownIfNeeded(){this.pauseGroups.length>0&&this.requestUpdate()}_handleWakeAll(){this._wakeAllPending?(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,this._fireWakeAll()):(We("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},Ce))}_fireWake(e){this.dispatchEvent(new CustomEvent("wake-automation",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireAdjust(e){this.dispatchEvent(new CustomEvent("adjust-automation",{detail:{entityId:e.entity_id,friendlyName:e.friendly_name,resumeAt:e.resume_at},bubbles:!0,composed:!0}))}_fireAdjustGroup(e){this.dispatchEvent(new CustomEvent("adjust-group",{detail:{entityIds:e.automations.map(e=>e.entity_id),friendlyNames:e.automations.map(e=>e.friendly_name||e.entity_id),resumeAt:e.resumeAt},bubbles:!0,composed:!0}))}_fireWakeAll(){this.dispatchEvent(new CustomEvent("wake-all",{bubbles:!0,composed:!0}))}render(){if(0===this.pausedCount)return B``;const e=this.hass?.locale?.language;return B`
    ...
    `}}At.styles=[ye,wt],e([ce({attribute:!1})],At.prototype,"hass",void 0),e([ce({attribute:!1})],At.prototype,"pauseGroups",void 0),e([ce({type:Number})],At.prototype,"pausedCount",void 0),e([he()],At.prototype,"_wakeAllPending",void 0);const zt=r`
    :host {
      display: block;
    }
...
`;class $t extends ne{constructor(){super(...arguments),this.scheduleMode=!1,this.customDuration={days:0,hours:0,minutes:30},this.customDurationInput="30m",this.showCustomInput=!1,this.lastDuration=null,this.disableAtDate="",this.disableAtTime="",this.resumeAtDate="",this.resumeAtTime=""}_getBasePresets(){const e=this.hass?.states?.[lt],t=e?.attributes?.duration_presets;return t?.length?t:Ee.filter(e=>null!==e.minutes)}_getDurationPills(){return[...this._getBasePresets(),{label:_e(this.hass,"duration.custom"),minutes:null}]}_getDurationPreview(){const e=Be(this.customDurationInput);return e?Ue(e.days,e.hours,e.minutes):""}_isDurationValid(){return Ge(this.customDurationInput)}_renderDateOptions(){const e=function(e=365,t){const a=[],o=new Date,i=o.getFullYear();for(let s=0;s<e;s++){const e=new Date(o);e.setDate(e.getDate()+s);const r=e.getFullYear(),n=`${r}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=e.toLocaleDateString(t,{weekday:"short"}),d=e.toLocaleDateString(t,{month:"short"}),u=e.getDate(),c=r!==i?`${l}, ${d} ${u}, ${r}`:`${l}, ${d} ${u}`;a.push({value:n,label:c})}return a}(365,this.hass?.locale?.language);return e.map(e=>B`<option value="${e.value}">${e.label}</option>`)}_renderLastDurationBadge(){if(!this.lastDuration)return"";const e=this._getBasePresets(),t=this.lastDuration.minutes,a=!e.some(e=>e.minutes===t);if(!a)return"";const{days:o,hours:i,minutes:s}=this.lastDuration.duration,r=He(o,i,s).replace(/ /g,""),n=qe(this.customDuration),l=!this.showCustomInput&&t===n;return B`
    ...
    `}}$t.styles=zt,e([ce({attribute:!1})],$t.prototype,"hass",void 0),e([ce({type:Boolean})],$t.prototype,"scheduleMode",void 0),e([ce({attribute:!1})],$t.prototype,"customDuration",void 0),e([ce({type:String})],$t.prototype,"customDurationInput",void 0),e([ce({type:Boolean})],$t.prototype,"showCustomInput",void 0),e([ce({attribute:!1})],$t.prototype,"lastDuration",void 0),e([ce({type:String})],$t.prototype,"disableAtDate",void 0),e([ce({type:String})],$t.prototype,"disableAtTime",void 0),e([ce({type:String})],$t.prototype,"resumeAtDate",void 0),e([ce({type:String})],$t.prototype,"resumeAtTime",void 0);const kt=r`
    :host {
      display: block;
    }
...
`,Tt=[{label:"+15m",minutes:15},{label:"+30m",minutes:30},{label:"+1h",hours:1},{label:"+2h",hours:2}],jt=[{label:"-15m",minutes:-15,thresholdMs:15*xe},{label:"-30m",minutes:-30,thresholdMs:30*xe}],Dt=xe;class Rt extends ne{constructor(){super(...arguments),this.open=!1,this.entityId="",this.friendlyName="",this.resumeAt="",this.entityIds=[],this.friendlyNames=[],this._countdownState={interval:null,syncTimeout:null}}get _isGroupMode(){return this.entityIds.length>1}updated(e){e.has("open")&&(this.open?this._startSynchronizedCountdown():this._stopCountdown())}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown()}_startSynchronizedCountdown(){xt(this._countdownState),this._countdownState=vt(()=>this.requestUpdate())}_stopCountdown(){xt(this._countdownState)}_isDecrementDisabled(e){if(!this.resumeAt)return!0;return new Date(this.resumeAt).getTime()-Date.now()-e<Dt}_fireAdjustTime(e){this.entityIds.length>0?this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityIds:this.entityIds,...e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityId:this.entityId,...e},bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}_handleOverlayKeydown(e){"Escape"===e.key&&this._close()}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}render(){return this.open?B`
    ...
    `:B``}}Rt.styles=Ct,e([ce({attribute:!1})],Rt.prototype,"hass",void 0),e([ce({type:Boolean})],Rt.prototype,"open",void 0),e([ce({type:String})],Rt.prototype,"entityId",void 0),e([ce({type:String})],Rt.prototype,"friendlyName",void 0),e([ce({type:String})],Rt.prototype,"resumeAt",void 0),e([ce({attribute:!1})],Rt.prototype,"entityIds",void 0),e([ce({attribute:!1})],Rt.prototype,"friendlyNames",void 0);const Mt=Symbol.for("autosnooze.registration.done.v1"),Et=new Set,Pt="autosnooze-card",It=[{tag:"autosnooze-card-editor",ctor:ft},{tag:"autosnooze-active-pauses",ctor:At},{tag:"autosnooze-duration-selector",ctor:$t},{tag:"autosnooze-automation-list",ctor:St},{tag:"autosnooze-adjust-modal",ctor:Rt},{tag:Pt,ctor:bt}];function Ft(e,t,a){Et.has(e)||(Et.add(e),console.warn(t))}function Nt(e="0.2.15"){const t=function(e){return{type:Pt,name:"AutoSnooze Card",description:`Temporarily pause automations with area and label filtering (v${e})`,preview:!0,documentationURL:"https://github.com/mossipcams/autosnooze#readme"}}(e),a=function(){const e=window.customCards;return Array.isArray(e)?e:(void 0!==e&&Ft("customCards-not-array",`[AutoSnooze] window.customCards was not an array (got ${typeof e}); resetting.`),[])}(),o=a.findIndex(e=>e?.type===Pt);-1===o?a.push(t):a[o]={...a[o],...t},window.customCards=a}!function(){const e=globalThis;!0===e[Mt]||(It.forEach(({tag:e,ctor:t})=>function(e,t,a=customElements){const o=a.get(e);if(o)o!==t&&Ft(`element-conflict:${e}`,`[AutoSnooze] Element tag "${e}" is already registered with a different constructor.`);else try{a.define(e,t)}catch(o){const i=a.get(e);if(i===t)return;if(i)return void Ft(`element-conflict:${e}`,`[AutoSnooze] Element tag "${e}" was claimed by a different constructor during registration.`);throw o}}(e,t)),e[Mt]=!0),Nt()}();export{At as AutoSnoozeActivePauses,Rt as AutoSnoozeAdjustModal,St as AutoSnoozeAutomationList,$t as AutoSnoozeDurationSelector,bt as AutomationPauseCard,ft as AutomationPauseCardEditor};
