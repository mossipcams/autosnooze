        ...
        `:B`
          <div class="duration-selector">
            ...
            <div class="duration-pills" role="radiogroup" aria-labelledby="duration-header">
              ${this._getDurationPills().map(e=>{const t=Oe(this._customDuration),o=null===e.minutes?this._showCustomInput:!this._showCustomInput&&e.minutes===t;return B`
                    <button
                      type="button"
                      class="pill ${o?"active":""}"
                      ...
                      role="radio"
                      aria-checked=${o}
                      aria-label="${null===e.minutes?be(this.hass,"a11y.custom_duration"):be(this.hass,"a11y.snooze_for_duration",{duration:e.label})}"
                    >
                      ${e.label}
                    </button>
                  `})}
