...
`,ve=1e3,xe=6e4,we=36e5,ze=864e5,$e=60,Ae=1440,ke=300,Se=300,Te=3e3,Ce=5e3,De=1e3,je=5e3,Me=1e3,Ee=3e4,Re=[{label:"30m",minutes:30},{label:"1h",minutes:60},{label:"Custom",minutes:null}],Pe=[30,60,120,240],Ie="autosnooze_exclude",Le="autosnooze_include";function Ne(e,t){const o=1e3-Date.now()%1e3;e.syncTimeout=globalThis.setTimeout(()=>{e.syncTimeout=null,t(),e.interval=globalThis.setInterval(()=>{t();Date.now()%1e3>50&&(Ue(e),Ne(e,t))},De)},o)}function Oe(e){const t={interval:null,syncTimeout:null};return Ne(t,e),t}function Ue(e){null!==e.interval&&(globalThis.clearInterval(e.interval),e.interval=null),null!==e.syncTimeout&&(globalThis.clearTimeout(e.syncTimeout),e.syncTimeout=null)}const Fe="autosnooze_last_duration";const Be="autosnooze_recent_snoozes";function He(){try{const e=localStorage.getItem(Be);if(!e)return[];const t=JSON.parse(e);if(!Array.isArray(t))return[];const o=Date.now()-2592e6;return t.filter(e=>"string"==typeof e.id&&"number"==typeof e.timestamp&&e.timestamp>o)}catch{return[]}}function Ge(e){const t=e.toLowerCase().replace(/\s+/g,"");if(!t)return null;let o=0,a=!1;const i=t.match(/(\d+(?:\.\d+)?)\s*d/),s=t.match(/(\d+(?:\.\d+)?)\s*h/),r=t.match(/(\d+(?:\.\d+)?)\s*m(?!i)/);if(i?.[1]){const e=parseFloat(i[1]);if(isNaN(e)||e<0)return null;o+=e*Ae,a=!0}if(s?.[1]){const e=parseFloat(s[1]);if(isNaN(e)||e<0)return null;o+=e*$e,a=!0}if(r?.[1]){const e=parseFloat(r[1]);if(isNaN(e)||e<0)return null;o+=e,a=!0}if(!a){if(!/^\d+(?:\.\d+)?$/.test(t))return null;const e=parseFloat(t);if(isNaN(e)||!(e>0))return null;o=e}if(o=Math.round(o),o<=0)return null;const n=Math.floor(o/Ae),l=o%Ae;return{days:n,hours:Math.floor(l/$e),minutes:l%$e}}function qe(e){return null!==Ge(e)}function We(e){return e.days*Ae+e.hours*$e+e.minutes}function Ve(e){const t=Math.floor(e/Ae),o=e%Ae;return{days:t,hours:Math.floor(o/$e),minutes:o%$e}}const Ye={days:0,hours:0,minutes:30};class Ke{constructor(){this._state={selected:[],filterTab:"all",search:"",customDuration:{...Ye},customDurationInput:"30m",durationMs:30*xe}}getState(){return{...this._state,selected:[...this._state.selected],customDuration:{...this._state.customDuration}}}setSelection(e){this._state.selected=[...e]}toggleSelection(e){this._state.selected.includes(e)?this._state.selected=this._state.selected.filter(t=>t!==e):this._state.selected=[...this._state.selected,e]}clearSelection(){this._state.selected=[]}setFilterTab(e){this._state.filterTab=e}setSearch(e){this._state.search=e}setDuration(e,t){this._state.customDuration={...e},this._state.customDurationInput=t,this._state.durationMs=We(e)*xe}}const Ze="sensor.autosnooze_snoozed_automations",Je={},Xe={},Qe=[];let et=null,tt=null,ot=null,at=null,it=null,st=null;function rt(e){return!e||"object"!=typeof e||Array.isArray(e)?null:e}function nt(e){return rt(e)}function lt(e){return rt(e)}function dt(e){const t=rt(e?.attributes);return!!t&&(1===t.schema_version?null!==rt(t.paused)&&null!==rt(t.scheduled):"paused"in t||"scheduled"in t||"paused_automations"in t||"scheduled_snoozes"in t||"duration_presets"in t||"critical_terms"in t)}function ct(e){const t=e?.states?.[Ze];if(dt(t))return t;const o=Object.values(e?.states??{}).filter(dt);return o.find(e=>e.entity_id.startsWith(Ze))??o[0]}function ut(e){if(0===Object.keys(e).length)return Qe;const t={};return Object.entries(e).forEach(([e,o])=>{const a=o.resume_at;t[a]||(t[a]={resumeAt:a,disableAt:o.disable_at,automations:[]}),t[a].automations.push({entity_id:e,friendly_name:o.friendly_name,resume_at:o.resume_at,paused_at:o.paused_at,days:o.days,hours:o.hours,minutes:o.minutes,disable_at:o.disable_at,notification_trigger:o.notification_trigger})}),Object.values(t).sort((e,t)=>new Date(e.resumeAt).getTime()-new Date(t.resumeAt).getTime())}function ht(e){const t=ct(e),o=t?.attributes,a=t?.entity_id??null,i=rt(o),s=i?.schema_version,r=i?.paused??i?.paused_automations,n=i?.scheduled??i?.scheduled_snoozes;if(o===et&&s===tt&&r===ot&&n===at&&a===it&&st)return st;const l=function(e){const t=rt(e);if(!t)return{paused:Je,scheduled:Xe};const o=t.schema_version;if(1===o){const e=nt(t.paused),o=lt(t.scheduled);return e&&o?{paused:e,scheduled:o}:{paused:Je,scheduled:Xe}}if(void 0===o){const e=nt(t.paused)??nt(t.paused_automations)??{},o=lt(t.scheduled)??lt(t.scheduled_snoozes)??{};if(Object.keys(e).length>0||Object.keys(o).length>0)return{paused:e,scheduled:o}}const a=nt(t.paused_automations),i=lt(t.scheduled_snoozes);return{paused:a??Je,scheduled:i??Xe}}(o);return et=o,tt=s,ot=r,at=n,it=a,st={paused:l.paused,scheduled:l.scheduled,groups:ut(l.paused)},st}function pt(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`}function mt(e){return`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}function gt(e){return{adjustModalOpen:!0,adjustModalEntityId:e.entityId??"",adjustModalFriendlyName:e.friendlyName??"",adjustModalResumeAt:e.resumeAt,adjustModalEntityIds:e.entityIds??[],adjustModalFriendlyNames:e.friendlyNames??[]}}function bt(e){return Oe(e)}function _t(e){Ue(e)}function ft(){return new Ke}function yt(){return function(){try{const e=localStorage.getItem(Fe);if(!e)return null;const t=JSON.parse(e);return"number"!=typeof t.minutes||"number"!=typeof t.duration?.days||"number"!=typeof t.duration?.hours||"number"!=typeof t.duration?.minutes||"number"!=typeof t.timestamp?null:Date.now()-t.timestamp>6048e5?(localStorage.removeItem(Fe),null):t}catch{return null}}()}function vt(){return He().map(e=>e.id)}function xt(e){return ht(e)}function wt(e){return Boolean(ct(e))}function zt(e){return ct(e)}function $t(e,t){const o=new Date(e),a=new Date,i={weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return o.getFullYear()>a.getFullYear()&&(i.year="numeric"),o.toLocaleString(t,i)}function At(e,t="Resuming..."){const o=new Date(e).getTime()-Date.now();if(o<=0)return t;const a=Math.floor(o/ze),i=Math.floor(o%ze/we),s=Math.floor(o%we/xe),r=Math.floor(o%xe/ve);return a>0?`${a}d ${i}h ${s}m`:i>0?`${i}h ${s}m ${r}s`:`${s}m ${r}s`}function kt(e,t,o){const a=[];return e>0&&a.push(`${e} day${1!==e?"s":""}`),t>0&&a.push(`${t} hour${1!==t?"s":""}`),o>0&&a.push(`${o} minute${1!==o?"s":""}`),a.join(", ")}function St(e,t,o){const a=[];return e>0&&a.push(`${e}d`),t>0&&a.push(`${t}h`),o>0&&a.push(`${o}m`),a.join(" ")||"0m"}function Tt(e="light"){!function(e,t,o){const a=new CustomEvent(`hass-${t}`,{bubbles:!0,composed:!0,detail:o});e.dispatchEvent(a)}(window,"haptic",e)}const Ct=Symbol.for("autosnooze.customElements.define.patched"),Dt=Symbol.for("autosnooze.customElements.registeredCtors");function jt(){return navigator.userAgent.toLowerCase().includes("jsdom")}function Mt(){if(!jt())return;const e=customElements;if(e[Ct])return;const t=e.define.bind(e);e.define=(o,a,i)=>{const s=function(){const e=customElements;return e[Dt]??=new WeakSet,e[Dt]}();if(s.has(a)&&!e.get(o)){const e=class extends a{};return t(o,e,i),void s.add(e)}try{t(o,a,i),s.add(a)}catch(e){if(!function(e){return e instanceof Error&&e.message.includes("constructor has already been registered")}(e))throw e;const r=class extends a{};t(o,r,i),s.add(r)}},e[Ct]=!0}function Et(e,t){jt()&&Mt(),customElements.get(e)||customElements.define(e,t)}async function Rt(e,t){try{await e.callService("autosnooze","cancel",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to wake automation:",e),e}}async function Pt(e,t){try{await e.callService("autosnooze","cancel_scheduled",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to cancel scheduled snooze:",e),e}}function It(e,t){if(!e||!t)return null;const o=new Date(`${e}T${t}`);if(Number.isNaN(o.getTime()))return null;const a=`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`,i=`${String(o.getHours()).padStart(2,"0")}:${String(o.getMinutes()).padStart(2,"0")}`;if(a!==e||i!==t)return null;const s=o.getTimezoneOffset(),r=s<=0?"+":"-",n=Math.abs(s);return`${e}T${t}${`${r}${String(Math.floor(n/60)).padStart(2,"0")}:${String(n%60).padStart(2,"0")}`}`}function Lt(e,t){const o=new Date(e.getFullYear(),e.getMonth(),e.getDate()+1,t,0);return{date:`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`,time:`${String(t).padStart(2,"0")}:00`}}function Nt(e,t,o){return t&&"none"!==t?"about_to_end"===t?void 0===o?{...e,notification_trigger:t}:{...e,notification_trigger:t,notification_lead_minutes:o}:{...e,notification_trigger:t}:e}const Ot="autosnooze_confirm",Ut=["alarm","security","siren","lock","smoke","carbon monoxide","co2","leak","flood","fire","gas"];function Ft(e){if(!e)return null;const t=new Date(e).getTime();return Number.isFinite(t)?t:null}function Bt(e,t){return _e(e.hass,"Resume time is required"===t?e.resumeAtDate||e.resumeAtTime?"toast.error.invalid_datetime":"toast.error.resume_time_required":"Resume time must be in the future"===t?"toast.error.resume_time_past":"toast.error.snooze_before_resume")}function Ht(e,t){return t.some(t=>{const o=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(?<![a-z0-9])${o}(?![a-z0-9])`,"i").test(e)})}function Gt(e){const t=ct(e)?.attributes?.critical_terms;return Array.isArray(t)&&t.length>0&&t.every(e=>"string"==typeof e)?t:Ut}function qt(e){const t=new Set(e.selected),o=e.criticalTerms??Ut;return e.automations.some(a=>{return!!t.has(a.id)&&(i=a.labels,s=e.labelRegistry,i.some(e=>e===Ot||s[e]?.name===Ot)||Ht(a.id,o)||Ht(a.name,o));var i,s})}async function Wt(e){const t=function(e){if(e.untilTomorrow&&!e.scheduleMode){const t=Lt(new Date,8);return{...e,scheduleMode:!0,resumeAtDate:t.date,resumeAtTime:t.time,disableAtDate:"",disableAtTime:""}}return e}(e);if(t.scheduleMode){const e=function(e){const t=Ft(It(e.resumeAtDate,e.resumeAtTime));if(null===t)return{status:"error",message:"Resume time is required"};if(t<=e.nowMs)return{status:"error",message:"Resume time must be in the future"};const o=e.disableAtDate&&e.disableAtTime?It(e.disableAtDate,e.disableAtTime):null,a=Ft(o);return e.disableAtDate&&e.disableAtTime&&null===o||null!==a&&a>=t?{status:"error",message:"Snooze time must be before resume time"}:{status:"valid"}}({...t,nowMs:t.nowMs??0});if("error"===e.status)return{status:"validation_error",toastMessage:Bt(t,e.message)}}if(!t.forceConfirm&&t.automations&&qt({selected:t.selected,automations:t.automations,labelRegistry:t.labelRegistry??{},criticalTerms:Gt(t.hass)}))return{status:"confirm_required"};const o=t.scheduleMode?function(e){const t=e.disableAtDate&&e.disableAtTime?It(e.disableAtDate,e.disableAtTime):null,o=It(e.resumeAtDate,e.resumeAtTime);if(!o)return null;const a=Nt({entity_id:e.selected,resume_at:o,...t&&{disable_at:t},...e.forceConfirm&&{confirm:!0}},e.notificationTrigger,e.notificationLeadMinutes),i=e.selected.length;return{request:a,toastMessage:t?1===i?_e(e.hass,"toast.success.scheduled_one"):_e(e.hass,"toast.success.scheduled_many",{count:i}):1===i?_e(e.hass,"toast.success.snoozed_until_one",{time:$t(o,e.hass.locale?.language)}):_e(e.hass,"toast.success.snoozed_until_many",{count:i,time:$t(o,e.hass.locale?.language)})}}(t):function(e){const{days:t,hours:o,minutes:a}=e.customDuration,i={minutes:We(e.customDuration),duration:e.customDuration,timestamp:Date.now()};return{request:Nt({entity_id:e.selected,days:t,hours:o,minutes:a,...e.forceConfirm&&{confirm:!0}},e.notificationTrigger,e.notificationLeadMinutes),toastMessage:1===e.selected.length?_e(e.hass,"toast.success.snoozed_for_one",{duration:kt(t,o,a)}):_e(e.hass,"toast.success.snoozed_for_many",{count:e.selected.length,duration:kt(t,o,a)}),lastDuration:i}}(t);if(!o)return{status:"aborted"};try{await async function(e,t){try{await e.callService("autosnooze","pause",t)}catch(e){throw console.error("[AutoSnooze] Failed to pause automations:",e),e}}(t.hass,o.request)}catch(e){if("confirm_required"===function(e){const t=e;return t?.translation_key??t?.data?.translation_key}(e))return{status:"confirm_required"};throw e}return function(e){try{const t=Date.now(),o=He(),a=e.map(e=>({id:e,timestamp:t})),i=new Set(e),s=[...a,...o.filter(e=>!i.has(e.id))].slice(0,10);localStorage.setItem(Be,JSON.stringify(s))}catch{}}(t.selected),function(e){return"lastDuration"in e}(o)?(function(e,t){try{const o={minutes:t,duration:e,timestamp:Date.now()};localStorage.setItem(Fe,JSON.stringify(o))}catch{}}(o.lastDuration.duration,o.lastDuration.minutes),{status:"submitted",toastMessage:o.toastMessage,lastDuration:o.lastDuration}):{status:"submitted",toastMessage:o.toastMessage}}async function Vt(e){await async function(e){try{await e.callService("autosnooze","cancel_all",{})}catch(e){throw console.error("[AutoSnooze] Failed to wake all automations:",e),e}}(e)}async function Yt(e,t){await async function(e,t){try{await e.callService("autosnooze","clear_notification",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to clear snooze notification:",e),e}}(e,t)}async function Kt(e,t,o){const{entityId:a,entityIds:i,...s}=t,r=i||a||"";await async function(e,t,o){try{await e.callService("autosnooze","adjust",{entity_id:t,...o})}catch(e){throw console.error("[AutoSnooze] Failed to adjust snooze:",e),e}}(e,r,s);const n=24*(s.days||0)*60*60*1e3+60*(s.hours||0)*60*1e3+60*(s.minutes||0)*1e3;return{nextResumeAt:new Date(new Date(o).getTime()+n).toISOString()}}function Zt(e){return e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}const Jt={loadLabels:async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/label_registry/list"}),o={};return Array.isArray(t)&&t.forEach(e=>{o[e.label_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch label registry:",e),null}},loadCategories:async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/category_registry/list",scope:"automation"}),o={};return Array.isArray(t)&&t.forEach(e=>{o[e.category_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch category registry:",e),{}}},loadEntities:async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/entity_registry/list"}),o={};return Array.isArray(t)&&t.filter(e=>e.entity_id.startsWith("automation.")).forEach(e=>{o[e.entity_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch entity registry:",e),{}}},getAutomations:function(e,t){return e.states?Object.keys(e.states).filter(e=>e.startsWith("automation.")).map(o=>{const a=e.states[o];if(!a)return null;const i=t[o],s=e.entities?.[o];return{id:o,name:a.attributes?.friendly_name??o.replace("automation.",""),area_id:i?.area_id??s?.area_id??null,category_id:i?.categories?.automation??null,labels:i?.labels??s?.labels??[]}}).filter(e=>null!==e).sort((e,t)=>e.name.localeCompare(t.name)):[]},setTimeout:setTimeout,clearTimeout:clearTimeout};class Xt{constructor(e,t={}){this.changed=e,this.labels={},this.labelsUnavailable=!1,this.categories={},this.entities={},this.cacheVersion=0,this.connected=!1,this.labelsLoaded=!1,this.categoriesLoaded=!1,this.entitiesLoaded=!1,this.retryDelay=Me,this.cachedVersion=-1,this.deps={...Jt,...t}}get snapshot(){return{labels:this.labels,labelsUnavailable:this.labelsUnavailable,categories:this.categories,entities:this.entities,cacheVersion:this.cacheVersion}}connect(e){return this.connected=!0,this.hass=e,e.connection?Promise.all([this.loadLabels(),this.loadCategories(),this.loadEntities()]).then(()=>{}):Promise.resolve()}disconnect(){this.connected=!1,void 0!==this.retryTimer&&this.deps.clearTimeout(this.retryTimer),this.retryTimer=void 0}getAutomations(e){return this.cachedStates===e.states&&this.cachedVersion===this.cacheVersion&&this.automations||(this.automations=this.deps.getAutomations(e,this.entities),this.cachedStates=e.states,this.cachedVersion=this.cacheVersion),this.automations}shouldUpdate(e,t){if(!e||!t)return!0;if(ct(e)!==ct(t)||e.entities!==t.entities||e.areas!==t.areas||(e.language??e.locale?.language)!==(t.language??t.locale?.language))return!0;if(!e.states||!t.states)return!0;if(e.states===t.states)return!1;const o=Object.entries(e.states).filter(([e])=>e.startsWith("automation.")),a=Object.keys(t.states).filter(e=>e.startsWith("automation.")).length;return o.length!==a||o.some(([e,o])=>t.states[e]!==o)}loadLabels(e){return e&&(this.hass=e),this.labelsLoaded||void 0!==this.retryTimer?Promise.resolve():this.labelsPromise??=this.deps.loadLabels(this.hass).then(e=>{if(null===e)return this.labelsUnavailable=!0,void 0===this.retryTimer&&(this.retryTimer=this.deps.setTimeout(()=>{this.finishRetry(),this.loadLabels()},this.retryDelay),this.retryDelay=Math.min(2*this.retryDelay,Ee)),void this.changed();this.labels=e,this.labelsLoaded=!0,this.labelsUnavailable=!1,this.retryDelay=Me,this.finishRetry(),this.invalidate()}).finally(()=>{this.labelsPromise=void 0})}loadCategories(e){return e&&(this.hass=e),this.categoriesLoaded?Promise.resolve():this.categoriesPromise??=this.deps.loadCategories(this.hass).then(e=>{this.categories=e,this.categoriesLoaded=!0,this.changed()}).finally(()=>{this.categoriesPromise=void 0})}loadEntities(e){return e&&(this.hass=e),this.entitiesLoaded?Promise.resolve():this.entitiesPromise??=this.deps.loadEntities(this.hass).then(e=>{this.entities=e,this.entitiesLoaded=!0,this.invalidate()}).finally(()=>{this.entitiesPromise=void 0})}finishRetry(){void 0!==this.retryTimer&&this.deps.clearTimeout(this.retryTimer),this.retryTimer=void 0}invalidate(){this.cacheVersion++,this.connected&&this.changed()}}class Qt extends HTMLElement{show(e,t,o=t,a){this.clear();const i=document.createElement("div");if(i.className="toast",i.setAttribute("role","alert"),i.setAttribute("aria-live","polite"),i.setAttribute("aria-atomic","true"),a){const s=document.createElement("span");s.textContent=e,i.appendChild(s);const r=document.createElement("button");r.className="toast-undo-btn",r.textContent=t,r.setAttribute("aria-label",o),r.onclick=e=>{e.stopPropagation(),a(),this.clear()},i.appendChild(r)}else i.textContent=e;this.appendChild(i),this.durationTimer=setTimeout(()=>{i.style.animation=`slideUp ${Se}ms ease-out reverse`,this.fadeTimer=setTimeout(()=>this.clear(),Se),this.durationTimer=void 0},Ce)}disconnectedCallback(){this.clear()}clear(){void 0!==this.durationTimer&&clearTimeout(this.durationTimer),void 0!==this.fadeTimer&&clearTimeout(this.fadeTimer),this.durationTimer=this.fadeTimer=void 0,this.replaceChildren()}}Et("autosnooze-toast",Qt);class eo extends ne{constructor(){super(...arguments),this.scheduled={}}createRenderRoot(){return this}render(){const e=Object.entries(this.scheduled);return e.length?H`
      <div class="scheduled-list" role="region" aria-label="${_e(this.hass,"a11y.scheduled_region")}">
        ...
        ${e.map(([e,t])=>{const o=t.friendly_name||e;return H`
      ...
      <ha-card>
        ...
        <div class="snooze-setup">
          ...
          <div class="notify-section">
            ...
            ${this._notificationsEnabled?H`
              <div class="notify-detail">
                ...
                ${"about_to_end"===this._notificationTrigger?H`
                  <label class="notify-field">
                    ...
                    >
                      ${Pe.map(e=>H`<option value=${String(e)}>${this._formatLeadLabel(e)}</option>`)}
                    </select>
                  </label>
                `:""}
              </div>
          ...
          <button
            type="button"
            class="snooze-btn"
            ?disabled=${0===this._selected.length||!this._scheduleMode&&!this._untilTomorrow&&!qe(this._customDurationInput)||this._scheduleMode&&!this._hasResumeAt()||this._loading}
            @click=${()=>this._snooze()}
        ...
        ${o>0?H`<autosnooze-active-pauses
              .hass=${this.hass}
    ...
    `}}to.styles=[ye,fe],e([ue({attribute:!1})],to.prototype,"hass",void 0),e([ue({attribute:!1})],to.prototype,"config",void 0),e([he()],to.prototype,"_selected",void 0),e([he()],to.prototype,"_duration",void 0),e([he()],to.prototype,"_customDuration",void 0),e([he()],to.prototype,"_customDurationInput",void 0),e([he()],to.prototype,"_loading",void 0),e([he()],to.prototype,"_scheduleMode",void 0),e([he()],to.prototype,"_notificationsEnabled",void 0),e([he()],to.prototype,"_notificationTrigger",void 0),e([he()],to.prototype,"_notificationLeadMinutes",void 0),e([he()],to.prototype,"_disableAtDate",void 0),e([he()],to.prototype,"_disableAtTime",void 0),e([he()],to.prototype,"_resumeAtDate",void 0),e([he()],to.prototype,"_resumeAtTime",void 0),e([he()],to.prototype,"_showCustomInput",void 0),e([he()],to.prototype,"_untilTomorrow",void 0),e([he()],to.prototype,"_lastDuration",void 0),e([he()],to.prototype,"_recentSnoozeIds",void 0),e([he()],to.prototype,"_adjustModalOpen",void 0),e([he()],to.prototype,"_adjustModalEntityId",void 0),e([he()],to.prototype,"_adjustModalFriendlyName",void 0),e([he()],to.prototype,"_adjustModalResumeAt",void 0),e([he()],to.prototype,"_adjustModalEntityIds",void 0),e([he()],to.prototype,"_adjustModalFriendlyNames",void 0),e([he()],to.prototype,"_guardrailConfirmOpen",void 0),Et("autosnooze-card",to);class oo extends ne{constructor(){super(...arguments),this.config={}}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-snoozed-card",title:"Snoozed Automations"}}setConfig(e){this.config=e}getCardSize(){const e=this.hass?xt(this.hass):null;return 1+(e?Object.keys(e.paused).length:0)}shouldUpdate(e){const t=e.get("hass");if(!t||!this.hass)return!0;const o=zt(t)!==zt(this.hass),a=(t.language??t.locale?.language)!==(this.hass.language??this.hass.locale?.language);return o||a}render(){if(!this.hass||!this.config)return H``;const e=xt(this.hass),t=Object.keys(e.paused).length;return H`
      <ha-card>
        <div class="header">
          <ha-icon icon="mdi:bell-sleep"></ha-icon>
          ${this.config?.title||_e(this.hass,"card.snoozed_title")}
          ${t>0?H`<span class="status-summary"
        ...
        ${t>0?H`<autosnooze-active-pauses
              .hass=${this.hass}
              .pauseGroups=${e.groups}
              .pausedCount=${t}
              .readonly=${!0}
            ></autosnooze-active-pauses>`:H`<div class="snoozed-empty" role="status">
              ${_e(this.hass,"status.no_snoozed")}
            </div>`}
      </ha-card>
    `}}oo.styles=[ye,fe],e([ue({attribute:!1})],oo.prototype,"hass",void 0),e([ue({attribute:!1})],oo.prototype,"config",void 0),Et("autosnooze-snoozed-card",oo);const ao=r`
  .row {
    margin-bottom: 12px;
  }
  .row label {
...
`;class io extends ne{constructor(){super(...arguments),this._config={}}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config)return;const o={...this._config,[e]:t};""!==t&&null!=t||delete o[e],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0}))}render(){return this._config?H`
      <div class="row">
    ...
    `:H``}}io.styles=ao,e([ue({attribute:!1})],io.prototype,"hass",void 0),e([he()],io.prototype,"_config",void 0),Et("autosnooze-card-editor",io);const so=r`
    :host {
      display: block;
    }
    .snooze-list {
...
`;class ro extends ne{constructor(){super(...arguments),this.pauseGroups=[],this.pausedCount=0,this.readonly=!1,this._wakeAllPending=!1,this._wakeAllTimeout=null,this._countdownState={interval:null,syncTimeout:null}}connectedCallback(){super.connectedCallback(),this._syncCountdownLifecycle()}updated(e){e.has("pauseGroups")&&this._syncCountdownLifecycle()}disconnectedCallback(){super.disconnectedCallback(),_t(this._countdownState),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null)}_updateCountdownIfNeeded(){this.pauseGroups.length>0&&this.requestUpdate()}_hasLiveCountdowns(){return this.pauseGroups.some(e=>!e.disableAt)}_scheduleCountdownBootstrap(){this._countdownState={interval:null,syncTimeout:globalThis.setTimeout(()=>{this._countdownState.syncTimeout=null,this._hasLiveCountdowns()&&(this._countdownState=bt(()=>this._updateCountdownIfNeeded()))},0)}}_syncCountdownLifecycle(){_t(this._countdownState),0!==this.pauseGroups.length?this._hasLiveCountdowns()?this._countdownState=bt(()=>this._updateCountdownIfNeeded()):this._countdownState={interval:null,syncTimeout:null}:this._scheduleCountdownBootstrap()}_handleWakeAll(){this._wakeAllPending?(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,this._fireWakeAll()):(Tt("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},Te))}_fireWake(e){this.dispatchEvent(new CustomEvent("wake-automation",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireClearNotification(e){this.dispatchEvent(new CustomEvent("clear-notification",{detail:{entityId:e},bubbles:!0,composed:!0}))}_hasNotificationConfig(e){return void 0!==e.notification_trigger&&"none"!==e.notification_trigger}_fireAdjust(e){this.dispatchEvent(new CustomEvent("adjust-automation",{detail:{entityId:e.entity_id,friendlyName:e.friendly_name,resumeAt:e.resume_at},bubbles:!0,composed:!0}))}_fireAdjustGroup(e){this.dispatchEvent(new CustomEvent("adjust-group",{detail:{entityIds:e.automations.map(e=>e.entity_id),friendlyNames:e.automations.map(e=>e.friendly_name||e.entity_id),resumeAt:e.resumeAt},bubbles:!0,composed:!0}))}_fireWakeAll(){this.dispatchEvent(new CustomEvent("wake-all",{bubbles:!0,composed:!0}))}render(){if(0===this.pausedCount)return H``;const e=this.hass?.locale?.language;return H`
      <div class="snooze-list" role="region" aria-label="${_e(this.hass,"a11y.snoozed_region")}">
        ...
        ${this.pauseGroups.map(t=>H`
          <div class="pause-group" role="group">
            ${this.readonly?H`<div class="pause-group-header">
                  <ha-icon icon="mdi:timer-outline" aria-hidden="true"></ha-icon>
                  ${t.disableAt?H`${_e(this.hass,"status.resumes")} ${$t(t.resumeAt,e)}`:H`<span class="countdown">${At(t.resumeAt,_e(this.hass,"status.resuming"))}</span>`}
                </div>`:H`<div class="pause-group-header"
            ...
            ${t.automations.map(e=>this.readonly?H`<div class="paused-item">
                  <ha-icon class="paused-icon" icon="mdi:sleep" aria-hidden="true"></ha-icon>
                  <div class="paused-info">
                    <div class="paused-name">${e.friendly_name||e.entity_id}</div>
                  </div>
                </div>`:H`<div class="paused-item" role="button" tabindex="0" @click=${()=>this._fireAdjust(e)} @keydown=${t=>{"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),this._fireAdjust(e))}}>
                  <ha-icon class="paused-icon" icon="mdi:sleep" aria-hidden="true"></ha-icon>
                  <div class="paused-info">
                    <div class="paused-name">${e.friendly_name||e.entity_id}</div>
                  </div>
                  ${this._hasNotificationConfig(e)?H`
                    <button
                      type="button"
        ...
        `)}
        ${!this.readonly&&this.pausedCount>1?H`
    ...
    `}}ro.styles=[ye,so],e([ue({attribute:!1})],ro.prototype,"hass",void 0),e([ue({attribute:!1})],ro.prototype,"pauseGroups",void 0),e([ue({type:Number})],ro.prototype,"pausedCount",void 0),e([ue({type:Boolean})],ro.prototype,"readonly",void 0),e([he()],ro.prototype,"_wakeAllPending",void 0),Et("autosnooze-active-pauses",ro);const no=r`
    :host {
      display: block;
    }
...
`;class lo extends ne{constructor(){super(...arguments),this.scheduleMode=!1,this.customDuration={days:0,hours:0,minutes:30},this.customDurationInput="30m",this.showCustomInput=!1,this.untilTomorrow=!1,this.lastDuration=null,this.disableAtDate="",this.disableAtTime="",this.resumeAtDate="",this.resumeAtTime=""}_getBasePresets(){const e=function(e){const t=ct(e)?.attributes?.duration_presets;return t?.length?t:null}(this.hass);return e?.length?e.filter(e=>null!==e.minutes):Re.filter(e=>null!==e.minutes)}_getDurationPills(){return[...this._getBasePresets(),{label:_e(this.hass,"duration.custom"),minutes:null}]}_getDurationPreview(){const e=Ge(this.customDurationInput);return e?kt(e.days,e.hours,e.minutes):""}_isDurationValid(){return qe(this.customDurationInput)}_renderDateOptions(){const e=function(e=365,t){const o=[],a=new Date,i=a.getFullYear();for(let s=0;s<e;s++){const e=new Date(a);e.setDate(e.getDate()+s);const r=e.getFullYear(),n=`${r}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=e.toLocaleDateString(t,{weekday:"short"}),d=e.toLocaleDateString(t,{month:"short"}),c=e.getDate(),u=r!==i?`${l}, ${d} ${c}, ${r}`:`${l}, ${d} ${c}`;o.push({value:n,label:u})}return o}(365,this.hass?.locale?.language);return e.map(e=>H`<option value="${e.value}">${e.label}</option>`)}_renderLastDurationBadge(){if(!this.lastDuration)return"";const e=this._getBasePresets(),t=this.lastDuration.minutes,o=!e.some(e=>e.minutes===t);if(!o)return"";const{days:a,hours:i,minutes:s}=this.lastDuration.duration,r=St(a,i,s).replace(/ /g,""),n=We(this.customDuration),l=!this.untilTomorrow&&!this.showCustomInput&&t===n;return H`
    ...
    `}_fireDurationChange(e,t){const o=Ve(e),a=St(o.days,o.hours,o.minutes);this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:e,duration:o,input:a,showCustomInput:t?.showCustomInput??!1},bubbles:!0,composed:!0}))}_fireCustomDurationChange(e){const t=Ge(e),o=t?We(t):0;this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:o,duration:t??{days:0,hours:0,minutes:0},input:e},bubbles:!0,composed:!0}))}_fireScheduleModeChange(e){this.dispatchEvent(new CustomEvent("schedule-mode-change",{detail:{enabled:e},bubbles:!0,composed:!0}))}_fireScheduleFieldChange(e,t){this.dispatchEvent(new CustomEvent("schedule-field-change",{detail:{field:e,value:t},bubbles:!0,composed:!0}))}_formatScheduleDateTime(e){const t=this.hass?.locale?.language;return new Date(e).toLocaleString(t,{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}_renderUntilTomorrowPreview(){const e=Lt(new Date,8),t=It(e.date,e.time);return t?`${_e(this.hass,"status.resumes")} ${this._formatScheduleDateTime(t)}`:""}_fireUntilTomorrowSelect(){this.dispatchEvent(new CustomEvent("until-tomorrow-select",{bubbles:!0,composed:!0}))}_renderScheduleSummary(){if(!this.resumeAtDate||!this.resumeAtTime)return"";const e=It(this.resumeAtDate,this.resumeAtTime);if(!e)return"";if(!Boolean(this.disableAtDate&&this.disableAtTime))return H`
      ...
      `;const t=It(this.disableAtDate,this.disableAtTime);return t?new Date(t).getTime()>=new Date(e).getTime()?H`
    ...
    `:""}render(){if(this.scheduleMode)return H`
      ...
      `;const e=this._getDurationPills(),t=e[e.length-1],o=e.slice(0,-1).filter(e=>null!==e.minutes);return H`
      <div class="duration-selector">
        ...
        <div class="duration-pills" role="radiogroup" aria-labelledby="duration-header">
          ${o.map(e=>{const t=We(this.customDuration),o=!this.untilTomorrow&&!this.showCustomInput&&e.minutes===t;return H`
                <button
                  type="button"
                  class="pill ${o?"active":""}"
        ...
        ${this.showCustomInput?H`
          <div class="custom-duration-input">
            ...
            />
            ${this._getDurationPreview()&&this._isDurationValid()?H`<div class="duration-preview" role="status" aria-live="polite">${_e(this.hass,"duration.preview_label")} ${this._getDurationPreview()}</div>`:H`<div class="duration-help" id="duration-help">${_e(this.hass,"duration.help")}</div>`}
          </div>
        `:""}
    ...
    `}}lo.styles=no,e([ue({attribute:!1})],lo.prototype,"hass",void 0),e([ue({type:Boolean})],lo.prototype,"scheduleMode",void 0),e([ue({attribute:!1})],lo.prototype,"customDuration",void 0),e([ue({type:String})],lo.prototype,"customDurationInput",void 0),e([ue({type:Boolean})],lo.prototype,"showCustomInput",void 0),e([ue({type:Boolean})],lo.prototype,"untilTomorrow",void 0),e([ue({attribute:!1})],lo.prototype,"lastDuration",void 0),e([ue({type:String})],lo.prototype,"disableAtDate",void 0),e([ue({type:String})],lo.prototype,"disableAtTime",void 0),e([ue({type:String})],lo.prototype,"resumeAtDate",void 0),e([ue({type:String})],lo.prototype,"resumeAtTime",void 0),Et("autosnooze-duration-selector",lo);const co=r`
    :host {
      display: block;
    }
...
`;function uo(e,t,o="Unassigned"){return e?t.areas?.[e]?.name??Zt(e):o}function ho(e,t){return t[e]?.name??Zt(e)}function po(e,t,o="Uncategorized"){return e?t[e]?.name??Zt(e):o}function mo(e,t,o){return!(!e.labels||0===e.labels.length)&&e.labels.some(e=>{const a=o[e]?.name;return a?.toLowerCase()===t})}function go(e,t,o){const a={};return e.forEach(e=>{const i=t(e);if(!i||0===i.length)return a[o]||(a[o]=[]),void a[o].push(e.automation);i.forEach(t=>{a[t]||(a[t]=[]),a[t].push(e.automation)})}),Object.entries(a).sort((e,t)=>e[0]===o?1:t[0]===o?-1:e[0].localeCompare(t[0]))}function bo(e){const t=new Set([Ie.toLowerCase(),Le.toLowerCase()]),o=e.search.toLowerCase(),a=new Set,i=new Set,s=new Set,r=e.automations.map(o=>{o.area_id&&a.add(o.area_id),o.category_id&&s.add(o.category_id);const r=function(e,t,o){return e.labels?.length?e.labels.map(e=>ho(e,t)).filter(e=>!o.has(e.toLowerCase())):[]}(o,e.labelRegistry,t);return o.labels?.length&&o.labels.forEach(o=>{const a=ho(o,e.labelRegistry).toLowerCase();t.has(a)||i.add(o)}),{automation:o,areaName:o.area_id?e.hass?uo(o.area_id,e.hass,e.emptyAreaLabel):Zt(o.area_id):e.emptyAreaLabel,categoryName:o.category_id?po(o.category_id,e.categoryRegistry,e.emptyCategoryLabel):e.emptyCategoryLabel,visibleLabelNames:r,hasIncludeLabel:mo(o,Le,e.labelRegistry),hasExcludeLabel:mo(o,Ie,e.labelRegistry)}}),n=r.some(e=>e.hasIncludeLabel),l=r.filter(e=>!!(n?e.hasIncludeLabel:!e.hasExcludeLabel)&&(!o||(e.automation.name.toLowerCase().includes(o)||e.automation.id.toLowerCase().includes(o)))),d="areas"===e.filterTab?go(l,e=>e.automation.area_id?[e.areaName]:null,e.emptyAreaLabel):"categories"===e.filterTab?go(l,e=>e.automation.category_id?[e.categoryName]:null,e.emptyCategoryLabel):"labels"===e.filterTab?go(l,e=>e.visibleLabelNames.length>0?e.visibleLabelNames:null,e.emptyLabelLabel):[];return{filtered:l.map(e=>e.automation),grouped:d,areaCount:a.size,labelCount:i.size,categoryCount:s.size}}class _o extends ne{constructor(){super(...arguments),this.automations=[],this.selected=[],this.labelRegistry={},this.labelRegistryUnavailable=!1,this.categoryRegistry={},this.recentSnoozeIds=[],this._filterTab="all",this._search="",this._searchInput="",this._expandedGroups={},this._searchTimeout=null,this._viewModelCache=null}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null)}_fireSelectionChange(e){this.dispatchEvent(new CustomEvent("selection-change",{detail:{selected:e},bubbles:!0,composed:!0}))}_toggleSelection(e){let t;Tt("selection"),t=this.selected.includes(e)?this.selected.filter(t=>t!==e):[...this.selected,e],this._fireSelectionChange(t)}_toggleGroupExpansion(e){const t=!1!==this._expandedGroups[e];this._expandedGroups={...this._expandedGroups,[e]:!t}}_selectGroup(e){const t=e.map(e=>e.id);let o;o=t.every(e=>this.selected.includes(e))?this.selected.filter(e=>!t.includes(e)):[...new Set([...this.selected,...t])],this._fireSelectionChange(o)}_selectAllVisible(){const e=this._getViewModel().filtered.map(e=>e.id),t=[...new Set([...this.selected,...e])];this._fireSelectionChange(t)}_clearSelection(){this._fireSelectionChange([])}_getFilteredAutomations(){return this._getViewModel().filtered}_getAreaName(e){return this.hass?uo(e,this.hass):_e(this.hass,"group.unassigned")}_getLabelName(e){return ho(e,this.labelRegistry)}_getCategoryName(e){return po(e,this.categoryRegistry)}_getGroupedByTab(e){return bo({automations:this.automations,search:this._search,filterTab:e,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,emptyAreaLabel:_e(this.hass,"group.unassigned"),emptyLabelLabel:_e(this.hass,"group.unlabeled"),emptyCategoryLabel:_e(this.hass,"group.uncategorized")}).grouped}_getGroupedByArea(){return this._getGroupedByTab("areas")}_getGroupedByLabel(){return this._getGroupedByTab("labels")}_getGroupedByCategory(){return this._getGroupedByTab("categories")}_getAreaCount(){return this._getViewModel().areaCount}_getLabelCount(){return this._getViewModel().labelCount}_getCategoryCount(){return this._getViewModel().categoryCount}_getViewModel(){const e=this._viewModelCache;if(e&&e.automations===this.automations&&e.search===this._search&&e.filterTab===this._filterTab&&e.hass===this.hass&&e.labelRegistry===this.labelRegistry&&e.categoryRegistry===this.categoryRegistry)return e.result;const t=bo({automations:this.automations,search:this._search,filterTab:this._filterTab,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,emptyAreaLabel:_e(this.hass,"group.unassigned"),emptyLabelLabel:_e(this.hass,"group.unlabeled"),emptyCategoryLabel:_e(this.hass,"group.uncategorized")});return this._viewModelCache={automations:this.automations,search:this._search,filterTab:this._filterTab,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,result:t},t}_handleSearchInput(e){const t=e.target.value;this._searchInput=t,null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},ke)}_clearSearch(){null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null),this._searchInput="",this._search=""}_handleSearchKeydown(e){"Escape"===e.key&&(this._searchInput||this._search)&&(e.preventDefault(),this._clearSearch())}_renderSelectionList(e,t){const{filtered:o,grouped:a}=e;if("all"===this._filterTab){if(0===o.length)return H`<div class="list-empty" role="status">${_e(this.hass,"list.empty")}</div>`;const e=new Set(this.recentSnoozeIds),a=[],i=[];for(const t of o)(e.has(t.id)?a:i).push(t);const s=a.concat(i);return H`
        ${a.length>0?H`
      ...
      `)}
      `}return 0===a.length?H`<div class="list-empty" role="status">${_e(this.hass,"list.empty")}</div>`:a.map(([e,o])=>{const a=!1!==this._expandedGroups[e],i=o.every(e=>t.has(e.id)),s=o.some(e=>t.has(e.id))&&!i;return H`
        <button
          type="button"
        ...
        ${a?o.map(e=>H`
              ...
              `):""}
      `})}render(){const e=this._getViewModel(),{filtered:t}=e,o=new Set(this.selected),a=this.labelRegistryUnavailable,i=this._searchInput.length>0||this._search.length>0,s=t.length>0&&t.every(e=>o.has(e.id));return H`
      ...
      <div class="search-row selection-actions">
        ...
        ${t.length>0?H`
              ...
              ${s?"":H`
                  ...
                  `}
              ${this.selected.length>0?H`<button type="button" class="select-all-btn clear-selection-btn" @click=${()=>this._clearSelection()} aria-label="${_e(this.hass,"a11y.clear_selection")}">${_e(this.hass,"button.clear")}</button>`:""}
            `:""}
      </div>
    ...
    `}}_o.styles=co,e([ue({attribute:!1})],_o.prototype,"hass",void 0),e([ue({attribute:!1})],_o.prototype,"automations",void 0),e([ue({attribute:!1})],_o.prototype,"selected",void 0),e([ue({attribute:!1})],_o.prototype,"labelRegistry",void 0),e([ue({type:Boolean})],_o.prototype,"labelRegistryUnavailable",void 0),e([ue({attribute:!1})],_o.prototype,"categoryRegistry",void 0),e([ue({attribute:!1})],_o.prototype,"recentSnoozeIds",void 0),e([he()],_o.prototype,"_filterTab",void 0),e([he()],_o.prototype,"_search",void 0),e([he()],_o.prototype,"_searchInput",void 0),e([he()],_o.prototype,"_expandedGroups",void 0),Et("autosnooze-automation-list",_o);const fo=r`
    :host {
      display: block;
    }
    .modal-overlay {
...
`,yo=[{label:"+15m",minutes:15},{label:"+30m",minutes:30},{label:"+1h",hours:1},{label:"+2h",hours:2}],vo=[{label:"-15m",minutes:-15,thresholdMs:15*xe},{label:"-30m",minutes:-30,thresholdMs:30*xe}],xo=xe;class wo extends ne{constructor(){super(...arguments),this.open=!1,this.entityId="",this.friendlyName="",this.resumeAt="",this.entityIds=[],this.friendlyNames=[],this._countdownState={interval:null,syncTimeout:null}}get _isGroupMode(){return this.entityIds.length>1}updated(e){e.has("open")&&(this.open?this._startSynchronizedCountdown():this._stopCountdown())}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown()}_startSynchronizedCountdown(){_t(this._countdownState),this._countdownState=bt(()=>this.requestUpdate())}_stopCountdown(){_t(this._countdownState)}_isDecrementDisabled(e){if(!this.resumeAt)return!0;return new Date(this.resumeAt).getTime()-Date.now()-e<xo}_fireAdjustTime(e){this.entityIds.length>0?this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityIds:this.entityIds,...e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityId:this.entityId,...e},bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}_handleOverlayKeydown(e){"Escape"===e.key&&this._close()}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}render(){return this.open?H`
    ...
    `:H``}}wo.styles=fo,e([ue({attribute:!1})],wo.prototype,"hass",void 0),e([ue({type:Boolean})],wo.prototype,"open",void 0),e([ue({type:String})],wo.prototype,"entityId",void 0),e([ue({type:String})],wo.prototype,"friendlyName",void 0),e([ue({type:String})],wo.prototype,"resumeAt",void 0),e([ue({attribute:!1})],wo.prototype,"entityIds",void 0),e([ue({attribute:!1})],wo.prototype,"friendlyNames",void 0),Et("autosnooze-adjust-modal",wo);const zo=Symbol.for("autosnooze.registration.done.v1"),$o=new Set,Ao="https://github.com/mossipcams/autosnooze#readme";function ko(){const e=window.customCards;return Array.isArray(e)?e:(void 0!==e&&(t="customCards-not-array",o=`[AutoSnooze] window.customCards was not an array (got ${typeof e}); resetting.`,$o.has(t)||($o.add(t),console.warn(o))),[]);var t,o}function So(e="0.2.27"){const t=function(e){return[{type:"autosnooze-card",name:"AutoSnooze Card",description:`Temporarily pause automations with area and label filtering (v${e})`,preview:!0,documentationURL:Ao},{type:"autosnooze-snoozed-card",name:"AutoSnooze Snoozed Card",description:`Read-only view of currently snoozed automations and when they resume (v${e})`,preview:!0,documentationURL:Ao}]}(e),o=ko();t.forEach(e=>{const t=o.findIndex(t=>t?.type===e.type);-1===t?o.push(e):o[t]={...o[t],...e}}),window.customCards=o}!function(){const e=globalThis;!0===e[zo]||(e[zo]=!0),So()}();export{ro as AutoSnoozeActivePauses,wo as AutoSnoozeAdjustModal,_o as AutoSnoozeAutomationList,lo as AutoSnoozeDurationSelector,oo as AutoSnoozeSnoozedCard,to as AutomationPauseCard,io as AutomationPauseCardEditor};
