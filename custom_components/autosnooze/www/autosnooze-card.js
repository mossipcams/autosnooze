...
`;class At extends ne{constructor(){super(...arguments),this.pauseGroups=[],this.pausedCount=0,this._wakeAllPending=!1,this._wakeAllTimeout=null,this._countdownState={interval:null,syncTimeout:null}}connectedCallback(){super.connectedCallback(),xt(this._countdownState),this._countdownState=vt(()=>this._updateCountdownIfNeeded())}disconnectedCallback(){super.disconnectedCallback(),xt(this._countdownState),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null)}_updateCountdownIfNeeded(){this.pauseGroups.length>0&&this.requestUpdate()}_handleWakeAll(){this._wakeAllPending?(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,this._fireWakeAll()):(We("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},Ce))}_fireWake(e){this.dispatchEvent(new CustomEvent("wake-automation",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireAdjust(e){this.dispatchEvent(new CustomEvent("adjust-automation",{detail:{entityId:e.entity_id,friendlyName:e.friendly_name,resumeAt:e.resume_at},bubbles:!0,composed:!0}))}_fireAdjustGroup(e){this.dispatchEvent(new CustomEvent("adjust-group",{detail:{entityIds:e.automations.map(e=>e.entity_id),friendlyNames:e.automations.map(e=>e.friendly_name||e.entity_id),resumeAt:e.resumeAt},bubbles:!0,composed:!0}))}_fireWakeAll(){this.dispatchEvent(new CustomEvent("wake-all",{bubbles:!0,composed:!0}))}render(){if(0===this.pausedCount)return B``;const e=this.hass?.locale?.language;return B`
    ...
    `}}At.styles=[ye,wt],e([ce({attribute:!1})],At.prototype,"hass",void 0),e([ce({attribute:!1})],At.prototype,"pauseGroups",void 0),e([ce({type:Number})],At.prototype,"pausedCount",void 0);const zt=r`
    :host {
      display: block;
    }
...
`;class St extends ne{constructor(){super(...arguments),this.automations=[],this.selected=[],this.labelRegistry={},this.labelRegistryUnavailable=!1,this.categoryRegistry={},this._filterTab="all",this._search="",this._searchInput="",this._expandedGroups={},this._searchTimeout=null}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null)}_fireSelectionChange(e){this.dispatchEvent(new CustomEvent("selection-change",{detail:{selected:e},bubbles:!0,composed:!0}))}_toggleSelection(e){let t;We("selection"),t=this.selected.includes(e)?this.selected.filter(t=>t!==e):[...this.selected,e],this._fireSelectionChange(t)}_toggleGroupExpansion(e){this._expandedGroups={...this._expandedGroups,[e]:!this._expandedGroups[e]}}_selectGroup(e){const t=e.map(e=>e.id);let a;a=t.every(e=>this.selected.includes(e))?this.selected.filter(e=>!t.includes(e)):[...new Set([...this.selected,...t])],this._fireSelectionChange(a)}_selectAllVisible(){const e=this._getFilteredAutomations().map(e=>e.id),t=[...new Set([...this.selected,...e])];this._fireSelectionChange(t)}_clearSelection(){this._fireSelectionChange([])}_getFilteredAutomations(){return function(e,t,a){let o=e;o=e.some(e=>st(e,Ie,a))?o.filter(e=>st(e,Ie,a)):o.filter(e=>!st(e,Fe,a));const i=t.toLowerCase();return i&&(o=o.filter(e=>e.name.toLowerCase().includes(i)||e.id.toLowerCase().includes(i))),o}(this.automations,this._search,this.labelRegistry)}_getAreaName(e){return this.hass?function(e,t,a="Unassigned"){return e?t.areas?.[e]?.name??it(e):a}(e,this.hass):_e(this.hass,"group.unassigned")}_getLabelName(e){return function(e,t){return t[e]?.name??it(e)}(e,this.labelRegistry)}_getCategoryName(e){return function(e,t,a="Uncategorized"){return e?t[e]?.name??it(e):a}(e,this.categoryRegistry)}_getGroupedByArea(){return rt(this._getFilteredAutomations(),e=>e.area_id?[this._getAreaName(e.area_id)]:null,_e(this.hass,"group.unassigned"))}_getGroupedByLabel(){const e=this._getFilteredAutomations(),t=[Fe.toLowerCase(),Ie.toLowerCase()];return rt(e,e=>{if(!e.labels?.length)return null;const a=e.labels.map(e=>this._getLabelName(e)).filter(e=>!t.includes(e.toLowerCase()));return a.length>0?a:null},_e(this.hass,"group.unlabeled"))}_getGroupedByCategory(){return rt(this._getFilteredAutomations(),e=>e.category_id?[this._getCategoryName(e.category_id)]:null,_e(this.hass,"group.uncategorized"))}_getAreaCount(){return nt(this.automations,e=>e.area_id?[e.area_id]:null)}_getLabelCount(){const e=[Fe.toLowerCase(),Ie.toLowerCase()];return nt(this.automations,t=>{if(!t.labels?.length)return null;const a=t.labels.filter(t=>!e.includes(this._getLabelName(t).toLowerCase()));return a.length>0?a:null})}_getCategoryCount(){return nt(this.automations,e=>e.category_id?[e.category_id]:null)}_handleSearchInput(e){const t=e.target.value;this._searchInput=t,null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},ke)}_clearSearch(){null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null),this._searchInput="",this._search=""}_handleSearchKeydown(e){"Escape"===e.key&&(this._searchInput||this._search)&&(e.preventDefault(),this._clearSearch())}_renderSelectionList(){const e=this._getFilteredAutomations();if("all"===this._filterTab)return 0===e.length?B`<div class="list-empty" role="status">${_e(this.hass,"list.empty")}</div>`:e.map(e=>B`
      ...
      `);const t="areas"===this._filterTab?this._getGroupedByArea():"categories"===this._filterTab?this._getGroupedByCategory():this._getGroupedByLabel();return 0===t.length?B`<div class="list-empty" role="status">${_e(this.hass,"list.empty")}</div>`:t.map(([e,t])=>{const a=!1!==this._expandedGroups[e],o=t.every(e=>this.selected.includes(e.id)),i=t.some(e=>this.selected.includes(e.id))&&!o;return B`
        ...
        ${a?t.map(e=>B`
              ...
              `):""}
      `})}render(){const e=this._getFilteredAutomations(),t=this.labelRegistryUnavailable,a=this._searchInput.length>0||this._search.length>0,o=e.length>0&&e.every(e=>this.selected.includes(e.id));return B`
      <div class="filter-tabs" role="tablist" aria-label="${_e(this.hass,"a11y.filter_tabs")}">
        ...
        >
          ...
          <span class="tab-count" aria-label="${_e(this.hass,"a11y.area_count",{count:this._getAreaCount()})}">${this._getAreaCount()}</span>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <span class="tab-count" aria-label="${_e(this.hass,"a11y.category_count",{count:this._getCategoryCount()})}">${this._getCategoryCount()}</span>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <span class="tab-count" aria-label="${_e(this.hass,"a11y.label_count",{count:this._getLabelCount()})}">${this._getLabelCount()}</span>
        </button>
      </div>
      ...
      ${e.length>0?B`
            <div class="selection-actions" role="toolbar" aria-label="${_e(this.hass,"a11y.selection_actions")}">
              <span role="status" aria-live="polite">${_e(this.hass,"selection.count",{selected:this.selected.length,total:e.length})}</span>
              ${o?"":B`
                    <button
                      type="button"
...
`,Tt=[{label:"+15m",minutes:15},{label:"+30m",minutes:30},{label:"+1h",hours:1},{label:"+2h",hours:2}],jt=[{label:"-15m",minutes:-15,thresholdMs:15*xe},{label:"-30m",minutes:-30,thresholdMs:30*xe}],Dt=xe;class Rt extends ne{constructor(){super(...arguments),this.open=!1,this.entityId="",this.friendlyName="",this.resumeAt="",this.entityIds=[],this.friendlyNames=[],this._countdownState={interval:null,syncTimeout:null}}get _isGroupMode(){return this.entityIds.length>1}updated(e){e.has("open")&&(this.open?this._startSynchronizedCountdown():this._stopCountdown())}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown()}_startSynchronizedCountdown(){xt(this._countdownState),this._countdownState=vt(()=>this.requestUpdate())}_stopCountdown(){xt(this._countdownState)}_isDecrementDisabled(e){if(!this.resumeAt)return!0;return new Date(this.resumeAt).getTime()-Date.now()-e<Dt}_fireAdjustTime(e){this.entityIds.length>0?this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityIds:this.entityIds,...e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityId:this.entityId,...e},bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}_handleOverlayKeydown(e){"Escape"===e.key&&this._close()}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}render(){return this.open?B`
    ...
    `:B``}}Rt.styles=Ct,e([ce({attribute:!1})],Rt.prototype,"hass",void 0),e([ce({type:Boolean})],Rt.prototype,"open",void 0),e([ce({type:String})],Rt.prototype,"entityId",void 0),e([ce({type:String})],Rt.prototype,"friendlyName",void 0),e([ce({type:String})],Rt.prototype,"resumeAt",void 0),e([ce({attribute:!1})],Rt.prototype,"entityIds",void 0),e([ce({attribute:!1})],Rt.prototype,"friendlyNames",void 0);const Et=Symbol.for("autosnooze.registration.done.v1"),Mt=new Set,Pt="autosnooze-card",Ft=[{tag:"autosnooze-card-editor",ctor:ft},{tag:"autosnooze-active-pauses",ctor:At},{tag:"autosnooze-duration-selector",ctor:$t},{tag:"autosnooze-automation-list",ctor:St},{tag:"autosnooze-adjust-modal",ctor:Rt},{tag:Pt,ctor:bt}];function It(e,t,a){Mt.has(e)||(Mt.add(e),console.warn(t))}function Nt(e="0.2.15"){const t=function(e){return{type:Pt,name:"AutoSnooze Card",description:`Temporarily pause automations with area and label filtering (v${e})`,preview:!0,documentationURL:"https://github.com/mossipcams/autosnooze#readme"}}(e),a=function(){const e=window.customCards;return Array.isArray(e)?e:(void 0!==e&&It("customCards-not-array",`[AutoSnooze] window.customCards was not an array (got ${typeof e}); resetting.`),[])}(),o=a.findIndex(e=>e?.type===Pt);-1===o?a.push(t):a[o]={...a[o],...t},window.customCards=a}!function(){const e=globalThis;!0===e[Et]||(Ft.forEach(({tag:e,ctor:t})=>function(e,t,a=customElements){const o=a.get(e);if(o)o!==t&&It(`element-conflict:${e}`,`[AutoSnooze] Element tag "${e}" is already registered with a different constructor.`);else try{a.define(e,t)}catch(o){const i=a.get(e);if(i===t)return;if(i)return void It(`element-conflict:${e}`,`[AutoSnooze] Element tag "${e}" was claimed by a different constructor during registration.`);throw o}}(e,t)),e[Et]=!0),Nt()}();export{At as AutoSnoozeActivePauses,Rt as AutoSnoozeAdjustModal,St as AutoSnoozeAutomationList,$t as AutoSnoozeDurationSelector,bt as AutomationPauseCard,ft as AutomationPauseCardEditor};
