...
`,ve=1e3,xe=6e4,we=36e5,ze=864e5,Ae=60,$e=1440,ke=300,Se=300,Ce=3e3,Te=5e3,Re=1e3,je=5e3,De=1e3,Me=3e4,Ee=[{label:"30m",minutes:30},{label:"1h",minutes:60},{label:"12h",minutes:720},{label:"1d",minutes:1440},{label:"Custom",minutes:null}],Pe={not_automation:"Failed to snooze: One or more selected items are not automations",invalid_duration:"Failed to snooze: Please specify a valid duration (days, hours, or minutes)",resume_time_past:"Failed to snooze: Resume time must be in the future",disable_after_resume:"Failed to snooze: Snooze time must be before resume time",save_failed:"Failed to save changes. Please try again or check Home Assistant logs.",invalid_adjustment:"Adjustment must be non-zero. Specify at least one of: days, hours, or minutes.",adjust_time_too_short:"Cannot shorten snooze that much. Resume time must be at least 1 minute away.",confirm_required:"Failed to snooze: Confirmation is required for one or more selected automations"},Fe="autosnooze_exclude",Ie="autosnooze_include";const Ne="autosnooze_last_duration";function Le(e,t){const a=new Date(e),o=new Date,i={weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return a.getFullYear()>o.getFullYear()&&(i.year="numeric"),a.toLocaleString(t,i)}function Oe(e,t="Resuming..."){const a=new Date(e).getTime()-Date.now();if(a<=0)return t;const o=Math.floor(a/ze),i=Math.floor(a%ze/we),s=Math.floor(a%we/xe),r=Math.floor(a%xe/ve);return o>0?`${o}d ${i}h ${s}m`:i>0?`${i}h ${s}m ${r}s`:`${s}m ${r}s`}function Ue(e,t,a){const o=[];return e>0&&o.push(`${e} day${1!==e?"s":""}`),t>0&&o.push(`${t} hour${1!==t?"s":""}`),a>0&&o.push(`${a} minute${1!==a?"s":""}`),o.join(", ")}function He(e,t,a){const o=[];return e>0&&o.push(`${e}d`),t>0&&o.push(`${t}h`),a>0&&o.push(`${a}m`),o.join(" ")||"0m"}function Ge(e){const t=e.toLowerCase().replace(/\s+/g,"");if(!t)return null;let a=0,o=!1;const i=t.match(/(\d+(?:\.\d+)?)\s*d/),s=t.match(/(\d+(?:\.\d+)?)\s*h/),r=t.match(/(\d+(?:\.\d+)?)\s*m(?!i)/);if(i?.[1]){const e=parseFloat(i[1]);if(isNaN(e)||e<0)return null;a+=e*$e,o=!0}if(s?.[1]){const e=parseFloat(s[1]);if(isNaN(e)||e<0)return null;a+=e*Ae,o=!0}if(r?.[1]){const e=parseFloat(r[1]);if(isNaN(e)||e<0)return null;a+=e,o=!0}if(!o){const e=parseFloat(t);if(isNaN(e)||!(e>0))return null;a=e}if(a=Math.round(a),a<=0)return null;const n=Math.floor(a/$e),l=a%$e;return{days:n,hours:Math.floor(l/Ae),minutes:l%Ae}}function Be(e){return null!==Ge(e)}function qe(e){return e.days*$e+e.hours*Ae+e.minutes}function We(e="light"){!function(e,t,a){const o=new CustomEvent(`hass-${t}`,{bubbles:!0,composed:!0,detail:a});e.dispatchEvent(o)}(window,"haptic",e)}function Ve(e,t){const a=e,o=a?.translation_key??a?.data?.translation_key;if(o&&Pe[o])return Pe[o];const i=a?.message??"";for(const[e,t]of Object.entries(Pe))if(i.includes(e)||i.toLowerCase().includes(e.replace(/_/g," ")))return t;return`${t}. Check Home Assistant logs for details.`}async function Ye(e,t){try{await e.callService("autosnooze","cancel",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to wake automation:",e),e}}async function Ke(e,t){try{await e.callService("autosnooze","cancel_scheduled",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to cancel scheduled snooze:",e),e}}function Ze(e,t){if(!e||!t)return null;const a=new Date(`${e}T${t}`);if(Number.isNaN(a.getTime()))return null;const o=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,i=`${String(a.getHours()).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}`;if(o!==e||i!==t)return null;const s=a.getTimezoneOffset(),r=s<=0?"+":"-",n=Math.abs(s);return`${e}T${t}${`${r}${String(Math.floor(n/60)).padStart(2,"0")}:${String(n%60).padStart(2,"0")}`}`}async function Je(e){const t=e.scheduleMode?function(e){const t=e.disableAtDate&&e.disableAtTime?Ze(e.disableAtDate,e.disableAtTime):null,a=Ze(e.resumeAtDate,e.resumeAtTime);if(!a)return null;const o={entity_id:e.selected,resume_at:a,...t&&{disable_at:t},...e.forceConfirm&&{confirm:!0}},i=e.selected.length;return{request:o,toastMessage:t?1===i?_e(e.hass,"toast.success.scheduled_one"):_e(e.hass,"toast.success.scheduled_many",{count:i}):1===i?_e(e.hass,"toast.success.snoozed_until_one",{time:Le(a,e.hass.locale?.language)}):_e(e.hass,"toast.success.snoozed_until_many",{count:i,time:Le(a,e.hass.locale?.language)})}}(e):function(e){const{days:t,hours:a,minutes:o}=e.customDuration,i={minutes:qe(e.customDuration),duration:e.customDuration,timestamp:Date.now()};return{request:{entity_id:e.selected,days:t,hours:a,minutes:o,...e.forceConfirm&&{confirm:!0}},toastMessage:1===e.selected.length?_e(e.hass,"toast.success.snoozed_for_one",{duration:Ue(t,a,o)}):_e(e.hass,"toast.success.snoozed_for_many",{count:e.selected.length,duration:Ue(t,a,o)}),lastDuration:i}}(e);if(!t)return{status:"aborted"};try{await async function(e,t){try{await e.callService("autosnooze","pause",t)}catch(e){throw console.error("[AutoSnooze] Failed to pause automations:",e),e}}(e.hass,t.request)}catch(e){if("confirm_required"===function(e){const t=e;return t?.translation_key??t?.data?.translation_key}(e))return{status:"confirm_required"};throw e}return function(e){return"lastDuration"in e}(t)?(function(e,t){try{const a={minutes:t,duration:e,timestamp:Date.now()};localStorage.setItem(Ne,JSON.stringify(a))}catch{}}(t.lastDuration.duration,t.lastDuration.minutes),{status:"submitted",toastMessage:t.toastMessage,lastDuration:t.lastDuration}):{status:"submitted",toastMessage:t.toastMessage}}async function Xe(e){await async function(e){try{await e.callService("autosnooze","cancel_all",{})}catch(e){throw console.error("[AutoSnooze] Failed to wake all automations:",e),e}}(e)}function Qe(e){if(!e)return null;const t=new Date(e).getTime();return Number.isFinite(t)?t:null}async function et(e,t,a){const{entityId:o,entityIds:i,...s}=t,r=i||o||"";await async function(e,t,a){try{await e.callService("autosnooze","adjust",{entity_id:t,...a})}catch(e){throw console.error("[AutoSnooze] Failed to adjust snooze:",e),e}}(e,r,s);const n=24*(s.days||0)*60*60*1e3+60*(s.hours||0)*60*1e3+60*(s.minutes||0)*1e3;return{nextResumeAt:new Date(new Date(a).getTime()+n).toISOString()}}function tt(e,t){const a=1e3-Date.now()%1e3;e.syncTimeout=globalThis.setTimeout(()=>{e.syncTimeout=null,t(),e.interval=globalThis.setInterval(()=>{t();Date.now()%1e3>50&&(ot(e),tt(e,t))},Re)},a)}function at(e){const t={interval:null,syncTimeout:null};return tt(t,e),t}function ot(e){null!==e.interval&&(globalThis.clearInterval(e.interval),e.interval=null),null!==e.syncTimeout&&(globalThis.clearTimeout(e.syncTimeout),e.syncTimeout=null)}function it(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`}function st(e){return`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}function rt(e){return{adjustModalOpen:!0,adjustModalEntityId:e.entityId??"",adjustModalFriendlyName:e.friendlyName??"",adjustModalResumeAt:e.resumeAt,adjustModalEntityIds:e.entityIds??[],adjustModalFriendlyNames:e.friendlyNames??[]}}function nt(e){ot(e)}function lt(e){return e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function dt(e,t,a="Unassigned"){return e?t.areas?.[e]?.name??lt(e):a}function ut(e,t){return t[e]?.name??lt(e)}function ct(e,t,a="Uncategorized"){return e?t[e]?.name??lt(e):a}function ht(e,t,a){return!(!e.labels||0===e.labels.length)&&e.labels.some(e=>{const o=a[e]?.name;return o?.toLowerCase()===t})}function mt(e,t,a){const o={};return e.forEach(e=>{const i=t(e);if(!i||0===i.length)return o[a]||(o[a]=[]),void o[a].push(e.automation);i.forEach(t=>{o[t]||(o[t]=[]),o[t].push(e.automation)})}),Object.entries(o).sort((e,t)=>e[0]===a?1:t[0]===a?-1:e[0].localeCompare(t[0]))}function pt(e){const t=new Set([Fe.toLowerCase(),Ie.toLowerCase()]),a=e.search.toLowerCase(),o=new Set,i=new Set,s=new Set,r=e.automations.map(a=>{a.area_id&&o.add(a.area_id),a.category_id&&s.add(a.category_id);const r=function(e,t,a){return e.labels?.length?e.labels.map(e=>ut(e,t)).filter(e=>!a.has(e.toLowerCase())):[]}(a,e.labelRegistry,t);return a.labels?.length&&a.labels.forEach(a=>{const o=ut(a,e.labelRegistry).toLowerCase();t.has(o)||i.add(a)}),{automation:a,areaName:a.area_id?e.hass?dt(a.area_id,e.hass,e.emptyAreaLabel):lt(a.area_id):e.emptyAreaLabel,categoryName:a.category_id?ct(a.category_id,e.categoryRegistry,e.emptyCategoryLabel):e.emptyCategoryLabel,visibleLabelNames:r,hasIncludeLabel:ht(a,Ie,e.labelRegistry),hasExcludeLabel:ht(a,Fe,e.labelRegistry)}}),n=r.some(e=>e.hasIncludeLabel),l=r.filter(e=>!!(n?e.hasIncludeLabel:!e.hasExcludeLabel)&&(!a||(e.automation.name.toLowerCase().includes(a)||e.automation.id.toLowerCase().includes(a)))),d="areas"===e.filterTab?mt(l,e=>e.automation.area_id?[e.areaName]:null,e.emptyAreaLabel):"categories"===e.filterTab?mt(l,e=>e.automation.category_id?[e.categoryName]:null,e.emptyCategoryLabel):"labels"===e.filterTab?mt(l,e=>e.visibleLabelNames.length>0?e.visibleLabelNames:null,e.emptyLabelLabel):[];return{filtered:l.map(e=>e.automation),grouped:d,areaCount:o.size,labelCount:i.size,categoryCount:s.size}}const gt="sensor.autosnooze_snoozed_automations",bt={},_t={},ft=[];let yt=null,vt=null,xt=null,wt=null,zt=null;function At(e){return!e||"object"!=typeof e||Array.isArray(e)?null:e}function $t(e){return At(e)}function kt(e){return At(e)}function St(e){if(0===Object.keys(e).length)return ft;const t={};return Object.entries(e).forEach(([e,a])=>{const o=a.resume_at;t[o]||(t[o]={resumeAt:o,disableAt:a.disable_at,automations:[]}),t[o].automations.push({entity_id:e,friendly_name:a.friendly_name,resume_at:a.resume_at,paused_at:a.paused_at,days:a.days,hours:a.hours,minutes:a.minutes,disable_at:a.disable_at})}),Object.values(t).sort((e,t)=>new Date(e.resumeAt).getTime()-new Date(t.resumeAt).getTime())}function Ct(e){const t=e?.states?.[gt]?.attributes,a=At(t),o=a?.schema_version,i=a?.paused??a?.paused_automations,s=a?.scheduled??a?.scheduled_snoozes;if(t===yt&&o===vt&&i===xt&&s===wt&&zt)return zt;const r=function(e){const t=At(e);if(!t)return{paused:bt,scheduled:_t};const a=t.schema_version;if(1===a){const e=$t(t.paused),a=kt(t.scheduled);return e&&a?{paused:e,scheduled:a}:{paused:bt,scheduled:_t}}if(void 0===a){const e=$t(t.paused)??$t(t.paused_automations)??{},a=kt(t.scheduled)??kt(t.scheduled_snoozes)??{};if(Object.keys(e).length>0||Object.keys(a).length>0)return{paused:e,scheduled:a}}const o=$t(t.paused_automations),i=kt(t.scheduled_snoozes);return{paused:o??bt,scheduled:i??_t}}(t);return yt=t,vt=o,xt=i,wt=s,zt={paused:r.paused,scheduled:r.scheduled,groups:St(r.paused)},zt}const Tt={days:0,hours:0,minutes:30};class Rt{constructor(){this._state={selected:[],filterTab:"all",search:"",customDuration:{...Tt},customDurationInput:"30m",durationMs:30*xe}}getState(){return{...this._state,selected:[...this._state.selected],customDuration:{...this._state.customDuration}}}setSelection(e){this._state.selected=[...e]}toggleSelection(e){this._state.selected.includes(e)?this._state.selected=this._state.selected.filter(t=>t!==e):this._state.selected=[...this._state.selected,e]}clearSelection(){this._state.selected=[]}setFilterTab(e){this._state.filterTab=e}setSearch(e){this._state.search=e}setDuration(e,t){this._state.customDuration={...e},this._state.customDurationInput=t,this._state.durationMs=qe(e)*xe}}class jt extends ne{constructor(){super(...arguments),this.config={},this._cardStore=new Rt,this._selected=[],this._duration=30*xe,this._customDuration={days:0,hours:0,minutes:30},this._customDurationInput="30m",this._loading=!1,this._scheduleMode=!1,this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime="",this._labelRegistry={},this._labelRegistryUnavailable=!1,this._categoryRegistry={},this._entityRegistry={},this._showCustomInput=!1,this._automationsCache=null,this._automationsCacheVersion=0,this._lastDuration=null,this._adjustModalOpen=!1,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt="",this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[],this._guardrailConfirmOpen=!1,this._labelsFetched=!1,this._categoriesFetched=!1,this._entityRegistryFetched=!1,this._labelRegistryFetchPromise=null,this._categoryRegistryFetchPromise=null,this._entityRegistryFetchPromise=null,this._lastAutomationFingerprintStates=null,this._lastAutomationFingerprint="",this._lastHassStates=null,this._lastCacheVersion=0,this._toastTimeout=null,this._toastFadeTimeout=null,this._labelRegistryRetryTimeout=null,this._labelRegistryRetryDelayMs=De}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-card",title:"AutoSnooze"}}setConfig(e){this.config=e}getCardSize(){const e=this._getPausedSnapshot(),t=e.paused,a=e.scheduled;return 4+Object.keys(t).length+Object.keys(a).length}shouldUpdate(e){if(!e.has("hass"))return!0;const t=e.get("hass"),a=this.hass;if(!t||!a)return!0;const o=t.states?.[gt],i=a.states?.[gt];if(o!==i)return!0;if(t.entities!==a.entities)return!0;if(t.areas!==a.areas)return!0;if((t.language??t.locale?.language)!==(a.language??a.locale?.language))return!0;const s=a.states,r=t.states;return!s||!r||r!==s&&this._haveAutomationStatesChanged(r,s)}updated(e){if(super.updated(e),e.has("hass")&&this.hass?.connection&&(this._labelsFetched||null!==this._labelRegistryRetryTimeout||this._fetchLabelRegistry(),this._categoriesFetched||this._fetchCategoryRegistry(),this._entityRegistryFetched||this._fetchEntityRegistry()),e.has("hass")&&this._adjustModalOpen){const e=this._getPaused();if(this._adjustModalEntityIds.length>0){this._adjustModalEntityIds.some(t=>e[t])||this._handleCloseModalEvent();const t=this._adjustModalEntityIds.find(t=>e[t]);if(t){const a=e[t];a?.resume_at&&a.resume_at!==this._adjustModalResumeAt&&(this._adjustModalResumeAt=a.resume_at)}}else if(this._adjustModalEntityId){const t=e[this._adjustModalEntityId];t?.resume_at&&t.resume_at!==this._adjustModalResumeAt&&(this._adjustModalResumeAt=t.resume_at),t||this._handleCloseModalEvent()}}}connectedCallback(){super.connectedCallback(),this._fetchLabelRegistry(),this._fetchCategoryRegistry(),this._fetchEntityRegistry(),this._lastDuration=function(){try{const e=localStorage.getItem(Ne);if(!e)return null;const t=JSON.parse(e);return"number"!=typeof t.minutes||"number"!=typeof t.duration?.days||"number"!=typeof t.duration?.hours||"number"!=typeof t.duration?.minutes||"number"!=typeof t.timestamp?null:Date.now()-t.timestamp>6048e5?(localStorage.removeItem(Ne),null):t}catch{return null}}()}disconnectedCallback(){super.disconnectedCallback(),null!==this._toastTimeout&&(clearTimeout(this._toastTimeout),this._toastTimeout=null),null!==this._toastFadeTimeout&&(clearTimeout(this._toastFadeTimeout),this._toastFadeTimeout=null),null!==this._labelRegistryRetryTimeout&&(clearTimeout(this._labelRegistryRetryTimeout),this._labelRegistryRetryTimeout=null)}async _fetchLabelRegistry(){if(!this._labelsFetched&&this.hass?.connection)if(this._labelRegistryFetchPromise)await this._labelRegistryFetchPromise;else{this._labelRegistryFetchPromise=(async()=>{const e=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/label_registry/list"}),a={};return Array.isArray(t)&&t.forEach(e=>{a[e.label_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch label registry:",e),null}}(this.hass);if(null!==e)this._labelRegistry=e,this._labelsFetched=!0,this._labelRegistryUnavailable=!1,this._automationsCacheVersion++,this._labelRegistryRetryDelayMs=De,null!==this._labelRegistryRetryTimeout&&(clearTimeout(this._labelRegistryRetryTimeout),this._labelRegistryRetryTimeout=null);else if(this._labelsFetched=!1,this._labelRegistryUnavailable=!0,null===this._labelRegistryRetryTimeout){const e=this._labelRegistryRetryDelayMs;this._labelRegistryRetryTimeout=window.setTimeout(()=>{this._labelRegistryRetryTimeout=null,this.isConnected&&this._fetchLabelRegistry()},e),this._labelRegistryRetryDelayMs=Math.min(2*this._labelRegistryRetryDelayMs,Me)}})();try{await this._labelRegistryFetchPromise}finally{this._labelRegistryFetchPromise=null}}}async _fetchCategoryRegistry(){if(!this._categoriesFetched&&this.hass?.connection)if(this._categoryRegistryFetchPromise)await this._categoryRegistryFetchPromise;else{this._categoryRegistryFetchPromise=(async()=>{this._categoryRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/category_registry/list",scope:"automation"}),a={};return Array.isArray(t)&&t.forEach(e=>{a[e.category_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch category registry:",e),{}}}(this.hass),this._categoriesFetched=!0})();try{await this._categoryRegistryFetchPromise}finally{this._categoryRegistryFetchPromise=null}}}async _fetchEntityRegistry(){if(!this._entityRegistryFetched&&this.hass?.connection)if(this._entityRegistryFetchPromise)await this._entityRegistryFetchPromise;else{this._entityRegistryFetchPromise=(async()=>{this._entityRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/entity_registry/list"}),a={};return Array.isArray(t)&&t.filter(e=>e.entity_id.startsWith("automation.")).forEach(e=>{a[e.entity_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch entity registry:",e),{}}}(this.hass),this._entityRegistryFetched=!0,this._automationsCacheVersion++})();try{await this._entityRegistryFetchPromise}finally{this._entityRegistryFetchPromise=null}}}_getAutomations(){if(!this.hass?.states)return[];const e=this.hass.states,t=this._automationsCacheVersion;if(this._lastHassStates===e&&this._lastCacheVersion===t&&this._automationsCache)return this._automationsCache;const a=function(e,t){const a=e?.states,o=e?.entities;return a?Object.keys(a).filter(e=>e.startsWith("automation.")).map(e=>{const i=a[e];if(!i)return null;const s=t?.[e],r=o?.[e],n=s?.categories??{};return{id:e,name:i.attributes?.friendly_name??e.replace("automation.",""),area_id:s?.area_id??r?.area_id??null,category_id:n.automation??null,labels:s?.labels??r?.labels??[]}}).filter(e=>null!==e).sort((e,t)=>e.name.localeCompare(t.name)):[]}(this.hass,this._entityRegistry);return this._automationsCache=a,this._lastCacheVersion=t,this._lastHassStates=e,a}_getAutomationStateFingerprint(e){if(this._lastAutomationFingerprintStates===e)return this._lastAutomationFingerprint;const t=Object.keys(e).filter(e=>e.startsWith("automation.")).sort().map(t=>{const a=e[t];return`${t}:${a?.state??""}:${a?.last_changed??""}:${a?.last_updated??""}`}).join("|");return this._lastAutomationFingerprintStates=e,this._lastAutomationFingerprint=t,t}_haveAutomationStatesChanged(e,t){let a=0;for(const[o,i]of Object.entries(e))if(o.startsWith("automation.")){if(a+=1,!(o in t))return!0;if(t[o]!==i)return!0}let o=0;for(const e of Object.keys(t))e.startsWith("automation.")&&(o+=1);return a!==o}_getPaused(){return this._getPausedSnapshot().paused}_getPausedGroupedByResumeTime(){return this._getPausedSnapshot().groups}_getScheduled(){return this._getPausedSnapshot().scheduled}_getPausedSnapshot(){return this.hass?Ct(this.hass):{paused:{},scheduled:{},groups:[]}}_isSnoozeSensorAvailable(){return Boolean(this.hass?.states?.[gt])}_formatDateTime(e){return Le(e,this._getLocale())}_getLocale(){return this.hass?.locale?.language}_hasResumeAt(){return Boolean(this._resumeAtDate&&this._resumeAtTime)}_hasDisableAt(){return Boolean(this._disableAtDate&&this._disableAtTime)}_hapticFeedback(e="light"){We(e)}_showToast(e,t={}){const{showUndo:a=!1,onUndo:o=null}=t;if(!this.shadowRoot)return;const i=this.shadowRoot.querySelector(".toast");i&&i.remove();const s=document.createElement("div");if(s.className="toast",s.setAttribute("role","alert"),s.setAttribute("aria-live","polite"),s.setAttribute("aria-atomic","true"),a&&o){const t=document.createElement("span");t.textContent=e,s.appendChild(t);const a=document.createElement("button");a.className="toast-undo-btn",a.textContent=_e(this.hass,"button.undo"),a.setAttribute("aria-label",_e(this.hass,"a11y.undo_action")),a.addEventListener("click",e=>{e.stopPropagation(),o(),s.remove()}),s.appendChild(a)}else s.textContent=e;this.shadowRoot.appendChild(s),null!==this._toastTimeout&&clearTimeout(this._toastTimeout),null!==this._toastFadeTimeout&&clearTimeout(this._toastFadeTimeout),this._toastTimeout=window.setTimeout(()=>{this._toastTimeout=null,this.shadowRoot&&s.parentNode&&(s.style.animation=`slideUp ${Se}ms ease-out reverse`,this._toastFadeTimeout=window.setTimeout(()=>{this._toastFadeTimeout=null,s.parentNode&&s.remove()},Se))},Te)}async _snooze(e=!1){if(0!==this._selected.length&&!this._loading){if(this._scheduleMode){if(!this._hasResumeAt())return void this._showToast(_e(this.hass,"toast.error.resume_time_required"));const e=function(e){const t=Qe(Ze(e.resumeAtDate,e.resumeAtTime));if(null===t)return{status:"error",message:"Resume time is required"};if(t<=e.nowMs)return{status:"error",message:"Resume time must be in the future"};const a=e.disableAtDate&&e.disableAtTime?Ze(e.disableAtDate,e.disableAtTime):null;if(e.disableAtDate&&e.disableAtTime&&null===a)return{status:"error",message:"Snooze time must be before resume time"};if(a){const e=Qe(a);if(null===e)return{status:"error",message:"Snooze time must be before resume time"};if(e>=t)return{status:"error",message:"Snooze time must be before resume time"}}return{status:"valid"}}({disableAtDate:this._disableAtDate,disableAtTime:this._disableAtTime,resumeAtDate:this._resumeAtDate,resumeAtTime:this._resumeAtTime,nowMs:Date.now()+je});if("error"===e.status){const t="Resume time is required"===e.message?_e(this.hass,"toast.error.invalid_datetime"):"Resume time must be in the future"===e.message?_e(this.hass,"toast.error.resume_time_past"):_e(this.hass,"toast.error.snooze_before_resume");return void this._showToast(t)}}else if(0===this._duration)return;this._loading=!0,this._guardrailConfirmOpen=!1;try{if(!this.hass)return void(this._loading=!1);const t=this._selected.length,a=[...this._selected],o=this._scheduleMode,i=this._hasDisableAt(),s=await Je({hass:this.hass,selected:this._selected,scheduleMode:this._scheduleMode,customDuration:this._customDuration,disableAtDate:this._disableAtDate,disableAtTime:this._disableAtTime,resumeAtDate:this._resumeAtDate,resumeAtTime:this._resumeAtTime,forceConfirm:e});if("confirm_required"===s.status)return this._guardrailConfirmOpen=!0,void(this._loading=!1);if("aborted"===s.status)return void(this._loading=!1);if(s.lastDuration&&(this._lastDuration=s.lastDuration),!this.isConnected||!this.shadowRoot)return void(this._loading=!1);this._hapticFeedback("success"),this._showToast(s.toastMessage,{showUndo:!0,onUndo:async()=>{try{if(!this.hass)return;const e=await async function(e,t,a){const o=a.wasScheduleMode&&a.hadDisableAt?t=>Ke(e,t):t=>Ye(e,t),i=await Promise.allSettled(t.map(e=>o(e))),s=[],r=[];return i.forEach((e,a)=>{const o=t[a];o&&("fulfilled"===e.status?s.push(o):r.push(o))}),{succeeded:s,failed:r}}(this.hass,a,{wasScheduleMode:o,hadDisableAt:i});if(this.isConnected)if(0===e.failed.length){this._setSelected(a);const e=1===t?_e(this.hass,"toast.success.restored_one"):_e(this.hass,"toast.success.restored_many",{count:t});this._showToast(e)}else this._setSelected(e.failed),this._showToast(_e(this.hass,"toast.error.undo_failed"))}catch(e){console.error("Undo failed:",e),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.error.undo_failed"))}}}),this._setSelected([]),this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime=""}catch(e){console.error("Snooze failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ve(e,"Failed to snooze automations"))}this._loading=!1}}async _wake(e){if(this.hass)try{await async function(e,t){await Ye(e,t)}(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.resumed"))}catch(e){console.error("Wake failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ve(e,_e(this.hass,"toast.error.resume_failed")))}}async _handleWakeEvent(e){await this._wake(e.detail.entityId)}async _handleWakeAllEvent(){if(this.hass)try{await Xe(this.hass),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.resumed_all"))}catch(e){console.error("Wake all failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ve(e,_e(this.hass,"toast.error.resume_all_failed")))}}_handleAdjustAutomationEvent(e){const t=rt({entityId:e.detail.entityId,friendlyName:e.detail.friendlyName,resumeAt:e.detail.resumeAt});this._adjustModalOpen=t.adjustModalOpen,this._adjustModalEntityId=t.adjustModalEntityId,this._adjustModalFriendlyName=t.adjustModalFriendlyName,this._adjustModalResumeAt=t.adjustModalResumeAt,this._adjustModalEntityIds=t.adjustModalEntityIds,this._adjustModalFriendlyNames=t.adjustModalFriendlyNames}_handleAdjustGroupEvent(e){const t=rt({entityIds:e.detail.entityIds,friendlyNames:e.detail.friendlyNames,resumeAt:e.detail.resumeAt});this._adjustModalOpen=t.adjustModalOpen,this._adjustModalEntityIds=t.adjustModalEntityIds,this._adjustModalFriendlyNames=t.adjustModalFriendlyNames,this._adjustModalEntityId=t.adjustModalEntityId,this._adjustModalFriendlyName=t.adjustModalFriendlyName,this._adjustModalResumeAt=t.adjustModalResumeAt}async _handleAdjustTimeEvent(e){if(this.hass)try{const t=await et(this.hass,e.detail,this._adjustModalResumeAt);this._hapticFeedback("success"),this._adjustModalResumeAt=t.nextResumeAt,this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.adjusted"))}catch(e){console.error("Adjust failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ve(e,_e(this.hass,"toast.error.adjust_failed")))}}_handleCloseModalEvent(){const e={adjustModalOpen:!1,adjustModalEntityId:"",adjustModalFriendlyName:"",adjustModalResumeAt:"",adjustModalEntityIds:[],adjustModalFriendlyNames:[]};this._adjustModalOpen=e.adjustModalOpen,this._adjustModalEntityId=e.adjustModalEntityId,this._adjustModalFriendlyName=e.adjustModalFriendlyName,this._adjustModalResumeAt=e.adjustModalResumeAt,this._adjustModalEntityIds=e.adjustModalEntityIds,this._adjustModalFriendlyNames=e.adjustModalFriendlyNames}async _cancelScheduled(e){if(this.hass)try{await async function(e,t){await Ke(e,t)}(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.cancelled"))}catch(e){console.error("Cancel scheduled failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ve(e,_e(this.hass,"toast.error.cancel_failed")))}}_setSelected(e){this._cardStore.setSelection(e),this._selected=this._cardStore.getState().selected}_setDurationState(e,t){this._cardStore.setDuration(e,t);const a=this._cardStore.getState();this._duration=a.durationMs,this._customDuration=a.customDuration,this._customDurationInput=a.customDurationInput}_handleDurationChange(e){const{duration:t,input:a,showCustomInput:o}=e.detail;this._setDurationState(t,a),void 0!==o&&(this._showCustomInput=o)}_handleScheduleModeChange(e){const t=function(e){if(!e.enabled)return{scheduleMode:!1,disableAtDate:"",disableAtTime:"",resumeAtDate:"",resumeAtTime:""};const t=new Date(e.now.getTime()+60*e.resumeMinutes*1e3);return{scheduleMode:!0,disableAtDate:it(e.now),disableAtTime:st(e.now),resumeAtDate:it(t),resumeAtTime:st(t)}}({enabled:e.detail.enabled,now:new Date,resumeMinutes:this._lastDuration?.minutes??30});this._scheduleMode=t.scheduleMode,e.detail.enabled&&(this._disableAtDate=t.disableAtDate,this._disableAtTime=t.disableAtTime,this._resumeAtDate=t.resumeAtDate,this._resumeAtTime=t.resumeAtTime)}_handleScheduleFieldChange(e){const{field:t,value:a}=e.detail;switch(t){case"disableAtDate":this._disableAtDate=a;break;case"disableAtTime":this._disableAtTime=a;break;case"resumeAtDate":this._resumeAtDate=a;break;case"resumeAtTime":this._resumeAtTime=a}}_handleCustomInputToggle(e){this._showCustomInput=e.detail.show}_handleSelectionChange(e){this._setSelected(e.detail.selected)}_handleGuardrailCancel(){this._guardrailConfirmOpen=!1}async _handleGuardrailContinue(){this._guardrailConfirmOpen=!1,await this._snooze(!0)}_renderScheduledPauses(e,t){return 0===e?"":G`
    ...
    `}}jt.styles=[ye,fe],e([ce({attribute:!1})],jt.prototype,"hass",void 0),e([ce({attribute:!1})],jt.prototype,"config",void 0),e([he()],jt.prototype,"_selected",void 0),e([he()],jt.prototype,"_duration",void 0),e([he()],jt.prototype,"_customDuration",void 0),e([he()],jt.prototype,"_customDurationInput",void 0),e([he()],jt.prototype,"_loading",void 0),e([he()],jt.prototype,"_scheduleMode",void 0),e([he()],jt.prototype,"_disableAtDate",void 0),e([he()],jt.prototype,"_disableAtTime",void 0),e([he()],jt.prototype,"_resumeAtDate",void 0),e([he()],jt.prototype,"_resumeAtTime",void 0),e([he()],jt.prototype,"_labelRegistry",void 0),e([he()],jt.prototype,"_labelRegistryUnavailable",void 0),e([he()],jt.prototype,"_categoryRegistry",void 0),e([he()],jt.prototype,"_entityRegistry",void 0),e([he()],jt.prototype,"_showCustomInput",void 0),e([he()],jt.prototype,"_automationsCache",void 0),e([he()],jt.prototype,"_automationsCacheVersion",void 0),e([he()],jt.prototype,"_lastDuration",void 0),e([he()],jt.prototype,"_adjustModalOpen",void 0),e([he()],jt.prototype,"_adjustModalEntityId",void 0),e([he()],jt.prototype,"_adjustModalFriendlyName",void 0),e([he()],jt.prototype,"_adjustModalResumeAt",void 0),e([he()],jt.prototype,"_adjustModalEntityIds",void 0),e([he()],jt.prototype,"_adjustModalFriendlyNames",void 0),e([he()],jt.prototype,"_guardrailConfirmOpen",void 0);const Dt=r`
  .row {
    margin-bottom: 12px;
  }
  .row label {
...
`;class Mt extends ne{constructor(){super(...arguments),this._config={}}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config)return;const a={...this._config,[e]:t};""!==t&&null!=t||delete a[e],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:a},bubbles:!0,composed:!0}))}render(){return this._config?G`
      <div class="row">
    ...
    `:G``}}Mt.styles=Dt,e([ce({attribute:!1})],Mt.prototype,"hass",void 0),e([he()],Mt.prototype,"_config",void 0);const Et=r`
    :host {
      display: block;
    }
    .snooze-list {
...
`;class Pt extends ne{constructor(){super(...arguments),this.pauseGroups=[],this.pausedCount=0,this._wakeAllPending=!1,this._wakeAllTimeout=null,this._countdownState={interval:null,syncTimeout:null}}connectedCallback(){super.connectedCallback(),this._syncCountdownLifecycle()}updated(e){e.has("pauseGroups")&&this._syncCountdownLifecycle()}disconnectedCallback(){super.disconnectedCallback(),ot(this._countdownState),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null)}_updateCountdownIfNeeded(){this.pauseGroups.length>0&&this.requestUpdate()}_hasLiveCountdowns(){return this.pauseGroups.some(e=>!e.disableAt)}_scheduleCountdownBootstrap(){this._countdownState={interval:null,syncTimeout:globalThis.setTimeout(()=>{this._countdownState.syncTimeout=null,this._hasLiveCountdowns()&&(this._countdownState=at(()=>this._updateCountdownIfNeeded()))},0)}}_syncCountdownLifecycle(){ot(this._countdownState),0!==this.pauseGroups.length?this._hasLiveCountdowns()?this._countdownState=at(()=>this._updateCountdownIfNeeded()):this._countdownState={interval:null,syncTimeout:null}:this._scheduleCountdownBootstrap()}_handleWakeAll(){this._wakeAllPending?(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,this._fireWakeAll()):(We("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},Ce))}_fireWake(e){this.dispatchEvent(new CustomEvent("wake-automation",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireAdjust(e){this.dispatchEvent(new CustomEvent("adjust-automation",{detail:{entityId:e.entity_id,friendlyName:e.friendly_name,resumeAt:e.resume_at},bubbles:!0,composed:!0}))}_fireAdjustGroup(e){this.dispatchEvent(new CustomEvent("adjust-group",{detail:{entityIds:e.automations.map(e=>e.entity_id),friendlyNames:e.automations.map(e=>e.friendly_name||e.entity_id),resumeAt:e.resumeAt},bubbles:!0,composed:!0}))}_fireWakeAll(){this.dispatchEvent(new CustomEvent("wake-all",{bubbles:!0,composed:!0}))}render(){if(0===this.pausedCount)return G``;const e=this.hass?.locale?.language;return G`
    ...
    `}}Pt.styles=[ye,Et],e([ce({attribute:!1})],Pt.prototype,"hass",void 0),e([ce({attribute:!1})],Pt.prototype,"pauseGroups",void 0),e([ce({type:Number})],Pt.prototype,"pausedCount",void 0),e([he()],Pt.prototype,"_wakeAllPending",void 0);const Ft=r`
    :host {
      display: block;
    }
...
`;class It extends ne{constructor(){super(...arguments),this.scheduleMode=!1,this.customDuration={days:0,hours:0,minutes:30},this.customDurationInput="30m",this.showCustomInput=!1,this.lastDuration=null,this.disableAtDate="",this.disableAtTime="",this.resumeAtDate="",this.resumeAtTime=""}_getBasePresets(){const e=this.hass?.states?.[gt],t=e?.attributes?.duration_presets;return t?.length?t:Ee.filter(e=>null!==e.minutes)}_getDurationPills(){return[...this._getBasePresets(),{label:_e(this.hass,"duration.custom"),minutes:null}]}_getDurationPreview(){const e=Ge(this.customDurationInput);return e?Ue(e.days,e.hours,e.minutes):""}_isDurationValid(){return Be(this.customDurationInput)}_renderDateOptions(){const e=function(e=365,t){const a=[],o=new Date,i=o.getFullYear();for(let s=0;s<e;s++){const e=new Date(o);e.setDate(e.getDate()+s);const r=e.getFullYear(),n=`${r}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=e.toLocaleDateString(t,{weekday:"short"}),d=e.toLocaleDateString(t,{month:"short"}),u=e.getDate(),c=r!==i?`${l}, ${d} ${u}, ${r}`:`${l}, ${d} ${u}`;a.push({value:n,label:c})}return a}(365,this.hass?.locale?.language);return e.map(e=>G`<option value="${e.value}">${e.label}</option>`)}_renderLastDurationBadge(){if(!this.lastDuration)return"";const e=this._getBasePresets(),t=this.lastDuration.minutes,a=!e.some(e=>e.minutes===t);if(!a)return"";const{days:o,hours:i,minutes:s}=this.lastDuration.duration,r=He(o,i,s).replace(/ /g,""),n=qe(this.customDuration),l=!this.showCustomInput&&t===n;return G`
    ...
    `}}It.styles=Ft,e([ce({attribute:!1})],It.prototype,"hass",void 0),e([ce({type:Boolean})],It.prototype,"scheduleMode",void 0),e([ce({attribute:!1})],It.prototype,"customDuration",void 0),e([ce({type:String})],It.prototype,"customDurationInput",void 0),e([ce({type:Boolean})],It.prototype,"showCustomInput",void 0),e([ce({attribute:!1})],It.prototype,"lastDuration",void 0),e([ce({type:String})],It.prototype,"disableAtDate",void 0),e([ce({type:String})],It.prototype,"disableAtTime",void 0),e([ce({type:String})],It.prototype,"resumeAtDate",void 0),e([ce({type:String})],It.prototype,"resumeAtTime",void 0);const Nt=r`
    :host {
      display: block;
    }
...
`;class Lt extends ne{constructor(){super(...arguments),this.automations=[],this.selected=[],this.labelRegistry={},this.labelRegistryUnavailable=!1,this.categoryRegistry={},this._filterTab="all",this._search="",this._searchInput="",this._expandedGroups={},this._searchTimeout=null,this._viewModelCache=null}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null)}_fireSelectionChange(e){this.dispatchEvent(new CustomEvent("selection-change",{detail:{selected:e},bubbles:!0,composed:!0}))}_toggleSelection(e){let t;We("selection"),t=this.selected.includes(e)?this.selected.filter(t=>t!==e):[...this.selected,e],this._fireSelectionChange(t)}_toggleGroupExpansion(e){this._expandedGroups={...this._expandedGroups,[e]:!this._expandedGroups[e]}}_selectGroup(e){const t=e.map(e=>e.id);let a;a=t.every(e=>this.selected.includes(e))?this.selected.filter(e=>!t.includes(e)):[...new Set([...this.selected,...t])],this._fireSelectionChange(a)}_selectAllVisible(){const e=this._getViewModel().filtered.map(e=>e.id),t=[...new Set([...this.selected,...e])];this._fireSelectionChange(t)}_clearSelection(){this._fireSelectionChange([])}_getFilteredAutomations(){return this._getViewModel().filtered}_getAreaName(e){return this.hass?dt(e,this.hass):_e(this.hass,"group.unassigned")}_getLabelName(e){return ut(e,this.labelRegistry)}_getCategoryName(e){return ct(e,this.categoryRegistry)}_getGroupedByTab(e){return pt({automations:this.automations,search:this._search,filterTab:e,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,emptyAreaLabel:_e(this.hass,"group.unassigned"),emptyLabelLabel:_e(this.hass,"group.unlabeled"),emptyCategoryLabel:_e(this.hass,"group.uncategorized")}).grouped}_getGroupedByArea(){return this._getGroupedByTab("areas")}_getGroupedByLabel(){return this._getGroupedByTab("labels")}_getGroupedByCategory(){return this._getGroupedByTab("categories")}_getAreaCount(){return this._getViewModel().areaCount}_getLabelCount(){return this._getViewModel().labelCount}_getCategoryCount(){return this._getViewModel().categoryCount}_getViewModel(){const e=this._viewModelCache;if(e&&e.automations===this.automations&&e.search===this._search&&e.filterTab===this._filterTab&&e.hass===this.hass&&e.labelRegistry===this.labelRegistry&&e.categoryRegistry===this.categoryRegistry)return e.result;const t=pt({automations:this.automations,search:this._search,filterTab:this._filterTab,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,emptyAreaLabel:_e(this.hass,"group.unassigned"),emptyLabelLabel:_e(this.hass,"group.unlabeled"),emptyCategoryLabel:_e(this.hass,"group.uncategorized")});return this._viewModelCache={automations:this.automations,search:this._search,filterTab:this._filterTab,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,result:t},t}_handleSearchInput(e){const t=e.target.value;this._searchInput=t,null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},ke)}_clearSearch(){null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null),this._searchInput="",this._search=""}_handleSearchKeydown(e){"Escape"===e.key&&(this._searchInput||this._search)&&(e.preventDefault(),this._clearSearch())}_renderSelectionList(e,t){const{filtered:a,grouped:o}=e;return"all"===this._filterTab?0===a.length?G`<div class="list-empty" role="status">${_e(this.hass,"list.empty")}</div>`:a.map(e=>G`
    ...
    `}}Lt.styles=Nt,e([ce({attribute:!1})],Lt.prototype,"hass",void 0),e([ce({attribute:!1})],Lt.prototype,"automations",void 0),e([ce({attribute:!1})],Lt.prototype,"selected",void 0),e([ce({attribute:!1})],Lt.prototype,"labelRegistry",void 0),e([ce({type:Boolean})],Lt.prototype,"labelRegistryUnavailable",void 0),e([ce({attribute:!1})],Lt.prototype,"categoryRegistry",void 0),e([he()],Lt.prototype,"_filterTab",void 0),e([he()],Lt.prototype,"_search",void 0),e([he()],Lt.prototype,"_searchInput",void 0),e([he()],Lt.prototype,"_expandedGroups",void 0);const Ot=r`
    :host {
      display: block;
    }
    .modal-overlay {
...
`,Ut=[{label:"+15m",minutes:15},{label:"+30m",minutes:30},{label:"+1h",hours:1},{label:"+2h",hours:2}],Ht=[{label:"-15m",minutes:-15,thresholdMs:15*xe},{label:"-30m",minutes:-30,thresholdMs:30*xe}],Gt=xe;class Bt extends ne{constructor(){super(...arguments),this.open=!1,this.entityId="",this.friendlyName="",this.resumeAt="",this.entityIds=[],this.friendlyNames=[],this._countdownState={interval:null,syncTimeout:null}}get _isGroupMode(){return this.entityIds.length>1}updated(e){e.has("open")&&(this.open?this._startSynchronizedCountdown():this._stopCountdown())}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown()}_startSynchronizedCountdown(){nt(this._countdownState),this._countdownState=at(()=>this.requestUpdate())}_stopCountdown(){nt(this._countdownState)}_isDecrementDisabled(e){if(!this.resumeAt)return!0;return new Date(this.resumeAt).getTime()-Date.now()-e<Gt}_fireAdjustTime(e){this.entityIds.length>0?this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityIds:this.entityIds,...e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityId:this.entityId,...e},bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}_handleOverlayKeydown(e){"Escape"===e.key&&this._close()}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}render(){return this.open?G`
    ...
    `:G``}}Bt.styles=Ot,e([ce({attribute:!1})],Bt.prototype,"hass",void 0),e([ce({type:Boolean})],Bt.prototype,"open",void 0),e([ce({type:String})],Bt.prototype,"entityId",void 0),e([ce({type:String})],Bt.prototype,"friendlyName",void 0),e([ce({type:String})],Bt.prototype,"resumeAt",void 0),e([ce({attribute:!1})],Bt.prototype,"entityIds",void 0),e([ce({attribute:!1})],Bt.prototype,"friendlyNames",void 0);const qt=Symbol.for("autosnooze.registration.done.v1"),Wt=new Set,Vt="autosnooze-card",Yt=[{tag:"autosnooze-card-editor",ctor:Mt},{tag:"autosnooze-active-pauses",ctor:Pt},{tag:"autosnooze-duration-selector",ctor:It},{tag:"autosnooze-automation-list",ctor:Lt},{tag:"autosnooze-adjust-modal",ctor:Bt},{tag:Vt,ctor:jt}];function Kt(e,t,a){Wt.has(e)||(Wt.add(e),console.warn(t))}function Zt(e="0.2.17"){const t=function(e){return{type:Vt,name:"AutoSnooze Card",description:`Temporarily pause automations with area and label filtering (v${e})`,preview:!0,documentationURL:"https://github.com/mossipcams/autosnooze#readme"}}(e),a=function(){const e=window.customCards;return Array.isArray(e)?e:(void 0!==e&&Kt("customCards-not-array",`[AutoSnooze] window.customCards was not an array (got ${typeof e}); resetting.`),[])}(),o=a.findIndex(e=>e?.type===Vt);-1===o?a.push(t):a[o]={...a[o],...t},window.customCards=a}!function(){const e=globalThis;!0===e[qt]||(Yt.forEach(({tag:e,ctor:t})=>function(e,t,a=customElements){const o=a.get(e);if(o)o!==t&&Kt(`element-conflict:${e}`,`[AutoSnooze] Element tag "${e}" is already registered with a different constructor.`);else try{a.define(e,t)}catch(o){const i=a.get(e);if(i===t)return;if(i)return void Kt(`element-conflict:${e}`,`[AutoSnooze] Element tag "${e}" was claimed by a different constructor during registration.`);throw o}}(e,t)),e[qt]=!0),Zt()}();export{Pt as AutoSnoozeActivePauses,Bt as AutoSnoozeAdjustModal,Lt as AutoSnoozeAutomationList,It as AutoSnoozeDurationSelector,jt as AutomationPauseCard,Mt as AutomationPauseCardEditor};
