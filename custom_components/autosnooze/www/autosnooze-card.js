...
`;class Lt extends ne{constructor(){super(...arguments),this.scheduleMode=!1,this.customDuration={days:0,hours:0,minutes:30},this.customDurationInput="30m",this.showCustomInput=!1,this.lastDuration=null,this.disableAtDate="",this.disableAtTime="",this.resumeAtDate="",this.resumeAtTime=""}_getBasePresets(){const e=this.hass?.states?.[_t],t=e?.attributes?.duration_presets;return t?.length?t:Ee.filter(e=>null!==e.minutes)}_getDurationPills(){return[...this._getBasePresets(),{label:_e(this.hass,"duration.custom"),minutes:null}]}_getDurationPreview(){const e=qe(this.customDurationInput);return e?Ge(e.days,e.hours,e.minutes):""}_isDurationValid(){return We(this.customDurationInput)}_renderDateOptions(){const e=function(e=365,t){const a=[],o=new Date,i=o.getFullYear();for(let s=0;s<e;s++){const e=new Date(o);e.setDate(e.getDate()+s);const r=e.getFullYear(),n=`${r}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=e.toLocaleDateString(t,{weekday:"short"}),d=e.toLocaleDateString(t,{month:"short"}),u=e.getDate(),c=r!==i?`${l}, ${d} ${u}, ${r}`:`${l}, ${d} ${u}`;a.push({value:n,label:c})}return a}(365,this.hass?.locale?.language);return e.map(e=>G`<option value="${e.value}">${e.label}</option>`)}_renderLastDurationBadge(){if(!this.lastDuration)return"";const e=this._getBasePresets(),t=this.lastDuration.minutes,a=!e.some(e=>e.minutes===t);if(!a)return"";const{days:o,hours:i,minutes:s}=this.lastDuration.duration,r=Be(o,i,s).replace(/ /g,""),n=Ve(this.customDuration),l=!this.showCustomInput&&t===n;return G`
    ...
    `}}Lt.styles=Nt,e([ce({attribute:!1})],Lt.prototype,"hass",void 0),e([ce({type:Boolean})],Lt.prototype,"scheduleMode",void 0),e([ce({attribute:!1})],Lt.prototype,"customDuration",void 0),e([ce({type:String})],Lt.prototype,"customDurationInput",void 0),e([ce({type:Boolean})],Lt.prototype,"showCustomInput",void 0),e([ce({attribute:!1})],Lt.prototype,"lastDuration",void 0),e([ce({type:String})],Lt.prototype,"disableAtDate",void 0),e([ce({type:String})],Lt.prototype,"disableAtTime",void 0),e([ce({type:String})],Lt.prototype,"resumeAtDate",void 0),e([ce({type:String})],Lt.prototype,"resumeAtTime",void 0);const Ot=r`
    :host {
      display: block;
    }
...
`;class Ut extends ne{constructor(){super(...arguments),this.automations=[],this.selected=[],this.labelRegistry={},this.labelRegistryUnavailable=!1,this.categoryRegistry={},this.recentSnoozeIds=[],this._filterTab="all",this._search="",this._searchInput="",this._expandedGroups={},this._searchTimeout=null,this._viewModelCache=null}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null)}_fireSelectionChange(e){this.dispatchEvent(new CustomEvent("selection-change",{detail:{selected:e},bubbles:!0,composed:!0}))}_toggleSelection(e){let t;Ye("selection"),t=this.selected.includes(e)?this.selected.filter(t=>t!==e):[...this.selected,e],this._fireSelectionChange(t)}_toggleGroupExpansion(e){this._expandedGroups={...this._expandedGroups,[e]:!this._expandedGroups[e]}}_selectGroup(e){const t=e.map(e=>e.id);let a;a=t.every(e=>this.selected.includes(e))?this.selected.filter(e=>!t.includes(e)):[...new Set([...this.selected,...t])],this._fireSelectionChange(a)}_selectAllVisible(){const e=this._getViewModel().filtered.map(e=>e.id),t=[...new Set([...this.selected,...e])];this._fireSelectionChange(t)}_clearSelection(){this._fireSelectionChange([])}_getFilteredAutomations(){return this._getViewModel().filtered}_getAreaName(e){return this.hass?ct(e,this.hass):_e(this.hass,"group.unassigned")}_getLabelName(e){return ht(e,this.labelRegistry)}_getCategoryName(e){return mt(e,this.categoryRegistry)}_getGroupedByTab(e){return bt({automations:this.automations,search:this._search,filterTab:e,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,emptyAreaLabel:_e(this.hass,"group.unassigned"),emptyLabelLabel:_e(this.hass,"group.unlabeled"),emptyCategoryLabel:_e(this.hass,"group.uncategorized")}).grouped}_getGroupedByArea(){return this._getGroupedByTab("areas")}_getGroupedByLabel(){return this._getGroupedByTab("labels")}_getGroupedByCategory(){return this._getGroupedByTab("categories")}_getAreaCount(){return this._getViewModel().areaCount}_getLabelCount(){return this._getViewModel().labelCount}_getCategoryCount(){return this._getViewModel().categoryCount}_getViewModel(){const e=this._viewModelCache;if(e&&e.automations===this.automations&&e.search===this._search&&e.filterTab===this._filterTab&&e.hass===this.hass&&e.labelRegistry===this.labelRegistry&&e.categoryRegistry===this.categoryRegistry)return e.result;const t=bt({automations:this.automations,search:this._search,filterTab:this._filterTab,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,emptyAreaLabel:_e(this.hass,"group.unassigned"),emptyLabelLabel:_e(this.hass,"group.unlabeled"),emptyCategoryLabel:_e(this.hass,"group.uncategorized")});return this._viewModelCache={automations:this.automations,search:this._search,filterTab:this._filterTab,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,result:t},t}_handleSearchInput(e){const t=e.target.value;this._searchInput=t,null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},ke)}_clearSearch(){null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null),this._searchInput="",this._search=""}_handleSearchKeydown(e){"Escape"===e.key&&(this._searchInput||this._search)&&(e.preventDefault(),this._clearSearch())}_renderSelectionList(e,t){const{filtered:a,grouped:o}=e;if("all"===this._filterTab){if(0===a.length)return G`<div class="list-empty" role="status">${_e(this.hass,"list.empty")}</div>`;const e=new Set(this.recentSnoozeIds),o=a.some(t=>e.has(t.id));return G`
        ...
        `:""}
        ${[...a].sort((t,a)=>(e.has(a.id)?1:0)-(e.has(t.id)?1:0)).map(a=>G`
        <button
          type="button"
          class="list-item ${t.has(a.id)?"selected":""} ${e.has(a.id)?"is-recent":""}"
          @click=${()=>this._toggleSelection(a.id)}
          role="option"
          aria-selected=${t.has(a.id)}
        >
          <input
            type="checkbox"
            .checked=${t.has(a.id)}
            ...
            aria-label="${_e(this.hass,"a11y.select_automation",{name:a.name})}"
            tabindex="-1"
          />
