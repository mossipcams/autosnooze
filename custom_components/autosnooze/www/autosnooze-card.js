...
`,At=[{label:"+15m",minutes:15},{label:"+30m",minutes:30},{label:"+1h",hours:1},{label:"+2h",hours:2}],kt=[{label:"-15m",minutes:-15,thresholdMs:15*xe},{label:"-30m",minutes:-30,thresholdMs:30*xe}],St=xe;class Ct extends ne{constructor(){super(...arguments),this.open=!1,this.entityId="",this.friendlyName="",this.resumeAt="",this.entityIds=[],this.friendlyNames=[],this._countdownState={interval:null,syncTimeout:null}}get _isGroupMode(){return this.entityIds.length>1}updated(e){e.has("open")&&(this.open?this._startSynchronizedCountdown():this._stopCountdown())}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown()}_startSynchronizedCountdown(){Qe(this._countdownState),this._countdownState=Xe(()=>this.requestUpdate())}_stopCountdown(){Qe(this._countdownState)}_isDecrementDisabled(e){if(!this.resumeAt)return!0;return new Date(this.resumeAt).getTime()-Date.now()-e<St}_fireAdjustTime(e){this.entityIds.length>0?this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityIds:this.entityIds,...e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityId:this.entityId,...e},bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}_handleOverlayKeydown(e){"Escape"===e.key&&this._close()}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}render(){return this.open?G`
    ...
    `:G``}}Ct.styles=$t,e([ce({attribute:!1})],Ct.prototype,"hass",void 0),e([ce({type:Boolean})],Ct.prototype,"open",void 0),e([ce({type:String})],Ct.prototype,"entityId",void 0),e([ce({type:String})],Ct.prototype,"friendlyName",void 0),e([ce({type:String})],Ct.prototype,"resumeAt",void 0),e([ce({attribute:!1})],Ct.prototype,"entityIds",void 0),e([ce({attribute:!1})],Ct.prototype,"friendlyNames",void 0);const Tt=Symbol.for("autosnooze.registration.done.v1"),Dt=new Set,jt="autosnooze-card",Rt=[{tag:"autosnooze-card-editor",ctor:bt},{tag:"autosnooze-active-pauses",ctor:yt},{tag:"autosnooze-duration-selector",ctor:xt},{tag:"autosnooze-automation-list",ctor:zt},{tag:"autosnooze-adjust-modal",ctor:Ct},{tag:jt,ctor:gt}];function Et(e,t,a){Dt.has(e)||(Dt.add(e),void 0===a?console.warn(t):console.warn(t,a))}function Pt(e="0.2.13"){const t=function(e){return{type:jt,name:"AutoSnooze Card",description:`Temporarily pause automations with area and label filtering (v${e})`,preview:!0,documentationURL:"https://github.com/mossipcams/autosnooze#readme"}}(e),a=function(){const e=window.customCards;return Array.isArray(e)?e:[]}(),o=a.findIndex(e=>e?.type===jt);-1===o?a.push(t):a[o]={...a[o],...t},window.customCards=a}!function(){const e=globalThis;!0===e[Tt]||(Rt.forEach(({tag:e,ctor:t})=>function(e,t,a=customElements){const o=a.get(e);if(o)o!==t&&Et(`element-conflict:${e}`,`[AutoSnooze] Element tag "${e}" is already registered with a different constructor.`);else try{a.define(e,t)}catch(o){if(a.get(e)===t)return;Et(`element-define-failed:${e}`,`[AutoSnooze] Failed to register element tag "${e}".`,o)}}(e,t)),e[Tt]=!0),Pt()}();export{yt as AutoSnoozeActivePauses,Ct as AutoSnoozeAdjustModal,zt as AutoSnoozeAutomationList,xt as AutoSnoozeDurationSelector,gt as AutomationPauseCard,bt as AutomationPauseCardEditor};
