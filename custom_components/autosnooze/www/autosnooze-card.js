              ...
              `:N`
                ...
                <div class="duration-selector">
                  ...
                  <div class="duration-pills" role="radiogroup" aria-labelledby="duration-header">
                    ${o.map(e=>{const t=null===e.minutes?this._showCustomInput:!this._showCustomInput&&r===e;return N`
                          <button
                            class="pill ${t?"active":""}"
                  ...
                  ${this._showCustomInput?N`
                    <div class="custom-duration-input">
                      ...
                      />
                      ${n&&l?N`<div class="duration-preview" role="status" aria-live="polite">Duration: ${n}</div>`:N`<div class="duration-help" id="duration-help">Enter duration: 30m, 2h, 4h30m, 1d, 1d2h</div>`}
                    </div>
                  `:""}
