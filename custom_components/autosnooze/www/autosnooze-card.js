        ...
        ${this.pauseGroups.map(t=>G`
          <div class="pause-group" role="group">
            <div class="pause-group-header"
              ...
              ${t.disableAt?G`${be(this.hass,"status.resumes")} ${Me(t.resumeAt,e)}`:G`<span class="countdown">${Fe(t.resumeAt,be(this.hass,"status.resuming"))}</span>`}
            </div>
