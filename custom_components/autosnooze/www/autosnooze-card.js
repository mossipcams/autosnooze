...
`;class zt extends ne{constructor(){super(...arguments),this.automations=[],this.selected=[],this.labelRegistry={},this.labelRegistryUnavailable=!1,this.categoryRegistry={},this._filterTab="all",this._search="",this._expandedGroups={},this._searchTimeout=null}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null)}_fireSelectionChange(e){this.dispatchEvent(new CustomEvent("selection-change",{detail:{selected:e},bubbles:!0,composed:!0}))}_toggleSelection(e){let t;qe("selection"),t=this.selected.includes(e)?this.selected.filter(t=>t!==e):[...this.selected,e],this._fireSelectionChange(t)}_toggleGroupExpansion(e){this._expandedGroups={...this._expandedGroups,[e]:!this._expandedGroups[e]}}_selectGroup(e){const t=e.map(e=>e.id);let a;a=t.every(e=>this.selected.includes(e))?this.selected.filter(e=>!t.includes(e)):[...new Set([...this.selected,...t])],this._fireSelectionChange(a)}_selectAllVisible(){const e=this._getFilteredAutomations().map(e=>e.id);let t;t=e.every(e=>this.selected.includes(e))?this.selected.filter(t=>!e.includes(t)):[...new Set([...this.selected,...e])],this._fireSelectionChange(t)}_clearSelection(){this._fireSelectionChange([])}_getFilteredAutomations(){return function(e,t,a){let o=e;const i=e.some(e=>it(e,Ie,a));o=i?o.filter(e=>it(e,Ie,a)):o.filter(e=>!it(e,Fe,a));const s=t.toLowerCase();return s&&(o=o.filter(e=>e.name.toLowerCase().includes(s)||e.id.toLowerCase().includes(s))),o}(this.automations,this._search,this.labelRegistry)}_getAreaName(e){return this.hass?function(e,t,a="Unassigned"){return e?t.areas?.[e]?.name??ot(e):a}(e,this.hass):be(this.hass,"group.unassigned")}_getLabelName(e){return function(e,t){return t[e]?.name??ot(e)}(e,this.labelRegistry)}_getCategoryName(e){return function(e,t,a="Uncategorized"){return e?t[e]?.name??ot(e):a}(e,this.categoryRegistry)}_getGroupedByArea(){return st(this._getFilteredAutomations(),e=>e.area_id?[this._getAreaName(e.area_id)]:null,be(this.hass,"group.unassigned"))}_getGroupedByLabel(){const e=this._getFilteredAutomations(),t=[Fe.toLowerCase(),Ie.toLowerCase()];return st(e,e=>{if(!e.labels?.length)return null;const a=e.labels.map(e=>this._getLabelName(e)).filter(e=>!t.includes(e.toLowerCase()));return a.length>0?a:null},be(this.hass,"group.unlabeled"))}_getGroupedByCategory(){return st(this._getFilteredAutomations(),e=>e.category_id?[this._getCategoryName(e.category_id)]:null,be(this.hass,"group.uncategorized"))}_getAreaCount(){return rt(this.automations,e=>e.area_id?[e.area_id]:null)}_getLabelCount(){const e=[Fe.toLowerCase(),Ie.toLowerCase()];return rt(this.automations,t=>{if(!t.labels?.length)return null;const a=t.labels.filter(t=>!e.includes(this._getLabelName(t).toLowerCase()));return a.length>0?a:null})}_getCategoryCount(){return rt(this.automations,e=>e.category_id?[e.category_id]:null)}_handleSearchInput(e){const t=e.target.value;null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},ke)}_renderSelectionList(){const e=this._getFilteredAutomations();if("all"===this._filterTab)return 0===e.length?G`<div class="list-empty" role="status">${be(this.hass,"list.empty")}</div>`:e.map(e=>G`
      ...
      `);const t="areas"===this._filterTab?this._getGroupedByArea():"categories"===this._filterTab?this._getGroupedByCategory():this._getGroupedByLabel();return 0===t.length?G`<div class="list-empty" role="status">${be(this.hass,"list.empty")}</div>`:t.map(([e,t])=>{const a=!1!==this._expandedGroups[e],o=t.every(e=>this.selected.includes(e.id)),i=t.some(e=>this.selected.includes(e.id))&&!o;return G`
        ...
        ${a?t.map(e=>G`
              ...
              `):""}
      `})}render(){const e=this._getFilteredAutomations(),t=this.labelRegistryUnavailable;return G`
    ...
    `}}zt.styles=wt,e([ce({attribute:!1})],zt.prototype,"hass",void 0),e([ce({attribute:!1})],zt.prototype,"automations",void 0),e([ce({attribute:!1})],zt.prototype,"selected",void 0),e([ce({attribute:!1})],zt.prototype,"labelRegistry",void 0),e([ce({type:Boolean})],zt.prototype,"labelRegistryUnavailable",void 0),e([ce({attribute:!1})],zt.prototype,"categoryRegistry",void 0),e([he()],zt.prototype,"_filterTab",void 0),e([he()],zt.prototype,"_search",void 0),e([he()],zt.prototype,"_expandedGroups",void 0);const $t=r`
    :host {
      display: block;
    }
    .modal-overlay {
