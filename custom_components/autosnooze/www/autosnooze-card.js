...
`,mt=1e3,gt=6e4,bt=36e5,ft=864e5,_t=60,xt=1440,vt=300,yt=300,wt=3e3,$t=5e3,At=1e3,kt=5e3,St=[{label:"30m",minutes:30},{label:"1h",minutes:60},{label:"4h",minutes:240},{label:"1 day",minutes:1440},{label:"Custom",minutes:null}],zt={not_automation:"Failed to snooze: One or more selected items are not automations",invalid_duration:"Failed to snooze: Please specify a valid duration (days, hours, or minutes)",resume_time_past:"Failed to snooze: Resume time must be in the future",disable_after_resume:"Failed to snooze: Snooze time must be before resume time"},Ct="autosnooze_exclude",Tt="autosnooze_include",Et={light:10,medium:20,heavy:30,success:[10,50,10],error:[20,100,20,100,20],selection:8};function Dt(t,e,o){const i=[];return t>0&&i.push(`${t} day${1!==t?"s":""}`),e>0&&i.push(`${e} hour${1!==e?"s":""}`),o>0&&i.push(`${o} minute${1!==o?"s":""}`),i.join(", ")}function Rt(t){const e=t.toLowerCase().replace(/\s+/g,"");if(!e)return null;let o=0,i=!1;const r=e.match(/(\d+(?:\.\d+)?)\s*d/),s=e.match(/(\d+(?:\.\d+)?)\s*h/),a=e.match(/(\d+(?:\.\d+)?)\s*m(?!i)/);if(r?.[1]){const t=parseFloat(r[1]);if(isNaN(t)||t<0)return null;o+=t*xt,i=!0}if(s?.[1]){const t=parseFloat(s[1]);if(isNaN(t)||t<0)return null;o+=t*_t,i=!0}if(a?.[1]){const t=parseFloat(a[1]);if(isNaN(t)||t<0)return null;o+=t,i=!0}if(!i){const t=parseFloat(e);if(isNaN(t)||!(t>0))return null;o=t}if(o=Math.round(o),o<=0)return null;const n=Math.floor(o/xt),l=o%xt;return{days:n,hours:Math.floor(l/_t),minutes:l%_t}}function Pt(t,e){if(!t||!e)return null;const o=new Date(`${t}T${e}`).getTimezoneOffset(),i=o<=0?"+":"-",r=Math.abs(o);return`${t}T${e}${`${i}${String(Math.floor(r/60)).padStart(2,"0")}:${String(r%60).padStart(2,"0")}`}`}function Ft(t="light"){if(!navigator.vibrate)return;const e=Et[t];void 0!==e&&navigator.vibrate(e)}function Mt(t,e){const o=t,i=o?.translation_key??o?.data?.translation_key;if(i&&zt[i])return zt[i];const r=o?.message??"";for(const[t,e]of Object.entries(zt))if(r.includes(t)||r.toLowerCase().includes(t.replace(/_/g," ")))return e;return`${e}. Check Home Assistant logs for details.`}async function Ut(t,e){try{await t.callService("autosnooze","pause",e)}catch(t){throw console.error("[AutoSnooze] Failed to pause automations:",t),t}}async function Ot(t,e){try{await t.callService("autosnooze","cancel",{entity_id:e})}catch(t){throw console.error("[AutoSnooze] Failed to wake automation:",t),t}}async function Nt(t,e){try{await t.callService("autosnooze","cancel_scheduled",{entity_id:e})}catch(t){throw console.error("[AutoSnooze] Failed to cancel scheduled snooze:",t),t}}function Lt(t){return t.replace(/_/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function Ht(t,e,o){return!(!t.labels||0===t.labels.length)&&t.labels.some(t=>{const i=o[t]?.name;return i?.toLowerCase()===e})}function It(t,e,o){const i={};return t.forEach(t=>{const r=e(t);r&&0!==r.length?r.forEach(e=>{i[e]||(i[e]=[]),i[e].push(t)}):(i[o]||(i[o]=[]),i[o].push(t))}),Object.entries(i).sort((t,e)=>t[0]===o?1:e[0]===o?-1:t[0].localeCompare(e[0]))}function jt(t,e){const o=new Set;return t.forEach(t=>{const i=e(t);i&&i.forEach(t=>o.add(t))}),o.size}const Bt="sensor.autosnooze_snoozed_automations";function Gt(t){const e=t?.states?.[Bt];return e?.attributes?.paused_automations??{}}class Wt extends nt{constructor(){super(...arguments),this.config={},this._selected=[],this._duration=30*gt,this._customDuration={days:0,hours:0,minutes:30},this._customDurationInput="30m",this._loading=!1,this._search="",this._filterTab="all",this._expandedGroups={},this._scheduleMode=!1,this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime="",this._labelRegistry={},this._categoryRegistry={},this._entityRegistry={},this._showCustomInput=!1,this._automationsCache=null,this._automationsCacheVersion=0,this._wakeAllPending=!1,this._interval=null,this._syncTimeout=null,this._labelsFetched=!1,this._categoriesFetched=!1,this._entityRegistryFetched=!1,this._lastHassStates=null,this._lastCacheVersion=0,this._searchTimeout=null,this._wakeAllTimeout=null,this._toastTimeout=null,this._toastFadeTimeout=null}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-card",title:"AutoSnooze"}}setConfig(t){this.config=t}getCardSize(){const t=this._getPaused(),e=this._getScheduled();return 4+Object.keys(t).length+Object.keys(e).length}shouldUpdate(t){if(!t.has("hass"))return!0;const e=t.get("hass"),o=this.hass;if(!e||!o)return!0;const i=e.states?.["sensor.autosnooze_snoozed_automations"],r=o.states?.["sensor.autosnooze_snoozed_automations"];if(i!==r)return!0;if(e.entities!==o.entities)return!0;if(e.areas!==o.areas)return!0;const s=o.states??{},a=e.states??{};for(const t of Object.keys(s))if(t.startsWith("automation.")&&a[t]!==s[t])return!0;for(const t of Object.keys(a))if(t.startsWith("automation.")&&!s[t])return!0;return!1}updated(t){super.updated(t),t.has("hass")&&this.hass?.connection&&(this._labelsFetched||this._fetchLabelRegistry(),this._categoriesFetched||this._fetchCategoryRegistry(),this._entityRegistryFetched||this._fetchEntityRegistry())}connectedCallback(){super.connectedCallback(),this._interval&&(window.clearInterval(this._interval),this._interval=null),this._syncTimeout&&(window.clearTimeout(this._syncTimeout),this._syncTimeout=null),this._startSynchronizedCountdown(),this._fetchLabelRegistry(),this._fetchCategoryRegistry(),this._fetchEntityRegistry()}disconnectedCallback(){super.disconnectedCallback(),null!==this._interval&&(clearInterval(this._interval),this._interval=null),null!==this._syncTimeout&&(clearTimeout(this._syncTimeout),this._syncTimeout=null),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),null!==this._toastTimeout&&(clearTimeout(this._toastTimeout),this._toastTimeout=null),null!==this._toastFadeTimeout&&(clearTimeout(this._toastFadeTimeout),this._toastFadeTimeout=null)}_startSynchronizedCountdown(){const t=1e3-Date.now()%1e3;this._syncTimeout=window.setTimeout(()=>{this._syncTimeout=null,this._updateCountdownIfNeeded(),this._interval=window.setInterval(()=>{this._updateCountdownIfNeeded()},At)},t)}_updateCountdownIfNeeded(){if(!this.hass)return;const t=Gt(this.hass);Object.keys(t).length>0&&this.requestUpdate()}async _fetchLabelRegistry(){!this._labelsFetched&&this.hass?.connection&&(this._labelRegistry=await async function(t){try{const e=await t.connection.sendMessagePromise({type:"config/label_registry/list"}),o={};return Array.isArray(e)&&e.forEach(t=>{o[t.label_id]=t}),o}catch(t){return console.warn("[AutoSnooze] Failed to fetch label registry:",t),{}}}(this.hass),this._labelsFetched=!0)}async _fetchCategoryRegistry(){!this._categoriesFetched&&this.hass?.connection&&(this._categoryRegistry=await async function(t){try{const e=await t.connection.sendMessagePromise({type:"config/category_registry/list",scope:"automation"}),o={};return Array.isArray(e)&&e.forEach(t=>{o[t.category_id]=t}),o}catch(t){return console.warn("[AutoSnooze] Failed to fetch category registry:",t),{}}}(this.hass),this._categoriesFetched=!0)}async _fetchEntityRegistry(){!this._entityRegistryFetched&&this.hass?.connection&&(this._entityRegistry=await async function(t){try{const e=await t.connection.sendMessagePromise({type:"config/entity_registry/list"}),o={};return Array.isArray(e)&&e.filter(t=>t.entity_id.startsWith("automation.")).forEach(t=>{o[t.entity_id]=t}),o}catch(t){return console.warn("[AutoSnooze] Failed to fetch entity registry:",t),{}}}(this.hass),this._entityRegistryFetched=!0,this._automationsCacheVersion++)}_getAutomations(){if(!this.hass?.states)return[];const t=this.hass.states,e=this._automationsCacheVersion;if(this._lastHassStates===t&&this._lastCacheVersion===e&&this._automationsCache)return this._automationsCache;const o=function(t,e){const o=t?.states,i=t?.entities;if(!o)return[];const r=Object.keys(o).filter(t=>t.startsWith("automation.")).map(t=>{const r=o[t];if(!r)return null;const s=e?.[t],a=i?.[t],n=(s?.categories??{}).automation??null;return{id:t,name:r.attributes?.friendly_name??t.replace("automation.",""),area_id:s?.area_id??a?.area_id??null,category_id:n,labels:s?.labels??a?.labels??[]}}).filter(t=>null!==t).sort((t,e)=>t.name.localeCompare(e.name));return r}(this.hass,this._entityRegistry);return this._automationsCache=o,this._lastCacheVersion=e,this._lastHassStates=t,o}_getFilteredAutomations(){return function(t,e,o){let i=t;const r=t.some(t=>Ht(t,Tt,o));i=r?i.filter(t=>Ht(t,Tt,o)):i.filter(t=>!Ht(t,Ct,o));const s=e.toLowerCase();return s&&(i=i.filter(t=>t.name.toLowerCase().includes(s)||t.id.toLowerCase().includes(s))),i}(this._getAutomations(),this._search,this._labelRegistry)}_getAreaName(t){return this.hass?function(t,e){return t?e.areas?.[t]?.name??Lt(t):"Unassigned"}(t,this.hass):"Unassigned"}_getLabelName(t){return function(t,e){return e[t]?.name??Lt(t)}(t,this._labelRegistry)}_getCategoryName(t){return function(t,e){return t?e[t]?.name??Lt(t):"Uncategorized"}(t,this._categoryRegistry)}_getGroupedByArea(){return It(this._getFilteredAutomations(),t=>t.area_id?[this._getAreaName(t.area_id)]:null,"Unassigned")}_getGroupedByLabel(){const t=this._getFilteredAutomations(),e=[Ct.toLowerCase(),Tt.toLowerCase()];return It(t,t=>{if(!t.labels?.length)return null;const o=t.labels.map(t=>this._getLabelName(t)).filter(t=>!e.includes(t.toLowerCase()));return o.length>0?o:null},"Unlabeled")}_getGroupedByCategory(){return It(this._getFilteredAutomations(),t=>t.category_id?[this._getCategoryName(t.category_id)]:null,"Uncategorized")}_getAreaCount(){return jt(this._getAutomations(),t=>t.area_id?[t.area_id]:null)}_getLabelCount(){const t=this._getAutomations(),e=[Ct.toLowerCase(),Tt.toLowerCase()];return jt(t,t=>{if(!t.labels?.length)return null;const o=t.labels.filter(t=>!e.includes(this._getLabelName(t).toLowerCase()));return o.length>0?o:null})}_getCategoryCount(){return jt(this._getAutomations(),t=>t.category_id?[t.category_id]:null)}_getPaused(){return this.hass?Gt(this.hass):{}}_getPausedGroupedByResumeTime(){return this.hass?function(t){const e=Gt(t),o={};return Object.entries(e).forEach(([t,e])=>{const i=e.resume_at;o[i]||(o[i]={resumeAt:i,disableAt:e.disable_at,automations:[]}),o[i].automations.push({entity_id:t,friendly_name:e.friendly_name,resume_at:e.resume_at,paused_at:e.paused_at,days:e.days,hours:e.hours,minutes:e.minutes,disable_at:e.disable_at})}),Object.values(o).sort((t,e)=>new Date(t.resumeAt).getTime()-new Date(e.resumeAt).getTime())}(this.hass):[]}_getScheduled(){return this.hass?function(t){const e=t?.states?.[Bt];return e?.attributes?.scheduled_snoozes??{}}(this.hass):{}}_formatDateTime(t){return function(t,e){const o=new Date(t),i=new Date,r={weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return o.getFullYear()>i.getFullYear()&&(r.year="numeric"),o.toLocaleString(e,r)}(t,this._getLocale())}_formatCountdown(t){return function(t){const e=new Date(t).getTime()-Date.now();if(e<=0)return"Resuming...";const o=Math.floor(e/ft),i=Math.floor(e%ft/bt),r=Math.floor(e%bt/gt),s=Math.floor(e%gt/mt);return o>0?`${o}d ${i}h ${r}m`:i>0?`${i}h ${r}m ${s}s`:`${r}m ${s}s`}(t)}_getLocale(){return this.hass?.locale?.language}_toggleSelection(t){Ft("selection"),this._selected.includes(t)?this._selected=this._selected.filter(e=>e!==t):this._selected=[...this._selected,t]}_toggleGroupExpansion(t){this._expandedGroups={...this._expandedGroups,[t]:!this._expandedGroups[t]}}_selectGroup(t){const e=t.map(t=>t.id),o=e.every(t=>this._selected.includes(t));this._selected=o?this._selected.filter(t=>!e.includes(t)):[...new Set([...this._selected,...e])]}_selectAllVisible(){const t=this._getFilteredAutomations().map(t=>t.id),e=t.every(t=>this._selected.includes(t));this._selected=e?this._selected.filter(e=>!t.includes(e)):[...new Set([...this._selected,...t])]}_clearSelection(){this._selected=[]}_setDuration(t){this._duration=t*gt;const e=function(t){const e=Math.floor(t/xt),o=t%xt;return{days:e,hours:Math.floor(o/_t),minutes:o%_t}}(t);this._customDuration=e,this._customDurationInput=function(t,e,o){const i=[];return t>0&&i.push(`${t}d`),e>0&&i.push(`${e}h`),o>0&&i.push(`${o}m`),i.join(" ")||"0m"}(e.days,e.hours,e.minutes)}_updateCustomDuration(){const t=(e=this._customDuration).days*xt+e.hours*_t+e.minutes;var e;this._duration=t*gt}_handleDurationInput(t){this._customDurationInput=t;const e=Rt(t);e&&(this._customDuration=e,this._updateCustomDuration())}_getDurationPreview(){const t=Rt(this._customDurationInput);return t?Dt(t.days,t.hours,t.minutes):""}_isDurationValid(){return null!==Rt(this._customDurationInput)}_enterScheduleMode(){const{date:t,time:e}=function(){const t=new Date;return{date:`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`,time:`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}}();this._scheduleMode=!0,this._disableAtDate=t,this._disableAtTime=e,this._resumeAtDate=t,this._resumeAtTime=e}_hasResumeAt(){return Boolean(this._resumeAtDate&&this._resumeAtTime)}_hasDisableAt(){return Boolean(this._disableAtDate&&this._disableAtTime)}_parseDurationInput(t){return Rt(t)}_formatDuration(t,e,o){return Dt(t,e,o)}_combineDateTime(t,e){return Pt(t,e)}_getErrorMessage(t,e){return Mt(t,e)}_formatRegistryId(t){return Lt(t)}_handleKeyDown(t,e){"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),e())}_hapticFeedback(t="light"){Ft(t)}_handleSearchInput(t){const e=t.target.value;null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=e,this._searchTimeout=null},vt)}_showToast(t,e={}){const{showUndo:o=!1,onUndo:i=null}=e;if(!this.shadowRoot)return;const r=this.shadowRoot.querySelector(".toast");r&&r.remove();const s=document.createElement("div");if(s.className="toast",s.setAttribute("role","alert"),s.setAttribute("aria-live","polite"),s.setAttribute("aria-atomic","true"),o&&i){const e=document.createElement("span");e.textContent=t,s.appendChild(e);const o=document.createElement("button");o.className="toast-undo-btn",o.textContent="Undo",o.setAttribute("aria-label","Undo last action"),o.addEventListener("click",t=>{t.stopPropagation(),i(),s.remove()}),s.appendChild(o)}else s.textContent=t;this.shadowRoot.appendChild(s),null!==this._toastTimeout&&clearTimeout(this._toastTimeout),null!==this._toastFadeTimeout&&clearTimeout(this._toastFadeTimeout),this._toastTimeout=window.setTimeout(()=>{this._toastTimeout=null,this.shadowRoot&&s.parentNode&&(s.style.animation=`slideUp ${yt}ms ease-out reverse`,this._toastFadeTimeout=window.setTimeout(()=>{this._toastFadeTimeout=null,s.parentNode&&s.remove()},yt))},$t)}async _snooze(){if(0!==this._selected.length&&!this._loading){if(this._scheduleMode){if(!this._hasResumeAt())return void this._showToast("Please set a complete resume date and time");const t=this._hasDisableAt()?Pt(this._disableAtDate,this._disableAtTime):null,e=Pt(this._resumeAtDate,this._resumeAtTime);if(!e)return void this._showToast("Invalid resume date/time");const o=Date.now()+kt,i=new Date(e).getTime();if(i<=o)return void this._showToast("Resume time must be in the future");if(t){if(new Date(t).getTime()>=i)return void this._showToast("Snooze time must be before resume time")}}else if(0===this._duration)return;this._loading=!0;try{if(!this.hass)return void(this._loading=!1);const t=this._selected.length,e=[...this._selected],o=this._scheduleMode,i=this._hasDisableAt();let r;if(this._scheduleMode){const e=this._hasDisableAt()?Pt(this._disableAtDate,this._disableAtTime):null,o=Pt(this._resumeAtDate,this._resumeAtTime);if(!o)return void(this._loading=!1);if(await Ut(this.hass,{entity_id:this._selected,resume_at:o,...e&&{disable_at:e}}),!this.isConnected||!this.shadowRoot)return void(this._loading=!1);r=e?`Scheduled ${t} automation${1!==t?"s":""} to snooze`:`Snoozed ${t} automation${1!==t?"s":""} until ${this._formatDateTime(o)}`}else{const{days:e,hours:o,minutes:i}=this._customDuration;if(await Ut(this.hass,{entity_id:this._selected,days:e,hours:o,minutes:i}),!this.isConnected||!this.shadowRoot)return void(this._loading=!1);const s=Dt(e,o,i);r=`Snoozed ${t} automation${1!==t?"s":""} for ${s}`}this._hapticFeedback("success"),this._showToast(r,{showUndo:!0,onUndo:async()=>{try{if(!this.hass)return;for(const t of e)o&&i?await Nt(this.hass,t):await Ot(this.hass,t);this.isConnected&&(this._selected=e,this._showToast(`Restored ${t} automation${1!==t?"s":""}`))}catch(t){console.error("Undo failed:",t),this.isConnected&&this.shadowRoot&&this._showToast("Failed to undo. The automations may have already been modified.")}}}),this._selected=[],this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime=""}catch(t){console.error("Snooze failed:",t),this._hapticFeedback("error"),this.isConnected&&this.shadowRoot&&this._showToast(Mt(t,"Failed to snooze automations"))}this._loading=!1}}async _wake(t){if(this.hass)try{await Ot(this.hass,t),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast("Automation resumed successfully")}catch(t){console.error("Wake failed:",t),this._hapticFeedback("error"),this.isConnected&&this.shadowRoot&&this._showToast(Mt(t,"Failed to resume automation"))}}async _handleWakeAll(){if(this._wakeAllPending){if(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,!this.hass)return;try{await async function(t){try{await t.callService("autosnooze","cancel_all",{})}catch(t){throw console.error("[AutoSnooze] Failed to wake all automations:",t),t}}(this.hass),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast("All automations resumed successfully")}catch(t){console.error("Wake all failed:",t),this._hapticFeedback("error"),this.isConnected&&this.shadowRoot&&this._showToast("Failed to resume automations. Check Home Assistant logs for details.")}}else this._hapticFeedback("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},wt)}async _cancelScheduled(t){if(this.hass)try{await Nt(this.hass,t),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast("Scheduled snooze cancelled successfully")}catch(t){console.error("Cancel scheduled failed:",t),this._hapticFeedback("error"),this.isConnected&&this.shadowRoot&&this._showToast(Mt(t,"Failed to cancel scheduled snooze"))}}_renderDateOptions(){const t=function(t=365,e){const o=[],i=new Date,r=i.getFullYear();for(let s=0;s<t;s++){const t=new Date(i);t.setDate(t.getDate()+s);const a=t.getFullYear(),n=`${a}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`,l=t.toLocaleDateString(e,{weekday:"short"}),c=t.toLocaleDateString(e,{month:"short"}),d=t.getDate(),h=a!==r?`${l}, ${c} ${d}, ${a}`:`${l}, ${c} ${d}`;o.push({value:n,label:h})}return o}(365,this._getLocale());return t.map(t=>B`<option value="${t.value}">${t.label}</option>`)}_renderSelectionList(){const t=this._getFilteredAutomations();if("all"===this._filterTab)return 0===t.length?B`<div class="list-empty" role="status">No automations found</div>`:t.map(t=>B`
        <button
          type="button"
    ...
    `}}Wt.styles=pt,t([ht({attribute:!1})],Wt.prototype,"hass",void 0),t([ht({attribute:!1})],Wt.prototype,"config",void 0),t([ut()],Wt.prototype,"_selected",void 0),t([ut()],Wt.prototype,"_duration",void 0),t([ut()],Wt.prototype,"_customDuration",void 0),t([ut()],Wt.prototype,"_customDurationInput",void 0),t([ut()],Wt.prototype,"_loading",void 0),t([ut()],Wt.prototype,"_search",void 0),t([ut()],Wt.prototype,"_filterTab",void 0),t([ut()],Wt.prototype,"_expandedGroups",void 0),t([ut()],Wt.prototype,"_scheduleMode",void 0),t([ut()],Wt.prototype,"_disableAtDate",void 0),t([ut()],Wt.prototype,"_disableAtTime",void 0),t([ut()],Wt.prototype,"_resumeAtDate",void 0),t([ut()],Wt.prototype,"_resumeAtTime",void 0),t([ut()],Wt.prototype,"_labelRegistry",void 0),t([ut()],Wt.prototype,"_categoryRegistry",void 0),t([ut()],Wt.prototype,"_entityRegistry",void 0),t([ut()],Wt.prototype,"_showCustomInput",void 0),t([ut()],Wt.prototype,"_automationsCache",void 0),t([ut()],Wt.prototype,"_automationsCacheVersion",void 0),t([ut()],Wt.prototype,"_wakeAllPending",void 0);const Vt=a`
  .row {
    margin-bottom: 12px;
  }
  .row label {
...
`;class Yt extends nt{constructor(){super(...arguments),this._config={}}setConfig(t){this._config=t}_valueChanged(t,e){if(!this._config)return;const o={...this._config,[t]:e};""!==e&&null!=e||delete o[t],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0}))}render(){return this._config?B`
      <div class="row">
    ...
    `:B``}}Yt.styles=Vt,t([ht({attribute:!1})],Yt.prototype,"hass",void 0),t([ut()],Yt.prototype,"_config",void 0),customElements.get("autosnooze-card-editor")||customElements.define("autosnooze-card-editor",Yt),customElements.get("autosnooze-card")||customElements.define("autosnooze-card",Wt),window.customCards=window.customCards||[],window.customCards.some(t=>"autosnooze-card"===t.type)||window.customCards.push({type:"autosnooze-card",name:"AutoSnooze Card",description:"Temporarily pause automations with area and label filtering (v0.2.8)",preview:!0});export{Wt as AutomationPauseCard,Yt as AutomationPauseCardEditor};
