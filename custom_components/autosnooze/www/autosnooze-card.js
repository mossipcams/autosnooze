...
`,ve=1e3,xe=6e4,we=36e5,ze=864e5,$e=60,Ae=1440,ke=300,Se=300,Te=3e3,Ce=5e3,je=1e3,Ee=5e3,De=1e3,Me=3e4,Pe=[{label:"30m",minutes:30},{label:"1h",minutes:60},{label:"Custom",minutes:null}],Re=[30,60,120,240],Ie="autosnooze_exclude",Le="autosnooze_include";function Ne(e,t){const o=1e3-Date.now()%1e3;e.syncTimeout=globalThis.setTimeout(()=>{e.syncTimeout=null,t(),e.interval=globalThis.setInterval(()=>{t();Date.now()%1e3>50&&(Fe(e),Ne(e,t))},je)},o)}function Oe(e){const t={interval:null,syncTimeout:null};return Ne(t,e),t}function Fe(e){null!==e.interval&&(globalThis.clearInterval(e.interval),e.interval=null),null!==e.syncTimeout&&(globalThis.clearTimeout(e.syncTimeout),e.syncTimeout=null)}const Ue="autosnooze_last_duration";const He="autosnooze_recent_snoozes";function Be(){try{const e=localStorage.getItem(He);if(!e)return[];const t=JSON.parse(e);if(!Array.isArray(t))return[];const o=Date.now()-2592e6;return t.filter(e=>"string"==typeof e.id&&"number"==typeof e.timestamp&&e.timestamp>o)}catch{return[]}}const Ge="autosnooze_hide_snoozed";const qe="sensor.autosnooze_snoozed_automations",We={},Ve={},Ye=[];let Ke=null,Ze=null,Je=null,Xe=null,Qe=null,et=null;function tt(e){return!e||"object"!=typeof e||Array.isArray(e)?null:e}function ot(e){return tt(e)}function at(e){return tt(e)}function it(e){const t=tt(e?.attributes);return!!t&&(1===t.schema_version?null!==tt(t.paused)&&null!==tt(t.scheduled):"paused"in t||"scheduled"in t||"paused_automations"in t||"scheduled_snoozes"in t||"duration_presets"in t||"critical_terms"in t)}function st(e){const t=e?.states?.[qe];if(it(t))return t;const o=Object.values(e?.states??{}).filter(it);return o.find(e=>e.entity_id.startsWith(qe))??o[0]}function rt(e){if(0===Object.keys(e).length)return Ye;const t={};return Object.entries(e).forEach(([e,o])=>{const a=o.resume_at;t[a]||(t[a]={resumeAt:a,disableAt:o.disable_at,automations:[]}),t[a].automations.push({entity_id:e,friendly_name:o.friendly_name,resume_at:o.resume_at,paused_at:o.paused_at,days:o.days,hours:o.hours,minutes:o.minutes,disable_at:o.disable_at,notification_trigger:o.notification_trigger})}),Object.values(t).sort((e,t)=>new Date(e.resumeAt).getTime()-new Date(t.resumeAt).getTime())}function nt(e){const t=st(e),o=t?.attributes,a=t?.entity_id??null,i=tt(o),s=i?.schema_version,r=i?.paused??i?.paused_automations,n=i?.scheduled??i?.scheduled_snoozes;if(o===Ke&&s===Ze&&r===Je&&n===Xe&&a===Qe&&et)return et;const l=function(e){const t=tt(e);if(!t)return{paused:We,scheduled:Ve};const o=t.schema_version;if(1===o){const e=ot(t.paused),o=at(t.scheduled);return e&&o?{paused:e,scheduled:o}:{paused:We,scheduled:Ve}}if(void 0===o){const e=ot(t.paused)??ot(t.paused_automations)??{},o=at(t.scheduled)??at(t.scheduled_snoozes)??{};if(Object.keys(e).length>0||Object.keys(o).length>0)return{paused:e,scheduled:o}}const a=ot(t.paused_automations),i=at(t.scheduled_snoozes);return{paused:a??We,scheduled:i??Ve}}(o);return Ke=o,Ze=s,Je=r,Xe=n,Qe=a,et={paused:l.paused,scheduled:l.scheduled,groups:rt(l.paused)},et}function lt(){const e=globalThis.navigator,t=e?.userAgent??"",o=(e?.maxTouchPoints??0)>1;return/iPad/i.test(t)||"MacIntel"===e?.platform&&o?"tablet":/Android/i.test(t)?/Mobile/i.test(t)?"mobile":"tablet":/iPhone|iPod|Mobile/i.test(t)?"mobile":"web"}function dt(e,t){if(e.services?.autosnooze?.report_telemetry&&"function"==typeof e.callService&&function(e){const t=e.states?.["sensor.autosnooze_snoozed_automations"]?.attributes,o=t?.telemetry_enabled;return!1!==o}(e))try{const o={event:t.event,source:t.source??"card",platform:t.platform??lt()};"properties"in t&&void 0!==t.properties&&null!==t.properties&&(o.properties=t.properties),"card_type"in t&&void 0!==t.card_type&&null!==t.card_type&&(o.card_type=t.card_type);const a=e.callService("autosnooze","report_telemetry",o,void 0,!1);Promise.resolve(a).catch(()=>{})}catch{}}function ct(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`}function ut(e){return`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}function ht(e){return{adjustModalOpen:!0,adjustModalEntityId:e.entityId??"",adjustModalFriendlyName:e.friendlyName??"",adjustModalResumeAt:e.resumeAt,adjustModalEntityIds:e.entityIds??[],adjustModalFriendlyNames:e.friendlyNames??[]}}function pt(e){return Oe(e)}function mt(e){Fe(e)}function gt(){return function(){try{const e=localStorage.getItem(Ue);if(!e)return null;const t=JSON.parse(e);return"number"!=typeof t.minutes||"number"!=typeof t.duration?.days||"number"!=typeof t.duration?.hours||"number"!=typeof t.duration?.minutes||"number"!=typeof t.timestamp?null:Date.now()-t.timestamp>6048e5?(localStorage.removeItem(Ue),null):t}catch{return null}}()}function bt(){return Be().map(e=>e.id)}function _t(e){return nt(e)}function ft(e){return Boolean(st(e))}function yt(e){return st(e)}function vt(e,t){dt(e,{event:"card_viewed",card_type:t,source:"card"})}function xt(e,t){dt(e,{event:"wake_clicked",properties:{scope:t},source:"card"})}function wt(e,t){dt(e,{event:"adjust_opened",properties:{scope:t},source:"card"})}function zt(e,t,o,a){dt(e,{event:"notification_options_changed",properties:{trigger:t,enabled:o,notification_lead_minutes:a},source:"card"})}function $t(e){return e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function At(e,t,o="Unassigned"){return e?t.areas?.[e]?.name??$t(e):o}function kt(e,t){return t[e]?.name??$t(e)}function St(e,t,o="Uncategorized"){return e?t[e]?.name??$t(e):o}function Tt(e,t,o){return!(!e.labels||0===e.labels.length)&&e.labels.some(e=>{const a=o[e]?.name;return a?.toLowerCase()===t})}function Ct(e,t,o){const a={};return e.forEach(e=>{const i=t(e);if(!i||0===i.length)return a[o]||(a[o]=[]),void a[o].push(e.automation);i.forEach(t=>{a[t]||(a[t]=[]),a[t].push(e.automation)})}),Object.entries(a).sort((e,t)=>e[0]===o?1:t[0]===o?-1:e[0].localeCompare(t[0]))}function jt(e){const t=new Set([Ie.toLowerCase(),Le.toLowerCase()]),o=e.search.toLowerCase(),a=e.automations.map(o=>{const a=function(e,t,o){return e.labels?.length?e.labels.map(e=>kt(e,t)).filter(e=>!o.has(e.toLowerCase())):[]}(o,e.labelRegistry,t);return{automation:o,areaName:o.area_id?e.hass?At(o.area_id,e.hass,e.emptyAreaLabel):$t(o.area_id):e.emptyAreaLabel,categoryName:o.category_id?St(o.category_id,e.categoryRegistry,e.emptyCategoryLabel):e.emptyCategoryLabel,visibleLabelNames:a,hasIncludeLabel:Tt(o,Le,e.labelRegistry),hasExcludeLabel:Tt(o,Ie,e.labelRegistry)}}),i=a.some(e=>e.hasIncludeLabel),s=e.pausedEntityIds,r=Boolean(e.hideSnoozed),n=a.filter(e=>!!(i?e.hasIncludeLabel:!e.hasExcludeLabel)&&((!r||!s?.has(e.automation.id))&&(!o||(e.automation.name.toLowerCase().includes(o)||e.automation.id.toLowerCase().includes(o))))),l="areas"===e.filterTab?Ct(n,e=>e.automation.area_id?[e.areaName]:null,e.emptyAreaLabel):"categories"===e.filterTab?Ct(n,e=>e.automation.category_id?[e.categoryName]:null,e.emptyCategoryLabel):"labels"===e.filterTab?Ct(n,e=>e.visibleLabelNames.length>0?e.visibleLabelNames:null,e.emptyLabelLabel):[],d=new Set,c=new Set,u=new Set;return n.forEach(o=>{o.automation.area_id&&d.add(o.automation.area_id),o.automation.category_id&&u.add(o.automation.category_id),o.automation.labels?.length&&o.automation.labels.forEach(o=>{const a=kt(o,e.labelRegistry).toLowerCase();t.has(a)||c.add(o)})}),{filtered:n.map(e=>e.automation),grouped:l,areaCount:d.size,labelCount:c.size,categoryCount:u.size}}function Et(e,t){const o=new Date(e),a=new Date,i={weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return o.getFullYear()>a.getFullYear()&&(i.year="numeric"),o.toLocaleString(t,i)}function Dt(e,t="Resuming..."){const o=new Date(e).getTime()-Date.now();if(o<=0)return t;const a=Math.floor(o/ze),i=Math.floor(o%ze/we),s=Math.floor(o%we/xe),r=Math.floor(o%xe/ve);return a>0?`${a}d ${i}h ${s}m`:i>0?`${i}h ${s}m ${r}s`:`${s}m ${r}s`}function Mt(e,t,o){const a=[];return e>0&&a.push(`${e} day${1!==e?"s":""}`),t>0&&a.push(`${t} hour${1!==t?"s":""}`),o>0&&a.push(`${o} minute${1!==o?"s":""}`),a.join(", ")}function Pt(e,t,o){const a=[];return e>0&&a.push(`${e}d`),t>0&&a.push(`${t}h`),o>0&&a.push(`${o}m`),a.join(" ")||"0m"}function Rt(e){const t=e.toLowerCase().replace(/\s+/g,"");if(!t)return null;let o=0,a=!1;const i=t.match(/(\d+(?:\.\d+)?)\s*d/),s=t.match(/(\d+(?:\.\d+)?)\s*h/),r=t.match(/(\d+(?:\.\d+)?)\s*m(?!i)/);if(i?.[1]){const e=parseFloat(i[1]);if(isNaN(e)||e<0)return null;o+=e*Ae,a=!0}if(s?.[1]){const e=parseFloat(s[1]);if(isNaN(e)||e<0)return null;o+=e*$e,a=!0}if(r?.[1]){const e=parseFloat(r[1]);if(isNaN(e)||e<0)return null;o+=e,a=!0}if(!a){if(!/^\d+(?:\.\d+)?$/.test(t))return null;const e=parseFloat(t);if(isNaN(e)||!(e>0))return null;o=e}if(o=Math.round(o),o<=0)return null;const n=Math.floor(o/Ae),l=o%Ae;return{days:n,hours:Math.floor(l/$e),minutes:l%$e}}function It(e){return null!==Rt(e)}function Lt(e){return e.days*Ae+e.hours*$e+e.minutes}function Nt(e){const t=Math.floor(e/Ae),o=e%Ae;return{days:t,hours:Math.floor(o/$e),minutes:o%$e}}function Ot(e="light"){!function(e,t,o){const a=new CustomEvent(`hass-${t}`,{bubbles:!0,composed:!0,detail:o});e.dispatchEvent(a)}(window,"haptic",e)}const Ft=Symbol.for("autosnooze.customElements.define.patched"),Ut=Symbol.for("autosnooze.customElements.registeredCtors");function Ht(){return navigator.userAgent.toLowerCase().includes("jsdom")}function Bt(){if(!Ht())return;const e=customElements;if(e[Ft])return;const t=e.define.bind(e);e.define=(o,a,i)=>{const s=function(){const e=customElements;return e[Ut]??=new WeakSet,e[Ut]}();if(s.has(a)&&!e.get(o)){const e=class extends a{};return t(o,e,i),void s.add(e)}try{t(o,a,i),s.add(a)}catch(e){if(!function(e){return e instanceof Error&&e.message.includes("constructor has already been registered")}(e))throw e;const r=class extends a{};t(o,r,i),s.add(r)}},e[Ft]=!0}function Gt(e,t){Ht()&&Bt(),customElements.get(e)||customElements.define(e,t)}async function qt(e,t){try{await e.callService("autosnooze","cancel",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to wake automation:",e),e}}async function Wt(e,t){try{await e.callService("autosnooze","cancel_scheduled",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to cancel scheduled snooze:",e),e}}function Vt(e,t){if(!e||!t)return null;const o=new Date(`${e}T${t}`);if(Number.isNaN(o.getTime()))return null;const a=`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`,i=`${String(o.getHours()).padStart(2,"0")}:${String(o.getMinutes()).padStart(2,"0")}`;if(a!==e||i!==t)return null;const s=o.getTimezoneOffset(),r=s<=0?"+":"-",n=Math.abs(s);return`${e}T${t}${`${r}${String(Math.floor(n/60)).padStart(2,"0")}:${String(n%60).padStart(2,"0")}`}`}function Yt(e,t){const o=new Date(e.getFullYear(),e.getMonth(),e.getDate()+1,t,0);return{date:`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`,time:`${String(t).padStart(2,"0")}:00`}}function Kt(e,t,o){return t&&"none"!==t?"about_to_end"===t?void 0===o?{...e,notification_trigger:t}:{...e,notification_trigger:t,notification_lead_minutes:o}:{...e,notification_trigger:t}:e}const Zt="autosnooze_confirm",Jt=["alarm","security","siren","lock","smoke","carbon monoxide","co2","leak","flood","fire","gas"];function Xt(e){if(!e)return null;const t=new Date(e).getTime();return Number.isFinite(t)?t:null}function Qt(e,t){return _e(e.hass,"Resume time is required"===t?e.resumeAtDate||e.resumeAtTime?"toast.error.invalid_datetime":"toast.error.resume_time_required":"Resume time must be in the future"===t?"toast.error.resume_time_past":"toast.error.snooze_before_resume")}function eo(e,t){return t.some(t=>{const o=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(?<![a-z0-9])${o}(?![a-z0-9])`,"i").test(e)})}function to(e){const t=st(e)?.attributes?.critical_terms;return Array.isArray(t)&&t.length>0&&t.every(e=>"string"==typeof e)?t:Jt}function oo(e){const t=new Set(e.selected),o=e.criticalTerms??Jt;return e.automations.some(a=>{return!!t.has(a.id)&&(i=a.labels,s=e.labelRegistry,i.some(e=>e===Zt||s[e]?.name===Zt)||eo(a.id,o)||eo(a.name,o));var i,s})}async function ao(e){const t=function(e){if(e.untilTomorrow&&!e.scheduleMode){const t=Yt(new Date,8);return{...e,scheduleMode:!0,resumeAtDate:t.date,resumeAtTime:t.time,disableAtDate:"",disableAtTime:""}}return e}(e);if(t.scheduleMode){const e=function(e){const t=Xt(Vt(e.resumeAtDate,e.resumeAtTime));if(null===t)return{status:"error",message:"Resume time is required"};if(t<=e.nowMs)return{status:"error",message:"Resume time must be in the future"};const o=e.disableAtDate&&e.disableAtTime?Vt(e.disableAtDate,e.disableAtTime):null,a=Xt(o);return e.disableAtDate&&e.disableAtTime&&null===o||null!==a&&a>=t?{status:"error",message:"Snooze time must be before resume time"}:{status:"valid"}}({...t,nowMs:t.nowMs??0});if("error"===e.status)return{status:"validation_error",toastMessage:Qt(t,e.message)}}if(!t.forceConfirm&&t.automations&&oo({selected:t.selected,automations:t.automations,labelRegistry:t.labelRegistry??{},criticalTerms:to(t.hass)}))return{status:"confirm_required"};const o=t.scheduleMode?function(e){const t=e.disableAtDate&&e.disableAtTime?Vt(e.disableAtDate,e.disableAtTime):null,o=Vt(e.resumeAtDate,e.resumeAtTime);if(!o)return null;const a=Kt({entity_id:e.selected,resume_at:o,...t&&{disable_at:t},...e.forceConfirm&&{confirm:!0}},e.notificationTrigger,e.notificationLeadMinutes),i=e.selected.length;return{request:a,toastMessage:t?1===i?_e(e.hass,"toast.success.scheduled_one"):_e(e.hass,"toast.success.scheduled_many",{count:i}):1===i?_e(e.hass,"toast.success.snoozed_until_one",{time:Et(o,e.hass.locale?.language)}):_e(e.hass,"toast.success.snoozed_until_many",{count:i,time:Et(o,e.hass.locale?.language)})}}(t):function(e){const{days:t,hours:o,minutes:a}=e.customDuration,i={minutes:Lt(e.customDuration),duration:e.customDuration,timestamp:Date.now()};return{request:Kt({entity_id:e.selected,days:t,hours:o,minutes:a,...e.forceConfirm&&{confirm:!0}},e.notificationTrigger,e.notificationLeadMinutes),toastMessage:1===e.selected.length?_e(e.hass,"toast.success.snoozed_for_one",{duration:Mt(t,o,a)}):_e(e.hass,"toast.success.snoozed_for_many",{count:e.selected.length,duration:Mt(t,o,a)}),lastDuration:i}}(t);if(!o)return{status:"aborted"};try{await async function(e,t){try{await e.callService("autosnooze","pause",t)}catch(e){throw console.error("[AutoSnooze] Failed to pause automations:",e),e}}(t.hass,o.request)}catch(e){if("confirm_required"===function(e){const t=e;return t?.translation_key??t?.data?.translation_key}(e))return{status:"confirm_required"};throw e}return function(e){try{const t=Date.now(),o=Be(),a=e.map(e=>({id:e,timestamp:t})),i=new Set(e),s=[...a,...o.filter(e=>!i.has(e.id))].slice(0,10);localStorage.setItem(He,JSON.stringify(s))}catch{}}(t.selected),function(e){return"lastDuration"in e}(o)?(function(e,t){try{const o={minutes:t,duration:e,timestamp:Date.now()};localStorage.setItem(Ue,JSON.stringify(o))}catch{}}(o.lastDuration.duration,o.lastDuration.minutes),{status:"submitted",toastMessage:o.toastMessage,lastDuration:o.lastDuration}):{status:"submitted",toastMessage:o.toastMessage}}async function io(e){await async function(e){try{await e.callService("autosnooze","cancel_all",{})}catch(e){throw console.error("[AutoSnooze] Failed to wake all automations:",e),e}}(e)}async function so(e,t){await async function(e,t){try{await e.callService("autosnooze","clear_notification",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to clear snooze notification:",e),e}}(e,t)}async function ro(e,t,o){const{entityId:a,entityIds:i,...s}=t,r=i||a||"";await async function(e,t,o){try{await e.callService("autosnooze","adjust",{entity_id:t,...o})}catch(e){throw console.error("[AutoSnooze] Failed to adjust snooze:",e),e}}(e,r,s);const n=24*(s.days||0)*60*60*1e3+60*(s.hours||0)*60*1e3+60*(s.minutes||0)*1e3;return{nextResumeAt:new Date(new Date(o).getTime()+n).toISOString()}}const no={loadLabels:async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/label_registry/list"}),o={};return Array.isArray(t)&&t.forEach(e=>{o[e.label_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch label registry:",e),null}},loadCategories:async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/category_registry/list",scope:"automation"}),o={};return Array.isArray(t)&&t.forEach(e=>{o[e.category_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch category registry:",e),{}}},loadEntities:async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/entity_registry/list"}),o={};return Array.isArray(t)&&t.filter(e=>e.entity_id.startsWith("automation.")).forEach(e=>{o[e.entity_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch entity registry:",e),{}}},getAutomations:function(e,t){return e.states?Object.keys(e.states).filter(e=>e.startsWith("automation.")).map(o=>{const a=e.states[o];if(!a)return null;const i=t[o],s=e.entities?.[o];return{id:o,name:a.attributes?.friendly_name??o.replace("automation.",""),area_id:i?.area_id??s?.area_id??null,category_id:i?.categories?.automation??null,labels:i?.labels??s?.labels??[]}}).filter(e=>null!==e).sort((e,t)=>e.name.localeCompare(t.name)):[]},setTimeout:setTimeout,clearTimeout:clearTimeout};class lo{constructor(e,t={}){this.changed=e,this.labels={},this.labelsUnavailable=!1,this.categories={},this.entities={},this.cacheVersion=0,this.connected=!1,this.labelsLoaded=!1,this.categoriesLoaded=!1,this.entitiesLoaded=!1,this.retryDelay=De,this.cachedVersion=-1,this.deps={...no,...t}}get snapshot(){return{labels:this.labels,labelsUnavailable:this.labelsUnavailable,categories:this.categories,entities:this.entities,cacheVersion:this.cacheVersion}}connect(e){return this.connected=!0,this.hass=e,e.connection?Promise.all([this.loadLabels(),this.loadCategories(),this.loadEntities()]).then(()=>{}):Promise.resolve()}disconnect(){this.connected=!1,void 0!==this.retryTimer&&this.deps.clearTimeout(this.retryTimer),this.retryTimer=void 0}getAutomations(e){return this.cachedStates===e.states&&this.cachedVersion===this.cacheVersion&&this.automations||(this.automations=this.deps.getAutomations(e,this.entities),this.cachedStates=e.states,this.cachedVersion=this.cacheVersion),this.automations}shouldUpdate(e,t){if(!e||!t)return!0;if(st(e)!==st(t)||e.entities!==t.entities||e.areas!==t.areas||(e.language??e.locale?.language)!==(t.language??t.locale?.language))return!0;if(!e.states||!t.states)return!0;if(e.states===t.states)return!1;const o=Object.entries(e.states).filter(([e])=>e.startsWith("automation.")),a=Object.keys(t.states).filter(e=>e.startsWith("automation.")).length;return o.length!==a||o.some(([e,o])=>t.states[e]!==o)}loadLabels(e){return e&&(this.hass=e),this.labelsLoaded||void 0!==this.retryTimer?Promise.resolve():this.labelsPromise??=this.deps.loadLabels(this.hass).then(e=>{if(null===e)return this.labelsUnavailable=!0,void 0===this.retryTimer&&(this.retryTimer=this.deps.setTimeout(()=>{this.finishRetry(),this.loadLabels()},this.retryDelay),this.retryDelay=Math.min(2*this.retryDelay,Me)),void this.changed();this.labels=e,this.labelsLoaded=!0,this.labelsUnavailable=!1,this.retryDelay=De,this.finishRetry(),this.invalidate()}).finally(()=>{this.labelsPromise=void 0})}loadCategories(e){return e&&(this.hass=e),this.categoriesLoaded?Promise.resolve():this.categoriesPromise??=this.deps.loadCategories(this.hass).then(e=>{this.categories=e,this.categoriesLoaded=!0,this.changed()}).finally(()=>{this.categoriesPromise=void 0})}loadEntities(e){return e&&(this.hass=e),this.entitiesLoaded?Promise.resolve():this.entitiesPromise??=this.deps.loadEntities(this.hass).then(e=>{this.entities=e,this.entitiesLoaded=!0,this.invalidate()}).finally(()=>{this.entitiesPromise=void 0})}finishRetry(){void 0!==this.retryTimer&&this.deps.clearTimeout(this.retryTimer),this.retryTimer=void 0}invalidate(){this.cacheVersion++,this.connected&&this.changed()}}class co extends HTMLElement{show(e,t,o=t,a){this.clear();const i=document.createElement("div");if(i.className="toast",i.setAttribute("role","alert"),i.setAttribute("aria-live","polite"),i.setAttribute("aria-atomic","true"),a){const s=document.createElement("span");s.textContent=e,i.appendChild(s);const r=document.createElement("button");r.className="toast-undo-btn",r.textContent=t,r.setAttribute("aria-label",o),r.onclick=e=>{e.stopPropagation(),a(),this.clear()},i.appendChild(r)}else i.textContent=e;this.appendChild(i),this.durationTimer=setTimeout(()=>{i.style.animation=`slideUp ${Se}ms ease-out reverse`,this.fadeTimer=setTimeout(()=>this.clear(),Se),this.durationTimer=void 0},Ce)}disconnectedCallback(){this.clear()}clear(){void 0!==this.durationTimer&&clearTimeout(this.durationTimer),void 0!==this.fadeTimer&&clearTimeout(this.fadeTimer),this.durationTimer=this.fadeTimer=void 0,this.replaceChildren()}}Gt("autosnooze-toast",co);class uo extends ne{constructor(){super(...arguments),this.scheduled={}}createRenderRoot(){return this}render(){const e=Object.entries(this.scheduled);return e.length?B`
    ...
    `:B``}format(e){return Et(e,this.hass?.locale?.language)}cancel(e){this.dispatchEvent(new CustomEvent("cancel-scheduled",{detail:{entityId:e},bubbles:!0,composed:!0}))}}e([ue({attribute:!1})],uo.prototype,"hass",void 0),e([ue({attribute:!1})],uo.prototype,"scheduled",void 0),Gt("autosnooze-scheduled-pauses",uo);class ho extends ne{constructor(){super(...arguments),this.config={},this._shell=new lo(()=>this.requestUpdate()),this._selected=[],this._duration=30*xe,this._customDuration={days:0,hours:0,minutes:30},this._customDurationInput="30m",this._loading=!1,this._scheduleMode=!1,this._notificationsEnabled=!1,this._notificationTrigger="end",this._notificationLeadMinutes=60,this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime="",this._showCustomInput=!1,this._untilTomorrow=!1,this._lastDuration=null,this._recentSnoozeIds=[],this._adjustModalOpen=!1,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt="",this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[],this._guardrailConfirmOpen=!1,this._hideSnoozed=!1,this._pausedEntityIdsCache=[]}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-card",title:"AutoSnooze"}}setConfig(e){this.config=e}getCardSize(){const e=this._getPausedSnapshot(),t=e.paused,o=e.scheduled;return 4+Object.keys(t).length+Object.keys(o).length}shouldUpdate(e){return!e.has("hass")||this._shell.shouldUpdate(e.get("hass"),this.hass)}willUpdate(e){super.willUpdate(e),e.has("hass")&&(this._syncAdjustModalWithPausedState(),this._syncPausedEntityIdsCache())}updated(e){super.updated(e),e.has("hass")&&this.hass&&this._shell.connect(this.hass)}_syncPausedEntityIdsCache(){const e=Object.keys(this._getPausedSnapshot().paused),t=this._pausedEntityIdsCache;t.length===e.length&&e.every(e=>t.includes(e))||(this._pausedEntityIdsCache=e)}_syncAdjustModalWithPausedState(){const e=function(e,t){if(!t.open)return{action:"none"};if(t.entityIds.length>0){if(!t.entityIds.some(t=>e[t]))return{action:"close"};const o=t.entityIds.find(t=>e[t]);if(o){const a=e[o];if(a?.resume_at&&a.resume_at!==t.resumeAt)return{action:"update",resumeAt:a.resume_at}}return{action:"none"}}if(t.entityId){const o=e[t.entityId];if(o?.resume_at&&o.resume_at!==t.resumeAt)return{action:"update",resumeAt:o.resume_at};if(!o)return{action:"close"}}return{action:"none"}}(this._getPaused(),{open:this._adjustModalOpen,entityId:this._adjustModalEntityId,entityIds:this._adjustModalEntityIds,resumeAt:this._adjustModalResumeAt});"close"===e.action?this._handleCloseModalEvent():"update"===e.action&&(this._adjustModalResumeAt=e.resumeAt)}connectedCallback(){super.connectedCallback(),this.hass&&(vt(this.hass,"full"),this._shell.connect(this.hass)),this._lastDuration=gt(),this._hideSnoozed=function(){try{const e=localStorage.getItem(Ge);return null!==e&&!0===JSON.parse(e)}catch{return!1}}(),this._refreshRecentSnoozeIds()}disconnectedCallback(){super.disconnectedCallback(),this._shell.disconnect()}_refreshRecentSnoozeIds(){this._recentSnoozeIds=bt()}_getAutomations(){return this.hass?this._shell.getAutomations(this.hass):[]}_getPaused(){return this._getPausedSnapshot().paused}_getPausedGroupedByResumeTime(){return this._getPausedSnapshot().groups}_getScheduled(){return this._getPausedSnapshot().scheduled}_getPausedSnapshot(){return this.hass?_t(this.hass):{paused:{},scheduled:{},groups:[]}}_isSnoozeSensorAvailable(){return ft(this.hass)}_formatDateTime(e){return Et(e,this._getLocale())}_getLocale(){return this.hass?.locale?.language}_hasResumeAt(){return Boolean(this._resumeAtDate&&this._resumeAtTime)}_hasDisableAt(){return Boolean(this._disableAtDate&&this._disableAtTime)}_hapticFeedback(e="light"){Ot(e)}_showToast(e,t={}){this.shadowRoot?.querySelector("autosnooze-toast")?.show(e,_e(this.hass,"button.undo"),_e(this.hass,"a11y.undo_action"),t.showUndo?t.onUndo??void 0:void 0)}async _snooze(e=!1){if(0!==this._selected.length&&!this._loading&&(this._scheduleMode||this._untilTomorrow||0!==this._duration)){this._loading=!0,this._guardrailConfirmOpen=!1;try{if(!this.hass)return void(this._loading=!1);t=this.hass,o=this._selected.length,a=this._scheduleMode,i=this._untilTomorrow,dt(t,{event:"snooze_button_clicked",properties:{target_count:o,schedule_mode:a,until_tomorrow:i},source:"card"});const s=this._selected.length,r=[...this._selected],n=this._scheduleMode||this._untilTomorrow&&!this._scheduleMode,l=!(this._untilTomorrow&&!this._scheduleMode)&&this._hasDisableAt(),d=await ao({hass:this.hass,selected:this._selected,scheduleMode:this._scheduleMode,customDuration:this._customDuration,disableAtDate:this._disableAtDate,disableAtTime:this._disableAtTime,resumeAtDate:this._resumeAtDate,resumeAtTime:this._resumeAtTime,untilTomorrow:this._untilTomorrow,forceConfirm:e,automations:this._getAutomations(),labelRegistry:this._shell.labels,nowMs:Date.now()+Ee,...this._notificationsEnabled&&{notificationTrigger:this._notificationTrigger,..."about_to_end"===this._notificationTrigger&&{notificationLeadMinutes:this._notificationLeadMinutes}}});if("confirm_required"===d.status)return this._guardrailConfirmOpen=!0,void(this._loading=!1);if("validation_error"===d.status)return this._showToast(d.toastMessage),void(this._loading=!1);if("aborted"===d.status)return void(this._loading=!1);if(d.lastDuration&&(this._lastDuration=d.lastDuration),this._refreshRecentSnoozeIds(),!this.isConnected||!this.shadowRoot)return void(this._loading=!1);this._hapticFeedback("success"),this._showToast(d.toastMessage,{showUndo:!0,onUndo:async()=>{try{if(!this.hass)return;const e=await async function(e,t,o){const a=o.wasScheduleMode&&o.hadDisableAt?t=>Wt(e,t):t=>qt(e,t),i=await Promise.allSettled(t.map(e=>a(e))),s=[],r=[];return i.forEach((e,o)=>{const a=t[o];a&&("fulfilled"===e.status?s.push(a):r.push(a))}),{succeeded:s,failed:r}}(this.hass,r,{wasScheduleMode:n,hadDisableAt:l});if(this.isConnected)if(0===e.failed.length){this._setSelected(r);const e=1===s?_e(this.hass,"toast.success.restored_one"):_e(this.hass,"toast.success.restored_many",{count:s});this._showToast(e)}else this._setSelected(e.failed),this._showToast(_e(this.hass,"toast.error.undo_failed"))}catch(e){console.error("Undo failed:",e),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.error.undo_failed"))}}}),this._setSelected([]),this._notificationsEnabled=!1,this._notificationTrigger="end",this._notificationLeadMinutes=60,this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime="",this._untilTomorrow=!1}catch(e){console.error("Snooze failed:",e),this._hapticFeedback("failure")}var t,o,a,i;this._loading=!1}}async _wake(e){if(this.hass)try{await async function(e,t){await qt(e,t)}(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.resumed"))}catch(e){console.error("Wake failed:",e),this._hapticFeedback("failure")}}async _handleWakeEvent(e){this.hass&&xt(this.hass,"one"),await this._wake(e.detail.entityId)}async _handleWakeAllEvent(){if(this.hass){xt(this.hass,"all");try{await io(this.hass),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.resumed_all"))}catch(e){console.error("Wake all failed:",e),this._hapticFeedback("failure")}}}async _handleClearNotificationEvent(e){if(this.hass)try{await so(this.hass,e.detail.entityId),this._hapticFeedback("success")}catch(e){console.error("Clear notification failed:",e),this._hapticFeedback("failure")}}_handleAdjustAutomationEvent(e){this.hass&&wt(this.hass,"one");const t=ht({entityId:e.detail.entityId,friendlyName:e.detail.friendlyName,resumeAt:e.detail.resumeAt});this._adjustModalOpen=t.adjustModalOpen,this._adjustModalEntityId=t.adjustModalEntityId,this._adjustModalFriendlyName=t.adjustModalFriendlyName,this._adjustModalResumeAt=t.adjustModalResumeAt,this._adjustModalEntityIds=t.adjustModalEntityIds,this._adjustModalFriendlyNames=t.adjustModalFriendlyNames}_handleAdjustGroupEvent(e){this.hass&&wt(this.hass,"group");const t=ht({entityIds:e.detail.entityIds,friendlyNames:e.detail.friendlyNames,resumeAt:e.detail.resumeAt});this._adjustModalOpen=t.adjustModalOpen,this._adjustModalEntityIds=t.adjustModalEntityIds,this._adjustModalFriendlyNames=t.adjustModalFriendlyNames,this._adjustModalEntityId=t.adjustModalEntityId,this._adjustModalFriendlyName=t.adjustModalFriendlyName,this._adjustModalResumeAt=t.adjustModalResumeAt}async _handleAdjustTimeEvent(e){if(!this.hass)return;const t=1440*(e.detail.days??0)+60*(e.detail.hours??0)+(e.detail.minutes??0);0!==t&&function(e,t,o){dt(e,{event:"adjust_option_selected",properties:{direction:t,delta_minutes:o},source:"card"})}(this.hass,t>0?"extend":"shorten",Math.abs(t));try{const t=await ro(this.hass,e.detail,this._adjustModalResumeAt);this._hapticFeedback("success"),this._adjustModalResumeAt=t.nextResumeAt,this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.adjusted"))}catch(e){console.error("Adjust failed:",e),this._hapticFeedback("failure")}}_handleCloseModalEvent(){const e={adjustModalOpen:!1,adjustModalEntityId:"",adjustModalFriendlyName:"",adjustModalResumeAt:"",adjustModalEntityIds:[],adjustModalFriendlyNames:[]};this._adjustModalOpen=e.adjustModalOpen,this._adjustModalEntityId=e.adjustModalEntityId,this._adjustModalFriendlyName=e.adjustModalFriendlyName,this._adjustModalResumeAt=e.adjustModalResumeAt,this._adjustModalEntityIds=e.adjustModalEntityIds,this._adjustModalFriendlyNames=e.adjustModalFriendlyNames}async _cancelScheduled(e){if(this.hass){dt(this.hass,{event:"scheduled_cancel_clicked",properties:{target_count:1},source:"card"});try{await async function(e,t){await Wt(e,t)}(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(_e(this.hass,"toast.success.cancelled"))}catch(e){console.error("Cancel scheduled failed:",e),this._hapticFeedback("failure")}}}_setSelected(e){this._selected=[...e]}_setDurationState(e,t){this._customDuration={...e},this._customDurationInput=t,this._duration=Lt(e)*xe}_handleDurationChange(e){const{duration:t,input:o,showCustomInput:a}=e.detail;this._untilTomorrow=!1,this._setDurationState(t,o),void 0!==a&&(this._showCustomInput=a)}_handleScheduleModeChange(e){var t,o;this.hass&&(t=this.hass,o=e.detail.enabled,dt(t,{event:"schedule_mode_toggled",properties:{enabled:o},source:"card"})),e.detail.enabled&&(this._untilTomorrow=!1);const a=function(e){if(!e.enabled)return{scheduleMode:!1,disableAtDate:"",disableAtTime:"",resumeAtDate:"",resumeAtTime:""};const t=new Date(e.now.getTime()+60*e.resumeMinutes*1e3);return{scheduleMode:!0,disableAtDate:ct(e.now),disableAtTime:ut(e.now),resumeAtDate:ct(t),resumeAtTime:ut(t)}}({enabled:e.detail.enabled,now:new Date,resumeMinutes:this._lastDuration?.minutes??30});this._scheduleMode=a.scheduleMode,e.detail.enabled&&(this._disableAtDate=a.disableAtDate,this._disableAtTime=a.disableAtTime,this._resumeAtDate=a.resumeAtDate,this._resumeAtTime=a.resumeAtTime)}_handleScheduleFieldChange(e){const{field:t,value:o}=e.detail;switch(t){case"disableAtDate":this._disableAtDate=o;break;case"disableAtTime":this._disableAtTime=o;break;case"resumeAtDate":this._resumeAtDate=o;break;case"resumeAtTime":this._resumeAtTime=o}}_handleCustomInputToggle(e){var t,o;this.hass&&(t=this.hass,o=e.detail.show,dt(t,{event:"custom_duration_toggled",properties:{enabled:o},source:"card"})),this._showCustomInput=e.detail.show,e.detail.show&&(this._untilTomorrow=!1)}_handleUntilTomorrowSelect(){this.hass&&dt(this.hass,{event:"until_tomorrow_selected",source:"card"}),this._untilTomorrow=!0,this._showCustomInput=!1}_handleNotificationsToggle(e){this._notificationsEnabled=e.target.checked,this.hass&&zt(this.hass,this._notificationsEnabled?this._notificationTrigger:"none",this._notificationsEnabled,this._notificationLeadMinutes)}_handleNotificationWhenChange(e){this._notificationTrigger=e.target.value,this.hass&&zt(this.hass,this._notificationTrigger,this._notificationsEnabled,this._notificationLeadMinutes)}_handleNotificationLeadChange(e){this._notificationLeadMinutes=Number(e.target.value),this.hass&&zt(this.hass,this._notificationTrigger,this._notificationsEnabled,this._notificationLeadMinutes)}_formatLeadLabel(e){const{days:t,hours:o,minutes:a}=Nt(e);return Mt(t,o,a)}_handleSelectionChange(e){this._setSelected(e.detail.selected)}_toggleHideSnoozed(){var e,t;this._hideSnoozed=!this._hideSnoozed,function(e){try{localStorage.setItem(Ge,JSON.stringify(e))}catch{}}(this._hideSnoozed),this.hass&&(e=this.hass,t=this._hideSnoozed,dt(e,{event:"hide_snoozed_toggled",properties:{enabled:t},source:"card"}))}_handleGuardrailCancel(){var e,t;this._guardrailConfirmOpen=!1,this.hass&&(e=this.hass,t=this._selected.length,dt(e,{event:"confirmation_dismissed",properties:{target_count:t},source:"card"}))}async _handleGuardrailContinue(){var e,t;this._guardrailConfirmOpen=!1,this.hass&&(e=this.hass,t=this._selected.length,dt(e,{event:"confirmation_result",properties:{target_count:t},source:"card"})),await this._snooze(!0)}render(){if(!this.hass||!this.config)return B``;const e=this._getPausedSnapshot(),t=e.paused,o=Object.keys(t).length,a=e.scheduled,i=Object.keys(a).length,s=this._getAutomations(),r=this._isSnoozeSensorAvailable();return B`
      <ha-card>
        <div class="header">
        ...
        <div class="snooze-setup">
              ...
              <div class="notify-detail">
                ...
                ${"about_to_end"===this._notificationTrigger?B`
                  <label class="notify-field">
                    ...
                    >
                      ${Re.map(e=>B`<option value=${String(e)}>${this._formatLeadLabel(e)}</option>`)}
                    </select>
                  </label>
                `:""}
              </div>
          ...
          <button
            type="button"
            class="snooze-btn"
            ?disabled=${0===this._selected.length||!this._scheduleMode&&!this._untilTomorrow&&!It(this._customDurationInput)||this._scheduleMode&&!this._hasResumeAt()||this._loading}
            @click=${()=>this._snooze()}
    ...
    `}}ho.styles=[ye,fe],e([ue({attribute:!1})],ho.prototype,"hass",void 0),e([ue({attribute:!1})],ho.prototype,"config",void 0),e([he()],ho.prototype,"_selected",void 0),e([he()],ho.prototype,"_duration",void 0),e([he()],ho.prototype,"_customDuration",void 0),e([he()],ho.prototype,"_customDurationInput",void 0),e([he()],ho.prototype,"_loading",void 0),e([he()],ho.prototype,"_scheduleMode",void 0),e([he()],ho.prototype,"_notificationsEnabled",void 0),e([he()],ho.prototype,"_notificationTrigger",void 0),e([he()],ho.prototype,"_notificationLeadMinutes",void 0),e([he()],ho.prototype,"_disableAtDate",void 0),e([he()],ho.prototype,"_disableAtTime",void 0),e([he()],ho.prototype,"_resumeAtDate",void 0),e([he()],ho.prototype,"_resumeAtTime",void 0),e([he()],ho.prototype,"_showCustomInput",void 0),e([he()],ho.prototype,"_untilTomorrow",void 0),e([he()],ho.prototype,"_lastDuration",void 0),e([he()],ho.prototype,"_recentSnoozeIds",void 0),e([he()],ho.prototype,"_adjustModalOpen",void 0),e([he()],ho.prototype,"_adjustModalEntityId",void 0),e([he()],ho.prototype,"_adjustModalFriendlyName",void 0),e([he()],ho.prototype,"_adjustModalResumeAt",void 0),e([he()],ho.prototype,"_adjustModalEntityIds",void 0),e([he()],ho.prototype,"_adjustModalFriendlyNames",void 0),e([he()],ho.prototype,"_guardrailConfirmOpen",void 0),e([he()],ho.prototype,"_hideSnoozed",void 0),Gt("autosnooze-card",ho);class po extends ne{constructor(){super(...arguments),this.config={}}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-snoozed-card",title:"Snoozed Automations"}}setConfig(e){this.config=e}connectedCallback(){super.connectedCallback(),this.hass&&vt(this.hass,"snoozed_only")}getCardSize(){const e=this.hass?_t(this.hass):null;return 1+(e?Object.keys(e.paused).length:0)}shouldUpdate(e){const t=e.get("hass");if(!t||!this.hass)return!0;const o=yt(t)!==yt(this.hass),a=(t.language??t.locale?.language)!==(this.hass.language??this.hass.locale?.language);return o||a}render(){if(!this.hass||!this.config)return B``;const e=_t(this.hass),t=Object.keys(e.paused).length;return B`
      <ha-card>
        <div class="header">
    ...
    `}}po.styles=[ye,fe],e([ue({attribute:!1})],po.prototype,"hass",void 0),e([ue({attribute:!1})],po.prototype,"config",void 0),Gt("autosnooze-snoozed-card",po);const mo=r`
  .row {
    margin-bottom: 12px;
  }
  .row label {
...
`;class go extends ne{constructor(){super(...arguments),this._config={}}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config)return;const o={...this._config,[e]:t};""!==t&&null!=t||delete o[e],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0}))}render(){return this._config?B`
      <div class="row">
    ...
    `:B``}}go.styles=mo,e([ue({attribute:!1})],go.prototype,"hass",void 0),e([he()],go.prototype,"_config",void 0),Gt("autosnooze-card-editor",go);const bo=r`
    :host {
      display: block;
    }
    .snooze-list {
...
`;class _o extends ne{constructor(){super(...arguments),this.pauseGroups=[],this.pausedCount=0,this.readonly=!1,this._wakeAllPending=!1,this._wakeAllTimeout=null,this._countdownState={interval:null,syncTimeout:null}}connectedCallback(){super.connectedCallback(),this._syncCountdownLifecycle()}updated(e){e.has("pauseGroups")&&this._syncCountdownLifecycle()}disconnectedCallback(){super.disconnectedCallback(),mt(this._countdownState),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null)}_updateCountdownIfNeeded(){this.pauseGroups.length>0&&this.requestUpdate()}_hasLiveCountdowns(){return this.pauseGroups.some(e=>!e.disableAt)}_scheduleCountdownBootstrap(){this._countdownState={interval:null,syncTimeout:globalThis.setTimeout(()=>{this._countdownState.syncTimeout=null,this._hasLiveCountdowns()&&(this._countdownState=pt(()=>this._updateCountdownIfNeeded()))},0)}}_syncCountdownLifecycle(){mt(this._countdownState),0!==this.pauseGroups.length?this._hasLiveCountdowns()?this._countdownState=pt(()=>this._updateCountdownIfNeeded()):this._countdownState={interval:null,syncTimeout:null}:this._scheduleCountdownBootstrap()}_handleWakeAll(){this._wakeAllPending?(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,this._fireWakeAll()):(Ot("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},Te))}_fireWake(e){this.dispatchEvent(new CustomEvent("wake-automation",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireClearNotification(e){this.dispatchEvent(new CustomEvent("clear-notification",{detail:{entityId:e},bubbles:!0,composed:!0}))}_hasNotificationConfig(e){return void 0!==e.notification_trigger&&"none"!==e.notification_trigger}_fireAdjust(e){this.dispatchEvent(new CustomEvent("adjust-automation",{detail:{entityId:e.entity_id,friendlyName:e.friendly_name,resumeAt:e.resume_at},bubbles:!0,composed:!0}))}_fireAdjustGroup(e){this.dispatchEvent(new CustomEvent("adjust-group",{detail:{entityIds:e.automations.map(e=>e.entity_id),friendlyNames:e.automations.map(e=>e.friendly_name||e.entity_id),resumeAt:e.resumeAt},bubbles:!0,composed:!0}))}_fireWakeAll(){this.dispatchEvent(new CustomEvent("wake-all",{bubbles:!0,composed:!0}))}render(){if(0===this.pausedCount)return B``;const e=this.hass?.locale?.language;return B`
        ...
        ${this.pauseGroups.map(t=>B`
          <div class="pause-group" role="group">
            ${this.readonly?B`<div class="pause-group-header">
                  ...
                  ${t.disableAt?B`${_e(this.hass,"status.resumes")} ${Et(t.resumeAt,e)}`:B`<span class="countdown">${Dt(t.resumeAt,_e(this.hass,"status.resuming"))}</span>`}
    ...
    `}}_o.styles=[ye,bo],e([ue({attribute:!1})],_o.prototype,"hass",void 0),e([ue({attribute:!1})],_o.prototype,"pauseGroups",void 0),e([ue({type:Number})],_o.prototype,"pausedCount",void 0),e([ue({type:Boolean})],_o.prototype,"readonly",void 0),e([he()],_o.prototype,"_wakeAllPending",void 0),Gt("autosnooze-active-pauses",_o);const fo=r`
    :host {
      display: block;
    }
...
`;class yo extends ne{constructor(){super(...arguments),this.scheduleMode=!1,this.customDuration={days:0,hours:0,minutes:30},this.customDurationInput="30m",this.showCustomInput=!1,this.untilTomorrow=!1,this.lastDuration=null,this.disableAtDate="",this.disableAtTime="",this.resumeAtDate="",this.resumeAtTime=""}_getBasePresets(){const e=function(e){const t=st(e)?.attributes?.duration_presets;return t?.length?t:null}(this.hass);return e?.length?e.filter(e=>null!==e.minutes):Pe.filter(e=>null!==e.minutes)}_getDurationPills(){return[...this._getBasePresets(),{label:_e(this.hass,"duration.custom"),minutes:null}]}_getDurationPreview(){const e=Rt(this.customDurationInput);return e?Mt(e.days,e.hours,e.minutes):""}_isDurationValid(){return It(this.customDurationInput)}_renderDateOptions(){const e=function(e=365,t){const o=[],a=new Date,i=a.getFullYear();for(let s=0;s<e;s++){const e=new Date(a);e.setDate(e.getDate()+s);const r=e.getFullYear(),n=`${r}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=e.toLocaleDateString(t,{weekday:"short"}),d=e.toLocaleDateString(t,{month:"short"}),c=e.getDate(),u=r!==i?`${l}, ${d} ${c}, ${r}`:`${l}, ${d} ${c}`;o.push({value:n,label:u})}return o}(365,this.hass?.locale?.language);return e.map(e=>B`<option value="${e.value}">${e.label}</option>`)}_renderLastDurationBadge(){if(!this.lastDuration)return"";const e=this._getBasePresets(),t=this.lastDuration.minutes,o=!e.some(e=>e.minutes===t);if(!o)return"";const{days:a,hours:i,minutes:s}=this.lastDuration.duration,r=Pt(a,i,s).replace(/ /g,""),n=Lt(this.customDuration),l=!this.untilTomorrow&&!this.showCustomInput&&t===n;return B`
      <button
        type="button"
    ...
    `}_fireDurationChange(e,t){const o=Nt(e),a=Pt(o.days,o.hours,o.minutes);this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:e,duration:o,input:a,showCustomInput:t?.showCustomInput??!1},bubbles:!0,composed:!0}))}_fireCustomDurationChange(e){const t=Rt(e),o=t?Lt(t):0;this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:o,duration:t??{days:0,hours:0,minutes:0},input:e},bubbles:!0,composed:!0}))}_fireScheduleModeChange(e){this.dispatchEvent(new CustomEvent("schedule-mode-change",{detail:{enabled:e},bubbles:!0,composed:!0}))}_fireScheduleFieldChange(e,t){this.dispatchEvent(new CustomEvent("schedule-field-change",{detail:{field:e,value:t},bubbles:!0,composed:!0}))}_formatScheduleDateTime(e){const t=this.hass?.locale?.language;return new Date(e).toLocaleString(t,{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}_renderUntilTomorrowPreview(){const e=Yt(new Date,8),t=Vt(e.date,e.time);return t?`${_e(this.hass,"status.resumes")} ${this._formatScheduleDateTime(t)}`:""}_fireUntilTomorrowSelect(){this.dispatchEvent(new CustomEvent("until-tomorrow-select",{bubbles:!0,composed:!0}))}_renderScheduleSummary(){if(!this.resumeAtDate||!this.resumeAtTime)return"";const e=Vt(this.resumeAtDate,this.resumeAtTime);if(!e)return"";if(!Boolean(this.disableAtDate&&this.disableAtTime))return B`
      ...
      `;const t=Vt(this.disableAtDate,this.disableAtTime);return t?new Date(t).getTime()>=new Date(e).getTime()?B`
    ...
    `:""}render(){if(this.scheduleMode)return B`
      ...
      <div class="duration-selector">
        ...
        <div class="duration-pills" role="radiogroup" aria-labelledby="duration-header">
          ${o.map(e=>{const t=Lt(this.customDuration),o=!this.untilTomorrow&&!this.showCustomInput&&e.minutes===t;return B`
                <button
                  type="button"
                  class="pill ${o?"active":""}"
    ...
    `}}yo.styles=fo,e([ue({attribute:!1})],yo.prototype,"hass",void 0),e([ue({type:Boolean})],yo.prototype,"scheduleMode",void 0),e([ue({attribute:!1})],yo.prototype,"customDuration",void 0),e([ue({type:String})],yo.prototype,"customDurationInput",void 0),e([ue({type:Boolean})],yo.prototype,"showCustomInput",void 0),e([ue({type:Boolean})],yo.prototype,"untilTomorrow",void 0),e([ue({attribute:!1})],yo.prototype,"lastDuration",void 0),e([ue({type:String})],yo.prototype,"disableAtDate",void 0),e([ue({type:String})],yo.prototype,"disableAtTime",void 0),e([ue({type:String})],yo.prototype,"resumeAtDate",void 0),e([ue({type:String})],yo.prototype,"resumeAtTime",void 0),Gt("autosnooze-duration-selector",yo);const vo=r`
    :host {
      display: block;
    }
...
`;class xo extends ne{constructor(){super(...arguments),this.automations=[],this.selected=[],this.labelRegistry={},this.labelRegistryUnavailable=!1,this.categoryRegistry={},this.recentSnoozeIds=[],this.pausedEntityIds=[],this.hideSnoozed=!1,this._filterTab="all",this._search="",this._searchInput="",this._expandedGroups={},this._searchTimeout=null,this._viewModelCache=null}updated(e){super.updated(e),this.hideSnoozed&&(e.has("pausedEntityIds")||e.has("selected")||e.has("hideSnoozed"))&&this._pruneHiddenSelection()}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null)}_fireSelectionChange(e){this.dispatchEvent(new CustomEvent("selection-change",{detail:{selected:e},bubbles:!0,composed:!0}))}_toggleSelection(e){let t;Ot("selection"),t=this.selected.includes(e)?this.selected.filter(t=>t!==e):[...this.selected,e],this._fireSelectionChange(t)}_toggleGroupExpansion(e){const t=!1!==this._expandedGroups[e];this._expandedGroups={...this._expandedGroups,[e]:!t}}_selectGroup(e){const t=e.map(e=>e.id);let o;o=t.every(e=>this.selected.includes(e))?this.selected.filter(e=>!t.includes(e)):[...new Set([...this.selected,...t])],this._fireSelectionChange(o)}_selectAllVisible(){const e=this._getViewModel().filtered.map(e=>e.id),t=[...new Set([...this.selected,...e])];var o,a;this.hass&&(o=this.hass,a=e.length,dt(o,{event:"selection_feature_used",properties:{target_count:a},source:"card"})),this._fireSelectionChange(t)}_clearSelection(){this._fireSelectionChange([])}_getFilteredAutomations(){return this._getViewModel().filtered}_getAreaName(e){return this.hass?At(e??null,this.hass):_e(this.hass,"group.unassigned")}_getLabelName(e){return kt(e,this.labelRegistry)}_getCategoryName(e){return St(e??null,this.categoryRegistry)}_getGroupedByTab(e){return jt(this._buildViewModelInput(e)).grouped}_getGroupedByArea(){return this._getGroupedByTab("areas")}_getGroupedByLabel(){return this._getGroupedByTab("labels")}_getGroupedByCategory(){return this._getGroupedByTab("categories")}_getAreaCount(){return this._getViewModel().areaCount}_getLabelCount(){return this._getViewModel().labelCount}_getCategoryCount(){return this._getViewModel().categoryCount}_buildViewModelInput(e){return{automations:this.automations,search:this._search,filterTab:e,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,emptyAreaLabel:_e(this.hass,"group.unassigned"),emptyLabelLabel:_e(this.hass,"group.unlabeled"),emptyCategoryLabel:_e(this.hass,"group.uncategorized"),hideSnoozed:this.hideSnoozed,pausedEntityIds:new Set(this.pausedEntityIds)}}_getViewModel(){const e=this._viewModelCache;if(e&&e.automations===this.automations&&e.search===this._search&&e.filterTab===this._filterTab&&e.hass===this.hass&&e.labelRegistry===this.labelRegistry&&e.categoryRegistry===this.categoryRegistry&&e.hideSnoozed===this.hideSnoozed&&e.pausedEntityIds===this.pausedEntityIds)return e.result;const t=jt(this._buildViewModelInput(this._filterTab));return this._viewModelCache={automations:this.automations,search:this._search,filterTab:this._filterTab,hass:this.hass,labelRegistry:this.labelRegistry,categoryRegistry:this.categoryRegistry,hideSnoozed:this.hideSnoozed,pausedEntityIds:this.pausedEntityIds,result:t},t}_pruneHiddenSelection(){if(!this.hideSnoozed||0===this.pausedEntityIds.length||0===this.selected.length)return;const e=new Set(this.pausedEntityIds),t=this.selected.filter(t=>!e.has(t));t.length!==this.selected.length&&this._fireSelectionChange(t)}_selectFilterTab(e){this._filterTab=e,this.hass&&function(e,t){dt(e,{event:"filter_tab_selected",properties:{tab:t},source:"card"})}(this.hass,e)}_handleSearchInput(e){const t=e.target.value;this._searchInput=t,null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},ke)}_clearSearch(){null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null),this._searchInput="",this._search=""}_handleSearchKeydown(e){"Escape"===e.key&&(this._searchInput||this._search)&&(e.preventDefault(),this._clearSearch())}_renderSelectionList(e,t){const{filtered:o,grouped:a}=e;if("all"===this._filterTab){if(0===o.length)return B`<div class="list-empty" role="status">${_e(this.hass,"list.empty")}</div>`;const e=new Set(this.recentSnoozeIds),a=[],i=[];for(const t of o)(e.has(t.id)?a:i).push(t);const s=a.concat(i);return B`
    ...
    `}}xo.styles=vo,e([ue({attribute:!1})],xo.prototype,"hass",void 0),e([ue({attribute:!1})],xo.prototype,"automations",void 0),e([ue({attribute:!1})],xo.prototype,"selected",void 0),e([ue({attribute:!1})],xo.prototype,"labelRegistry",void 0),e([ue({type:Boolean})],xo.prototype,"labelRegistryUnavailable",void 0),e([ue({attribute:!1})],xo.prototype,"categoryRegistry",void 0),e([ue({attribute:!1})],xo.prototype,"recentSnoozeIds",void 0),e([ue({attribute:!1})],xo.prototype,"pausedEntityIds",void 0),e([ue({type:Boolean})],xo.prototype,"hideSnoozed",void 0),e([he()],xo.prototype,"_filterTab",void 0),e([he()],xo.prototype,"_search",void 0),e([he()],xo.prototype,"_searchInput",void 0),e([he()],xo.prototype,"_expandedGroups",void 0),Gt("autosnooze-automation-list",xo);const wo=r`
    :host {
      display: block;
    }
    .modal-overlay {
...
`,zo=[{label:"+15m",minutes:15},{label:"+30m",minutes:30},{label:"+1h",hours:1},{label:"+2h",hours:2}],$o=[{label:"-15m",minutes:-15,thresholdMs:15*xe},{label:"-30m",minutes:-30,thresholdMs:30*xe}],Ao=xe;class ko extends ne{constructor(){super(...arguments),this.open=!1,this.entityId="",this.friendlyName="",this.resumeAt="",this.entityIds=[],this.friendlyNames=[],this._countdownState={interval:null,syncTimeout:null}}get _isGroupMode(){return this.entityIds.length>1}updated(e){e.has("open")&&(this.open?this._startSynchronizedCountdown():this._stopCountdown())}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown()}_startSynchronizedCountdown(){mt(this._countdownState),this._countdownState=pt(()=>this.requestUpdate())}_stopCountdown(){mt(this._countdownState)}_isDecrementDisabled(e){if(!this.resumeAt)return!0;return new Date(this.resumeAt).getTime()-Date.now()-e<Ao}_fireAdjustTime(e){this.entityIds.length>0?this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityIds:this.entityIds,...e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityId:this.entityId,...e},bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}_handleOverlayKeydown(e){"Escape"===e.key&&this._close()}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}render(){return this.open?B`
      <div class="modal-overlay" @click=${this._handleOverlayClick} @keydown=${this._handleOverlayKeydown}>
        <div class="modal-content" role="dialog" aria-modal="true" aria-labelledby="adjust-title" @click=${e=>e.stopPropagation()}>
          ...
          <div class="modal-body">
            ...
            <div class="remaining-time">${Dt(this.resumeAt,_e(this.hass,"status.resuming"))}</div>
    ...
    `:B``}}ko.styles=wo,e([ue({attribute:!1})],ko.prototype,"hass",void 0),e([ue({type:Boolean})],ko.prototype,"open",void 0),e([ue({type:String})],ko.prototype,"entityId",void 0),e([ue({type:String})],ko.prototype,"friendlyName",void 0),e([ue({type:String})],ko.prototype,"resumeAt",void 0),e([ue({attribute:!1})],ko.prototype,"entityIds",void 0),e([ue({attribute:!1})],ko.prototype,"friendlyNames",void 0),Gt("autosnooze-adjust-modal",ko);const So=Symbol.for("autosnooze.registration.done.v1"),To=new Set,Co="https://github.com/mossipcams/autosnooze#readme";function jo(){const e=window.customCards;return Array.isArray(e)?e:(void 0!==e&&(t="customCards-not-array",o=`[AutoSnooze] window.customCards was not an array (got ${typeof e}); resetting.`,To.has(t)||(To.add(t),console.warn(o))),[]);var t,o}function Eo(e="0.3.1b1"){const t=function(e){return[{type:"autosnooze-card",name:"AutoSnooze Card",description:`Temporarily pause automations with area and label filtering (v${e})`,preview:!0,documentationURL:Co},{type:"autosnooze-snoozed-card",name:"AutoSnooze Snoozed Card",description:`Read-only view of currently snoozed automations and when they resume (v${e})`,preview:!0,documentationURL:Co}]}(e),o=jo();t.forEach(e=>{const t=o.findIndex(t=>t?.type===e.type);-1===t?o.push(e):o[t]={...o[t],...e}}),window.customCards=o}!function(){const e=globalThis;!0===e[So]||(e[So]=!0),Eo()}();export{_o as AutoSnoozeActivePauses,ko as AutoSnoozeAdjustModal,xo as AutoSnoozeAutomationList,yo as AutoSnoozeDurationSelector,po as AutoSnoozeSnoozedCard,ho as AutomationPauseCard,go as AutomationPauseCardEditor};
