...
`,ct=[{label:"+15m",minutes:15},{label:"+30m",minutes:30},{label:"+1h",hours:1},{label:"+2h",hours:2}],ht=[{label:"-15m",minutes:-15,thresholdMs:15*ve},{label:"-30m",minutes:-30,thresholdMs:30*ve}],pt=ve;class mt extends ne{constructor(){super(...arguments),this.open=!1,this.entityId="",this.friendlyName="",this.resumeAt="",this.entityIds=[],this.friendlyNames=[],this._interval=null,this._syncTimeout=null}get _isGroupMode(){return this.entityIds.length>1}updated(e){e.has("open")&&(this.open?this._startSynchronizedCountdown():this._stopCountdown())}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown()}_startSynchronizedCountdown(){this._stopCountdown();const e=1e3-Date.now()%1e3;this._syncTimeout=window.setTimeout(()=>{this._syncTimeout=null,this.requestUpdate(),this._interval=window.setInterval(()=>{this.requestUpdate()},Te)},e)}_stopCountdown(){null!==this._interval&&(clearInterval(this._interval),this._interval=null),null!==this._syncTimeout&&(clearTimeout(this._syncTimeout),this._syncTimeout=null)}_isDecrementDisabled(e){if(!this.resumeAt)return!0;return new Date(this.resumeAt).getTime()-Date.now()-e<pt}_fireAdjustTime(e){this.entityIds.length>0?this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityIds:this.entityIds,...e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityId:this.entityId,...e},bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}render(){return this.open?G`
    ...
    `:G``}}mt.styles=ut,e([ce({attribute:!1})],mt.prototype,"hass",void 0),e([ce({type:Boolean})],mt.prototype,"open",void 0),e([ce({type:String})],mt.prototype,"entityId",void 0),e([ce({type:String})],mt.prototype,"friendlyName",void 0),e([ce({type:String})],mt.prototype,"resumeAt",void 0),e([ce({attribute:!1})],mt.prototype,"entityIds",void 0),e([ce({attribute:!1})],mt.prototype,"friendlyNames",void 0),customElements.get("autosnooze-card-editor")||customElements.define("autosnooze-card-editor",at),customElements.get("autosnooze-active-pauses")||customElements.define("autosnooze-active-pauses",st),customElements.get("autosnooze-duration-selector")||customElements.define("autosnooze-duration-selector",nt),customElements.get("autosnooze-automation-list")||customElements.define("autosnooze-automation-list",dt),customElements.get("autosnooze-adjust-modal")||customElements.define("autosnooze-adjust-modal",mt),customElements.get("autosnooze-card")||customElements.define("autosnooze-card",tt),window.customCards=window.customCards||[],window.customCards.some(e=>"autosnooze-card"===e.type)||window.customCards.push({type:"autosnooze-card",name:"AutoSnooze Card",description:"Temporarily pause automations with area and label filtering (v0.2.10)",preview:!0});export{st as AutoSnoozeActivePauses,mt as AutoSnoozeAdjustModal,dt as AutoSnoozeAutomationList,nt as AutoSnoozeDurationSelector,tt as AutomationPauseCard,at as AutomationPauseCardEditor};
