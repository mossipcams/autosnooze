...
`,ve=1e3,ye=6e4,xe=36e5,we=864e5,ze=60,$e=1440,Ae=300,ke=300,Se=3e3,Ce=5e3,Te=1e3,De=5e3,Ee=[{label:"30m",minutes:30},{label:"1h",minutes:60},{label:"12h",minutes:720},{label:"1d",minutes:1440},{label:"Custom",minutes:null}],Pe={not_automation:"Failed to snooze: One or more selected items are not automations",invalid_duration:"Failed to snooze: Please specify a valid duration (days, hours, or minutes)",resume_time_past:"Failed to snooze: Resume time must be in the future",disable_after_resume:"Failed to snooze: Snooze time must be before resume time"},Re="autosnooze_exclude",Fe="autosnooze_include";function Me(e,t){const o=new Date(e),a=new Date,i={weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return o.getFullYear()>a.getFullYear()&&(i.year="numeric"),o.toLocaleString(t,i)}function Le(e,t,o){const a=[];return e>0&&a.push(`${e} day${1!==e?"s":""}`),t>0&&a.push(`${t} hour${1!==t?"s":""}`),o>0&&a.push(`${o} minute${1!==o?"s":""}`),a.join(", ")}function Ue(e,t,o){const a=[];return e>0&&a.push(`${e}d`),t>0&&a.push(`${t}h`),o>0&&a.push(`${o}m`),a.join(" ")||"0m"}function Oe(e){const t=e.toLowerCase().replace(/\s+/g,"");if(!t)return null;let o=0,a=!1;const i=t.match(/(\d+(?:\.\d+)?)\s*d/),s=t.match(/(\d+(?:\.\d+)?)\s*h/),r=t.match(/(\d+(?:\.\d+)?)\s*m(?!i)/);if(i?.[1]){const e=parseFloat(i[1]);if(isNaN(e)||e<0)return null;o+=e*$e,a=!0}if(s?.[1]){const e=parseFloat(s[1]);if(isNaN(e)||e<0)return null;o+=e*ze,a=!0}if(r?.[1]){const e=parseFloat(r[1]);if(isNaN(e)||e<0)return null;o+=e,a=!0}if(!a){const e=parseFloat(t);if(isNaN(e)||!(e>0))return null;o=e}if(o=Math.round(o),o<=0)return null;const n=Math.floor(o/$e),l=o%$e;return{days:n,hours:Math.floor(l/ze),minutes:l%ze}}function Ie(e){return null!==Oe(e)}function Ne(e){return e.days*$e+e.hours*ze+e.minutes}function He(e,t){if(!e||!t)return null;const o=new Date(`${e}T${t}`).getTimezoneOffset(),a=o<=0?"+":"-",i=Math.abs(o);return`${e}T${t}${`${a}${String(Math.floor(i/60)).padStart(2,"0")}:${String(i%60).padStart(2,"0")}`}`}function je(e="light"){!function(e,t,o){const a=new CustomEvent(`hass-${t}`,{bubbles:!0,composed:!0,detail:o});e.dispatchEvent(a)}(window,"haptic",e)}function Be(e,t){const o=e,a=o?.translation_key??o?.data?.translation_key;if(a&&Pe[a])return Pe[a];const i=o?.message??"";for(const[e,t]of Object.entries(Pe))if(i.includes(e)||i.toLowerCase().includes(e.replace(/_/g," ")))return t;return`${t}. Check Home Assistant logs for details.`}async function Ge(e,t){try{await e.callService("autosnooze","pause",t)}catch(e){throw console.error("[AutoSnooze] Failed to pause automations:",e),e}}async function We(e,t){try{await e.callService("autosnooze","cancel",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to wake automation:",e),e}}async function qe(e,t){try{await e.callService("autosnooze","cancel_scheduled",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to cancel scheduled snooze:",e),e}}const Ve="autosnooze_last_duration";function Ye(e){return e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function Ke(e,t,o){return!(!e.labels||0===e.labels.length)&&e.labels.some(e=>{const a=o[e]?.name;return a?.toLowerCase()===t})}function Ze(e,t,o){const a={};return e.forEach(e=>{const i=t(e);i&&0!==i.length?i.forEach(t=>{a[t]||(a[t]=[]),a[t].push(e)}):(a[o]||(a[o]=[]),a[o].push(e))}),Object.entries(a).sort((e,t)=>e[0]===o?1:t[0]===o?-1:e[0].localeCompare(t[0]))}function Je(e,t){const o=new Set;return e.forEach(e=>{const a=t(e);a&&a.forEach(e=>o.add(e))}),o.size}const Xe="sensor.autosnooze_snoozed_automations";function Qe(e){const t=e?.states?.[Xe];return t?.attributes?.paused_automations??{}}class et extends ne{constructor(){super(...arguments),this.config={},this._selected=[],this._duration=30*ye,this._customDuration={days:0,hours:0,minutes:30},this._customDurationInput="30m",this._loading=!1,this._search="",this._filterTab="all",this._expandedGroups={},this._scheduleMode=!1,this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime="",this._labelRegistry={},this._categoryRegistry={},this._entityRegistry={},this._showCustomInput=!1,this._automationsCache=null,this._automationsCacheVersion=0,this._lastDuration=null,this._labelsFetched=!1,this._categoriesFetched=!1,this._entityRegistryFetched=!1,this._lastHassStates=null,this._lastCacheVersion=0,this._searchTimeout=null,this._toastTimeout=null,this._toastFadeTimeout=null}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-card",title:"AutoSnooze"}}setConfig(e){this.config=e}getCardSize(){const e=this._getPaused(),t=this._getScheduled();return 4+Object.keys(e).length+Object.keys(t).length}shouldUpdate(e){if(!e.has("hass"))return!0;const t=e.get("hass"),o=this.hass;if(!t||!o)return!0;const a=t.states?.["sensor.autosnooze_snoozed_automations"],i=o.states?.["sensor.autosnooze_snoozed_automations"];if(a!==i)return!0;if(t.entities!==o.entities)return!0;if(t.areas!==o.areas)return!0;if((t.language??t.locale?.language)!==(o.language??o.locale?.language))return!0;const s=o.states??{},r=t.states??{};for(const e of Object.keys(s))if(e.startsWith("automation.")&&r[e]!==s[e])return!0;for(const e of Object.keys(r))if(e.startsWith("automation.")&&!s[e])return!0;return!1}updated(e){super.updated(e),e.has("hass")&&this.hass?.connection&&(this._labelsFetched||this._fetchLabelRegistry(),this._categoriesFetched||this._fetchCategoryRegistry(),this._entityRegistryFetched||this._fetchEntityRegistry())}connectedCallback(){super.connectedCallback(),this._fetchLabelRegistry(),this._fetchCategoryRegistry(),this._fetchEntityRegistry(),this._lastDuration=function(){try{const e=localStorage.getItem(Ve);if(!e)return null;const t=JSON.parse(e);return"number"!=typeof t.minutes||"number"!=typeof t.duration?.days||"number"!=typeof t.duration?.hours||"number"!=typeof t.duration?.minutes||"number"!=typeof t.timestamp?null:Date.now()-t.timestamp>6048e5?(localStorage.removeItem(Ve),null):t}catch{return null}}()}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null),null!==this._toastTimeout&&(clearTimeout(this._toastTimeout),this._toastTimeout=null),null!==this._toastFadeTimeout&&(clearTimeout(this._toastFadeTimeout),this._toastFadeTimeout=null)}async _fetchLabelRegistry(){!this._labelsFetched&&this.hass?.connection&&(this._labelRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/label_registry/list"}),o={};return Array.isArray(t)&&t.forEach(e=>{o[e.label_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch label registry:",e),{}}}(this.hass),this._labelsFetched=!0)}async _fetchCategoryRegistry(){!this._categoriesFetched&&this.hass?.connection&&(this._categoryRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/category_registry/list",scope:"automation"}),o={};return Array.isArray(t)&&t.forEach(e=>{o[e.category_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch category registry:",e),{}}}(this.hass),this._categoriesFetched=!0)}async _fetchEntityRegistry(){!this._entityRegistryFetched&&this.hass?.connection&&(this._entityRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/entity_registry/list"}),o={};return Array.isArray(t)&&t.filter(e=>e.entity_id.startsWith("automation.")).forEach(e=>{o[e.entity_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch entity registry:",e),{}}}(this.hass),this._entityRegistryFetched=!0,this._automationsCacheVersion++)}_getAutomations(){if(!this.hass?.states)return[];const e=this.hass.states,t=this._automationsCacheVersion;if(this._lastHassStates===e&&this._lastCacheVersion===t&&this._automationsCache)return this._automationsCache;const o=function(e,t){const o=e?.states,a=e?.entities;if(!o)return[];const i=Object.keys(o).filter(e=>e.startsWith("automation.")).map(e=>{const i=o[e];if(!i)return null;const s=t?.[e],r=a?.[e],n=(s?.categories??{}).automation??null;return{id:e,name:i.attributes?.friendly_name??e.replace("automation.",""),area_id:s?.area_id??r?.area_id??null,category_id:n,labels:s?.labels??r?.labels??[]}}).filter(e=>null!==e).sort((e,t)=>e.name.localeCompare(t.name));return i}(this.hass,this._entityRegistry);return this._automationsCache=o,this._lastCacheVersion=t,this._lastHassStates=e,o}_getFilteredAutomations(){return function(e,t,o){let a=e;const i=e.some(e=>Ke(e,Fe,o));a=i?a.filter(e=>Ke(e,Fe,o)):a.filter(e=>!Ke(e,Re,o));const s=t.toLowerCase();return s&&(a=a.filter(e=>e.name.toLowerCase().includes(s)||e.id.toLowerCase().includes(s))),a}(this._getAutomations(),this._search,this._labelRegistry)}_getAreaName(e){return this.hass?function(e,t){return e?t.areas?.[e]?.name??Ye(e):"Unassigned"}(e,this.hass):be(this.hass,"group.unassigned")}_getLabelName(e){return function(e,t){return t[e]?.name??Ye(e)}(e,this._labelRegistry)}_getCategoryName(e){return function(e,t){return e?t[e]?.name??Ye(e):"Uncategorized"}(e,this._categoryRegistry)}_getGroupedByArea(){return Ze(this._getFilteredAutomations(),e=>e.area_id?[this._getAreaName(e.area_id)]:null,be(this.hass,"group.unassigned"))}_getGroupedByLabel(){const e=this._getFilteredAutomations(),t=[Re.toLowerCase(),Fe.toLowerCase()];return Ze(e,e=>{if(!e.labels?.length)return null;const o=e.labels.map(e=>this._getLabelName(e)).filter(e=>!t.includes(e.toLowerCase()));return o.length>0?o:null},be(this.hass,"group.unlabeled"))}_getGroupedByCategory(){return Ze(this._getFilteredAutomations(),e=>e.category_id?[this._getCategoryName(e.category_id)]:null,be(this.hass,"group.uncategorized"))}_getAreaCount(){return Je(this._getAutomations(),e=>e.area_id?[e.area_id]:null)}_getLabelCount(){const e=this._getAutomations(),t=[Re.toLowerCase(),Fe.toLowerCase()];return Je(e,e=>{if(!e.labels?.length)return null;const o=e.labels.filter(e=>!t.includes(this._getLabelName(e).toLowerCase()));return o.length>0?o:null})}_getCategoryCount(){return Je(this._getAutomations(),e=>e.category_id?[e.category_id]:null)}_getPaused(){return this.hass?Qe(this.hass):{}}_getPausedGroupedByResumeTime(){return this.hass?function(e){const t=Qe(e),o={};return Object.entries(t).forEach(([e,t])=>{const a=t.resume_at;o[a]||(o[a]={resumeAt:a,disableAt:t.disable_at,automations:[]}),o[a].automations.push({entity_id:e,friendly_name:t.friendly_name,resume_at:t.resume_at,paused_at:t.paused_at,days:t.days,hours:t.hours,minutes:t.minutes,disable_at:t.disable_at})}),Object.values(o).sort((e,t)=>new Date(e.resumeAt).getTime()-new Date(t.resumeAt).getTime())}(this.hass):[]}_getScheduled(){return this.hass?function(e){const t=e?.states?.[Xe];return t?.attributes?.scheduled_snoozes??{}}(this.hass):{}}_formatDateTime(e){return Me(e,this._getLocale())}_getLocale(){return this.hass?.locale?.language}_toggleSelection(e){je("selection"),this._selected.includes(e)?this._selected=this._selected.filter(t=>t!==e):this._selected=[...this._selected,e]}_toggleGroupExpansion(e){this._expandedGroups={...this._expandedGroups,[e]:!this._expandedGroups[e]}}_selectGroup(e){const t=e.map(e=>e.id),o=t.every(e=>this._selected.includes(e));this._selected=o?this._selected.filter(e=>!t.includes(e)):[...new Set([...this._selected,...t])]}_selectAllVisible(){const e=this._getFilteredAutomations().map(e=>e.id),t=e.every(e=>this._selected.includes(e));this._selected=t?this._selected.filter(t=>!e.includes(t)):[...new Set([...this._selected,...e])]}_clearSelection(){this._selected=[]}_hasResumeAt(){return Boolean(this._resumeAtDate&&this._resumeAtTime)}_hasDisableAt(){return Boolean(this._disableAtDate&&this._disableAtTime)}_parseDurationInput(e){return Oe(e)}_formatDuration(e,t,o){return Le(e,t,o)}_combineDateTime(e,t){return He(e,t)}_getErrorMessage(e,t){return Be(e,t)}_formatRegistryId(e){return Ye(e)}_handleKeyDown(e,t){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),t())}_hapticFeedback(e="light"){je(e)}_handleSearchInput(e){const t=e.target.value;null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},Ae)}_showToast(e,t={}){const{showUndo:o=!1,onUndo:a=null}=t;if(!this.shadowRoot)return;const i=this.shadowRoot.querySelector(".toast");i&&i.remove();const s=document.createElement("div");if(s.className="toast",s.setAttribute("role","alert"),s.setAttribute("aria-live","polite"),s.setAttribute("aria-atomic","true"),o&&a){const t=document.createElement("span");t.textContent=e,s.appendChild(t);const o=document.createElement("button");o.className="toast-undo-btn",o.textContent=be(this.hass,"button.undo"),o.setAttribute("aria-label",be(this.hass,"a11y.undo_action")),o.addEventListener("click",e=>{e.stopPropagation(),a(),s.remove()}),s.appendChild(o)}else s.textContent=e;this.shadowRoot.appendChild(s),null!==this._toastTimeout&&clearTimeout(this._toastTimeout),null!==this._toastFadeTimeout&&clearTimeout(this._toastFadeTimeout),this._toastTimeout=window.setTimeout(()=>{this._toastTimeout=null,this.shadowRoot&&s.parentNode&&(s.style.animation=`slideUp ${ke}ms ease-out reverse`,this._toastFadeTimeout=window.setTimeout(()=>{this._toastFadeTimeout=null,s.parentNode&&s.remove()},ke))},Ce)}async _snooze(){if(0!==this._selected.length&&!this._loading){if(this._scheduleMode){if(!this._hasResumeAt())return void this._showToast(be(this.hass,"toast.error.resume_time_required"));const e=this._hasDisableAt()?He(this._disableAtDate,this._disableAtTime):null,t=He(this._resumeAtDate,this._resumeAtTime);if(!t)return void this._showToast(be(this.hass,"toast.error.invalid_datetime"));const o=Date.now()+De,a=new Date(t).getTime();if(a<=o)return void this._showToast(be(this.hass,"toast.error.resume_time_past"));if(e){if(new Date(e).getTime()>=a)return void this._showToast(be(this.hass,"toast.error.snooze_before_resume"))}}else if(0===this._duration)return;this._loading=!0;try{if(!this.hass)return void(this._loading=!1);const e=this._selected.length,t=[...this._selected],o=this._scheduleMode,a=this._hasDisableAt();let i;if(this._scheduleMode){const t=this._hasDisableAt()?He(this._disableAtDate,this._disableAtTime):null,o=He(this._resumeAtDate,this._resumeAtTime);if(!o)return void(this._loading=!1);if(await Ge(this.hass,{entity_id:this._selected,resume_at:o,...t&&{disable_at:t}}),!this.isConnected||!this.shadowRoot)return void(this._loading=!1);if(t)i=1===e?be(this.hass,"toast.success.scheduled_one"):be(this.hass,"toast.success.scheduled_many",{count:e});else{const t=this._formatDateTime(o);i=1===e?be(this.hass,"toast.success.snoozed_until_one",{time:t}):be(this.hass,"toast.success.snoozed_until_many",{count:e,time:t})}}else{const{days:t,hours:o,minutes:a}=this._customDuration;if(await Ge(this.hass,{entity_id:this._selected,days:t,hours:o,minutes:a}),!this.isConnected||!this.shadowRoot)return void(this._loading=!1);const s=Le(t,o,a);i=1===e?be(this.hass,"toast.success.snoozed_for_one",{duration:s}):be(this.hass,"toast.success.snoozed_for_many",{count:e,duration:s});const r=Ne(this._customDuration);!function(e,t){try{const o={minutes:t,duration:e,timestamp:Date.now()};localStorage.setItem(Ve,JSON.stringify(o))}catch{}}(this._customDuration,r),this._lastDuration={minutes:r,duration:this._customDuration,timestamp:Date.now()}}this._hapticFeedback("success"),this._showToast(i,{showUndo:!0,onUndo:async()=>{try{if(!this.hass)return;for(const e of t)o&&a?await qe(this.hass,e):await We(this.hass,e);if(this.isConnected){this._selected=t;const o=1===e?be(this.hass,"toast.success.restored_one"):be(this.hass,"toast.success.restored_many",{count:e});this._showToast(o)}}catch(e){console.error("Undo failed:",e),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.error.undo_failed"))}}}),this._selected=[],this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime=""}catch(e){console.error("Snooze failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Be(e,"Failed to snooze automations"))}this._loading=!1}}async _wake(e){if(this.hass)try{await We(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.resumed"))}catch(e){console.error("Wake failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Be(e,be(this.hass,"toast.error.resume_failed")))}}async _handleWakeEvent(e){await this._wake(e.detail.entityId)}async _handleWakeAllEvent(){if(this.hass)try{await async function(e){try{await e.callService("autosnooze","cancel_all",{})}catch(e){throw console.error("[AutoSnooze] Failed to wake all automations:",e),e}}(this.hass),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.resumed_all"))}catch(e){console.error("Wake all failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Be(e,be(this.hass,"toast.error.resume_all_failed")))}}async _cancelScheduled(e){if(this.hass)try{await qe(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.cancelled"))}catch(e){console.error("Cancel scheduled failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Be(e,be(this.hass,"toast.error.cancel_failed")))}}_handleDurationChange(e){const{minutes:t,duration:o,input:a,showCustomInput:i}=e.detail;this._duration=t*ye,this._customDuration=o,this._customDurationInput=a,void 0!==i&&(this._showCustomInput=i)}_handleScheduleModeChange(e){if(this._scheduleMode=e.detail.enabled,e.detail.enabled){const{date:e,time:t}=function(){const e=new Date;return{date:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,time:`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}}();this._disableAtDate=e,this._disableAtTime=t,this._resumeAtDate=e,this._resumeAtTime=t}}_handleScheduleFieldChange(e){const{field:t,value:o}=e.detail;switch(t){case"disableAtDate":this._disableAtDate=o;break;case"disableAtTime":this._disableAtTime=o;break;case"resumeAtDate":this._resumeAtDate=o;break;case"resumeAtTime":this._resumeAtTime=o}}_handleCustomInputToggle(e){this._showCustomInput=e.detail.show}_renderSelectionList(){const e=this._getFilteredAutomations();if("all"===this._filterTab)return 0===e.length?B`<div class="list-empty" role="status">${be(this.hass,"list.empty")}</div>`:e.map(e=>B`
        <button
          type="button"
      ...
      <ha-card>
        ...
        <div class="snooze-setup">
          ...
          <button
            type="button"
            class="snooze-btn"
            ?disabled=${0===this._selected.length||!this._scheduleMode&&!Ie(this._customDurationInput)||this._scheduleMode&&!this._hasResumeAt()||this._loading}
            @click=${()=>this._snooze()}
    ...
    `}}et.styles=fe,e([de({attribute:!1})],et.prototype,"hass",void 0),e([de({attribute:!1})],et.prototype,"config",void 0),e([he()],et.prototype,"_selected",void 0),e([he()],et.prototype,"_duration",void 0),e([he()],et.prototype,"_customDuration",void 0),e([he()],et.prototype,"_customDurationInput",void 0),e([he()],et.prototype,"_loading",void 0),e([he()],et.prototype,"_search",void 0),e([he()],et.prototype,"_filterTab",void 0),e([he()],et.prototype,"_expandedGroups",void 0),e([he()],et.prototype,"_scheduleMode",void 0),e([he()],et.prototype,"_disableAtDate",void 0),e([he()],et.prototype,"_disableAtTime",void 0),e([he()],et.prototype,"_resumeAtDate",void 0),e([he()],et.prototype,"_resumeAtTime",void 0),e([he()],et.prototype,"_labelRegistry",void 0),e([he()],et.prototype,"_categoryRegistry",void 0),e([he()],et.prototype,"_entityRegistry",void 0),e([he()],et.prototype,"_showCustomInput",void 0),e([he()],et.prototype,"_automationsCache",void 0),e([he()],et.prototype,"_automationsCacheVersion",void 0),e([he()],et.prototype,"_lastDuration",void 0);const tt=r`
  .row {
    margin-bottom: 12px;
  }
  .row label {
...
`;class ot extends ne{constructor(){super(...arguments),this._config={}}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config)return;const o={...this._config,[e]:t};""!==t&&null!=t||delete o[e],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0}))}render(){return this._config?B`
      <div class="row">
    ...
    `:B``}}ot.styles=tt,e([de({attribute:!1})],ot.prototype,"hass",void 0),e([he()],ot.prototype,"_config",void 0);const at=r`
    :host {
      display: block;
    }
    .snooze-list {
...
`;class it extends ne{constructor(){super(...arguments),this.pauseGroups=[],this.pausedCount=0,this._wakeAllPending=!1,this._wakeAllTimeout=null,this._interval=null,this._syncTimeout=null}connectedCallback(){super.connectedCallback(),this._interval&&(window.clearInterval(this._interval),this._interval=null),this._syncTimeout&&(window.clearTimeout(this._syncTimeout),this._syncTimeout=null),this._startSynchronizedCountdown()}disconnectedCallback(){super.disconnectedCallback(),null!==this._interval&&(clearInterval(this._interval),this._interval=null),null!==this._syncTimeout&&(clearTimeout(this._syncTimeout),this._syncTimeout=null),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null)}_startSynchronizedCountdown(){const e=1e3-Date.now()%1e3;this._syncTimeout=window.setTimeout(()=>{this._syncTimeout=null,this._updateCountdownIfNeeded(),this._interval=window.setInterval(()=>{this._updateCountdownIfNeeded()},Te)},e)}_updateCountdownIfNeeded(){this.pauseGroups.length>0&&this.requestUpdate()}_handleWakeAll(){this._wakeAllPending?(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,this._fireWakeAll()):(je("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},Se))}_fireWake(e){this.dispatchEvent(new CustomEvent("wake-automation",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireWakeAll(){this.dispatchEvent(new CustomEvent("wake-all",{bubbles:!0,composed:!0}))}render(){if(0===this.pausedCount)return B``;const e=this.hass?.locale?.language;return B`
        ...
        ${this.pauseGroups.map(t=>B`
          <div class="pause-group" role="group">
            <div class="pause-group-header">
              ...
              ${t.disableAt?B`${be(this.hass,"status.resumes")} ${Me(t.resumeAt,e)}`:B`<span class="countdown">${function(e){const t=new Date(e).getTime()-Date.now();if(t<=0)return"Resuming...";const o=Math.floor(t/we),a=Math.floor(t%we/xe),i=Math.floor(t%xe/ye),s=Math.floor(t%ye/ve);return o>0?`${o}d ${a}h ${i}m`:a>0?`${a}h ${i}m ${s}s`:`${i}m ${s}s`}(t.resumeAt)}</span>`}
            </div>
            ${t.automations.map(e=>B`
              <div class="paused-item">
                ...
                <button type="button" class="wake-btn" @click=${()=>this._fireWake(e.entity_id)}>
    ...
    `}}it.styles=at,e([de({attribute:!1})],it.prototype,"hass",void 0),e([de({attribute:!1})],it.prototype,"pauseGroups",void 0),e([de({type:Number})],it.prototype,"pausedCount",void 0);const st=r`
    :host {
      display: block;
    }
...
`;class rt extends ne{constructor(){super(...arguments),this.scheduleMode=!1,this.customDuration={days:0,hours:0,minutes:30},this.customDurationInput="30m",this.showCustomInput=!1,this.lastDuration=null,this.disableAtDate="",this.disableAtTime="",this.resumeAtDate="",this.resumeAtTime=""}_getDurationPills(){const e=this.hass?.states?.["sensor.autosnooze_snoozed_automations"],t=e?.attributes?.duration_presets,o=t?.length?t:Ee.filter(e=>null!==e.minutes);return[...o,{label:"Custom",minutes:null}]}_getDurationPreview(){const e=Oe(this.customDurationInput);return e?Le(e.days,e.hours,e.minutes):""}_isDurationValid(){return Ie(this.customDurationInput)}_renderDateOptions(){const e=function(e=365,t){const o=[],a=new Date,i=a.getFullYear();for(let s=0;s<e;s++){const e=new Date(a);e.setDate(e.getDate()+s);const r=e.getFullYear(),n=`${r}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=e.toLocaleDateString(t,{weekday:"short"}),u=e.toLocaleDateString(t,{month:"short"}),c=e.getDate(),d=r!==i?`${l}, ${u} ${c}, ${r}`:`${l}, ${u} ${c}`;o.push({value:n,label:d})}return o}(365,this.hass?.locale?.language);return e.map(e=>B`<option value="${e.value}">${e.label}</option>`)}_renderLastDurationBadge(){if(!this.lastDuration)return"";const e=this.hass?.states?.["sensor.autosnooze_snoozed_automations"],t=e?.attributes?.duration_presets,o=t?.length?t:Ee.filter(e=>null!==e.minutes),a=this.lastDuration.minutes,i=!o.some(e=>e.minutes===a);if(!i)return"";const{days:s,hours:r,minutes:n}=this.lastDuration.duration,l=Ue(s,r,n).replace(/ /g,""),u=Ne(this.customDuration),c=!this.showCustomInput&&a===u;return B`
      <button
        type="button"
        class="last-duration-badge ${c?"active":""}"
        @click=${()=>this._fireDurationChange(a)}
      >
        ${l}
      </button>
    `}_fireDurationChange(e,t){const o=function(e){const t=Math.floor(e/$e),o=e%$e;return{days:t,hours:Math.floor(o/ze),minutes:o%ze}}(e),a=Ue(o.days,o.hours,o.minutes);this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:e,duration:o,input:a,showCustomInput:t?.showCustomInput??!1},bubbles:!0,composed:!0}))}_fireCustomDurationChange(e){const t=Oe(e);if(t){const o=Ne(t);this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:o,duration:t,input:e},bubbles:!0,composed:!0}))}}_fireScheduleModeChange(e){this.dispatchEvent(new CustomEvent("schedule-mode-change",{detail:{enabled:e},bubbles:!0,composed:!0}))}_fireScheduleFieldChange(e,t){this.dispatchEvent(new CustomEvent("schedule-field-change",{detail:{field:e,value:t},bubbles:!0,composed:!0}))}render(){return this.scheduleMode?B`
      ...
      <div class="duration-selector">
        ...
        <div class="duration-pills" role="radiogroup" aria-labelledby="duration-header">
          ${this._getDurationPills().map(e=>{const t=Ne(this.customDuration),o=null===e.minutes?this.showCustomInput:!this.showCustomInput&&e.minutes===t;return B`
                <button
                  type="button"
                  class="pill ${o?"active":""}"
    ...
    `}}rt.styles=st,e([de({attribute:!1})],rt.prototype,"hass",void 0),e([de({type:Boolean})],rt.prototype,"scheduleMode",void 0),e([de({attribute:!1})],rt.prototype,"customDuration",void 0),e([de({type:String})],rt.prototype,"customDurationInput",void 0),e([de({type:Boolean})],rt.prototype,"showCustomInput",void 0),e([de({attribute:!1})],rt.prototype,"lastDuration",void 0),e([de({type:String})],rt.prototype,"disableAtDate",void 0),e([de({type:String})],rt.prototype,"disableAtTime",void 0),e([de({type:String})],rt.prototype,"resumeAtDate",void 0),e([de({type:String})],rt.prototype,"resumeAtTime",void 0),customElements.get("autosnooze-card-editor")||customElements.define("autosnooze-card-editor",ot),customElements.get("autosnooze-active-pauses")||customElements.define("autosnooze-active-pauses",it),customElements.get("autosnooze-duration-selector")||customElements.define("autosnooze-duration-selector",rt),customElements.get("autosnooze-card")||customElements.define("autosnooze-card",et),window.customCards=window.customCards||[],window.customCards.some(e=>"autosnooze-card"===e.type)||window.customCards.push({type:"autosnooze-card",name:"AutoSnooze Card",description:"Temporarily pause automations with area and label filtering (v0.2.9)",preview:!0});export{it as AutoSnoozeActivePauses,rt as AutoSnoozeDurationSelector,et as AutomationPauseCard,ot as AutomationPauseCardEditor};
