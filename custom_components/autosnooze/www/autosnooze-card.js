...
`,ye=1e3,ve=6e4,xe=36e5,we=864e5,ze=60,$e=1440,Ae=300,ke=300,Se=3e3,Ce=5e3,Te=1e3,je=5e3,De=[{label:"30m",minutes:30},{label:"1h",minutes:60},{label:"12h",minutes:720},{label:"1d",minutes:1440},{label:"Custom",minutes:null}],Ee={not_automation:"Failed to snooze: One or more selected items are not automations",invalid_duration:"Failed to snooze: Please specify a valid duration (days, hours, or minutes)",resume_time_past:"Failed to snooze: Resume time must be in the future",disable_after_resume:"Failed to snooze: Snooze time must be before resume time",invalid_adjustment:"Adjustment must be non-zero. Specify at least one of: days, hours, or minutes.",adjust_time_too_short:"Cannot shorten snooze that much. Resume time must be at least 1 minute away."},Re="autosnooze_exclude",Pe="autosnooze_include";function Me(e,t){const o=new Date(e),a=new Date,i={weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return o.getFullYear()>a.getFullYear()&&(i.year="numeric"),o.toLocaleString(t,i)}function Fe(e){const t=new Date(e).getTime()-Date.now();if(t<=0)return"Resuming...";const o=Math.floor(t/we),a=Math.floor(t%we/xe),i=Math.floor(t%xe/ve),s=Math.floor(t%ve/ye);return o>0?`${o}d ${a}h ${i}m`:a>0?`${a}h ${i}m ${s}s`:`${i}m ${s}s`}function Ie(e,t,o){const a=[];return e>0&&a.push(`${e} day${1!==e?"s":""}`),t>0&&a.push(`${t} hour${1!==t?"s":""}`),o>0&&a.push(`${o} minute${1!==o?"s":""}`),a.join(", ")}function Ne(e,t,o){const a=[];return e>0&&a.push(`${e}d`),t>0&&a.push(`${t}h`),o>0&&a.push(`${o}m`),a.join(" ")||"0m"}function Le(e){const t=e.toLowerCase().replace(/\s+/g,"");if(!t)return null;let o=0,a=!1;const i=t.match(/(\d+(?:\.\d+)?)\s*d/),s=t.match(/(\d+(?:\.\d+)?)\s*h/),r=t.match(/(\d+(?:\.\d+)?)\s*m(?!i)/);if(i?.[1]){const e=parseFloat(i[1]);if(isNaN(e)||e<0)return null;o+=e*$e,a=!0}if(s?.[1]){const e=parseFloat(s[1]);if(isNaN(e)||e<0)return null;o+=e*ze,a=!0}if(r?.[1]){const e=parseFloat(r[1]);if(isNaN(e)||e<0)return null;o+=e,a=!0}if(!a){const e=parseFloat(t);if(isNaN(e)||!(e>0))return null;o=e}if(o=Math.round(o),o<=0)return null;const n=Math.floor(o/$e),l=o%$e;return{days:n,hours:Math.floor(l/ze),minutes:l%ze}}function Oe(e){return null!==Le(e)}function Ue(e){return e.days*$e+e.hours*ze+e.minutes}function He(e,t){if(!e||!t)return null;const o=new Date(`${e}T${t}`).getTimezoneOffset(),a=o<=0?"+":"-",i=Math.abs(o);return`${e}T${t}${`${a}${String(Math.floor(i/60)).padStart(2,"0")}:${String(i%60).padStart(2,"0")}`}`}function Ge(e="light"){!function(e,t,o){const a=new CustomEvent(`hass-${t}`,{bubbles:!0,composed:!0,detail:o});e.dispatchEvent(a)}(window,"haptic",e)}function Be(e,t){const o=e,a=o?.translation_key??o?.data?.translation_key;if(a&&Ee[a])return Ee[a];const i=o?.message??"";for(const[e,t]of Object.entries(Ee))if(i.includes(e)||i.toLowerCase().includes(e.replace(/_/g," ")))return t;return`${t}. Check Home Assistant logs for details.`}async function qe(e,t){try{await e.callService("autosnooze","pause",t)}catch(e){throw console.error("[AutoSnooze] Failed to pause automations:",e),e}}async function We(e,t){try{await e.callService("autosnooze","cancel",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to wake automation:",e),e}}async function Ve(e,t){try{await e.callService("autosnooze","cancel_scheduled",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to cancel scheduled snooze:",e),e}}const Ye="autosnooze_last_duration";function Ze(e){return e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function Ke(e,t,o){return!(!e.labels||0===e.labels.length)&&e.labels.some(e=>{const a=o[e]?.name;return a?.toLowerCase()===t})}function Je(e,t,o){const a={};return e.forEach(e=>{const i=t(e);i&&0!==i.length?i.forEach(t=>{a[t]||(a[t]=[]),a[t].push(e)}):(a[o]||(a[o]=[]),a[o].push(e))}),Object.entries(a).sort((e,t)=>e[0]===o?1:t[0]===o?-1:e[0].localeCompare(t[0]))}function Xe(e,t){const o=new Set;return e.forEach(e=>{const a=t(e);a&&a.forEach(e=>o.add(e))}),o.size}const Qe="sensor.autosnooze_snoozed_automations";function et(e){const t=e?.states?.[Qe];return t?.attributes?.paused_automations??{}}class tt extends ne{constructor(){super(...arguments),this.config={},this._selected=[],this._duration=30*ve,this._customDuration={days:0,hours:0,minutes:30},this._customDurationInput="30m",this._loading=!1,this._scheduleMode=!1,this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime="",this._labelRegistry={},this._categoryRegistry={},this._entityRegistry={},this._showCustomInput=!1,this._automationsCache=null,this._automationsCacheVersion=0,this._lastDuration=null,this._adjustModalOpen=!1,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt="",this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[],this._labelsFetched=!1,this._categoriesFetched=!1,this._entityRegistryFetched=!1,this._lastHassStates=null,this._lastCacheVersion=0,this._toastTimeout=null,this._toastFadeTimeout=null}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-card",title:"AutoSnooze"}}setConfig(e){this.config=e}getCardSize(){const e=this._getPaused(),t=this._getScheduled();return 4+Object.keys(e).length+Object.keys(t).length}shouldUpdate(e){if(!e.has("hass"))return!0;const t=e.get("hass"),o=this.hass;if(!t||!o)return!0;const a=t.states?.["sensor.autosnooze_snoozed_automations"],i=o.states?.["sensor.autosnooze_snoozed_automations"];if(a!==i)return!0;if(t.entities!==o.entities)return!0;if(t.areas!==o.areas)return!0;if((t.language??t.locale?.language)!==(o.language??o.locale?.language))return!0;const s=o.states??{},r=t.states??{};for(const e of Object.keys(s))if(e.startsWith("automation.")&&r[e]!==s[e])return!0;for(const e of Object.keys(r))if(e.startsWith("automation.")&&!s[e])return!0;return!1}updated(e){if(super.updated(e),e.has("hass")&&this.hass?.connection&&(this._labelsFetched||this._fetchLabelRegistry(),this._categoriesFetched||this._fetchCategoryRegistry(),this._entityRegistryFetched||this._fetchEntityRegistry()),e.has("hass")&&this._adjustModalOpen){const e=this._getPaused();if(this._adjustModalEntityIds.length>0){this._adjustModalEntityIds.some(t=>e[t])||this._handleCloseModalEvent();const t=this._adjustModalEntityIds.find(t=>e[t]);if(t){const o=e[t];o?.resume_at&&o.resume_at!==this._adjustModalResumeAt&&(this._adjustModalResumeAt=o.resume_at)}}else if(this._adjustModalEntityId){const t=e[this._adjustModalEntityId];t?.resume_at&&t.resume_at!==this._adjustModalResumeAt&&(this._adjustModalResumeAt=t.resume_at),t||this._handleCloseModalEvent()}}}connectedCallback(){super.connectedCallback(),this._fetchLabelRegistry(),this._fetchCategoryRegistry(),this._fetchEntityRegistry(),this._lastDuration=function(){try{const e=localStorage.getItem(Ye);if(!e)return null;const t=JSON.parse(e);return"number"!=typeof t.minutes||"number"!=typeof t.duration?.days||"number"!=typeof t.duration?.hours||"number"!=typeof t.duration?.minutes||"number"!=typeof t.timestamp?null:Date.now()-t.timestamp>6048e5?(localStorage.removeItem(Ye),null):t}catch{return null}}()}disconnectedCallback(){super.disconnectedCallback(),null!==this._toastTimeout&&(clearTimeout(this._toastTimeout),this._toastTimeout=null),null!==this._toastFadeTimeout&&(clearTimeout(this._toastFadeTimeout),this._toastFadeTimeout=null)}async _fetchLabelRegistry(){!this._labelsFetched&&this.hass?.connection&&(this._labelRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/label_registry/list"}),o={};return Array.isArray(t)&&t.forEach(e=>{o[e.label_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch label registry:",e),{}}}(this.hass),this._labelsFetched=!0)}async _fetchCategoryRegistry(){!this._categoriesFetched&&this.hass?.connection&&(this._categoryRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/category_registry/list",scope:"automation"}),o={};return Array.isArray(t)&&t.forEach(e=>{o[e.category_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch category registry:",e),{}}}(this.hass),this._categoriesFetched=!0)}async _fetchEntityRegistry(){!this._entityRegistryFetched&&this.hass?.connection&&(this._entityRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/entity_registry/list"}),o={};return Array.isArray(t)&&t.filter(e=>e.entity_id.startsWith("automation.")).forEach(e=>{o[e.entity_id]=e}),o}catch(e){return console.warn("[AutoSnooze] Failed to fetch entity registry:",e),{}}}(this.hass),this._entityRegistryFetched=!0,this._automationsCacheVersion++)}_getAutomations(){if(!this.hass?.states)return[];const e=this.hass.states,t=this._automationsCacheVersion;if(this._lastHassStates===e&&this._lastCacheVersion===t&&this._automationsCache)return this._automationsCache;const o=function(e,t){const o=e?.states,a=e?.entities;if(!o)return[];const i=Object.keys(o).filter(e=>e.startsWith("automation.")).map(e=>{const i=o[e];if(!i)return null;const s=t?.[e],r=a?.[e],n=(s?.categories??{}).automation??null;return{id:e,name:i.attributes?.friendly_name??e.replace("automation.",""),area_id:s?.area_id??r?.area_id??null,category_id:n,labels:s?.labels??r?.labels??[]}}).filter(e=>null!==e).sort((e,t)=>e.name.localeCompare(t.name));return i}(this.hass,this._entityRegistry);return this._automationsCache=o,this._lastCacheVersion=t,this._lastHassStates=e,o}_getPaused(){return this.hass?et(this.hass):{}}_getPausedGroupedByResumeTime(){return this.hass?function(e){const t=et(e),o={};return Object.entries(t).forEach(([e,t])=>{const a=t.resume_at;o[a]||(o[a]={resumeAt:a,disableAt:t.disable_at,automations:[]}),o[a].automations.push({entity_id:e,friendly_name:t.friendly_name,resume_at:t.resume_at,paused_at:t.paused_at,days:t.days,hours:t.hours,minutes:t.minutes,disable_at:t.disable_at})}),Object.values(o).sort((e,t)=>new Date(e.resumeAt).getTime()-new Date(t.resumeAt).getTime())}(this.hass):[]}_getScheduled(){return this.hass?function(e){const t=e?.states?.[Qe];return t?.attributes?.scheduled_snoozes??{}}(this.hass):{}}_formatDateTime(e){return Me(e,this._getLocale())}_getLocale(){return this.hass?.locale?.language}_hasResumeAt(){return Boolean(this._resumeAtDate&&this._resumeAtTime)}_hasDisableAt(){return Boolean(this._disableAtDate&&this._disableAtTime)}_hapticFeedback(e="light"){Ge(e)}_showToast(e,t={}){const{showUndo:o=!1,onUndo:a=null}=t;if(!this.shadowRoot)return;const i=this.shadowRoot.querySelector(".toast");i&&i.remove();const s=document.createElement("div");if(s.className="toast",s.setAttribute("role","alert"),s.setAttribute("aria-live","polite"),s.setAttribute("aria-atomic","true"),o&&a){const t=document.createElement("span");t.textContent=e,s.appendChild(t);const o=document.createElement("button");o.className="toast-undo-btn",o.textContent=be(this.hass,"button.undo"),o.setAttribute("aria-label",be(this.hass,"a11y.undo_action")),o.addEventListener("click",e=>{e.stopPropagation(),a(),s.remove()}),s.appendChild(o)}else s.textContent=e;this.shadowRoot.appendChild(s),null!==this._toastTimeout&&clearTimeout(this._toastTimeout),null!==this._toastFadeTimeout&&clearTimeout(this._toastFadeTimeout),this._toastTimeout=window.setTimeout(()=>{this._toastTimeout=null,this.shadowRoot&&s.parentNode&&(s.style.animation=`slideUp ${ke}ms ease-out reverse`,this._toastFadeTimeout=window.setTimeout(()=>{this._toastFadeTimeout=null,s.parentNode&&s.remove()},ke))},Ce)}async _snooze(){if(0!==this._selected.length&&!this._loading){if(this._scheduleMode){if(!this._hasResumeAt())return void this._showToast(be(this.hass,"toast.error.resume_time_required"));const e=this._hasDisableAt()?He(this._disableAtDate,this._disableAtTime):null,t=He(this._resumeAtDate,this._resumeAtTime);if(!t)return void this._showToast(be(this.hass,"toast.error.invalid_datetime"));const o=Date.now()+je,a=new Date(t).getTime();if(a<=o)return void this._showToast(be(this.hass,"toast.error.resume_time_past"));if(e){if(new Date(e).getTime()>=a)return void this._showToast(be(this.hass,"toast.error.snooze_before_resume"))}}else if(0===this._duration)return;this._loading=!0;try{if(!this.hass)return void(this._loading=!1);const e=this._selected.length,t=[...this._selected],o=this._scheduleMode,a=this._hasDisableAt();let i;if(this._scheduleMode){const t=this._hasDisableAt()?He(this._disableAtDate,this._disableAtTime):null,o=He(this._resumeAtDate,this._resumeAtTime);if(!o)return void(this._loading=!1);if(await qe(this.hass,{entity_id:this._selected,resume_at:o,...t&&{disable_at:t}}),!this.isConnected||!this.shadowRoot)return void(this._loading=!1);if(t)i=1===e?be(this.hass,"toast.success.scheduled_one"):be(this.hass,"toast.success.scheduled_many",{count:e});else{const t=this._formatDateTime(o);i=1===e?be(this.hass,"toast.success.snoozed_until_one",{time:t}):be(this.hass,"toast.success.snoozed_until_many",{count:e,time:t})}}else{const{days:t,hours:o,minutes:a}=this._customDuration;if(await qe(this.hass,{entity_id:this._selected,days:t,hours:o,minutes:a}),!this.isConnected||!this.shadowRoot)return void(this._loading=!1);const s=Ie(t,o,a);i=1===e?be(this.hass,"toast.success.snoozed_for_one",{duration:s}):be(this.hass,"toast.success.snoozed_for_many",{count:e,duration:s});const r=Ue(this._customDuration);!function(e,t){try{const o={minutes:t,duration:e,timestamp:Date.now()};localStorage.setItem(Ye,JSON.stringify(o))}catch{}}(this._customDuration,r),this._lastDuration={minutes:r,duration:this._customDuration,timestamp:Date.now()}}this._hapticFeedback("success"),this._showToast(i,{showUndo:!0,onUndo:async()=>{try{if(!this.hass)return;for(const e of t)o&&a?await Ve(this.hass,e):await We(this.hass,e);if(this.isConnected){this._selected=t;const o=1===e?be(this.hass,"toast.success.restored_one"):be(this.hass,"toast.success.restored_many",{count:e});this._showToast(o)}}catch(e){console.error("Undo failed:",e),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.error.undo_failed"))}}}),this._selected=[],this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime=""}catch(e){console.error("Snooze failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Be(e,"Failed to snooze automations"))}this._loading=!1}}async _wake(e){if(this.hass)try{await We(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.resumed"))}catch(e){console.error("Wake failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Be(e,be(this.hass,"toast.error.resume_failed")))}}async _handleWakeEvent(e){await this._wake(e.detail.entityId)}async _handleWakeAllEvent(){if(this.hass)try{await async function(e){try{await e.callService("autosnooze","cancel_all",{})}catch(e){throw console.error("[AutoSnooze] Failed to wake all automations:",e),e}}(this.hass),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.resumed_all"))}catch(e){console.error("Wake all failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Be(e,be(this.hass,"toast.error.resume_all_failed")))}}_handleAdjustAutomationEvent(e){this._adjustModalOpen=!0,this._adjustModalEntityId=e.detail.entityId,this._adjustModalFriendlyName=e.detail.friendlyName,this._adjustModalResumeAt=e.detail.resumeAt,this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[]}_handleAdjustGroupEvent(e){this._adjustModalOpen=!0,this._adjustModalEntityIds=e.detail.entityIds,this._adjustModalFriendlyNames=e.detail.friendlyNames,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt=e.detail.resumeAt}async _handleAdjustTimeEvent(e){if(!this.hass)return;const{entityId:t,entityIds:o,...a}=e.detail,i=o||t||"";try{await async function(e,t,o){try{await e.callService("autosnooze","adjust",{entity_id:t,...o})}catch(e){throw console.error("[AutoSnooze] Failed to adjust snooze:",e),e}}(this.hass,i,a),this._hapticFeedback("success");const e=864e5*(a.days||0)+36e5*(a.hours||0)+6e4*(a.minutes||0),t=new Date(this._adjustModalResumeAt).getTime();this._adjustModalResumeAt=new Date(t+e).toISOString(),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.adjusted"))}catch(e){console.error("Adjust failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Be(e,be(this.hass,"toast.error.adjust_failed")))}}_handleCloseModalEvent(){this._adjustModalOpen=!1,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt="",this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[]}async _cancelScheduled(e){if(this.hass)try{await Ve(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.cancelled"))}catch(e){console.error("Cancel scheduled failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Be(e,be(this.hass,"toast.error.cancel_failed")))}}_handleDurationChange(e){const{minutes:t,duration:o,input:a,showCustomInput:i}=e.detail;this._duration=t*ve,this._customDuration=o,this._customDurationInput=a,void 0!==i&&(this._showCustomInput=i)}_handleScheduleModeChange(e){if(this._scheduleMode=e.detail.enabled,e.detail.enabled){const{date:e,time:t}=function(){const e=new Date;return{date:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,time:`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}}();this._disableAtDate=e,this._disableAtTime=t,this._resumeAtDate=e,this._resumeAtTime=t}}_handleScheduleFieldChange(e){const{field:t,value:o}=e.detail;switch(t){case"disableAtDate":this._disableAtDate=o;break;case"disableAtTime":this._disableAtTime=o;break;case"resumeAtDate":this._resumeAtDate=o;break;case"resumeAtTime":this._resumeAtTime=o}}_handleCustomInputToggle(e){this._showCustomInput=e.detail.show}_handleSelectionChange(e){this._selected=e.detail.selected}_renderScheduledPauses(e,t){return 0===e?"":G`
    ...
    `}render(){if(!this.hass||!this.config)return G``;const e=this._getPaused(),t=Object.keys(e).length,o=this._getScheduled(),a=Object.keys(o).length;return G`
      <ha-card>
        <div class="header">
    ...
    `}}tt.styles=fe,e([ce({attribute:!1})],tt.prototype,"hass",void 0),e([ce({attribute:!1})],tt.prototype,"config",void 0),e([he()],tt.prototype,"_selected",void 0),e([he()],tt.prototype,"_duration",void 0),e([he()],tt.prototype,"_customDuration",void 0),e([he()],tt.prototype,"_customDurationInput",void 0),e([he()],tt.prototype,"_loading",void 0),e([he()],tt.prototype,"_scheduleMode",void 0),e([he()],tt.prototype,"_disableAtDate",void 0),e([he()],tt.prototype,"_disableAtTime",void 0),e([he()],tt.prototype,"_resumeAtDate",void 0),e([he()],tt.prototype,"_resumeAtTime",void 0),e([he()],tt.prototype,"_labelRegistry",void 0),e([he()],tt.prototype,"_categoryRegistry",void 0),e([he()],tt.prototype,"_entityRegistry",void 0),e([he()],tt.prototype,"_showCustomInput",void 0),e([he()],tt.prototype,"_automationsCache",void 0),e([he()],tt.prototype,"_automationsCacheVersion",void 0),e([he()],tt.prototype,"_lastDuration",void 0),e([he()],tt.prototype,"_adjustModalOpen",void 0),e([he()],tt.prototype,"_adjustModalEntityId",void 0),e([he()],tt.prototype,"_adjustModalFriendlyName",void 0),e([he()],tt.prototype,"_adjustModalResumeAt",void 0),e([he()],tt.prototype,"_adjustModalEntityIds",void 0),e([he()],tt.prototype,"_adjustModalFriendlyNames",void 0);const ot=r`
  .row {
    margin-bottom: 12px;
  }
  .row label {
...
`;class at extends ne{constructor(){super(...arguments),this._config={}}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config)return;const o={...this._config,[e]:t};""!==t&&null!=t||delete o[e],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0}))}render(){return this._config?G`
      <div class="row">
    ...
    `:G``}}at.styles=ot,e([ce({attribute:!1})],at.prototype,"hass",void 0),e([he()],at.prototype,"_config",void 0);const it=r`
    :host {
      display: block;
    }
    .snooze-list {
...
`;class st extends ne{constructor(){super(...arguments),this.pauseGroups=[],this.pausedCount=0,this._wakeAllPending=!1,this._wakeAllTimeout=null,this._interval=null,this._syncTimeout=null}connectedCallback(){super.connectedCallback(),this._interval&&(window.clearInterval(this._interval),this._interval=null),this._syncTimeout&&(window.clearTimeout(this._syncTimeout),this._syncTimeout=null),this._startSynchronizedCountdown()}disconnectedCallback(){super.disconnectedCallback(),null!==this._interval&&(clearInterval(this._interval),this._interval=null),null!==this._syncTimeout&&(clearTimeout(this._syncTimeout),this._syncTimeout=null),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null)}_startSynchronizedCountdown(){const e=1e3-Date.now()%1e3;this._syncTimeout=window.setTimeout(()=>{this._syncTimeout=null,this._updateCountdownIfNeeded(),this._interval=window.setInterval(()=>{this._updateCountdownIfNeeded()},Te)},e)}_updateCountdownIfNeeded(){this.pauseGroups.length>0&&this.requestUpdate()}_handleWakeAll(){this._wakeAllPending?(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,this._fireWakeAll()):(Ge("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},Se))}_fireWake(e){this.dispatchEvent(new CustomEvent("wake-automation",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireAdjust(e){this.dispatchEvent(new CustomEvent("adjust-automation",{detail:{entityId:e.entity_id,friendlyName:e.friendly_name,resumeAt:e.resume_at},bubbles:!0,composed:!0}))}_fireAdjustGroup(e){this.dispatchEvent(new CustomEvent("adjust-group",{detail:{entityIds:e.automations.map(e=>e.entity_id),friendlyNames:e.automations.map(e=>e.friendly_name||e.entity_id),resumeAt:e.resumeAt},bubbles:!0,composed:!0}))}_fireWakeAll(){this.dispatchEvent(new CustomEvent("wake-all",{bubbles:!0,composed:!0}))}render(){if(0===this.pausedCount)return G``;const e=this.hass?.locale?.language;return G`
        ...
        ${this.pauseGroups.map(t=>G`
          <div class="pause-group" role="group">
            <div class="pause-group-header"
              ...
              ${t.disableAt?G`${be(this.hass,"status.resumes")} ${Me(t.resumeAt,e)}`:G`<span class="countdown">${Fe(t.resumeAt)}</span>`}
            </div>
            ${t.automations.map(e=>G`
              <div class="paused-item" @click=${()=>this._fireAdjust(e)}>
    ...
    `}}st.styles=it,e([ce({attribute:!1})],st.prototype,"hass",void 0),e([ce({attribute:!1})],st.prototype,"pauseGroups",void 0),e([ce({type:Number})],st.prototype,"pausedCount",void 0);const rt=r`
    :host {
      display: block;
    }
...
`;class nt extends ne{constructor(){super(...arguments),this.scheduleMode=!1,this.customDuration={days:0,hours:0,minutes:30},this.customDurationInput="30m",this.showCustomInput=!1,this.lastDuration=null,this.disableAtDate="",this.disableAtTime="",this.resumeAtDate="",this.resumeAtTime=""}_getDurationPills(){const e=this.hass?.states?.["sensor.autosnooze_snoozed_automations"],t=e?.attributes?.duration_presets,o=t?.length?t:De.filter(e=>null!==e.minutes);return[...o,{label:"Custom",minutes:null}]}_getDurationPreview(){const e=Le(this.customDurationInput);return e?Ie(e.days,e.hours,e.minutes):""}_isDurationValid(){return Oe(this.customDurationInput)}_renderDateOptions(){const e=function(e=365,t){const o=[],a=new Date,i=a.getFullYear();for(let s=0;s<e;s++){const e=new Date(a);e.setDate(e.getDate()+s);const r=e.getFullYear(),n=`${r}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=e.toLocaleDateString(t,{weekday:"short"}),d=e.toLocaleDateString(t,{month:"short"}),u=e.getDate(),c=r!==i?`${l}, ${d} ${u}, ${r}`:`${l}, ${d} ${u}`;o.push({value:n,label:c})}return o}(365,this.hass?.locale?.language);return e.map(e=>G`<option value="${e.value}">${e.label}</option>`)}_renderLastDurationBadge(){if(!this.lastDuration)return"";const e=this.hass?.states?.["sensor.autosnooze_snoozed_automations"],t=e?.attributes?.duration_presets,o=t?.length?t:De.filter(e=>null!==e.minutes),a=this.lastDuration.minutes,i=!o.some(e=>e.minutes===a);if(!i)return"";const{days:s,hours:r,minutes:n}=this.lastDuration.duration,l=Ne(s,r,n).replace(/ /g,""),d=Ue(this.customDuration),u=!this.showCustomInput&&a===d;return G`
      <button
        type="button"
        class="last-duration-badge ${u?"active":""}"
        @click=${()=>this._fireDurationChange(a)}
      >
        <ha-icon icon="mdi:history" aria-hidden="true"></ha-icon>
        ${l}
      </button>
    `}_fireDurationChange(e,t){const o=function(e){const t=Math.floor(e/$e),o=e%$e;return{days:t,hours:Math.floor(o/ze),minutes:o%ze}}(e),a=Ne(o.days,o.hours,o.minutes);this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:e,duration:o,input:a,showCustomInput:t?.showCustomInput??!1},bubbles:!0,composed:!0}))}_fireCustomDurationChange(e){const t=Le(e),o=t?Ue(t):0;this.dispatchEvent(new CustomEvent("duration-change",{detail:{minutes:o,duration:t??{days:0,hours:0,minutes:0},input:e},bubbles:!0,composed:!0}))}_fireScheduleModeChange(e){this.dispatchEvent(new CustomEvent("schedule-mode-change",{detail:{enabled:e},bubbles:!0,composed:!0}))}_fireScheduleFieldChange(e,t){this.dispatchEvent(new CustomEvent("schedule-field-change",{detail:{field:e,value:t},bubbles:!0,composed:!0}))}render(){return this.scheduleMode?G`
      ...
      <div class="duration-selector">
        ...
        <div class="duration-pills" role="radiogroup" aria-labelledby="duration-header">
          ${this._getDurationPills().map(e=>{const t=Ue(this.customDuration),o=null===e.minutes?this.showCustomInput:!this.showCustomInput&&e.minutes===t;return G`
                <button
                  type="button"
                  class="pill ${o?"active":""}"
    ...
    `}}nt.styles=rt,e([ce({attribute:!1})],nt.prototype,"hass",void 0),e([ce({type:Boolean})],nt.prototype,"scheduleMode",void 0),e([ce({attribute:!1})],nt.prototype,"customDuration",void 0),e([ce({type:String})],nt.prototype,"customDurationInput",void 0),e([ce({type:Boolean})],nt.prototype,"showCustomInput",void 0),e([ce({attribute:!1})],nt.prototype,"lastDuration",void 0),e([ce({type:String})],nt.prototype,"disableAtDate",void 0),e([ce({type:String})],nt.prototype,"disableAtTime",void 0),e([ce({type:String})],nt.prototype,"resumeAtDate",void 0),e([ce({type:String})],nt.prototype,"resumeAtTime",void 0);const lt=r`
    :host {
      display: block;
    }
...
`;class dt extends ne{constructor(){super(...arguments),this.automations=[],this.selected=[],this.labelRegistry={},this.categoryRegistry={},this._filterTab="all",this._search="",this._expandedGroups={},this._searchTimeout=null}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null)}_fireSelectionChange(e){this.dispatchEvent(new CustomEvent("selection-change",{detail:{selected:e},bubbles:!0,composed:!0}))}_toggleSelection(e){let t;Ge("selection"),t=this.selected.includes(e)?this.selected.filter(t=>t!==e):[...this.selected,e],this._fireSelectionChange(t)}_toggleGroupExpansion(e){this._expandedGroups={...this._expandedGroups,[e]:!this._expandedGroups[e]}}_selectGroup(e){const t=e.map(e=>e.id);let o;o=t.every(e=>this.selected.includes(e))?this.selected.filter(e=>!t.includes(e)):[...new Set([...this.selected,...t])],this._fireSelectionChange(o)}_selectAllVisible(){const e=this._getFilteredAutomations().map(e=>e.id);let t;t=e.every(e=>this.selected.includes(e))?this.selected.filter(t=>!e.includes(t)):[...new Set([...this.selected,...e])],this._fireSelectionChange(t)}_clearSelection(){this._fireSelectionChange([])}_getFilteredAutomations(){return function(e,t,o){let a=e;const i=e.some(e=>Ke(e,Pe,o));a=i?a.filter(e=>Ke(e,Pe,o)):a.filter(e=>!Ke(e,Re,o));const s=t.toLowerCase();return s&&(a=a.filter(e=>e.name.toLowerCase().includes(s)||e.id.toLowerCase().includes(s))),a}(this.automations,this._search,this.labelRegistry)}_getAreaName(e){return this.hass?function(e,t){return e?t.areas?.[e]?.name??Ze(e):"Unassigned"}(e,this.hass):be(this.hass,"group.unassigned")}_getLabelName(e){return function(e,t){return t[e]?.name??Ze(e)}(e,this.labelRegistry)}_getCategoryName(e){return function(e,t){return e?t[e]?.name??Ze(e):"Uncategorized"}(e,this.categoryRegistry)}_getGroupedByArea(){return Je(this._getFilteredAutomations(),e=>e.area_id?[this._getAreaName(e.area_id)]:null,be(this.hass,"group.unassigned"))}_getGroupedByLabel(){const e=this._getFilteredAutomations(),t=[Re.toLowerCase(),Pe.toLowerCase()];return Je(e,e=>{if(!e.labels?.length)return null;const o=e.labels.map(e=>this._getLabelName(e)).filter(e=>!t.includes(e.toLowerCase()));return o.length>0?o:null},be(this.hass,"group.unlabeled"))}_getGroupedByCategory(){return Je(this._getFilteredAutomations(),e=>e.category_id?[this._getCategoryName(e.category_id)]:null,be(this.hass,"group.uncategorized"))}_getAreaCount(){return Xe(this.automations,e=>e.area_id?[e.area_id]:null)}_getLabelCount(){const e=[Re.toLowerCase(),Pe.toLowerCase()];return Xe(this.automations,t=>{if(!t.labels?.length)return null;const o=t.labels.filter(t=>!e.includes(this._getLabelName(t).toLowerCase()));return o.length>0?o:null})}_getCategoryCount(){return Xe(this.automations,e=>e.category_id?[e.category_id]:null)}_handleSearchInput(e){const t=e.target.value;null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},Ae)}_handleKeyDown(e,t){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),t())}_renderSelectionList(){const e=this._getFilteredAutomations();if("all"===this._filterTab)return 0===e.length?G`<div class="list-empty" role="status">${be(this.hass,"list.empty")}</div>`:e.map(e=>G`
        <button
          type="button"
      ...
      ${this._getFilteredAutomations().length>0?G`
            <div class="selection-actions" role="toolbar" aria-label="${be(this.hass,"a11y.selection_actions")}">
              <span role="status" aria-live="polite">${be(this.hass,"selection.count",{selected:this.selected.length,total:this._getFilteredAutomations().length})}</span>
              <button
                type="button"
                class="select-all-btn"
                @click=${()=>this._selectAllVisible()}
                aria-label="${this._getFilteredAutomations().every(e=>this.selected.includes(e.id))?be(this.hass,"a11y.deselect_all"):be(this.hass,"a11y.select_all")}"
              >
                ${this._getFilteredAutomations().every(e=>this.selected.includes(e.id))?be(this.hass,"button.deselect_all"):be(this.hass,"button.select_all")}
              </button>
    ...
    `}}dt.styles=lt,e([ce({attribute:!1})],dt.prototype,"hass",void 0),e([ce({attribute:!1})],dt.prototype,"automations",void 0),e([ce({attribute:!1})],dt.prototype,"selected",void 0),e([ce({attribute:!1})],dt.prototype,"labelRegistry",void 0),e([ce({attribute:!1})],dt.prototype,"categoryRegistry",void 0),e([he()],dt.prototype,"_filterTab",void 0),e([he()],dt.prototype,"_search",void 0),e([he()],dt.prototype,"_expandedGroups",void 0);const ut=r`
    :host {
      display: block;
    }
    .modal-overlay {
...
`,ct=[{label:"+15m",minutes:15},{label:"+30m",minutes:30},{label:"+1h",hours:1},{label:"+2h",hours:2}],ht=[{label:"-15m",minutes:-15,thresholdMs:9e5},{label:"-30m",minutes:-30,thresholdMs:18e5}];class pt extends ne{constructor(){super(...arguments),this.open=!1,this.entityId="",this.friendlyName="",this.resumeAt="",this.entityIds=[],this.friendlyNames=[],this._interval=null,this._syncTimeout=null}get _isGroupMode(){return this.entityIds.length>1}updated(e){e.has("open")&&(this.open?this._startSynchronizedCountdown():this._stopCountdown())}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown()}_startSynchronizedCountdown(){this._stopCountdown();const e=1e3-Date.now()%1e3;this._syncTimeout=window.setTimeout(()=>{this._syncTimeout=null,this.requestUpdate(),this._interval=window.setInterval(()=>{this.requestUpdate()},Te)},e)}_stopCountdown(){null!==this._interval&&(clearInterval(this._interval),this._interval=null),null!==this._syncTimeout&&(clearTimeout(this._syncTimeout),this._syncTimeout=null)}_isDecrementDisabled(e){if(!this.resumeAt)return!0;return new Date(this.resumeAt).getTime()-Date.now()-e<6e4}_fireAdjustTime(e){this.entityIds.length>0?this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityIds:this.entityIds,...e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityId:this.entityId,...e},bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}render(){return this.open?G`
      <div class="modal-overlay" @click=${this._handleOverlayClick}>
        <div class="modal-content" @click=${e=>e.stopPropagation()}>
          ...
          <div class="modal-body">
            ...
            <div class="remaining-time">${Fe(this.resumeAt)}</div>
    ...
    `:G``}}pt.styles=ut,e([ce({attribute:!1})],pt.prototype,"hass",void 0),e([ce({type:Boolean})],pt.prototype,"open",void 0),e([ce({type:String})],pt.prototype,"entityId",void 0),e([ce({type:String})],pt.prototype,"friendlyName",void 0),e([ce({type:String})],pt.prototype,"resumeAt",void 0),e([ce({attribute:!1})],pt.prototype,"entityIds",void 0),e([ce({attribute:!1})],pt.prototype,"friendlyNames",void 0),customElements.get("autosnooze-card-editor")||customElements.define("autosnooze-card-editor",at),customElements.get("autosnooze-active-pauses")||customElements.define("autosnooze-active-pauses",st),customElements.get("autosnooze-duration-selector")||customElements.define("autosnooze-duration-selector",nt),customElements.get("autosnooze-automation-list")||customElements.define("autosnooze-automation-list",dt),customElements.get("autosnooze-adjust-modal")||customElements.define("autosnooze-adjust-modal",pt),customElements.get("autosnooze-card")||customElements.define("autosnooze-card",tt),window.customCards=window.customCards||[],window.customCards.some(e=>"autosnooze-card"===e.type)||window.customCards.push({type:"autosnooze-card",name:"AutoSnooze Card",description:"Temporarily pause automations with area and label filtering (v0.2.10)",preview:!0});export{st as AutoSnoozeActivePauses,pt as AutoSnoozeAdjustModal,dt as AutoSnoozeAutomationList,nt as AutoSnoozeDurationSelector,tt as AutomationPauseCard,at as AutomationPauseCardEditor};
