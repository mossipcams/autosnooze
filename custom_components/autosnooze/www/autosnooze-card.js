...
`,ve=1e3,xe=6e4,we=36e5,ze=864e5,$e=60,Ae=1440,ke=300,Se=300,Ce=3e3,Te=5e3,De=1e3,je=5e3,Re=1e3,Ee=3e4,Pe=[{label:"30m",minutes:30},{label:"1h",minutes:60},{label:"12h",minutes:720},{label:"1d",minutes:1440},{label:"Custom",minutes:null}],Me={not_automation:"Failed to snooze: One or more selected items are not automations",invalid_duration:"Failed to snooze: Please specify a valid duration (days, hours, or minutes)",resume_time_past:"Failed to snooze: Resume time must be in the future",disable_after_resume:"Failed to snooze: Snooze time must be before resume time",save_failed:"Failed to save changes. Please try again or check Home Assistant logs.",invalid_adjustment:"Adjustment must be non-zero. Specify at least one of: days, hours, or minutes.",adjust_time_too_short:"Cannot shorten snooze that much. Resume time must be at least 1 minute away.",confirm_required:"Failed to snooze: Confirmation is required for one or more selected automations"},Fe="autosnooze_exclude",Ie="autosnooze_include";function Ne(e,t){const a=new Date(e),o=new Date,i={weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return a.getFullYear()>o.getFullYear()&&(i.year="numeric"),a.toLocaleString(t,i)}function Oe(e,t="Resuming..."){const a=new Date(e).getTime()-Date.now();if(a<=0)return t;const o=Math.floor(a/ze),i=Math.floor(a%ze/we),s=Math.floor(a%we/xe),r=Math.floor(a%xe/ve);return o>0?`${o}d ${i}h ${s}m`:i>0?`${i}h ${s}m ${r}s`:`${s}m ${r}s`}function Le(e,t,a){const o=[];return e>0&&o.push(`${e} day${1!==e?"s":""}`),t>0&&o.push(`${t} hour${1!==t?"s":""}`),a>0&&o.push(`${a} minute${1!==a?"s":""}`),o.join(", ")}function Ue(e,t,a){const o=[];return e>0&&o.push(`${e}d`),t>0&&o.push(`${t}h`),a>0&&o.push(`${a}m`),o.join(" ")||"0m"}function He(e){const t=e.toLowerCase().replace(/\s+/g,"");if(!t)return null;let a=0,o=!1;const i=t.match(/(\d+(?:\.\d+)?)\s*d/),s=t.match(/(\d+(?:\.\d+)?)\s*h/),r=t.match(/(\d+(?:\.\d+)?)\s*m(?!i)/);if(i?.[1]){const e=parseFloat(i[1]);if(isNaN(e)||e<0)return null;a+=e*Ae,o=!0}if(s?.[1]){const e=parseFloat(s[1]);if(isNaN(e)||e<0)return null;a+=e*$e,o=!0}if(r?.[1]){const e=parseFloat(r[1]);if(isNaN(e)||e<0)return null;a+=e,o=!0}if(!o){const e=parseFloat(t);if(isNaN(e)||!(e>0))return null;a=e}if(a=Math.round(a),a<=0)return null;const n=Math.floor(a/Ae),l=a%Ae;return{days:n,hours:Math.floor(l/$e),minutes:l%$e}}function Ge(e){return null!==He(e)}function Be(e){return e.days*Ae+e.hours*$e+e.minutes}function We(e,t){if(!e||!t)return null;const a=new Date(`${e}T${t}`).getTimezoneOffset(),o=a<=0?"+":"-",i=Math.abs(a);return`${e}T${t}${`${o}${String(Math.floor(i/60)).padStart(2,"0")}:${String(i%60).padStart(2,"0")}`}`}function qe(e="light"){!function(e,t,a){const o=new CustomEvent(`hass-${t}`,{bubbles:!0,composed:!0,detail:a});e.dispatchEvent(o)}(window,"haptic",e)}function Ve(e,t){const a=e,o=a?.translation_key??a?.data?.translation_key;if(o&&Me[o])return Me[o];const i=a?.message??"";for(const[e,t]of Object.entries(Me))if(i.includes(e)||i.toLowerCase().includes(e.replace(/_/g," ")))return t;return`${t}. Check Home Assistant logs for details.`}function Ye(e){const t={interval:null,syncTimeout:null},a=1e3-Date.now()%1e3;return t.syncTimeout=window.setTimeout(()=>{t.syncTimeout=null,e(),t.interval=window.setInterval(()=>{e()},De)},a),t}function Ze(e){null!==e.interval&&(clearInterval(e.interval),e.interval=null),null!==e.syncTimeout&&(clearTimeout(e.syncTimeout),e.syncTimeout=null)}async function Ke(e,t){try{await e.callService("autosnooze","cancel",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to wake automation:",e),e}}async function Je(e,t){try{await e.callService("autosnooze","cancel_scheduled",{entity_id:t})}catch(e){throw console.error("[AutoSnooze] Failed to cancel scheduled snooze:",e),e}}const Xe="autosnooze_last_duration";async function Qe(e,t){await async function(e,t){try{await e.callService("autosnooze","pause",t)}catch(e){throw console.error("[AutoSnooze] Failed to pause automations:",e),e}}(e,t)}async function et(e){await async function(e){try{await e.callService("autosnooze","cancel_all",{})}catch(e){throw console.error("[AutoSnooze] Failed to wake all automations:",e),e}}(e)}async function tt(e,t,a){await async function(e,t,a){try{await e.callService("autosnooze","adjust",{entity_id:t,...a})}catch(e){throw console.error("[AutoSnooze] Failed to adjust snooze:",e),e}}(e,t,a)}function at(e){return e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function ot(e,t,a){return!(!e.labels||0===e.labels.length)&&e.labels.some(e=>{const o=a[e]?.name;return o?.toLowerCase()===t})}function it(e,t,a){const o={};return e.forEach(e=>{const i=t(e);i&&0!==i.length?i.forEach(t=>{o[t]||(o[t]=[]),o[t].push(e)}):(o[a]||(o[a]=[]),o[a].push(e))}),Object.entries(o).sort((e,t)=>e[0]===a?1:t[0]===a?-1:e[0].localeCompare(t[0]))}function st(e,t){const a=new Set;return e.forEach(e=>{const o=t(e);o&&o.forEach(e=>a.add(e))}),a.size}const rt="sensor.autosnooze_snoozed_automations";function nt(e){const t=e?.states?.[rt];return t?.attributes?.paused_automations??{}}class lt extends ne{constructor(){super(...arguments),this.config={},this._selected=[],this._duration=30*xe,this._customDuration={days:0,hours:0,minutes:30},this._customDurationInput="30m",this._loading=!1,this._scheduleMode=!1,this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime="",this._labelRegistry={},this._labelRegistryUnavailable=!1,this._categoryRegistry={},this._entityRegistry={},this._showCustomInput=!1,this._automationsCache=null,this._automationsCacheVersion=0,this._lastDuration=null,this._adjustModalOpen=!1,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt="",this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[],this._guardrailConfirmOpen=!1,this._labelsFetched=!1,this._categoriesFetched=!1,this._entityRegistryFetched=!1,this._lastAutomationFingerprintStates=null,this._lastAutomationFingerprint="",this._lastHassStates=null,this._lastCacheVersion=0,this._toastTimeout=null,this._toastFadeTimeout=null,this._labelRegistryRetryTimeout=null,this._labelRegistryRetryDelayMs=Re}static getConfigElement(){return document.createElement("autosnooze-card-editor")}static getStubConfig(){return{type:"custom:autosnooze-card",title:"AutoSnooze"}}setConfig(e){this.config=e}getCardSize(){const e=this._getPaused(),t=this._getScheduled();return 4+Object.keys(e).length+Object.keys(t).length}shouldUpdate(e){if(!e.has("hass"))return!0;const t=e.get("hass"),a=this.hass;if(!t||!a)return!0;const o=t.states?.[rt],i=a.states?.[rt];if(o!==i)return!0;if(t.entities!==a.entities)return!0;if(t.areas!==a.areas)return!0;if((t.language??t.locale?.language)!==(a.language??a.locale?.language))return!0;const s=a.states,r=t.states;if(!s||!r)return!0;if(r===s)return!1;return this._getAutomationStateFingerprint(r)!==this._getAutomationStateFingerprint(s)}updated(e){if(super.updated(e),e.has("hass")&&this.hass?.connection&&(this._labelsFetched||null!==this._labelRegistryRetryTimeout||this._fetchLabelRegistry(),this._categoriesFetched||this._fetchCategoryRegistry(),this._entityRegistryFetched||this._fetchEntityRegistry()),e.has("hass")&&this._adjustModalOpen){const e=this._getPaused();if(this._adjustModalEntityIds.length>0){this._adjustModalEntityIds.some(t=>e[t])||this._handleCloseModalEvent();const t=this._adjustModalEntityIds.find(t=>e[t]);if(t){const a=e[t];a?.resume_at&&a.resume_at!==this._adjustModalResumeAt&&(this._adjustModalResumeAt=a.resume_at)}}else if(this._adjustModalEntityId){const t=e[this._adjustModalEntityId];t?.resume_at&&t.resume_at!==this._adjustModalResumeAt&&(this._adjustModalResumeAt=t.resume_at),t||this._handleCloseModalEvent()}}}connectedCallback(){super.connectedCallback(),this._fetchLabelRegistry(),this._fetchCategoryRegistry(),this._fetchEntityRegistry(),this._lastDuration=function(){try{const e=localStorage.getItem(Xe);if(!e)return null;const t=JSON.parse(e);return"number"!=typeof t.minutes||"number"!=typeof t.duration?.days||"number"!=typeof t.duration?.hours||"number"!=typeof t.duration?.minutes||"number"!=typeof t.timestamp?null:Date.now()-t.timestamp>6048e5?(localStorage.removeItem(Xe),null):t}catch{return null}}()}disconnectedCallback(){super.disconnectedCallback(),null!==this._toastTimeout&&(clearTimeout(this._toastTimeout),this._toastTimeout=null),null!==this._toastFadeTimeout&&(clearTimeout(this._toastFadeTimeout),this._toastFadeTimeout=null),null!==this._labelRegistryRetryTimeout&&(clearTimeout(this._labelRegistryRetryTimeout),this._labelRegistryRetryTimeout=null)}async _fetchLabelRegistry(){if(this._labelsFetched||!this.hass?.connection)return;const e=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/label_registry/list"}),a={};return Array.isArray(t)&&t.forEach(e=>{a[e.label_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch label registry:",e),null}}(this.hass);if(null!==e)this._labelRegistry=e,this._labelsFetched=!0,this._labelRegistryUnavailable=!1,this._automationsCacheVersion++,this._labelRegistryRetryDelayMs=Re,null!==this._labelRegistryRetryTimeout&&(clearTimeout(this._labelRegistryRetryTimeout),this._labelRegistryRetryTimeout=null);else if(this._labelsFetched=!1,this._labelRegistryUnavailable=!0,null===this._labelRegistryRetryTimeout){const e=this._labelRegistryRetryDelayMs;this._labelRegistryRetryTimeout=window.setTimeout(()=>{this._labelRegistryRetryTimeout=null,this.isConnected&&this._fetchLabelRegistry()},e),this._labelRegistryRetryDelayMs=Math.min(2*this._labelRegistryRetryDelayMs,Ee)}}async _fetchCategoryRegistry(){!this._categoriesFetched&&this.hass?.connection&&(this._categoryRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/category_registry/list",scope:"automation"}),a={};return Array.isArray(t)&&t.forEach(e=>{a[e.category_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch category registry:",e),{}}}(this.hass),this._categoriesFetched=!0)}async _fetchEntityRegistry(){!this._entityRegistryFetched&&this.hass?.connection&&(this._entityRegistry=await async function(e){try{const t=await e.connection.sendMessagePromise({type:"config/entity_registry/list"}),a={};return Array.isArray(t)&&t.filter(e=>e.entity_id.startsWith("automation.")).forEach(e=>{a[e.entity_id]=e}),a}catch(e){return console.warn("[AutoSnooze] Failed to fetch entity registry:",e),{}}}(this.hass),this._entityRegistryFetched=!0,this._automationsCacheVersion++)}_getAutomations(){if(!this.hass?.states)return[];const e=this.hass.states,t=this._automationsCacheVersion;if(this._lastHassStates===e&&this._lastCacheVersion===t&&this._automationsCache)return this._automationsCache;const a=function(e,t){const a=e?.states,o=e?.entities;if(!a)return[];const i=Object.keys(a).filter(e=>e.startsWith("automation.")).map(e=>{const i=a[e];if(!i)return null;const s=t?.[e],r=o?.[e],n=(s?.categories??{}).automation??null;return{id:e,name:i.attributes?.friendly_name??e.replace("automation.",""),area_id:s?.area_id??r?.area_id??null,category_id:n,labels:s?.labels??r?.labels??[]}}).filter(e=>null!==e).sort((e,t)=>e.name.localeCompare(t.name));return i}(this.hass,this._entityRegistry);return this._automationsCache=a,this._lastCacheVersion=t,this._lastHassStates=e,a}_getAutomationStateFingerprint(e){if(this._lastAutomationFingerprintStates===e)return this._lastAutomationFingerprint;const t=Object.keys(e).filter(e=>e.startsWith("automation.")).sort().map(t=>{const a=e[t];return`${t}:${a?.state??""}:${a?.last_changed??""}:${a?.last_updated??""}`}).join("|");return this._lastAutomationFingerprintStates=e,this._lastAutomationFingerprint=t,t}_getPaused(){return this.hass?nt(this.hass):{}}_getPausedGroupedByResumeTime(){return this.hass?function(e){const t=nt(e),a={};return Object.entries(t).forEach(([e,t])=>{const o=t.resume_at;a[o]||(a[o]={resumeAt:o,disableAt:t.disable_at,automations:[]}),a[o].automations.push({entity_id:e,friendly_name:t.friendly_name,resume_at:t.resume_at,paused_at:t.paused_at,days:t.days,hours:t.hours,minutes:t.minutes,disable_at:t.disable_at})}),Object.values(a).sort((e,t)=>new Date(e.resumeAt).getTime()-new Date(t.resumeAt).getTime())}(this.hass):[]}_getScheduled(){return this.hass?function(e){const t=e?.states?.[rt];return t?.attributes?.scheduled_snoozes??{}}(this.hass):{}}_isSnoozeSensorAvailable(){return Boolean(this.hass?.states?.[rt])}_formatDateTime(e){return Ne(e,this._getLocale())}_getLocale(){return this.hass?.locale?.language}_hasResumeAt(){return Boolean(this._resumeAtDate&&this._resumeAtTime)}_hasDisableAt(){return Boolean(this._disableAtDate&&this._disableAtTime)}_hapticFeedback(e="light"){qe(e)}_showToast(e,t={}){const{showUndo:a=!1,onUndo:o=null}=t;if(!this.shadowRoot)return;const i=this.shadowRoot.querySelector(".toast");i&&i.remove();const s=document.createElement("div");if(s.className="toast",s.setAttribute("role","alert"),s.setAttribute("aria-live","polite"),s.setAttribute("aria-atomic","true"),a&&o){const t=document.createElement("span");t.textContent=e,s.appendChild(t);const a=document.createElement("button");a.className="toast-undo-btn",a.textContent=be(this.hass,"button.undo"),a.setAttribute("aria-label",be(this.hass,"a11y.undo_action")),a.addEventListener("click",e=>{e.stopPropagation(),o(),s.remove()}),s.appendChild(a)}else s.textContent=e;this.shadowRoot.appendChild(s),null!==this._toastTimeout&&clearTimeout(this._toastTimeout),null!==this._toastFadeTimeout&&clearTimeout(this._toastFadeTimeout),this._toastTimeout=window.setTimeout(()=>{this._toastTimeout=null,this.shadowRoot&&s.parentNode&&(s.style.animation=`slideUp ${Se}ms ease-out reverse`,this._toastFadeTimeout=window.setTimeout(()=>{this._toastFadeTimeout=null,s.parentNode&&s.remove()},Se))},Te)}async _callPauseWithGuardrailConfirm(e,t=!1){if(!this.hass)return!1;if(t)return await Qe(this.hass,{...e,confirm:!0}),!0;try{return await Qe(this.hass,e),!0}catch(e){const t=e;if("confirm_required"===(t?.translation_key??t?.data?.translation_key))return this._guardrailConfirmOpen=!0,!1;throw e}}async _snooze(e=!1){if(0!==this._selected.length&&!this._loading){if(this._scheduleMode){if(!this._hasResumeAt())return void this._showToast(be(this.hass,"toast.error.resume_time_required"));const e=this._hasDisableAt()?We(this._disableAtDate,this._disableAtTime):null,t=We(this._resumeAtDate,this._resumeAtTime);if(!t)return void this._showToast(be(this.hass,"toast.error.invalid_datetime"));const a=Date.now()+je,o=new Date(t).getTime();if(o<=a)return void this._showToast(be(this.hass,"toast.error.resume_time_past"));if(e){if(new Date(e).getTime()>=o)return void this._showToast(be(this.hass,"toast.error.snooze_before_resume"))}}else if(0===this._duration)return;this._loading=!0,this._guardrailConfirmOpen=!1;try{if(!this.hass)return void(this._loading=!1);const t=this._selected.length,a=[...this._selected],o=this._scheduleMode,i=this._hasDisableAt();let s;if(this._scheduleMode){const a=this._hasDisableAt()?We(this._disableAtDate,this._disableAtTime):null,o=We(this._resumeAtDate,this._resumeAtTime);if(!o)return void(this._loading=!1);if(!await this._callPauseWithGuardrailConfirm({entity_id:this._selected,resume_at:o,...a&&{disable_at:a}},e))return void(this._loading=!1);if(!this.isConnected||!this.shadowRoot)return void(this._loading=!1);if(a)s=1===t?be(this.hass,"toast.success.scheduled_one"):be(this.hass,"toast.success.scheduled_many",{count:t});else{const e=this._formatDateTime(o);s=1===t?be(this.hass,"toast.success.snoozed_until_one",{time:e}):be(this.hass,"toast.success.snoozed_until_many",{count:t,time:e})}}else{const{days:a,hours:o,minutes:i}=this._customDuration;if(!await this._callPauseWithGuardrailConfirm({entity_id:this._selected,days:a,hours:o,minutes:i},e))return void(this._loading=!1);if(!this.isConnected||!this.shadowRoot)return void(this._loading=!1);const r=Le(a,o,i);s=1===t?be(this.hass,"toast.success.snoozed_for_one",{duration:r}):be(this.hass,"toast.success.snoozed_for_many",{count:t,duration:r});const n=Be(this._customDuration);!function(e,t){try{const a={minutes:t,duration:e,timestamp:Date.now()};localStorage.setItem(Xe,JSON.stringify(a))}catch{}}(this._customDuration,n),this._lastDuration={minutes:n,duration:this._customDuration,timestamp:Date.now()}}this._hapticFeedback("success"),this._showToast(s,{showUndo:!0,onUndo:async()=>{try{if(!this.hass)return;const e=await async function(e,t,a){const o=a.wasScheduleMode&&a.hadDisableAt?t=>Je(e,t):t=>Ke(e,t),i=await Promise.allSettled(t.map(e=>o(e))),s=[],r=[];return i.forEach((e,a)=>{const o=t[a];o&&("fulfilled"===e.status?s.push(o):r.push(o))}),{succeeded:s,failed:r}}(this.hass,a,{wasScheduleMode:o,hadDisableAt:i});if(this.isConnected)if(0===e.failed.length){this._selected=a;const e=1===t?be(this.hass,"toast.success.restored_one"):be(this.hass,"toast.success.restored_many",{count:t});this._showToast(e)}else this._selected=e.failed,this._showToast(be(this.hass,"toast.error.undo_failed"))}catch(e){console.error("Undo failed:",e),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.error.undo_failed"))}}}),this._selected=[],this._disableAtDate="",this._disableAtTime="",this._resumeAtDate="",this._resumeAtTime=""}catch(e){console.error("Snooze failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ve(e,"Failed to snooze automations"))}this._loading=!1}}async _wake(e){if(this.hass)try{await async function(e,t){await Ke(e,t)}(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.resumed"))}catch(e){console.error("Wake failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ve(e,be(this.hass,"toast.error.resume_failed")))}}async _handleWakeEvent(e){await this._wake(e.detail.entityId)}async _handleWakeAllEvent(){if(this.hass)try{await et(this.hass),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.resumed_all"))}catch(e){console.error("Wake all failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ve(e,be(this.hass,"toast.error.resume_all_failed")))}}_handleAdjustAutomationEvent(e){this._adjustModalOpen=!0,this._adjustModalEntityId=e.detail.entityId,this._adjustModalFriendlyName=e.detail.friendlyName,this._adjustModalResumeAt=e.detail.resumeAt,this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[]}_handleAdjustGroupEvent(e){this._adjustModalOpen=!0,this._adjustModalEntityIds=e.detail.entityIds,this._adjustModalFriendlyNames=e.detail.friendlyNames,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt=e.detail.resumeAt}async _handleAdjustTimeEvent(e){if(!this.hass)return;const{entityId:t,entityIds:a,...o}=e.detail,i=a||t||"";try{await tt(this.hass,i,o),this._hapticFeedback("success");const e=(o.days||0)*ze+(o.hours||0)*we+(o.minutes||0)*xe,t=new Date(this._adjustModalResumeAt).getTime();this._adjustModalResumeAt=new Date(t+e).toISOString(),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.adjusted"))}catch(e){console.error("Adjust failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ve(e,be(this.hass,"toast.error.adjust_failed")))}}_handleCloseModalEvent(){this._adjustModalOpen=!1,this._adjustModalEntityId="",this._adjustModalFriendlyName="",this._adjustModalResumeAt="",this._adjustModalEntityIds=[],this._adjustModalFriendlyNames=[]}async _cancelScheduled(e){if(this.hass)try{await async function(e,t){await Je(e,t)}(this.hass,e),this._hapticFeedback("success"),this.isConnected&&this.shadowRoot&&this._showToast(be(this.hass,"toast.success.cancelled"))}catch(e){console.error("Cancel scheduled failed:",e),this._hapticFeedback("failure"),this.isConnected&&this.shadowRoot&&this._showToast(Ve(e,be(this.hass,"toast.error.cancel_failed")))}}_handleDurationChange(e){const{minutes:t,duration:a,input:o,showCustomInput:i}=e.detail;this._duration=t*xe,this._customDuration=a,this._customDurationInput=o,void 0!==i&&(this._showCustomInput=i)}_handleScheduleModeChange(e){if(this._scheduleMode=e.detail.enabled,e.detail.enabled){const e=new Date,{date:t,time:a}=function(){const e=new Date;return{date:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,time:`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}}(),o=this._lastDuration?.minutes??30,i=new Date(e.getTime()+o*xe),s=i.getFullYear(),r=String(i.getMonth()+1).padStart(2,"0"),n=String(i.getDate()).padStart(2,"0"),l=String(i.getHours()).padStart(2,"0"),d=String(i.getMinutes()).padStart(2,"0");this._disableAtDate=t,this._disableAtTime=a,this._resumeAtDate=`${s}-${r}-${n}`,this._resumeAtTime=`${l}:${d}`}}_handleScheduleFieldChange(e){const{field:t,value:a}=e.detail;switch(t){case"disableAtDate":this._disableAtDate=a;break;case"disableAtTime":this._disableAtTime=a;break;case"resumeAtDate":this._resumeAtDate=a;break;case"resumeAtTime":this._resumeAtTime=a}}_handleCustomInputToggle(e){this._showCustomInput=e.detail.show}_handleSelectionChange(e){this._selected=e.detail.selected}_handleGuardrailCancel(){this._guardrailConfirmOpen=!1}async _handleGuardrailContinue(){this._guardrailConfirmOpen=!1,await this._snooze(!0)}_renderScheduledPauses(e,t){return 0===e?"":G`
    ...
    `}}lt.styles=[ye,fe],e([ce({attribute:!1})],lt.prototype,"hass",void 0),e([ce({attribute:!1})],lt.prototype,"config",void 0),e([he()],lt.prototype,"_selected",void 0),e([he()],lt.prototype,"_duration",void 0),e([he()],lt.prototype,"_customDuration",void 0),e([he()],lt.prototype,"_customDurationInput",void 0),e([he()],lt.prototype,"_loading",void 0),e([he()],lt.prototype,"_scheduleMode",void 0),e([he()],lt.prototype,"_disableAtDate",void 0),e([he()],lt.prototype,"_disableAtTime",void 0),e([he()],lt.prototype,"_resumeAtDate",void 0),e([he()],lt.prototype,"_resumeAtTime",void 0),e([he()],lt.prototype,"_labelRegistry",void 0),e([he()],lt.prototype,"_labelRegistryUnavailable",void 0),e([he()],lt.prototype,"_categoryRegistry",void 0),e([he()],lt.prototype,"_entityRegistry",void 0),e([he()],lt.prototype,"_showCustomInput",void 0),e([he()],lt.prototype,"_automationsCache",void 0),e([he()],lt.prototype,"_automationsCacheVersion",void 0),e([he()],lt.prototype,"_lastDuration",void 0),e([he()],lt.prototype,"_adjustModalOpen",void 0),e([he()],lt.prototype,"_adjustModalEntityId",void 0),e([he()],lt.prototype,"_adjustModalFriendlyName",void 0),e([he()],lt.prototype,"_adjustModalResumeAt",void 0),e([he()],lt.prototype,"_adjustModalEntityIds",void 0),e([he()],lt.prototype,"_adjustModalFriendlyNames",void 0),e([he()],lt.prototype,"_guardrailConfirmOpen",void 0);const dt=r`
  .row {
    margin-bottom: 12px;
  }
  .row label {
...
`;class ut extends ne{constructor(){super(...arguments),this._config={}}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config)return;const a={...this._config,[e]:t};""!==t&&null!=t||delete a[e],this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:a},bubbles:!0,composed:!0}))}render(){return this._config?G`
      <div class="row">
    ...
    `:G``}}ut.styles=dt,e([ce({attribute:!1})],ut.prototype,"hass",void 0),e([he()],ut.prototype,"_config",void 0);const ct=r`
    :host {
      display: block;
    }
    .snooze-list {
...
`;class ht extends ne{constructor(){super(...arguments),this.pauseGroups=[],this.pausedCount=0,this._wakeAllPending=!1,this._wakeAllTimeout=null,this._countdownState={interval:null,syncTimeout:null}}connectedCallback(){super.connectedCallback(),Ze(this._countdownState),this._countdownState=Ye(()=>this._updateCountdownIfNeeded())}disconnectedCallback(){super.disconnectedCallback(),Ze(this._countdownState),null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null)}_updateCountdownIfNeeded(){this.pauseGroups.length>0&&this.requestUpdate()}_handleWakeAll(){this._wakeAllPending?(null!==this._wakeAllTimeout&&(clearTimeout(this._wakeAllTimeout),this._wakeAllTimeout=null),this._wakeAllPending=!1,this._fireWakeAll()):(qe("medium"),this._wakeAllPending=!0,this._wakeAllTimeout=window.setTimeout(()=>{this._wakeAllPending=!1,this._wakeAllTimeout=null},Ce))}_fireWake(e){this.dispatchEvent(new CustomEvent("wake-automation",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireAdjust(e){this.dispatchEvent(new CustomEvent("adjust-automation",{detail:{entityId:e.entity_id,friendlyName:e.friendly_name,resumeAt:e.resume_at},bubbles:!0,composed:!0}))}_fireAdjustGroup(e){this.dispatchEvent(new CustomEvent("adjust-group",{detail:{entityIds:e.automations.map(e=>e.entity_id),friendlyNames:e.automations.map(e=>e.friendly_name||e.entity_id),resumeAt:e.resumeAt},bubbles:!0,composed:!0}))}_fireWakeAll(){this.dispatchEvent(new CustomEvent("wake-all",{bubbles:!0,composed:!0}))}render(){if(0===this.pausedCount)return G``;const e=this.hass?.locale?.language;return G`
    ...
    `}}ht.styles=[ye,ct],e([ce({attribute:!1})],ht.prototype,"hass",void 0),e([ce({attribute:!1})],ht.prototype,"pauseGroups",void 0),e([ce({type:Number})],ht.prototype,"pausedCount",void 0);const mt=r`
    :host {
      display: block;
    }
...
`;class pt extends ne{constructor(){super(...arguments),this.scheduleMode=!1,this.customDuration={days:0,hours:0,minutes:30},this.customDurationInput="30m",this.showCustomInput=!1,this.lastDuration=null,this.disableAtDate="",this.disableAtTime="",this.resumeAtDate="",this.resumeAtTime=""}_getBasePresets(){const e=this.hass?.states?.[rt],t=e?.attributes?.duration_presets;return t?.length?t:Pe.filter(e=>null!==e.minutes)}_getDurationPills(){return[...this._getBasePresets(),{label:be(this.hass,"duration.custom"),minutes:null}]}_getDurationPreview(){const e=He(this.customDurationInput);return e?Le(e.days,e.hours,e.minutes):""}_isDurationValid(){return Ge(this.customDurationInput)}_renderDateOptions(){const e=function(e=365,t){const a=[],o=new Date,i=o.getFullYear();for(let s=0;s<e;s++){const e=new Date(o);e.setDate(e.getDate()+s);const r=e.getFullYear(),n=`${r}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=e.toLocaleDateString(t,{weekday:"short"}),d=e.toLocaleDateString(t,{month:"short"}),u=e.getDate(),c=r!==i?`${l}, ${d} ${u}, ${r}`:`${l}, ${d} ${u}`;a.push({value:n,label:c})}return a}(365,this.hass?.locale?.language);return e.map(e=>G`<option value="${e.value}">${e.label}</option>`)}_renderLastDurationBadge(){if(!this.lastDuration)return"";const e=this._getBasePresets(),t=this.lastDuration.minutes,a=!e.some(e=>e.minutes===t);if(!a)return"";const{days:o,hours:i,minutes:s}=this.lastDuration.duration,r=Ue(o,i,s).replace(/ /g,""),n=Be(this.customDuration),l=!this.showCustomInput&&t===n;return G`
    ...
    `}}pt.styles=mt,e([ce({attribute:!1})],pt.prototype,"hass",void 0),e([ce({type:Boolean})],pt.prototype,"scheduleMode",void 0),e([ce({attribute:!1})],pt.prototype,"customDuration",void 0),e([ce({type:String})],pt.prototype,"customDurationInput",void 0),e([ce({type:Boolean})],pt.prototype,"showCustomInput",void 0),e([ce({attribute:!1})],pt.prototype,"lastDuration",void 0),e([ce({type:String})],pt.prototype,"disableAtDate",void 0),e([ce({type:String})],pt.prototype,"disableAtTime",void 0),e([ce({type:String})],pt.prototype,"resumeAtDate",void 0),e([ce({type:String})],pt.prototype,"resumeAtTime",void 0);const gt=r`
    :host {
      display: block;
    }
...
`;class _t extends ne{constructor(){super(...arguments),this.automations=[],this.selected=[],this.labelRegistry={},this.labelRegistryUnavailable=!1,this.categoryRegistry={},this._filterTab="all",this._search="",this._expandedGroups={},this._searchTimeout=null}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimeout&&(clearTimeout(this._searchTimeout),this._searchTimeout=null)}_fireSelectionChange(e){this.dispatchEvent(new CustomEvent("selection-change",{detail:{selected:e},bubbles:!0,composed:!0}))}_toggleSelection(e){let t;qe("selection"),t=this.selected.includes(e)?this.selected.filter(t=>t!==e):[...this.selected,e],this._fireSelectionChange(t)}_toggleGroupExpansion(e){this._expandedGroups={...this._expandedGroups,[e]:!this._expandedGroups[e]}}_selectGroup(e){const t=e.map(e=>e.id);let a;a=t.every(e=>this.selected.includes(e))?this.selected.filter(e=>!t.includes(e)):[...new Set([...this.selected,...t])],this._fireSelectionChange(a)}_selectAllVisible(){const e=this._getFilteredAutomations().map(e=>e.id);let t;t=e.every(e=>this.selected.includes(e))?this.selected.filter(t=>!e.includes(t)):[...new Set([...this.selected,...e])],this._fireSelectionChange(t)}_clearSelection(){this._fireSelectionChange([])}_getFilteredAutomations(){return function(e,t,a){let o=e;const i=e.some(e=>ot(e,Ie,a));o=i?o.filter(e=>ot(e,Ie,a)):o.filter(e=>!ot(e,Fe,a));const s=t.toLowerCase();return s&&(o=o.filter(e=>e.name.toLowerCase().includes(s)||e.id.toLowerCase().includes(s))),o}(this.automations,this._search,this.labelRegistry)}_getAreaName(e){return this.hass?function(e,t,a="Unassigned"){return e?t.areas?.[e]?.name??at(e):a}(e,this.hass):be(this.hass,"group.unassigned")}_getLabelName(e){return function(e,t){return t[e]?.name??at(e)}(e,this.labelRegistry)}_getCategoryName(e){return function(e,t,a="Uncategorized"){return e?t[e]?.name??at(e):a}(e,this.categoryRegistry)}_getGroupedByArea(){return it(this._getFilteredAutomations(),e=>e.area_id?[this._getAreaName(e.area_id)]:null,be(this.hass,"group.unassigned"))}_getGroupedByLabel(){const e=this._getFilteredAutomations(),t=[Fe.toLowerCase(),Ie.toLowerCase()];return it(e,e=>{if(!e.labels?.length)return null;const a=e.labels.map(e=>this._getLabelName(e)).filter(e=>!t.includes(e.toLowerCase()));return a.length>0?a:null},be(this.hass,"group.unlabeled"))}_getGroupedByCategory(){return it(this._getFilteredAutomations(),e=>e.category_id?[this._getCategoryName(e.category_id)]:null,be(this.hass,"group.uncategorized"))}_getAreaCount(){return st(this.automations,e=>e.area_id?[e.area_id]:null)}_getLabelCount(){const e=[Fe.toLowerCase(),Ie.toLowerCase()];return st(this.automations,t=>{if(!t.labels?.length)return null;const a=t.labels.filter(t=>!e.includes(this._getLabelName(t).toLowerCase()));return a.length>0?a:null})}_getCategoryCount(){return st(this.automations,e=>e.category_id?[e.category_id]:null)}_handleSearchInput(e){const t=e.target.value;null!==this._searchTimeout&&clearTimeout(this._searchTimeout),this._searchTimeout=window.setTimeout(()=>{this._search=t,this._searchTimeout=null},ke)}_renderSelectionList(){const e=this._getFilteredAutomations();if("all"===this._filterTab)return 0===e.length?G`<div class="list-empty" role="status">${be(this.hass,"list.empty")}</div>`:e.map(e=>G`
        <button
          type="button"
    ...
    `}}_t.styles=gt,e([ce({attribute:!1})],_t.prototype,"hass",void 0),e([ce({attribute:!1})],_t.prototype,"automations",void 0),e([ce({attribute:!1})],_t.prototype,"selected",void 0),e([ce({attribute:!1})],_t.prototype,"labelRegistry",void 0),e([ce({type:Boolean})],_t.prototype,"labelRegistryUnavailable",void 0),e([ce({attribute:!1})],_t.prototype,"categoryRegistry",void 0),e([he()],_t.prototype,"_filterTab",void 0),e([he()],_t.prototype,"_search",void 0),e([he()],_t.prototype,"_expandedGroups",void 0);const bt=r`
    :host {
      display: block;
    }
    .modal-overlay {
...
`,ft=[{label:"+15m",minutes:15},{label:"+30m",minutes:30},{label:"+1h",hours:1},{label:"+2h",hours:2}],yt=[{label:"-15m",minutes:-15,thresholdMs:15*xe},{label:"-30m",minutes:-30,thresholdMs:30*xe}],vt=xe;class xt extends ne{constructor(){super(...arguments),this.open=!1,this.entityId="",this.friendlyName="",this.resumeAt="",this.entityIds=[],this.friendlyNames=[],this._countdownState={interval:null,syncTimeout:null}}get _isGroupMode(){return this.entityIds.length>1}updated(e){e.has("open")&&(this.open?this._startSynchronizedCountdown():this._stopCountdown())}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown()}_startSynchronizedCountdown(){Ze(this._countdownState),this._countdownState=Ye(()=>this.requestUpdate())}_stopCountdown(){Ze(this._countdownState)}_isDecrementDisabled(e){if(!this.resumeAt)return!0;return new Date(this.resumeAt).getTime()-Date.now()-e<vt}_fireAdjustTime(e){this.entityIds.length>0?this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityIds:this.entityIds,...e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("adjust-time",{detail:{entityId:this.entityId,...e},bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}_handleOverlayKeydown(e){"Escape"===e.key&&this._close()}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}render(){return this.open?G`
    ...
    `:G``}}xt.styles=bt,e([ce({attribute:!1})],xt.prototype,"hass",void 0),e([ce({type:Boolean})],xt.prototype,"open",void 0),e([ce({type:String})],xt.prototype,"entityId",void 0),e([ce({type:String})],xt.prototype,"friendlyName",void 0),e([ce({type:String})],xt.prototype,"resumeAt",void 0),e([ce({attribute:!1})],xt.prototype,"entityIds",void 0),e([ce({attribute:!1})],xt.prototype,"friendlyNames",void 0),customElements.get("autosnooze-card-editor")||customElements.define("autosnooze-card-editor",ut),customElements.get("autosnooze-active-pauses")||customElements.define("autosnooze-active-pauses",ht),customElements.get("autosnooze-duration-selector")||customElements.define("autosnooze-duration-selector",pt),customElements.get("autosnooze-automation-list")||customElements.define("autosnooze-automation-list",_t),customElements.get("autosnooze-adjust-modal")||customElements.define("autosnooze-adjust-modal",xt),customElements.get("autosnooze-card")||customElements.define("autosnooze-card",lt),window.customCards=window.customCards||[],window.customCards.some(e=>"autosnooze-card"===e.type)||window.customCards.push({type:"autosnooze-card",name:"AutoSnooze Card",description:"Temporarily pause automations with area and label filtering (v0.2.13)",preview:!0});export{ht as AutoSnoozeActivePauses,xt as AutoSnoozeAdjustModal,_t as AutoSnoozeAutomationList,pt as AutoSnoozeDurationSelector,lt as AutomationPauseCard,ut as AutomationPauseCardEditor};
