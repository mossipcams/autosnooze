/**
 * Tests for AutoSnoozeDurationSelector component.
 * Verifies the extracted duration selector renders and fires events correctly.
 */
...
describe('AutoSnoozeDurationSelector', () => {
  ...
  it('should fire duration-change event with correct detail', () => {
    ...
    el.addEventListener('duration-change', (e) => { firedDetail = e.detail; });
  ...
  it('should fire schedule-mode-change and schedule-field-change events', () => {
    ...
    el.addEventListener('schedule-mode-change', (e) => { modeDetail = e.detail; });
    el.addEventListener('schedule-field-change', (e) => { fieldDetail = e.detail; });
  ...
  it('should render last duration badge when lastDuration is unique from presets', async () => {
    const el = new AutoSnoozeDurationSelector();
    el.lastDuration = { minutes: 45, duration: { days: 0, hours: 0, minutes: 45 } };
    document.body.appendChild(el);
    await el.updateComplete;
  ...
  it('should render schedule link in duration mode', async () => {
    ...
    let detail = null;
    el.addEventListener('schedule-mode-change', (e) => { detail = e.detail; });
    link.click();
