...
## [0.4.0](https://github.com/mossipcams/autosnooze/compare/v0.3.0...v0.4.0) (2026-08-13)
...
* add "Until tomorrow" snooze preset ([#466](https://github.com/mossipcams/autosnooze/issues/466)) ([004f312](https://github.com/mossipcams/autosnooze/commit/004f3126db22c05ee2cdc04d96b7553643b1cb6e))
...
* recut 0.3.0 with PostHog key and header hide-snoozed toggle ([#508](https://github.com/mossipcams/autosnooze/issues/508)) ([88782e9](https://github.com/mossipcams/autosnooze/commit/88782e9b0654f6041965ae8f8399c57bf20000cf))
...
* consolidate duplicates, improve error handling, and add tests ([#143](https://github.com/mossipcams/autosnooze/issues/143)) ([45b85aa](https://github.com/mossipcams/autosnooze/commit/45b85aa54696f90a808405b35f76ee9e9051c3c8))
* extract application runtime and feature layers ([#329](https://github.com/mossipcams/autosnooze/issues/329)) ([1dfe99d](https://github.com/mossipcams/autosnooze/commit/1dfe99d3364ec23d070c6f9ea13e16d1b96357a1))
* inject CARD_VERSION from package.json at build time ([9c204c7](https://github.com/mossipcams/autosnooze/commit/9c204c764ab08b160e0b9ef852f08cab124be602))
* migrate frontend card from JavaScript to TypeScript ([#230](https://github.com/mossipcams/autosnooze/issues/230)) ([9fcd9bb](https://github.com/mossipcams/autosnooze/commit/9fcd9bbe19f8c14ed47bc83a43b58e7a44c7a85f))
* migrate frontend card from JavaScript to TypeScript ([#231](https://github.com/mossipcams/autosnooze/issues/231)) ([5b70273](https://github.com/mossipcams/autosnooze/commit/5b70273c604b27827e21b6c6d2223e58f2267a30))
* migrate frontend card from JavaScript to TypeScript ([#232](https://github.com/mossipcams/autosnooze/issues/232)) ([5382d11](https://github.com/mossipcams/autosnooze/commit/5382d11476ea497fb605e3a28a60536d1a7ae1bc))
* migrate test framework from Jest to Vitest ([#188](https://github.com/mossipcams/autosnooze/issues/188)) ([d24ef5f](https://github.com/mossipcams/autosnooze/commit/d24ef5ff4fccd4e27bd8889540dfed0af9adab42))
...
* replace autosnooze card styles with new mobile-first design ([#185](https://github.com/mossipcams/autosnooze/issues/185)) ([2000591](https://github.com/mossipcams/autosnooze/commit/20005911237c1161e329fba16bdc67c89ed58bce))
* simplify recent sort and drop narrative test comments ([a1cdd58](https://github.com/mossipcams/autosnooze/commit/a1cdd588365bf7bc23ba2f79437b120be824f75d))
* TypeScript migration with backend schema validation tests ([#233](https://github.com/mossipcams/autosnooze/issues/233)) ([4b40c38](https://github.com/mossipcams/autosnooze/commit/4b40c381fdde0bca9335458e024277ba0c04cc04))
